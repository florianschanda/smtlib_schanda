...
(assert (= z (fp #b1 #b01111000 #b01111011101010011101000)))
;; z should be Float32(0xBC3DD4E8 [Rational(-1555101, 134217728), -0.011586])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10000001 #b00000000101111011101000))))
(check-sat)
(exit)
