...
(assert (= z ((_ to_fp 8 24) #x0BCDBC18)))
;; z should be Float32(0x0BCDBC18 [Rational(1685379, 21267647932558653966460912964485513216), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00010111 #b10011011011110000011000)))
(check-sat)
(exit)
