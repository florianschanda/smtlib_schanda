...
(assert (= z (fp #b1 #b00000000 #b10101011100100100100101)))
;; z should be Float32(0x8055C925 [Rational(-5622053, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x8055C925)))
(check-sat)
(exit)
