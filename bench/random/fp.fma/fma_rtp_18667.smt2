...
(assert (= z ((_ to_fp 8 24) #x002F3D14)))
;; z should be Float32(0x002F3D14 [Rational(773957, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x002F3D15)))
(check-sat)
(exit)
