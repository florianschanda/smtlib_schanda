...
(assert (= y (fp #b1 #b01111111 #b11001110011010010100100)))
;; y should be Float32(0xBFE734A4 [Rational(-3788073, 2097152), -1.806294])
...
(assert (not (= result ((_ to_fp 8 24) #x81339A52))))
(check-sat)
(exit)
