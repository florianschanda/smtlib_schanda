...
(assert (= x ((_ to_fp 8 24) #x4AE1FDCD)))
;; x should be Float32(0x4AE1FDCD [Rational(14810573, 2), 7405286.500000])
...
(assert (= result (fp #b0 #b00010111 #b11000011111110111001011)))
(check-sat)
(exit)
