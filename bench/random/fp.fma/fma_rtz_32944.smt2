...
(assert (= z (fp #b1 #b10011000 #b11110011011110000111101)))
;; z should be Float32(0xCC79BC3D [Rational(-65466612), -65466612.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCC79BC3D))))
(check-sat)
(exit)
