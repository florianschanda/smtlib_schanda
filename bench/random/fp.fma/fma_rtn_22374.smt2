...
(assert (= y (fp #b0 #b11111111 #b11000111010000100101001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10010101 #b01100010011100101101011)))
;; z should be Float32(0xCAB1396B [Rational(-11614571, 2), -5807285.500000])
