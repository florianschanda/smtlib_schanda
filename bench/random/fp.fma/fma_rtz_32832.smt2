...
(assert (= y (fp #b1 #b00000000 #b00010001001011001001000)))
;; y should be Float32(0x80089648 [Rational(-70345, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFC44DF8)))
