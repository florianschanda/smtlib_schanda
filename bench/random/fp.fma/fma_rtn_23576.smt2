...
(assert (= x (fp #b0 #b00000000 #b00001110010000001011001)))
;; x should be Float32(0x00072059 [Rational(467033, 713623846352979940529142984724747568191373312), 0.000000])
