...
(assert (= y (fp #b1 #b10010010 #b10100100010110111001000)))
;; y should be Float32(0xC9522DC8 [Rational(-1721785, 2), -860892.500000])
...
(assert (= result (fp #b1 #b00010100 #b10100100010110111001000)))
(check-sat)
(exit)
