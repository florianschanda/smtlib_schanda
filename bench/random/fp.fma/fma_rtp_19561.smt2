...
(assert (= x (fp #b1 #b11011010 #b10001000100101101011010)))
;; x should be Float32(0xED444B5A [Rational(-3796884773402386807889330176), -3796884773402386807889330176.000000])
