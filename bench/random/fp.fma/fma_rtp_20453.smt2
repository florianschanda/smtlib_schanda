...
(assert (= x ((_ to_fp 8 24) #xFF8DAB2A)))
...
(assert (= z (fp #b0 #b00000000 #b11100100111000011001101)))
;; z should be Float32(0x007270CD [Rational(7499981, 713623846352979940529142984724747568191373312), 0.000000])
