...
(assert (= z (fp #b1 #b10000110 #b11100011010011101001011)))
;; z should be Float32(0xC371A74B [Rational(-15837003, 65536), -241.653488])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xC371A74A)))
(check-sat)
(exit)
