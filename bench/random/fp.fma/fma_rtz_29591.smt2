...
(assert (= y (fp #b0 #b11111111 #b01101010011001110001001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x534BBB7F)))
;; z should be Float32(0x534BBB7F [Rational(875024023552), 875024023552.000000])
