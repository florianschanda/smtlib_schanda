...
(assert (= z (fp #b0 #b10010101 #b00110111111100100010111)))
;; z should be Float32(0x4A9BF917 [Rational(10221847, 2), 5110923.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x4A9BF91F)))
(check-sat)
(exit)
