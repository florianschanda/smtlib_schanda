...
(assert (= x ((_ to_fp 8 24) #x00239C24)))
;; x should be Float32(0x00239C24 [Rational(583433, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b11001000011101100011101)))
