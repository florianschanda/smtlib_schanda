...
(assert (= x ((_ to_fp 8 24) #xCA8832C3)))
;; x should be Float32(0xCA8832C3 [Rational(-8925891, 2), -4462945.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00010000011001011000010))))
(check-sat)
(exit)
