...
(assert (= x (fp #b0 #b00000000 #b11001101100110001110101)))
;; x should be Float32(0x0066CC75 [Rational(6737013, 713623846352979940529142984724747568191373312), 0.000000])
