...
(assert (= z (fp #b1 #b00000000 #b11010110010010000111011)))
;; z should be Float32(0x806B243B [Rational(-7021627, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x806B243B)))
(check-sat)
(exit)
