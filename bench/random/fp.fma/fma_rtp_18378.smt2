...
(assert (= y (fp #b1 #b00000000 #b10010101000111011010110)))
;; y should be Float32(0x804A8ED6 [Rational(-2443115, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b00101010001110110101100)))
(check-sat)
(exit)
