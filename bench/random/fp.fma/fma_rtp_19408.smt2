...
(assert (= z (fp #b0 #b00000000 #b10011100011111111100101)))
;; z should be Float32(0x004E3FE5 [Rational(5128165, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b10011100011111111100110)))
(check-sat)
(exit)
