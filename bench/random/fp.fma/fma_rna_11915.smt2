...
(assert (= z ((_ to_fp 8 24) #x4AE9A66F)))
;; z should be Float32(0x4AE9A66F [Rational(15312495, 2), 7656247.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11010011010011001101111)))
(check-sat)
(exit)
