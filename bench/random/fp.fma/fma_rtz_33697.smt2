...
(assert (= x (fp #b1 #b00000000 #b11011000101010111111100)))
;; x should be Float32(0x806C55FC [Rational(-1774975, 178405961588244985132285746181186892047843328), -0.000000])
