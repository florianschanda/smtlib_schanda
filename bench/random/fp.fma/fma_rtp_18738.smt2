...
(assert (= y (fp #b1 #b00000000 #b00100010010111111000100)))
;; y should be Float32(0x80112FC4 [Rational(-281585, 178405961588244985132285746181186892047843328), -0.000000])
