...
(assert (= z (fp #b1 #b10010011 #b10010011100101111010100)))
;; z should be Float32(0xC9C9CBD4 [Rational(-3306229, 2), -1653114.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010011 #b10010011100101111010100)))
(check-sat)
(exit)
