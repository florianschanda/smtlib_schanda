...
(assert (= y (fp #b0 #b10111100 #b00001101101010100100010)))
;; y should be Float32(0x5E06D522 [Rational(2428927288629264384), 2428927288629264384.000000])
...
(assert (= result ((_ to_fp 8 24) #x9386D522)))
(check-sat)
(exit)
