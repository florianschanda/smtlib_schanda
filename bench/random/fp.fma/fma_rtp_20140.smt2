...
(assert (= x (fp #b1 #b00000000 #b11110000101111000010011)))
;; x should be Float32(0x80785E13 [Rational(-7888403, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FC5ADA1)))
