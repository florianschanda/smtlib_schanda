...
(assert (= z (fp #b0 #b10010100 #b10110111111110111000110)))
;; z should be Float32(0x4A5BFDC6 [Rational(7208675, 2), 3604337.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A5BFDC6))))
(check-sat)
(exit)
