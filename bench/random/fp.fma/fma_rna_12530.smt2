...
(assert (= z (fp #b0 #b00000000 #b00100101101001101010001)))
;; z should be Float32(0x0012D351 [Rational(1233745, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0012D351))))
(check-sat)
(exit)
