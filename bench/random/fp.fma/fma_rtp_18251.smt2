...
(assert (= y ((_ to_fp 8 24) #xC9E45A0C)))
;; y should be Float32(0xC9E45A0C [Rational(-3741315, 2), -1870657.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b10010101 #b11111011011110111111011)))
;; z should be Float32(0xCAFDBDFB [Rational(-16629243, 2), -8314621.500000])
