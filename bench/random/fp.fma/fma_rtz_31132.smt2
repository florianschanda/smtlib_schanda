...
(assert (= x (fp #b1 #b10010100 #b10110010111110101011110)))
;; x should be Float32(0xCA597D5E [Rational(-7126703, 2), -3563351.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b10110010111110101011100))))
(check-sat)
(exit)
