...
(assert (= y (fp #b1 #b10100111 #b01000100100000100101000)))
;; y should be Float32(0xD3A24128 [Rational(-1393755684864), -1393755684864.000000])
...
(assert (not (= result (fp #b0 #b00010010 #b01000100100000100101000))))
(check-sat)
(exit)
