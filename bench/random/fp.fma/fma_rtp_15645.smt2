...
(assert (= z (fp #b0 #b00001111 #b01100100100010011010001)))
;; z should be Float32(0x07B244D1 [Rational(11683025, 43556142965880123323311949751266331066368), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x07B244D2))))
(check-sat)
(exit)
