...
(assert (= y (fp #b1 #b10010101 #b11110010011001111011011)))
;; y should be Float32(0xCAF933DB [Rational(-16331739, 2), -8165869.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b00000100001110101001011)))
