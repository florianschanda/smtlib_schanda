...
(assert (= z ((_ to_fp 8 24) #x0059B1F7)))
;; z should be Float32(0x0059B1F7 [Rational(5878263, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b10110011011000111110111)))
(check-sat)
(exit)
