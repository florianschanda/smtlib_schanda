...
(assert (= x (fp #b0 #b00000000 #b11101001110110110100100)))
;; x should be Float32(0x0074EDA4 [Rational(1915753, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FCC6C28)))
