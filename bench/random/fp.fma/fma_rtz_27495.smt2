...
(assert (= z (fp #b0 #b10010100 #b11101101110011110011110)))
;; z should be Float32(0x4A76E79E [Rational(8090575, 2), 4045287.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A76E79E))))
(check-sat)
(exit)
