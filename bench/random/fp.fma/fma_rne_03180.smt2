...
(assert (= x (fp #b0 #b00000000 #b11001001000000100100011)))
;; x should be Float32(0x00648123 [Rational(6586659, 713623846352979940529142984724747568191373312), 0.000000])
