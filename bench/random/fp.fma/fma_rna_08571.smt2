...
(assert (= z (fp #b0 #b10010100 #b01100111000111101101110)))
;; z should be Float32(0x4A338F6E [Rational(5883831, 2), 2941915.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010100 #b01100111000111101101110)))
(check-sat)
(exit)
