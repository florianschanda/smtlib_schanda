...
(assert (= z (fp #b1 #b01011010 #b01000010100001010001000)))
;; z should be Float32(0xAD214288 [Rational(-1321041, 144115188075855872), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01011010 #b01000010100001010001001))))
(check-sat)
(exit)
