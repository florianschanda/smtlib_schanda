...
(assert (= x (fp #b0 #b11111000 #b11001010001101111111100)))
;; x should be Float32(0x7C651BFC [Rational(4758414284642910866592015233006436352), 4758414284642910866592015233006436352.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBD651BFC))))
(check-sat)
(exit)
