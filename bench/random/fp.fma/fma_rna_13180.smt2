...
(assert (= x (fp #b1 #b00000000 #b01000100100011100101100)))
;; x should be Float32(0x8022472C [Rational(-561611, 178405961588244985132285746181186892047843328), -0.000000])
