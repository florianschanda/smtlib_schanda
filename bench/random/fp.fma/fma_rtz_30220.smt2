...
(assert (= x (fp #b0 #b10011001 #b10011010010011101001111)))
;; x should be Float32(0x4CCD274F [Rational(107559544), 107559544.000000])
...
(assert (= result (fp #b1 #b00011011 #b10011010010011101001101)))
(check-sat)
(exit)
