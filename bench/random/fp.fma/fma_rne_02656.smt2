...
(assert (= x (fp #b0 #b10001100 #b01100100010000010110001)))
;; x should be Float32(0x463220B1 [Rational(11673777, 1024), 11400.172852])
...
(assert (= result ((_ to_fp 8 24) #x807FD378)))
(check-sat)
(exit)
