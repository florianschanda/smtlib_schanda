...
(assert (= y (fp #b0 #b10010101 #b10000001001111111101001)))
;; y should be Float32(0x4AC09FE9 [Rational(12623849, 2), 6311924.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BC09FE9))))
(check-sat)
(exit)
