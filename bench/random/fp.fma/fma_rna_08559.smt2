...
(assert (= z ((_ to_fp 8 24) #x0044C9B9)))
;; z should be Float32(0x0044C9B9 [Rational(4508089, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10001001100100110111001)))
(check-sat)
(exit)
