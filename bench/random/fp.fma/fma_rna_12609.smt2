...
(assert (= y (fp #b1 #b00000000 #b01101000011001001100010)))
;; y should be Float32(0x80343262 [Rational(-1710385, 356811923176489970264571492362373784095686656), -0.000000])
