...
(assert (= z (fp #b0 #b10010100 #b10010011111101011111110)))
;; z should be Float32(0x4A49FAFE [Rational(6618495, 2), 3309247.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A49FAFE))))
(check-sat)
(exit)
