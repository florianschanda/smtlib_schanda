...
(assert (= z ((_ to_fp 8 24) #x81701CB9)))
;; z should be Float32(0x81701CB9 [Rational(-15735993, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000010 #b11100000001110010111001))))
(check-sat)
(exit)
