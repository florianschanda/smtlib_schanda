...
(assert (= z ((_ to_fp 8 24) #x8067177C)))
;; z should be Float32(0x8067177C [Rational(-1689055, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b11001110001011101111100)))
(check-sat)
(exit)
