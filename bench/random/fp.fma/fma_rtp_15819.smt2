...
(assert (= z ((_ to_fp 8 24) #xCABF37B1)))
;; z should be Float32(0xCABF37B1 [Rational(-12531633, 2), -6265816.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01111110011011110110001))))
(check-sat)
(exit)
