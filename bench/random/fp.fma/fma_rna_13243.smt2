...
(assert (= x ((_ to_fp 8 24) #x803531D6)))
;; x should be Float32(0x803531D6 [Rational(-1743083, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFB85386)))
