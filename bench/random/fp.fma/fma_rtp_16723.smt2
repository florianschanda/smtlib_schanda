...
(assert (= x (fp #b0 #b00000000 #b00110001100000111101010)))
;; x should be Float32(0x0018C1EA [Rational(811253, 356811923176489970264571492362373784095686656), 0.000000])
