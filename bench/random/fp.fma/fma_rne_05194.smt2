...
(assert (= y (fp #b0 #b01101100 #b00100000111110011101000)))
;; y should be Float32(0x36107CE8 [Rational(1183645, 549755813888), 0.000002])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000000000010001))))
(check-sat)
(exit)
