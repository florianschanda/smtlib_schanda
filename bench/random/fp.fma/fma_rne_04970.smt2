...
(assert (= z (fp #b1 #b10010100 #b11110110011111001010010)))
;; z should be Float32(0xCA7B3E52 [Rational(-8232745, 2), -4116372.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11110110011111001010010))))
(check-sat)
(exit)
