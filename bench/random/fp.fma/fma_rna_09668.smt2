...
(assert (= x (fp #b0 #b01101110 #b01000101111100110010011)))
;; x should be Float32(0x3722F993 [Rational(10680723, 1099511627776), 0.000010])
...
(assert (= result ((_ to_fp 8 24) #x80000052)))
(check-sat)
(exit)
