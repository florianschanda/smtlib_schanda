...
(assert (= z ((_ to_fp 8 24) #x006EC982)))
;; z should be Float32(0x006EC982 [Rational(3630273, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006EC982))))
(check-sat)
(exit)
