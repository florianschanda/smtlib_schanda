...
(assert (= x (fp #b0 #b10010011 #b10100101100101111111100)))
;; x should be Float32(0x49D2CBFC [Rational(3453695, 2), 1726847.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00001000110100000100001)))
