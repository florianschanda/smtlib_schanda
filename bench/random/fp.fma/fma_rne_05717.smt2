...
(assert (= z (fp #b1 #b11011100 #b10111010010001011010001)))
;; z should be Float32(0xEE5D22D1 [Rational(-17109569405744769333991571456), -17109569405744769333991571456.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xEE5D22D1)))
(check-sat)
(exit)
