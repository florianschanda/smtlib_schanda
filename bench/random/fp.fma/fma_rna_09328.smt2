...
(assert (= z (fp #b1 #b00000000 #b00010110100011010000010)))
;; z should be Float32(0x800B4682 [Rational(-369473, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00010110100011010000010))))
(check-sat)
(exit)
