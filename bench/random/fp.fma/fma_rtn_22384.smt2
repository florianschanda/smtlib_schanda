...
(assert (= z (fp #b0 #b10010101 #b11111011100101001011001)))
;; z should be Float32(0x4AFDCA59 [Rational(16632409, 2), 8316204.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11111011100101001011001)))
(check-sat)
(exit)
