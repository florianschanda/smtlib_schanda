...
(assert (= z ((_ to_fp 8 24) #x1B676256)))
;; z should be Float32(0x1B676256 [Rational(7581995, 39614081257132168796771975168), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x1B676255)))
(check-sat)
(exit)
