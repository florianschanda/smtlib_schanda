...
(assert (= z (fp #b1 #b10010101 #b10010010000010001110001)))
;; z should be Float32(0xCAC90471 [Rational(-13173873, 2), -6586936.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10010010000010001110001))))
(check-sat)
(exit)
