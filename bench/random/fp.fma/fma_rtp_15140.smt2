...
(assert (= y ((_ to_fp 8 24) #x805DF30F)))
;; y should be Float32(0x805DF30F [Rational(-6157071, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b01110111110011000011101))))
(check-sat)
(exit)
