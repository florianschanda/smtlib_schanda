...
(assert (= z (fp #b0 #b10010101 #b11011111100111010110111)))
;; z should be Float32(0x4AEFCEB7 [Rational(15716023, 2), 7858011.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11011111100111010110111)))
(check-sat)
(exit)
