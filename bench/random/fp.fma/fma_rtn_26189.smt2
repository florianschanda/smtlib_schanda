...
(assert (= y ((_ to_fp 8 24) #xCAA4E77B)))
;; y should be Float32(0xCAA4E77B [Rational(-10807163, 2), -5403581.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10100100111001110111110))))
(check-sat)
(exit)
