...
(assert (= z ((_ to_fp 8 24) #x80698CE8)))
;; z should be Float32(0x80698CE8 [Rational(-864669, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11010011000110011100111))))
(check-sat)
(exit)
