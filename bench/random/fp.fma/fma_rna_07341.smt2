...
(assert (= x ((_ to_fp 8 24) #x4ABD321D)))
;; x should be Float32(0x4ABD321D [Rational(12399133, 2), 6199566.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10111101001100100010000))))
(check-sat)
(exit)
