...
(assert (= x (fp #b1 #b00000000 #b00010111110011011011110)))
;; x should be Float32(0x800BE6DE [Rational(-389999, 356811923176489970264571492362373784095686656), -0.000000])
