...
(assert (= x ((_ to_fp 8 24) #x6B543791)))
;; x should be Float32(0x6B543791 [Rational(256554678692749903409446912), 256554678692749903409446912.000000])
...
(assert (not (= result (fp #b0 #b01000001 #b10101000011011110010001))))
(check-sat)
(exit)
