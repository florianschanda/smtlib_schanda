...
(assert (= x (fp #b0 #b00000000 #b10101110101111111111110)))
;; x should be Float32(0x00575FFE [Rational(2863103, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC02EBFFB)))
(check-sat)
(exit)
