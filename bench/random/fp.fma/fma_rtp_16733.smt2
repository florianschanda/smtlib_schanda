...
(assert (= x (fp #b0 #b00000000 #b11110100010011100111110)))
;; x should be Float32(0x007A273E [Rational(4002719, 356811923176489970264571492362373784095686656), 0.000000])
