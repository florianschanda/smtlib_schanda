...
(assert (= x (fp #b1 #b11111111 #b00100110110010011000010)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8037A358)))
;; y should be Float32(0x8037A358 [Rational(-455787, 89202980794122492566142873090593446023921664), -0.000000])
