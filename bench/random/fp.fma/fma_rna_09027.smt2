...
(assert (= z (fp #b0 #b10010010 #b10110111010101111001000)))
;; z should be Float32(0x495BABC8 [Rational(1799545, 2), 899772.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010010 #b10110111010101111001000)))
(check-sat)
(exit)
