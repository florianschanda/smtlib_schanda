...
(assert (= y ((_ to_fp 8 24) #x770C536B)))
;; y should be Float32(0x770C536B [Rational(2846146396895968683295232879493120), 2846146396895968683295232879493120.000000])
...
(assert (= result ((_ to_fp 8 24) #x380C536B)))
(check-sat)
(exit)
