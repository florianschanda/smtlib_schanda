...
(assert (= z (fp #b1 #b10010101 #b11000100011101110110111)))
;; z should be Float32(0xCAE23BB7 [Rational(-14826423, 2), -7413211.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAE23BB7))))
(check-sat)
(exit)
