...
(assert (= z (fp #b0 #b10101100 #b00010001000000010101000)))
;; z should be Float32(0x560880A8 [Rational(37521538940928), 37521538940928.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x560880A8))))
(check-sat)
(exit)
