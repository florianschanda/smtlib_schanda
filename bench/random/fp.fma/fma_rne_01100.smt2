...
(assert (= z ((_ to_fp 8 24) #xADB68A98)))
;; z should be Float32(0xADB68A98 [Rational(-1495379, 72057594037927936), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b01011011 #b01101101000101010011000)))
(check-sat)
(exit)
