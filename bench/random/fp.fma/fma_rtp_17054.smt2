...
(assert (= z ((_ to_fp 8 24) #xCAFCEEB3)))
;; z should be Float32(0xCAFCEEB3 [Rational(-16576179, 2), -8288089.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b11111001110111010110011)))
(check-sat)
(exit)
