...
(assert (= z (fp #b0 #b10010101 #b01010010010000100110101)))
;; z should be Float32(0x4AA92135 [Rational(11084085, 2), 5542042.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AA9212D))))
(check-sat)
(exit)
