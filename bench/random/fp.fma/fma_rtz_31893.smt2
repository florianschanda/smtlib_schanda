...
(assert (= z (fp #b1 #b10010101 #b01110110001111011100101)))
;; z should be Float32(0xCABB1EE5 [Rational(-12263141, 2), -6131570.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCABB1EE5))))
(check-sat)
(exit)
