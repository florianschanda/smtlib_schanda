...
(assert (= z (fp #b0 #b10010101 #b11000010101101101000101)))
;; z should be Float32(0x4AE15B45 [Rational(14768965, 2), 7384482.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11000010101101100111101))))
(check-sat)
(exit)
