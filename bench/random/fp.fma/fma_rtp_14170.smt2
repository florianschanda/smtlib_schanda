...
(assert (= x ((_ to_fp 8 24) #x49A874FC)))
;; x should be Float32(0x49A874FC [Rational(2759999, 2), 1379999.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b01010000111010011110011))))
(check-sat)
(exit)
