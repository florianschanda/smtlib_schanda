...
(assert (= x (fp #b1 #b00000000 #b11110111100100111001001)))
;; x should be Float32(0x807BC9C9 [Rational(-8112585, 713623846352979940529142984724747568191373312), -0.000000])
