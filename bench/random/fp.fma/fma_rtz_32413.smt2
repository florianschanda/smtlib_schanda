...
(assert (= z ((_ to_fp 8 24) #x805A4DE3)))
;; z should be Float32(0x805A4DE3 [Rational(-5918179, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10110100100110111100010))))
(check-sat)
(exit)
