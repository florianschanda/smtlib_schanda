...
(assert (= x (fp #b1 #b00000000 #b00001000110001100010110)))
;; x should be Float32(0x80046316 [Rational(-143755, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FE41FA9)))
