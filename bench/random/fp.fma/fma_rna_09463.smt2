...
(assert (= x ((_ to_fp 8 24) #x6CB5BA54)))
;; x should be Float32(0x6CB5BA54 [Rational(1757563864340510609871208448), 1757563864340510609871208448.000000])
...
(assert (= result ((_ to_fp 8 24) #x2DB5BA53)))
(check-sat)
(exit)
