...
(assert (= z (fp #b0 #b01111101 #b01010101000100100010110)))
;; z should be Float32(0x3EAA8916 [Rational(5588107, 16777216), 0.333077])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x3EAA8925))))
(check-sat)
(exit)
