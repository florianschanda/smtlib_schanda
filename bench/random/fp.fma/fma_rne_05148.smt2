...
(assert (= z ((_ to_fp 8 24) #x8009AD38)))
;; z should be Float32(0x8009AD38 [Rational(-79271, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00010011010110100111000))))
(check-sat)
(exit)
