...
(assert (= x (fp #b1 #b11111111 #b11110000010101110000001)))
...
(assert (= z ((_ to_fp 8 24) #x804AA2A1)))
;; z should be Float32(0x804AA2A1 [Rational(-4891297, 713623846352979940529142984724747568191373312), -0.000000])
