...
(assert (= z ((_ to_fp 8 24) #x801548B8)))
;; z should be Float32(0x801548B8 [Rational(-174359, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x801548B8)))
(check-sat)
(exit)
