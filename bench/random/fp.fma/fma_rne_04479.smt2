...
(assert (= y (fp #b0 #b00000001 #b11011111110111110001011)))
;; y should be Float32(0x00EFEF8B [Rational(15724427, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0EFEF8A))))
(check-sat)
(exit)
