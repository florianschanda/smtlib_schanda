...
(assert (= x (fp #b1 #b10010101 #b01101000101100101011101)))
;; x should be Float32(0xCAB4595D [Rational(-11819357, 2), -5909678.500000])
...
(assert (= result (fp #b1 #b00010111 #b01101000101100101011010)))
(check-sat)
(exit)
