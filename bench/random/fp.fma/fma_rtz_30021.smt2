...
(assert (= x ((_ to_fp 8 24) #x0848E318)))
;; x should be Float32(0x0848E318 [Rational(1645667, 2722258935367507707706996859454145691648), 0.000000])
...
(assert (= result (fp #b0 #b10010000 #b10010001110001100010111)))
(check-sat)
(exit)
