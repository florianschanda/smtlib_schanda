...
(assert (= x (fp #b1 #b11111111 #b00011001000010111111100)))
...
(assert (= z ((_ to_fp 8 24) #x1E014A3B)))
;; z should be Float32(0x1E014A3B [Rational(8473147, 1237940039285380274899124224), 0.000000])
