...
(assert (= y (fp #b0 #b00000000 #b01101010011011111000111)))
;; y should be Float32(0x003537C7 [Rational(3487687, 713623846352979940529142984724747568191373312), 0.000000])
