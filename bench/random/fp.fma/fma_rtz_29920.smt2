...
(assert (= y (fp #b1 #b11001100 #b01111000010011001110001)))
;; y should be Float32(0xE63C2671 [Rational(-222128504390605137248256), -222128504390605137248256.000000])
...
(assert (not (= result (fp #b1 #b00110111 #b01111000010011001110001))))
(check-sat)
(exit)
