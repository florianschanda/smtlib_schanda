...
(assert (= z (fp #b0 #b10010101 #b11110000010010001100111)))
;; z should be Float32(0x4AF82467 [Rational(16262247, 2), 8131123.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AF82467))))
(check-sat)
(exit)
