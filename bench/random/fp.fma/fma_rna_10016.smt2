...
(assert (= x (fp #b0 #b00000000 #b00001110110101100101101)))
;; x should be Float32(0x00076B2D [Rational(486189, 713623846352979940529142984724747568191373312), 0.000000])
