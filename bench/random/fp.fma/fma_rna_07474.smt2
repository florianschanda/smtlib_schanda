...
(assert (= x (fp #b0 #b10010010 #b00011001001011011011000)))
;; x should be Float32(0x490C96D8 [Rational(1151707, 2), 575853.500000])
...
(assert (= result (fp #b1 #b00010100 #b00011001001011011010111)))
(check-sat)
(exit)
