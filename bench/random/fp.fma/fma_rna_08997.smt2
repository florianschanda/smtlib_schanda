...
(assert (= y (fp #b1 #b00000000 #b11010001000100010100100)))
;; y should be Float32(0x806888A4 [Rational(-1712681, 178405961588244985132285746181186892047843328), -0.000000])
