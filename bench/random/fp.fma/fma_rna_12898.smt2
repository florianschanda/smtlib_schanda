...
(assert (= x ((_ to_fp 8 24) #xFD762322)))
;; x should be Float32(0xFD762322 [Rational(-20448281684691534241133094900439449600), -20448281684691534241133094900439449600.000000])
...
(assert (= result (fp #b0 #b01111100 #b11101100010001100100000)))
(check-sat)
(exit)
