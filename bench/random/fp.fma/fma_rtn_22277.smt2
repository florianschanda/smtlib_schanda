...
(assert (= z ((_ to_fp 8 24) #x0078274D)))
;; z should be Float32(0x0078274D [Rational(7874381, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x0078274C)))
(check-sat)
(exit)
