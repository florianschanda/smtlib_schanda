...
(assert (= z ((_ to_fp 8 24) #xF00B86B0)))
;; z should be Float32(0xF00B86B0 [Rational(-172724974245985239678851219456), -172724974245985239678851219456.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xF00B86B0)))
(check-sat)
(exit)
