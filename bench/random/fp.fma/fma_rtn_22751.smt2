...
(assert (= z ((_ to_fp 8 24) #x260B1C5F)))
;; z should be Float32(0x260B1C5F [Rational(9116767, 18889465931478580854784), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01001100 #b00010110001110001011111))))
(check-sat)
(exit)
