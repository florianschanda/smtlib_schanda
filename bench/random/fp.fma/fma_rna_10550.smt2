...
(assert (= x ((_ to_fp 8 24) #xCAFAF051)))
;; x should be Float32(0xCAFAF051 [Rational(-16445521, 2), -8222760.500000])
...
(assert (= result (fp #b1 #b00010111 #b11110101111000001001101)))
(check-sat)
(exit)
