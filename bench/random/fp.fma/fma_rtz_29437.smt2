...
(assert (= y (fp #b1 #b10010101 #b01010100001011010000001)))
;; y should be Float32(0xCAAA1681 [Rational(-11146881, 2), -5573440.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BAA167F)))
(check-sat)
(exit)
