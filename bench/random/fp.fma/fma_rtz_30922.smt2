...
(assert (= z ((_ to_fp 8 24) #x00011A61)))
;; z should be Float32(0x00011A61 [Rational(72289, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00000010001101001100001))))
(check-sat)
(exit)
