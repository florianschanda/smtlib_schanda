...
(assert (= z (fp #b0 #b10001100 #b00111110010100101110111)))
;; z should be Float32(0x461F2977 [Rational(10430839, 1024), 10186.366211])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x461F2976))))
(check-sat)
(exit)
