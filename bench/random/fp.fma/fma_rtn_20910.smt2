...
(assert (= y (fp #b1 #b00000000 #b00001110000001010111100)))
;; y should be Float32(0x800702BC [Rational(-114863, 178405961588244985132285746181186892047843328), -0.000000])
