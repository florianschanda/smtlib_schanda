...
(assert (= x ((_ to_fp 8 24) #x004D709E)))
;; x should be Float32(0x004D709E [Rational(2537551, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b00110101110000100111011)))
(check-sat)
(exit)
