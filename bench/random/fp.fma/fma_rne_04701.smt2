...
(assert (= z (fp #b0 #b01000100 #b10000010000011110010010)))
;; z should be Float32(0x22410792 [Rational(6325193, 2417851639229258349412352), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x22410792))))
(check-sat)
(exit)
