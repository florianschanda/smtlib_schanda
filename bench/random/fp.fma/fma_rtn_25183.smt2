...
(assert (= z ((_ to_fp 8 24) #x539E8354)))
;; z should be Float32(0x539E8354 [Rational(1361616306176), 1361616306176.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10100111 #b00111101000001101010100)))
(check-sat)
(exit)
