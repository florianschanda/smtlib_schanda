...
(assert (= z ((_ to_fp 8 24) #x8031ACB6)))
;; z should be Float32(0x8031ACB6 [Rational(-1627739, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x8031ACB6)))
(check-sat)
(exit)
