...
(assert (= x (fp #b0 #b00000000 #b11101110010100101101001)))
;; x should be Float32(0x00772969 [Rational(7809385, 713623846352979940529142984724747568191373312), 0.000000])
