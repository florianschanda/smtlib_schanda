...
(assert (= z ((_ to_fp 8 24) #x8050391F)))
;; z should be Float32(0x8050391F [Rational(-5257503, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10100000011100100011111))))
(check-sat)
(exit)
