...
(assert (= z (fp #b1 #b10010101 #b01001010100000001010111)))
;; z should be Float32(0xCAA54057 [Rational(-10829911, 2), -5414955.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAA54057))))
(check-sat)
(exit)
