...
(assert (= z ((_ to_fp 8 24) #x80406B17)))
;; z should be Float32(0x80406B17 [Rational(-4221719, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10000000110101100011000))))
(check-sat)
(exit)
