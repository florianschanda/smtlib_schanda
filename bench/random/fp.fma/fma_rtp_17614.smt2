...
(assert (= x ((_ to_fp 8 24) #xCA81E9B7)))
;; x should be Float32(0xCA81E9B7 [Rational(-8513975, 2), -4256987.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10000001111010011011100))))
(check-sat)
(exit)
