...
(assert (= z ((_ to_fp 8 24) #x493C41D8)))
;; z should be Float32(0x493C41D8 [Rational(1542203, 2), 771101.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010010 #b01111000100000111010111))))
(check-sat)
(exit)
