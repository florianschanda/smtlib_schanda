...
(assert (= z (fp #b0 #b00110000 #b10111111111100010101100)))
;; z should be Float32(0x185FF8AC [Rational(3669547, 1267650600228229401496703205376), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x185FF8AC))))
(check-sat)
(exit)
