...
(assert (= x (fp #b1 #b10010101 #b11101000001100110001111)))
;; x should be Float32(0xCAF4198F [Rational(-15997327, 2), -7998663.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BF4198D)))
(check-sat)
(exit)
