...
(assert (= z (fp #b0 #b00110101 #b11101010101001101111111)))
;; z should be Float32(0x1AF5537F [Rational(16077695, 158456325028528675187087900672), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00110101 #b11101010101001110000000)))
(check-sat)
(exit)
