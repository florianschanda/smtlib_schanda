...
(assert (= z (fp #b0 #b10010100 #b00010000000101011101010)))
;; z should be Float32(0x4A080AEA [Rational(4457845, 2), 2228922.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A080AEA))))
(check-sat)
(exit)
