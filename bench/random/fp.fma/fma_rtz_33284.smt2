...
(assert (= x (fp #b1 #b11101010 #b01011010100001111001110)))
;; x should be Float32(0xF52D43CE [Rational(-219639306389513618190362451378176), -219639306389513618190362451378176.000000])
