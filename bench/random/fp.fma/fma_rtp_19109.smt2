...
(assert (= y ((_ to_fp 8 24) #x8061F327)))
;; y should be Float32(0x8061F327 [Rational(-6419239, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x807FFFFE)))
(check-sat)
(exit)
