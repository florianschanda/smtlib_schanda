...
(assert (= x (fp #b1 #b00000100 #b11111010111011111000101)))
;; x should be Float32(0x827D77C5 [Rational(-16611269, 89202980794122492566142873090593446023921664), -0.000000])
