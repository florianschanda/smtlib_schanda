...
(assert (= y ((_ to_fp 8 24) #x001AC6A9)))
;; y should be Float32(0x001AC6A9 [Rational(1754793, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b01111110 #b10101100011010101001000)))
(check-sat)
(exit)
