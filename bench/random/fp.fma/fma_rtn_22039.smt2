...
(assert (= z (fp #b1 #b00000000 #b00110110110001100110111)))
;; z should be Float32(0x801B6337 [Rational(-1794871, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x801B6337)))
(check-sat)
(exit)
