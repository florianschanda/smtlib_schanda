...
(assert (= y (fp #b0 #b11100101 #b01001111110000110011100)))
;; y should be Float32(0x72A7E19C [Rational(6650462929759903450368084803584), 6650462929759903450368084803584.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA827E19B))))
(check-sat)
(exit)
