...
(assert (= y (fp #b0 #b00101010 #b00100001010011100111010)))
;; y should be Float32(0x1510A73A [Rational(4739997, 162259276829213363391578010288128), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FDC9CFA)))
