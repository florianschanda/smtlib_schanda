...
(assert (= x ((_ to_fp 8 24) #x7FB6517F)))
...
(assert (= z ((_ to_fp 8 24) #x803D26AB)))
;; z should be Float32(0x803D26AB [Rational(-4007595, 713623846352979940529142984724747568191373312), -0.000000])
