...
(assert (= x (fp #b1 #b10010101 #b00111110001001101110111)))
;; x should be Float32(0xCA9F1377 [Rational(-10425207, 2), -5212603.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B9F1373))))
(check-sat)
(exit)
