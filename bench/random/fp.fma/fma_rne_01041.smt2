...
(assert (= y ((_ to_fp 8 24) #xFA8D52AE)))
;; y should be Float32(0xFA8D52AE [Rational(-366895400170593807296152466836422656), -366895400170593807296152466836422656.000000])
