...
(assert (= x (fp #b1 #b10010011 #b11001110001100110001100)))
;; x should be Float32(0xC9E7198C [Rational(-3786339, 2), -1893169.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b11001110001100110010010))))
(check-sat)
(exit)
