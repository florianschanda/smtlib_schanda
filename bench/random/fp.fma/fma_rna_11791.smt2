...
(assert (= z (fp #b1 #b10010011 #b10111010101010101010100)))
;; z should be Float32(0xC9DD5554 [Rational(-3626325, 2), -1813162.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010011 #b10111010101010100110100)))
(check-sat)
(exit)
