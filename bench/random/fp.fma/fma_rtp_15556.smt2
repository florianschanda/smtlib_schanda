...
(assert (= y (fp #b0 #b10010001 #b11010101110111100110000)))
;; y should be Float32(0x48EAEF30 [Rational(962291, 2), 481145.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x09EAEF11))))
(check-sat)
(exit)
