...
(assert (= y ((_ to_fp 8 24) #x7F81F30E)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x001E5FD3)))
;; z should be Float32(0x001E5FD3 [Rational(1990611, 713623846352979940529142984724747568191373312), 0.000000])
