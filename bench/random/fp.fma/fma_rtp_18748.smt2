...
(assert (= y (fp #b1 #b00000000 #b00000111010001001001001)))
;; y should be Float32(0x8003A249 [Rational(-238153, 713623846352979940529142984724747568191373312), -0.000000])
