...
(assert (= z (fp #b0 #b00000000 #b01000110010000101010011)))
;; z should be Float32(0x00232153 [Rational(2302291, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01000110010000101010011))))
(check-sat)
(exit)
