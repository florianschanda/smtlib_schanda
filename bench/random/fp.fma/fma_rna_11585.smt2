...
(assert (= y (fp #b0 #b10010101 #b11010001000110000100111)))
;; y should be Float32(0x4AE88C27 [Rational(15240231, 2), 7620115.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BE88C27)))
(check-sat)
(exit)
