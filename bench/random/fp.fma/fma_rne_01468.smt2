...
(assert (= y (fp #b0 #b10010011 #b10100011110100011101100)))
;; y should be Float32(0x49D1E8EC [Rational(3439163, 2), 1719581.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b10100011110100011110010))))
(check-sat)
(exit)
