...
(assert (= z (fp #b0 #b11010001 #b00000100010111001010001)))
;; z should be Float32(0x68822E51 [Rational(4918096237324492714541056), 4918096237324492714541056.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x68822E51))))
(check-sat)
(exit)
