...
(assert (= y (fp #b1 #b00000000 #b11000101000000100100101)))
;; y should be Float32(0x80628125 [Rational(-6455589, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0450249))))
(check-sat)
(exit)
