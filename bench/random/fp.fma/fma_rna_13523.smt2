...
(assert (= x (fp #b0 #b11111111 #b00100000001110010111110)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x0005E6D0)))
;; y should be Float32(0x0005E6D0 [Rational(24173, 44601490397061246283071436545296723011960832), 0.000000])
