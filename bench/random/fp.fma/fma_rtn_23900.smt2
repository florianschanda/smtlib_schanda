...
(assert (= z (fp #b1 #b01101100 #b01000001111101000111100)))
;; z should be Float32(0xB620FA3C [Rational(-2637455, 1099511627776), -0.000002])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xB620FA3C)))
(check-sat)
(exit)
