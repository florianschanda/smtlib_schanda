...
(assert (= x (fp #b1 #b10010101 #b01111111101010001011101)))
;; x should be Float32(0xCABFD45D [Rational(-12571741, 2), -6285870.500000])
...
(assert (= result (fp #b1 #b00000000 #b10111111110101000110000)))
(check-sat)
(exit)
