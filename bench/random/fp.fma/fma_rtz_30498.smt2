...
(assert (= x (fp #b0 #b00000000 #b00000100010111010010001)))
;; x should be Float32(0x00022E91 [Rational(142993, 713623846352979940529142984724747568191373312), 0.000000])
