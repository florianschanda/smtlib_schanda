...
(assert (= z (fp #b0 #b01100110 #b00000101000110000101111)))
;; z should be Float32(0x33028C2F [Rational(8555567, 281474976710656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b01100110 #b00000101000110000101111)))
(check-sat)
(exit)
