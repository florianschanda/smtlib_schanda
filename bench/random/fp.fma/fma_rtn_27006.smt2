...
(assert (= x (fp #b1 #b00000000 #b11001100011101010110100)))
;; x should be Float32(0x80663AB4 [Rational(-1674925, 178405961588244985132285746181186892047843328), -0.000000])
