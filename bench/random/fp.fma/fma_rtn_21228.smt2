...
(assert (= x (fp #b0 #b10010000 #b00010110110010110100000)))
;; x should be Float32(0x480B65A0 [Rational(285485, 2), 142742.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b11111011101001001101000))))
(check-sat)
(exit)
