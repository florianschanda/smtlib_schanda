...
(assert (= z (fp #b0 #b01100000 #b00011111101110100101001)))
;; z should be Float32(0x300FDD29 [Rational(9428265, 18014398509481984), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x300FDD29)))
(check-sat)
(exit)
