...
(assert (= z (fp #b1 #b10010100 #b10111001110101000000110)))
;; z should be Float32(0xCA5CEA06 [Rational(-7238915, 2), -3619457.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010100 #b10111001110101000000110)))
(check-sat)
(exit)
