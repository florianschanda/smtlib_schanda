...
(assert (= z (fp #b0 #b00000000 #b10100101011101000110010)))
;; z should be Float32(0x0052BA32 [Rational(2710809, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xB4FFFFFF))))
(check-sat)
(exit)
