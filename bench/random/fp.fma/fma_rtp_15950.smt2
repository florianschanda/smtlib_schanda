...
(assert (= z (fp #b0 #b00000000 #b10000000000100011010100)))
;; z should be Float32(0x004008D4 [Rational(1049141, 178405961588244985132285746181186892047843328), 0.000000])
