...
(assert (= z (fp #b0 #b00000000 #b00101111010000011101010)))
;; z should be Float32(0x0017A0EA [Rational(774261, 356811923176489970264571492362373784095686656), 0.000000])
