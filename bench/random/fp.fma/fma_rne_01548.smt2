...
(assert (= z (fp #b0 #b00000000 #b10111000000001100101010)))
;; z should be Float32(0x005C032A [Rational(3015061, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x005C032A)))
(check-sat)
(exit)
