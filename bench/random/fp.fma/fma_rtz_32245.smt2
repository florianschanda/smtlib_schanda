...
(assert (= z ((_ to_fp 8 24) #x4AD0935B)))
;; z should be Float32(0x4AD0935B [Rational(13669211, 2), 6834605.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10100001001001101011010))))
(check-sat)
(exit)
