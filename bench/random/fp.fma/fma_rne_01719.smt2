...
(assert (= z ((_ to_fp 8 24) #x002BDA3D)))
;; z should be Float32(0x002BDA3D [Rational(2873917, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b01010111101101000111101)))
(check-sat)
(exit)
