...
(assert (= z (fp #b0 #b00000000 #b10110111101110010010101)))
;; z should be Float32(0x005BDC95 [Rational(6020245, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10110111101110010010100))))
(check-sat)
(exit)
