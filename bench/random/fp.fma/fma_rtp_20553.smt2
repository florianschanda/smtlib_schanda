...
(assert (= x (fp #b1 #b11111111 #b11100000011110101100100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x804F9FA4)))
;; y should be Float32(0x804F9FA4 [Rational(-1304553, 178405961588244985132285746181186892047843328), -0.000000])
