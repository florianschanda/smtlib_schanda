...
(assert (= z (fp #b0 #b10010101 #b00110110111000100100101)))
;; z should be Float32(0x4A9B7125 [Rational(10187045, 2), 5093522.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00110110111000100100101))))
(check-sat)
(exit)
