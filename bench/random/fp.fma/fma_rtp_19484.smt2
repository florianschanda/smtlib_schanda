...
(assert (= y (fp #b1 #b11111111 #b00100010000110100010100)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00000000 #b11110010011011000110001)))
;; z should be Float32(0x00793631 [Rational(7943729, 713623846352979940529142984724747568191373312), 0.000000])
