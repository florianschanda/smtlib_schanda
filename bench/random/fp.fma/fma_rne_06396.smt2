...
(assert (= x (fp #b1 #b00000000 #b00111000011001010110001)))
;; x should be Float32(0x801C32B1 [Rational(-1847985, 713623846352979940529142984724747568191373312), -0.000000])
