...
(assert (= z ((_ to_fp 8 24) #x004FEA1D)))
;; z should be Float32(0x004FEA1D [Rational(5237277, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b10011111110101000011101)))
(check-sat)
(exit)
