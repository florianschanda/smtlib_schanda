...
(assert (= x ((_ to_fp 8 24) #x22E87768)))
;; x should be Float32(0x22E87768 [Rational(1904365, 302231454903657293676544), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10111000100010101101111)))
