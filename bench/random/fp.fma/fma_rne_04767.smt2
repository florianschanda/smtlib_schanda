...
(assert (= z (fp #b1 #b11010010 #b01001110110001010000001)))
;; z should be Float32(0xE9276281 [Rational(-12647236463809362871189504), -12647236463809362871189504.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xE9276281)))
(check-sat)
(exit)
