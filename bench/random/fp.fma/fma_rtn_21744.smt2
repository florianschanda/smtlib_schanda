...
(assert (= z ((_ to_fp 8 24) #x6A783BC6)))
;; z should be Float32(0x6A783BC6 [Rational(75023968835560984721489920), 75023968835560984721489920.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b11010100 #b11110000011101111000110))))
(check-sat)
(exit)
