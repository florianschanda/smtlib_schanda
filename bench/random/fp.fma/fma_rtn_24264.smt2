...
(assert (= x (fp #b1 #b10010101 #b10111111101000011100011)))
;; x should be Float32(0xCADFD0E3 [Rational(-14668003, 2), -7334001.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BDFD0E2))))
(check-sat)
(exit)
