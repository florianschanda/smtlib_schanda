...
(assert (= y (fp #b0 #b00000000 #b11000110111101110011110)))
;; y should be Float32(0x00637B9E [Rational(3259855, 356811923176489970264571492362373784095686656), 0.000000])
