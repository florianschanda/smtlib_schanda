...
(assert (= z (fp #b1 #b11100001 #b11111011101001011000101)))
;; z should be Float32(0xF0FDD2C5 [Rational(-628436097704931998673320017920), -628436097704931998673320017920.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xF0FDD2C4)))
(check-sat)
(exit)
