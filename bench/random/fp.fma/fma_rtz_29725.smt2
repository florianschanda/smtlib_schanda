...
(assert (= z ((_ to_fp 8 24) #x001B152E)))
;; z should be Float32(0x001B152E [Rational(887447, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00110110001010100101110))))
(check-sat)
(exit)
