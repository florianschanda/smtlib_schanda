...
(assert (= z (fp #b0 #b10010101 #b11111010100010100111011)))
;; z should be Float32(0x4AFD453B [Rational(16598331, 2), 8299165.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AFD453B)))
(check-sat)
(exit)
