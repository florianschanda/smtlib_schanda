...
(assert (= x (fp #b0 #b00000000 #b01011010101011111111011)))
;; x should be Float32(0x002D57FB [Rational(2971643, 713623846352979940529142984724747568191373312), 0.000000])
