...
(assert (= z ((_ to_fp 8 24) #x67EF8173)))
;; z should be Float32(0x67EF8173 [Rational(2262067012029336199888896), 2262067012029336199888896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b11001111 #b11011111000000101110011))))
(check-sat)
(exit)
