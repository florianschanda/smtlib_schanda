...
(assert (= x (fp #b1 #b00000000 #b01000001101011110100010)))
;; x should be Float32(0x8020D7A2 [Rational(-1076177, 356811923176489970264571492362373784095686656), -0.000000])
