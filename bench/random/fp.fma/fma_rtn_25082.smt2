...
(assert (= z ((_ to_fp 8 24) #x4AEBBDA9)))
;; z should be Float32(0x4AEBBDA9 [Rational(15449513, 2), 7724756.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010111011110110101001))))
(check-sat)
(exit)
