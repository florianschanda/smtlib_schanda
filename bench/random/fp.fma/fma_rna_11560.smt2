...
(assert (= z (fp #b0 #b11011011 #b01010011111010011001110)))
;; z should be Float32(0x6DA9F4CE [Rational(6574864670911094660003790848), 6574864670911094660003790848.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6DA9F4CE))))
(check-sat)
(exit)
