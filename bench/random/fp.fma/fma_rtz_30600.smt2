...
(assert (= x (fp #b0 #b00000000 #b00001010001011011010101)))
;; x should be Float32(0x000516D5 [Rational(333525, 713623846352979940529142984724747568191373312), 0.000000])
