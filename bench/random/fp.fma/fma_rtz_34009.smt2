...
(assert (= x ((_ to_fp 8 24) #x7FA8643B)))
...
(assert (= z ((_ to_fp 8 24) #x8063A5A5)))
;; z should be Float32(0x8063A5A5 [Rational(-6530469, 713623846352979940529142984724747568191373312), -0.000000])
