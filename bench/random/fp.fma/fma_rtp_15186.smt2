...
(assert (= y ((_ to_fp 8 24) #x4AED1B85)))
;; y should be Float32(0x4AED1B85 [Rational(15539077, 2), 7769538.500000])
...
(assert (= result (fp #b0 #b00010111 #b11011010001101110000110)))
(check-sat)
(exit)
