...
(assert (= z (fp #b1 #b11111101 #b11011110110111101010100)))
;; z should be Float32(0xFEEF6F54 [Rational(-159131769833149483115546192034326904832), -159131769833149483115546192034326904832.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xFEEF6F54)))
(check-sat)
(exit)
