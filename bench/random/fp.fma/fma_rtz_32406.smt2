...
(assert (= z ((_ to_fp 8 24) #xCAA649B5)))
;; z should be Float32(0xCAA649B5 [Rational(-10897845, 2), -5448922.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01001100100100110110100))))
(check-sat)
(exit)
