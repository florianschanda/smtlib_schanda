...
(assert (= z (fp #b1 #b00000000 #b00101101000010011011010)))
;; z should be Float32(0x801684DA [Rational(-737901, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00101101000010011011001))))
(check-sat)
(exit)
