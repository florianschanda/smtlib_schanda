...
(assert (= x (fp #b0 #b10010100 #b00101000011010110001110)))
;; x should be Float32(0x4A14358E [Rational(4856519, 2), 2428259.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00101000011010110001001))))
(check-sat)
(exit)
