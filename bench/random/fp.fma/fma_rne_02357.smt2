...
(assert (= y ((_ to_fp 8 24) #xCAC63285)))
;; y should be Float32(0xCAC63285 [Rational(-12989061, 2), -6494530.500000])
...
(assert (= result (fp #b1 #b00000000 #b11000110001100101000010)))
(check-sat)
(exit)
