...
(assert (= z ((_ to_fp 8 24) #x74F3CE3F)))
;; z should be Float32(0x74F3CE3F [Rational(154530188522528534728211930546176), 154530188522528534728211930546176.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x74F3CE40)))
(check-sat)
(exit)
