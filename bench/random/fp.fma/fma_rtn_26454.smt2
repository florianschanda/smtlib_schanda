...
(assert (= x ((_ to_fp 8 24) #xC73A650D)))
;; x should be Float32(0xC73A650D [Rational(-12215565, 256), -47717.050781])
...
(assert (not (= result (fp #b1 #b00010000 #b01110100110010000001101))))
(check-sat)
(exit)
