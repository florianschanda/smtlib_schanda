...
(assert (= z (fp #b1 #b01111111 #b01100001001100110011011)))
;; z should be Float32(0xBFB0999B [Rational(-11573659, 8388608), -1.379688])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xBFB0999B))))
(check-sat)
(exit)
