...
(assert (= z (fp #b1 #b10010100 #b11010101000010110111110)))
;; z should be Float32(0xCA6A85BE [Rational(-7684831, 2), -3842415.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11010101000010110101110))))
(check-sat)
(exit)
