...
(assert (= x ((_ to_fp 8 24) #x006F4023)))
;; x should be Float32(0x006F4023 [Rational(7290915, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10101010101111101101101)))
