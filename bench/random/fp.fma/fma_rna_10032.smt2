...
(assert (= x ((_ to_fp 8 24) #x001B586E)))
;; x should be Float32(0x001B586E [Rational(896055, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFD09C1D)))
