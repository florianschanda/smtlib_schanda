...
(assert (= x (fp #b1 #b11110110 #b11101011100011001111001)))
;; x should be Float32(0xFB75C679 [Rational(-1276138234050220025718761975231545344), -1276138234050220025718761975231545344.000000])
