...
(assert (= y (fp #b1 #b00000000 #b10000110000011110111100)))
;; y should be Float32(0x804307BC [Rational(-1098223, 178405961588244985132285746181186892047843328), -0.000000])
