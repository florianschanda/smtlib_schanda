...
(assert (= y ((_ to_fp 8 24) #x6B393240)))
;; y should be Float32(0x6B393240 [Rational(223888575544470596992630784), 223888575544470596992630784.000000])
...
(assert (not (= result (fp #b1 #b01011000 #b01110010011001000111111))))
(check-sat)
(exit)
