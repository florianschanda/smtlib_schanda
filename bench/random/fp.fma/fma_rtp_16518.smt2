...
(assert (= x ((_ to_fp 8 24) #x5208450F)))
;; x should be Float32(0x5208450F [Rational(146318540800), 146318540800.000000])
...
(assert (not (= result (fp #b1 #b00100110 #b00010000100010100001110))))
(check-sat)
(exit)
