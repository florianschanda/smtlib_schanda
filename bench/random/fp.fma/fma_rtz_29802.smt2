...
(assert (= y (fp #b1 #b10010101 #b01111101001001110100111)))
;; y should be Float32(0xCABE93A7 [Rational(-12489639, 2), -6244819.500000])
...
(assert (= result (fp #b1 #b00000000 #b10111110100100111010011)))
(check-sat)
(exit)
