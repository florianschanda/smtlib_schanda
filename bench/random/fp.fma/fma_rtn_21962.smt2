...
(assert (= z (fp #b1 #b01110010 #b11100000100010000100111)))
;; z should be Float32(0xB9704427 [Rational(-15746087, 68719476736), -0.000229])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01110010 #b11100001100010000100111))))
(check-sat)
(exit)
