...
(assert (= y (fp #b1 #b00000000 #b10000000001001001111100)))
;; y should be Float32(0x8040127C [Rational(-1049759, 178405961588244985132285746181186892047843328), -0.000000])
