...
(assert (= z ((_ to_fp 8 24) #x5D54C4D8)))
;; z should be Float32(0x5D54C4D8 [Rational(958226032874225664), 958226032874225664.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10111010 #b10101001100010011011001)))
(check-sat)
(exit)
