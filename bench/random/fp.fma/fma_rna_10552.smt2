...
(assert (= x (fp #b1 #b10010100 #b00100111001000001011110)))
;; x should be Float32(0xCA13905E [Rational(-4835375, 2), -2417687.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b00100111001000001011101))))
(check-sat)
(exit)
