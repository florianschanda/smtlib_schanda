...
(assert (= x (fp #b1 #b10010101 #b01110011000111010010101)))
;; x should be Float32(0xCAB98E95 [Rational(-12160661, 2), -6080330.500000])
...
(assert (= result (fp #b0 #b00000000 #b10111001100011101001100)))
(check-sat)
(exit)
