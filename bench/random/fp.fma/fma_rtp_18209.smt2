...
(assert (= y (fp #b0 #b00000000 #b10100001111101001101101)))
;; y should be Float32(0x0050FA6D [Rational(5306989, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC021F4D9)))
(check-sat)
(exit)
