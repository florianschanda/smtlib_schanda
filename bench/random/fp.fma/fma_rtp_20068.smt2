...
(assert (= x (fp #b1 #b00000000 #b11101100010001111111110)))
;; x should be Float32(0x807623FE [Rational(-3871231, 356811923176489970264571492362373784095686656), -0.000000])
