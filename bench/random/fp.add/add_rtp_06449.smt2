...
(assert (= x (fp #b1 #b01110110 #b01010110110000010001001)))
;; x should be Float32(0xBB2B6089 [Rational(-11231369, 4294967296), -0.002615])
...
(assert (not (= result (fp #b1 #b01110110 #b01010110110000010001001))))
(check-sat)
(exit)
