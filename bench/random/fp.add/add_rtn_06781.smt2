...
(assert (= x ((_ to_fp 8 24) #x4D21AF0F)))
;; x should be Float32(0x4D21AF0F [Rational(169537776), 169537776.000000])
...
(assert (= result (fp #b0 #b10011010 #b01000011010111100001111)))
(check-sat)
(exit)
