...
(assert (= y ((_ to_fp 8 24) #x00489E24)))
;; y should be Float32(0x00489E24 [Rational(1189769, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x00489E23))))
(check-sat)
(exit)
