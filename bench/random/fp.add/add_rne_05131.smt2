...
(assert (= x ((_ to_fp 8 24) #x86484556)))
;; x should be Float32(0x86484556 [Rational(-6562475, 174224571863520493293247799005065324265472), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x86484556))))
(check-sat)
(exit)
