...
(assert (= y ((_ to_fp 8 24) #xCA96B5A1)))
;; y should be Float32(0xCA96B5A1 [Rational(-9876897, 2), -4938448.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (not (= result (fp #b1 #b10010101 #b00101101011010110100001))))
(check-sat)
(exit)
