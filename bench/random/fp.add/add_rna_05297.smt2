...
(assert (= x (fp #b0 #b10010001 #b01110100000010010010000)))
;; x should be Float32(0x48BA0490 [Rational(761929, 2), 380964.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x48BA0490))))
(check-sat)
(exit)
