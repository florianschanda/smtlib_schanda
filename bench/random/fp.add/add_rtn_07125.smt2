...
(assert (= x ((_ to_fp 8 24) #x8009D0C4)))
;; x should be Float32(0x8009D0C4 [Rational(-160817, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x8009D0C3)))
(check-sat)
(exit)
