...
(assert (= y (fp #b1 #b00000000 #b00011000000010000000010)))
;; y should be Float32(0x800C0402 [Rational(-393729, 356811923176489970264571492362373784095686656), -0.000000])
