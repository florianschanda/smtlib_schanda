...
(assert (= x (fp #b1 #b00000000 #b10001000011110000110111)))
;; x should be Float32(0x80443C37 [Rational(-4471863, 713623846352979940529142984724747568191373312), -0.000000])
