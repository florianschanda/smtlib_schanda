...
(assert (= y (fp #b1 #b00000000 #b00011011100010100110011)))
;; y should be Float32(0x800DC533 [Rational(-902451, 713623846352979940529142984724747568191373312), -0.000000])
