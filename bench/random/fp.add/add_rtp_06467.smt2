...
(assert (= x (fp #b1 #b00000000 #b00011001001101110111011)))
;; x should be Float32(0x800C9BBB [Rational(-826299, 713623846352979940529142984724747568191373312), -0.000000])
