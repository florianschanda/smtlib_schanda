...
(assert (= y (fp #b0 #b00000000 #b00000101100001000100101)))
;; y should be Float32(0x0002C225 [Rational(180773, 713623846352979940529142984724747568191373312), 0.000000])
