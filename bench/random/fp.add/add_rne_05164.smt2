...
(assert (= x (fp #b1 #b00000000 #b11101000010100111101101)))
;; x should be Float32(0x807429ED [Rational(-7612909, 713623846352979940529142984724747568191373312), -0.000000])
