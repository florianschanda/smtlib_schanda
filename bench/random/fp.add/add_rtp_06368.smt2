...
(assert (= y ((_ to_fp 8 24) #x35F43994)))
;; y should be Float32(0x35F43994 [Rational(4001381, 2199023255552), 0.000002])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (= result (fp #b0 #b01101011 #b11101000011100110010100)))
(check-sat)
(exit)
