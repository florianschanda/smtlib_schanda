...
(assert (= y (fp #b0 #b10010101 #b10001000101101000101001)))
;; y should be Float32(0x4AC45A29 [Rational(12868137, 2), 6434068.500000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (= result ((_ to_fp 8 24) #x4AC45A2A)))
(check-sat)
(exit)
