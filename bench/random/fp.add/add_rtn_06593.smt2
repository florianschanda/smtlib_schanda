...
(assert (= x (fp #b0 #b10010100 #b00100011100110100001110)))
;; x should be Float32(0x4A11CD0E [Rational(4777607, 2), 2388803.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4A11CD0D))))
(check-sat)
(exit)
