...
(assert (= x ((_ to_fp 8 24) #x80191514)))
;; x should be Float32(0x80191514 [Rational(-410949, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x80991513)))
(check-sat)
(exit)
