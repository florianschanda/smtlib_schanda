...
(assert (= y (fp #b0 #b10010011 #b11111000100001001100100)))
;; y should be Float32(0x49FC4264 [Rational(4133017, 2), 2066508.500000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (= result (fp #b0 #b10010011 #b11111000100001001100100)))
(check-sat)
(exit)
