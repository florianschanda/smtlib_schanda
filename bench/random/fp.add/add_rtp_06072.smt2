...
(assert (= y ((_ to_fp 8 24) #xD664381A)))
;; y should be Float32(0xD664381A [Rational(-62732401377280), -62732401377280.000000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result (fp #b1 #b10101100 #b11001000011100000011001))))
(check-sat)
(exit)
