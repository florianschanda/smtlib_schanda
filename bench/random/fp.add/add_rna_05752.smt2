...
(assert (= y (fp #b1 #b10010001 #b00110001000110010110000)))
;; y should be Float32(0xC8988CB0 [Rational(-624843, 2), -312421.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result (fp #b1 #b10010001 #b00110001000110010110000))))
(check-sat)
(exit)
