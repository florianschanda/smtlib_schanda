...
(assert (= x ((_ to_fp 8 24) #x802673C2)))
;; x should be Float32(0x802673C2 [Rational(-1260001, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x80A673C1)))
(check-sat)
(exit)
