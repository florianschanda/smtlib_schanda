...
(assert (= x ((_ to_fp 8 24) #x50C32654)))
;; x should be Float32(0x50C32654 [Rational(26192551936), 26192551936.000000])
...
(assert (not (= result (fp #b0 #b10100001 #b10000110010011001010100))))
(check-sat)
(exit)
