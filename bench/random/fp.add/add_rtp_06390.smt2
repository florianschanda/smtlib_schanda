...
(assert (= y (fp #b0 #b10010001 #b00010010001011001010000)))
;; y should be Float32(0x48891650 [Rational(561509, 2), 280754.500000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x48891650))))
(check-sat)
(exit)
