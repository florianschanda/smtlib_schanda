...
(assert (= y ((_ to_fp 8 24) #x001D6CD6)))
;; y should be Float32(0x001D6CD6 [Rational(964203, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x80629329))))
(check-sat)
(exit)
