...
(assert (= x (fp #b1 #b00000000 #b00111110111100110000101)))
;; x should be Float32(0x801F7985 [Rational(-2062725, 713623846352979940529142984724747568191373312), -0.000000])
