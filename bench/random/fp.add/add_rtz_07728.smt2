...
(assert (= x (fp #b1 #b11011111 #b00101001111011101000111)))
;; x should be Float32(0xEF94F747 [Rational(-92205442838048334644460388352), -92205442838048334644460388352.000000])
