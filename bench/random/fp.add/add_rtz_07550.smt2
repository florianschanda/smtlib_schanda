...
(assert (= x (fp #b1 #b10010010 #b10001011111110100001000)))
;; x should be Float32(0xC945FD08 [Rational(-1621921, 2), -810960.500000])
...
(assert (not (= result (fp #b1 #b10010010 #b10001011111110100001000))))
(check-sat)
(exit)
