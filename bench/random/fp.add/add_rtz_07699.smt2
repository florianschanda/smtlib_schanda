...
(assert (= y ((_ to_fp 8 24) #x2286451B)))
;; y should be Float32(0x2286451B [Rational(8799515, 2417851639229258349412352), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x2286451A))))
(check-sat)
(exit)
