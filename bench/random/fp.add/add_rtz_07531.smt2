...
(assert (= x (fp #b1 #b10010101 #b11011001111110001110111)))
;; x should be Float32(0xCAECFC77 [Rational(-15531127, 2), -7765563.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAECFC76)))
(check-sat)
(exit)
