...
(assert (= x ((_ to_fp 8 24) #x807198A5)))
;; x should be Float32(0x807198A5 [Rational(-7444645, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x807198A6))))
(check-sat)
(exit)
