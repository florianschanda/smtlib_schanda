...
(assert (= x (fp #b1 #b00000000 #b10010001011101110010100)))
;; x should be Float32(0x8048BB94 [Rational(-1191653, 178405961588244985132285746181186892047843328), -0.000000])
