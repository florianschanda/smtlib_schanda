...
(assert (= x (fp #b0 #b00000000 #b10101000011000010101110)))
;; x should be Float32(0x005430AE [Rational(2758743, 356811923176489970264571492362373784095686656), 0.000000])
