...
(assert (= x ((_ to_fp 8 24) #x49CA05B4)))
;; x should be Float32(0x49CA05B4 [Rational(3309933, 2), 1654966.500000])
...
(assert (not (= result (fp #b0 #b10010011 #b10010100000010110110011))))
(check-sat)
(exit)
