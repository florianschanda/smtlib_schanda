...
(assert (= x (fp #b1 #b10010100 #b10000000001111001001110)))
;; x should be Float32(0xCA401E4E [Rational(-6295335, 2), -3147667.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA401E4D))))
(check-sat)
(exit)
