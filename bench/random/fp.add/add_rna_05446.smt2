...
(assert (= y ((_ to_fp 8 24) #x607C6648)))
;; y should be Float32(0x607C6648 [Rational(72749213240078106624), 72749213240078106624.000000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (= result ((_ to_fp 8 24) #x607C6648)))
(check-sat)
(exit)
