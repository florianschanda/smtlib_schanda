...
(assert (= x ((_ to_fp 8 24) #x805FA63F)))
;; x should be Float32(0x805FA63F [Rational(-6268479, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x805FA640))))
(check-sat)
(exit)
