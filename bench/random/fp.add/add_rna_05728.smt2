...
(assert (= y ((_ to_fp 8 24) #xCEBB5787)))
;; y should be Float32(0xCEBB5787 [Rational(-1571537792), -1571537792.000000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (= result (fp #b1 #b10011101 #b01110110101011110000111)))
(check-sat)
(exit)
