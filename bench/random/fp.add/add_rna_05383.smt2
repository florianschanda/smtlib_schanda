...
(assert (= y (fp #b1 #b10010100 #b00000011110000001111010)))
;; y should be Float32(0xCA01E07A [Rational(-4255805, 2), -2127902.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #xCA01E07A))))
(check-sat)
(exit)
