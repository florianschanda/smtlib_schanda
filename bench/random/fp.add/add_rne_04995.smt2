...
(assert (= y (fp #b0 #b00000000 #b00111110111000001100111)))
;; y should be Float32(0x001F7067 [Rational(2060391, 713623846352979940529142984724747568191373312), 0.000000])
