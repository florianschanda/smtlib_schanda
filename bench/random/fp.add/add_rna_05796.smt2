...
(assert (= x ((_ to_fp 8 24) #x984C35A9)))
;; x should be Float32(0x984C35A9 [Rational(-13383081, 5070602400912917605986812821504), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x984C35A9)))
(check-sat)
(exit)
