...
(assert (= x ((_ to_fp 8 24) #xCADAB33D)))
;; x should be Float32(0xCADAB33D [Rational(-14332733, 2), -7166366.500000])
...
(assert (= result (fp #b1 #b10010101 #b10110101011001100111101)))
(check-sat)
(exit)
