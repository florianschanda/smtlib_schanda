...
(assert (= x (fp #b1 #b10010101 #b10101011101011100011101)))
;; x should be Float32(0xCAD5D71D [Rational(-14014237, 2), -7007118.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCAD5D71D))))
(check-sat)
(exit)
