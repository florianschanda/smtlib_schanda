...
(assert (= x ((_ to_fp 8 24) #xCAA997B9)))
;; x should be Float32(0xCAA997B9 [Rational(-11114425, 2), -5557212.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b01010011001011110111000))))
(check-sat)
(exit)
