...
(assert (= y (fp #b1 #b10010101 #b10100011001100000010001)))
;; y should be Float32(0xCAD19811 [Rational(-13735953, 2), -6867976.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result (fp #b1 #b10010101 #b10100011001100000010001))))
(check-sat)
(exit)
