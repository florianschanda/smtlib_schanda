...
(assert (= x ((_ to_fp 8 24) #xCA24B276)))
;; x should be Float32(0xCA24B276 [Rational(-5396795, 2), -2698397.500000])
...
(assert (not (= result (fp #b1 #b10010100 #b01001001011001001110101))))
(check-sat)
(exit)
