...
(assert (= x ((_ to_fp 8 24) #xC0CAAB5C)))
;; x should be Float32(0xC0CAAB5C [Rational(-3320535, 524288), -6.333418])
...
(assert (not (= result (fp #b1 #b10000001 #b10010101010101101011011))))
(check-sat)
(exit)
