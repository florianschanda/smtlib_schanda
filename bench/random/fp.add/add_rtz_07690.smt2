...
(assert (= y ((_ to_fp 8 24) #x4AC64EFB)))
;; y should be Float32(0x4AC64EFB [Rational(12996347, 2), 6498173.500000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result (fp #b0 #b10010101 #b10001100100111011111010))))
(check-sat)
(exit)
