...
(assert (= y ((_ to_fp 8 24) #x4AFEF4AF)))
;; y should be Float32(0x4AFEF4AF [Rational(16708783, 2), 8354391.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result (fp #b0 #b10010101 #b11111101111010010101111))))
(check-sat)
(exit)
