...
(assert (= y ((_ to_fp 8 24) #x95F86B87)))
;; y should be Float32(0x95F86B87 [Rational(-16280455, 162259276829213363391578010288128), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (= result ((_ to_fp 8 24) #x95F86B87)))
(check-sat)
(exit)
