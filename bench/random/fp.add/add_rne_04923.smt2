...
(assert (= x ((_ to_fp 8 24) #xC90E75A8)))
;; x should be Float32(0xC90E75A8 [Rational(-1167029, 2), -583514.500000])
...
(assert (not (= result (fp #b1 #b10010010 #b00011100111010110101000))))
(check-sat)
(exit)
