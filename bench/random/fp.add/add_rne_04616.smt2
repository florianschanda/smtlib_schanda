...
(assert (= x (fp #b0 #b10010101 #b11100001001111111101111)))
;; x should be Float32(0x4AF09FEF [Rational(15769583, 2), 7884791.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4AF09FEF))))
(check-sat)
(exit)
