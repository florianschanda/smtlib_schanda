...
(assert (= y (fp #b1 #b10110100 #b01110000001000010000011)))
;; y should be Float32(0xDA381083 [Rational(-12952387635380224), -12952387635380224.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #xDA381083))))
(check-sat)
(exit)
