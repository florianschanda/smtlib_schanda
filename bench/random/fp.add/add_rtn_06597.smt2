...
(assert (= x ((_ to_fp 8 24) #x4AE0F589)))
;; x should be Float32(0x4AE0F589 [Rational(14742921, 2), 7371460.500000])
...
(assert (= result (fp #b0 #b10010101 #b11000001111010110001000)))
(check-sat)
(exit)
