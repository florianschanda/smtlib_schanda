...
(assert (= y ((_ to_fp 8 24) #x8070F5BE)))
;; y should be Float32(0x8070F5BE [Rational(-3701471, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x8070F5BF))))
(check-sat)
(exit)
