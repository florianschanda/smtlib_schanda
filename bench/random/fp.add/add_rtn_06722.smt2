...
(assert (= y ((_ to_fp 8 24) #xCAD2F641)))
;; y should be Float32(0xCAD2F641 [Rational(-13825601, 2), -6912800.500000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result (fp #b1 #b10010101 #b10100101111011001000001))))
(check-sat)
(exit)
