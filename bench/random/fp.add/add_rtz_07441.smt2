...
(assert (= x ((_ to_fp 8 24) #x2FAA5E57)))
;; x should be Float32(0x2FAA5E57 [Rational(11165271, 36028797018963968), 0.000000])
...
(assert (= result (fp #b0 #b01011111 #b01010100101111001010110)))
(check-sat)
(exit)
