...
(assert (= y (fp #b0 #b10101101 #b10111011000101000000010)))
;; y should be Float32(0x56DD8A02 [Rational(121792404389888), 121792404389888.000000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result ((_ to_fp 8 24) #x56DD8A02)))
(check-sat)
(exit)
