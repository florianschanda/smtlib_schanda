...
(assert (= x (fp #b0 #b10000011 #b11010000100001001000011)))
;; x should be Float32(0x41E84243 [Rational(15221315, 524288), 29.032354])
...
(assert (= result ((_ to_fp 8 24) #x41E84243)))
(check-sat)
(exit)
