...
(assert (= y ((_ to_fp 8 24) #xCAC95D7B)))
;; y should be Float32(0xCAC95D7B [Rational(-13196667, 2), -6598333.500000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result (fp #b1 #b10010101 #b10010010101110101111011))))
(check-sat)
(exit)
