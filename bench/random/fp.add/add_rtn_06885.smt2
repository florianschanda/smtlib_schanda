...
(assert (= x ((_ to_fp 8 24) #xCAA87BBB)))
;; x should be Float32(0xCAA87BBB [Rational(-11041723, 2), -5520861.500000])
...
(assert (= result (fp #b1 #b10010101 #b01010000111101110111011)))
(check-sat)
(exit)
