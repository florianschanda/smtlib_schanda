...
(assert (= x (fp #b0 #b10010011 #b00100101011010000110100)))
;; x should be Float32(0x4992B434 [Rational(2403597, 2), 1201798.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4992B434))))
(check-sat)
(exit)
