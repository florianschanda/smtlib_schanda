...
(assert (= y (fp #b1 #b10010101 #b01011100100011100111001)))
;; y should be Float32(0xCAAE4739 [Rational(-11421497, 2), -5710748.500000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result (fp #b1 #b10010101 #b01011100100011100111000))))
(check-sat)
(exit)
