...
(assert (= x (fp #b1 #b10010101 #b11111110101010101001001)))
;; x should be Float32(0xCAFF5549 [Rational(-16733513, 2), -8366756.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAFF5549)))
(check-sat)
(exit)
