...
(assert (= x ((_ to_fp 8 24) #xC96EBA78)))
;; x should be Float32(0xC96EBA78 [Rational(-1955663, 2), -977831.500000])
...
(assert (not (= result (fp #b1 #b10010010 #b11011101011101001111000))))
(check-sat)
(exit)
