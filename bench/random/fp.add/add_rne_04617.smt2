...
(assert (= x (fp #b0 #b10010101 #b10011101010001011001111)))
;; x should be Float32(0x4ACEA2CF [Rational(13542095, 2), 6771047.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4ACEA2CF))))
(check-sat)
(exit)
