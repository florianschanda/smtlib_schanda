...
(assert (= x (fp #b0 #b10010010 #b01000101011011111001000)))
;; x should be Float32(0x4922B7C8 [Rational(1332985, 2), 666492.500000])
...
(assert (= result (fp #b0 #b10010010 #b01000101011011111001000)))
(check-sat)
(exit)
