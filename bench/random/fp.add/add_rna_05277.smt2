...
(assert (= x ((_ to_fp 8 24) #x4A98F821)))
;; x should be Float32(0x4A98F821 [Rational(10024993, 2), 5012496.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b00110001111100000100001))))
(check-sat)
(exit)
