...
(assert (= y (fp #b0 #b00000000 #b11000000010011101011010)))
;; y should be Float32(0x0060275A [Rational(3150765, 356811923176489970264571492362373784095686656), 0.000000])
