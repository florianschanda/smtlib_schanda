...
(assert (= x (fp #b0 #b10010101 #b00111011010100110111011)))
;; x should be Float32(0x4A9DA9BB [Rational(10332603, 2), 5166301.500000])
...
(assert (= result (fp #b0 #b10010101 #b00111011010100110111011)))
(check-sat)
(exit)
