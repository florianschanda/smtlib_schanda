...
(assert (= x (fp #b0 #b01011110 #b10111000111111011110000)))
;; x should be Float32(0x2F5C7EF0 [Rational(903151, 4503599627370496), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2F5C7EEF))))
(check-sat)
(exit)
