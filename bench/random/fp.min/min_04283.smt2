...
(assert (= x (fp #b1 #b10010100 #b01000011000001001110010)))
;; x should be Float32(0xCA218272 [Rational(-5292345, 2), -2646172.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA218272))))
(check-sat)
(exit)
