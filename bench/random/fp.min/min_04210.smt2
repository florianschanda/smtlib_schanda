...
(assert (= x (fp #b0 #b00000000 #b00111010100101111110101)))
;; x should be Float32(0x001D4BF5 [Rational(1919989, 713623846352979940529142984724747568191373312), 0.000000])
