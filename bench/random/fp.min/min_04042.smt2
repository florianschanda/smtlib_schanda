...
(assert (= y ((_ to_fp 8 24) #x806BA608)))
;; y should be Float32(0x806BA608 [Rational(-881857, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (not (= result ((_ to_fp 8 24) #x806BA608))))
(check-sat)
(exit)
