...
(assert (= x ((_ to_fp 8 24) #xCABCCE49)))
;; x should be Float32(0xCABCCE49 [Rational(-12373577, 2), -6186788.500000])
...
(assert (= result (fp #b1 #b10010101 #b01111001100111001001001)))
(check-sat)
(exit)
