...
(assert (= y (fp #b1 #b01111110 #b01010011011111101001111)))
;; y should be Float32(0xBF29BF4F [Rational(-11124559, 16777216), -0.663075])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (= result ((_ to_fp 8 24) #xBF29BF4F)))
(check-sat)
(exit)
