...
(assert (= y ((_ to_fp 8 24) #xCAD59539)))
;; y should be Float32(0xCAD59539 [Rational(-13997369, 2), -6998684.500000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (= result (fp #b1 #b10010101 #b10101011001010100111001)))
(check-sat)
(exit)
