...
(assert (= y ((_ to_fp 8 24) #xCACCFFB5)))
;; y should be Float32(0xCACCFFB5 [Rational(-13434805, 2), -6717402.500000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (= result (fp #b1 #b10010101 #b10011001111111110110101)))
(check-sat)
(exit)
