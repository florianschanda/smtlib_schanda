...
(assert (= x (fp #b1 #b10010101 #b10001000111101100010011)))
;; x should be Float32(0xCAC47B13 [Rational(-12876563, 2), -6438281.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAC47B13)))
(check-sat)
(exit)
