...
(assert (= x (fp #b1 #b00111111 #b01010010001010001111001)))
;; x should be Float32(0x9FA91479 [Rational(-11080825, 154742504910672534362390528), -0.000000])
...
(assert (not (= result (fp #b1 #b00111111 #b01010010001010001111001))))
(check-sat)
(exit)
