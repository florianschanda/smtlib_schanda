...
(assert (= x (fp #b0 #b00000000 #b10000100000001110011001)))
;; x should be Float32(0x00420399 [Rational(4326297, 713623846352979940529142984724747568191373312), 0.000000])
