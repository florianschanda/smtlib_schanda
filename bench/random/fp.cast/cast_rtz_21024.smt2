...
;; y should be Float64(0xB7FA4EE500000000 [Rational(-1724133, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float64)
(assert (= z ((_ to_fp 11 53) #xB7FA4EE500000000)))
;; z should be y
