...
;; y should be Float64(0x380453E240000000 [Rational(5328777, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float64)
(assert (= z ((_ to_fp 11 53) #x380453E240000000)))
;; z should be y
