...
;; y should be Float64(0xB7F48DBE00000000 [Rational(-673503, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01101111111 #b0100100011011011111000000000000000000000000000000000)))
;; z should be y
