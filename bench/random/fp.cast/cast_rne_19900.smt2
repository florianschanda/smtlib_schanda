...
;; y should be Float128(0xBF7F1442680000000000000000000000 [Rational(-2263117, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float128)
(assert (= z ((_ to_fp 15 113) #xBF7F1442680000000000000000000000)))
;; z should be y
