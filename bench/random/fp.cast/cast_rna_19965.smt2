...
;; y should be Float64(0x415B916B20000000 [Rational(14453593, 2), 7226796.500000])

(declare-const z Float64)
(assert (= z (fp #b0 #b10000010101 #b1011100100010110101100100000000000000000000000000000)))
;; z should be y
