...
;; y should be Float64(0xB7FDE5B180000000 [Rational(-3918691, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01101111111 #b1101111001011011000110000000000000000000000000000000)))
;; z should be y
