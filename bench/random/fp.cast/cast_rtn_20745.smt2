...
;; y should be Float64(0xB7FA6CE900000000 [Rational(-1731817, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01101111111 #b1010011011001110100100000000000000000000000000000000)))
;; z should be y
