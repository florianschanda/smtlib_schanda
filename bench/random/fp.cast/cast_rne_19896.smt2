...
;; y should be Float64(0xB80A678A00000000 [Rational(-865221, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01110000000 #b1010011001111000101000000000000000000000000000000000)))
;; z should be y
