...
;; y should be Float64(0x380AE87100000000 [Rational(1763441, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const z Float64)
(assert (= z (fp #b0 #b01110000000 #b1010111010000111000100000000000000000000000000000000)))
;; z should be y
