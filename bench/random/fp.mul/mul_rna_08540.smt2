...
(assert (= x (fp #b0 #b10010101 #b00111001100010001010101)))
;; x should be Float32(0x4A9CC455 [Rational(10273877, 2), 5136938.500000])
...
(assert (= result ((_ to_fp 8 24) #x804E622B)))
(check-sat)
(exit)
