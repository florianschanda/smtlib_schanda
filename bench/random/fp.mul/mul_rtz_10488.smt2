...
(assert (= x (fp #b0 #b10010101 #b01100010000011001011111)))
;; x should be Float32(0x4AB1065F [Rational(11601503, 2), 5800751.500000])
...
(assert (= result (fp #b1 #b00000000 #b10110001000001100101111)))
(check-sat)
(exit)
