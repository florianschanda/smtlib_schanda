...
(assert (= y (fp #b0 #b00000000 #b01100000111011011001110)))
;; y should be Float32(0x003076CE [Rational(1588071, 356811923176489970264571492362373784095686656), 0.000000])
