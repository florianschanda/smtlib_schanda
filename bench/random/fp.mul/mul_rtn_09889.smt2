...
(assert (= y ((_ to_fp 8 24) #x095605E8)))
;; y should be Float32(0x095605E8 [Rational(1753277, 680564733841876926926749214863536422912), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x495605E7))))
(check-sat)
(exit)
