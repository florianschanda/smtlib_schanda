...
(assert (= y (fp #b0 #b00000000 #b10011111110000001000110)))
;; y should be Float32(0x004FE046 [Rational(2617379, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x401FC08B))))
(check-sat)
(exit)
