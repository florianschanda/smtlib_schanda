...
(assert (= x ((_ to_fp 8 24) #x49D161B4)))
;; x should be Float32(0x49D161B4 [Rational(3430509, 2), 1715254.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00110100010110000110110))))
(check-sat)
(exit)
