...
(assert (= y (fp #b0 #b00000000 #b10001011100111001101111)))
;; y should be Float32(0x0045CE6F [Rational(4574831, 713623846352979940529142984724747568191373312), 0.000000])
