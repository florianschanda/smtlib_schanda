...
(assert (= x (fp #b1 #b00000000 #b00000111111101101001101)))
;; x should be Float32(0x8003FB4D [Rational(-260941, 713623846352979940529142984724747568191373312), -0.000000])
