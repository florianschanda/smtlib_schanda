...
(assert (= y (fp #b1 #b10010100 #b10010100110110101011010)))
;; y should be Float32(0xCA4A6D5A [Rational(-6633133, 2), -3316566.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x00329B56))))
(check-sat)
(exit)
