...
(assert (= x ((_ to_fp 8 24) #x3C40DC61)))
;; x should be Float32(0x3C40DC61 [Rational(12639329, 1073741824), 0.011771])
...
(assert (= result (fp #b0 #b00000000 #b00000011000000110111001)))
(check-sat)
(exit)
