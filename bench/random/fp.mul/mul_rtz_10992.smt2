...
(assert (= x ((_ to_fp 8 24) #xE321FEEE)))
;; x should be Float32(0xE321FEEE [Rational(-2988295415797328642048), -2988295415797328642048.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2421FEEE))))
(check-sat)
(exit)
