...
(assert (= y (fp #b0 #b10010101 #b11100100001100011101111)))
;; y should be Float32(0x4AF218EF [Rational(15866095, 2), 7933047.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result ((_ to_fp 8 24) #x8BF218EE)))
(check-sat)
(exit)
