...
(assert (= x ((_ to_fp 8 24) #x000A811C)))
;; x should be Float32(0x000A811C [Rational(172103, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= result (fp #b0 #b01111101 #b01010000001000110111111)))
(check-sat)
(exit)
