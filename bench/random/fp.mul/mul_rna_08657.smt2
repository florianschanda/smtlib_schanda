...
(assert (= y (fp #b0 #b10100101 #b10110000001110101000110)))
;; y should be Float32(0x52D81D46 [Rational(464102031360), 464102031360.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x13D81D46))))
(check-sat)
(exit)
