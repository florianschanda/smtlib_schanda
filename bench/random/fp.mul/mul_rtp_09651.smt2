...
(assert (= y (fp #b0 #b00000000 #b10100100001110111110101)))
;; y should be Float32(0x00521DF5 [Rational(5381621, 713623846352979940529142984724747568191373312), 0.000000])
