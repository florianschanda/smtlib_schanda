...
(assert (= x ((_ to_fp 8 24) #xCAB9AD45)))
;; x should be Float32(0xCAB9AD45 [Rational(-12168517, 2), -6084258.500000])
...
(assert (= result (fp #b0 #b00000000 #b10111001101011010100011)))
(check-sat)
(exit)
