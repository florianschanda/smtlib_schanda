...
(assert (= x (fp #b0 #b00000000 #b10100100100001001101100)))
;; x should be Float32(0x0052426C [Rational(1347739, 178405961588244985132285746181186892047843328), 0.000000])
