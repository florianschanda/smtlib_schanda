...
(assert (= x ((_ to_fp 8 24) #xACA2472D)))
;; x should be Float32(0xACA2472D [Rational(-10635053, 2305843009213693952), -0.000000])
...
(assert (= result (fp #b0 #b11011001 #b01000100100011100101100)))
(check-sat)
(exit)
