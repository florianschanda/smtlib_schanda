...
(assert (= x (fp #b0 #b10001011 #b01111000001001011101011)))
;; x should be Float32(0x45BC12EB [Rational(12325611, 2048), 6018.364746])
...
(assert (not (= result ((_ to_fp 8 24) #x80001783))))
(check-sat)
(exit)
