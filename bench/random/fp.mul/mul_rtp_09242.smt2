...
(assert (= y ((_ to_fp 8 24) #x003FFCAA)))
;; y should be Float32(0x003FFCAA [Rational(2096725, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (= result (fp #b0 #b01111111 #b11111111111001010101000)))
(check-sat)
(exit)
