...
(assert (= x (fp #b0 #b10010100 #b10000000110111101111010)))
;; x should be Float32(0x4A406F7A [Rational(6305725, 2), 3152862.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B406F78))))
(check-sat)
(exit)
