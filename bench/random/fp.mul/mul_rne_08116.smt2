...
(assert (= x (fp #b0 #b00000000 #b01000100101001000011111)))
;; x should be Float32(0x0022521F [Rational(2249247, 713623846352979940529142984724747568191373312), 0.000000])
