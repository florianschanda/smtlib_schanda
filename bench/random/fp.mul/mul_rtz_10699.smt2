...
(assert (= x ((_ to_fp 8 24) #x003449BE)))
;; x should be Float32(0x003449BE [Rational(1713375, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b10100010010011011110111)))
(check-sat)
(exit)
