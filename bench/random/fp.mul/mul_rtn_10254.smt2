...
(assert (= y ((_ to_fp 8 24) #x48BB0850)))
;; y should be Float32(0x48BB0850 [Rational(766085, 2), 383042.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (not (= result (fp #b1 #b00010011 #b01110110000100001010000))))
(check-sat)
(exit)
