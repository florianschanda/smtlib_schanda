...
(assert (= x (fp #b1 #b00000000 #b10011000101010100100111)))
;; x should be Float32(0x804C5527 [Rational(-5002535, 713623846352979940529142984724747568191373312), -0.000000])
