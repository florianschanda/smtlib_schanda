...
(assert (= x (fp #b1 #b10010101 #b00001110001000101100101)))
;; x should be Float32(0xCA871165 [Rational(-8851813, 2), -4425906.500000])
...
(assert (= result (fp #b1 #b00000000 #b10000111000100010110010)))
(check-sat)
(exit)
