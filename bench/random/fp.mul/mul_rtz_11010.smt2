...
(assert (= x (fp #b1 #b00000000 #b00100010111110000100001)))
;; x should be Float32(0x80117C21 [Rational(-1145889, 713623846352979940529142984724747568191373312), -0.000000])
