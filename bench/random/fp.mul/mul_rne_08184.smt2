...
(assert (= x ((_ to_fp 8 24) #xCACDE6D7)))
;; x should be Float32(0xCACDE6D7 [Rational(-13493975, 2), -6746987.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10011011110011011010111))))
(check-sat)
(exit)
