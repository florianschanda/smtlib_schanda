...
(assert (= y ((_ to_fp 8 24) #xCAA81E9B)))
;; y should be Float32(0xCAA81E9B [Rational(-11017883, 2), -5508941.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result (fp #b1 #b00000000 #b10101000000111101001110))))
(check-sat)
(exit)
