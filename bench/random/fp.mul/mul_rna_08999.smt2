...
(assert (= y (fp #b1 #b10010100 #b10101001010111000000110)))
;; y should be Float32(0xCA54AE06 [Rational(-6969091, 2), -3484545.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result (fp #b0 #b00000000 #b01101010010101110000010)))
(check-sat)
(exit)
