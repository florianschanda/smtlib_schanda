...
(assert (= x (fp #b1 #b00000000 #b11001011000011001100001)))
;; x should be Float32(0x80658661 [Rational(-6653537, 713623846352979940529142984724747568191373312), -0.000000])
