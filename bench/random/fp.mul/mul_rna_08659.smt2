...
(assert (= y (fp #b0 #b00000000 #b01000101100111110001111)))
;; y should be Float32(0x0022CF8F [Rational(2281359, 713623846352979940529142984724747568191373312), 0.000000])
