...
(assert (= x (fp #b0 #b00000000 #b01001101100101000010010)))
;; x should be Float32(0x0026CA12 [Rational(1271049, 356811923176489970264571492362373784095686656), 0.000000])
