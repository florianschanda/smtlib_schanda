...
(assert (= y ((_ to_fp 8 24) #x6334443E)))
;; y should be Float32(0x6334443E [Rational(3325331301110854451200), 3325331301110854451200.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (= result ((_ to_fp 8 24) #xA434443C)))
(check-sat)
(exit)
