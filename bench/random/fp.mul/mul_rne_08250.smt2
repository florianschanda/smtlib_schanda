...
(assert (= y ((_ to_fp 8 24) #x1F9C5F8C)))
;; y should be Float32(0x1F9C5F8C [Rational(2562019, 38685626227668133590597632), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b1 #b10111111 #b00111000101111110001011))))
(check-sat)
(exit)
