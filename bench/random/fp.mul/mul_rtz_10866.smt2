...
(assert (= y ((_ to_fp 8 24) #x804501D8)))
;; y should be Float32(0x804501D8 [Rational(-565307, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x400A03AF))))
(check-sat)
(exit)
