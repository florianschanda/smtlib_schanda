...
(assert (= y (fp #b0 #b01101010 #b00010001001000100000101)))
;; y should be Float32(0x35089105 [Rational(8950021, 17592186044416), 0.000001])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b0 #b11101010 #b00010001001000100000100))))
(check-sat)
(exit)
