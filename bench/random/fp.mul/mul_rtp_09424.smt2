...
(assert (= x (fp #b0 #b00000000 #b10111001011110100001010)))
;; x should be Float32(0x005CBD0A [Rational(3038853, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0397A13)))
(check-sat)
(exit)
