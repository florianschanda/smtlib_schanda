...
(assert (= y (fp #b1 #b00000000 #b10100110100011010001010)))
;; y should be Float32(0x8053468A [Rational(-2728773, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result ((_ to_fp 8 24) #x40268D13)))
(check-sat)
(exit)
