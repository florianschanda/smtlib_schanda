...
(assert (= x (fp #b0 #b00000000 #b10010001100101111110001)))
;; x should be Float32(0x0048CBF1 [Rational(4770801, 713623846352979940529142984724747568191373312), 0.000000])
