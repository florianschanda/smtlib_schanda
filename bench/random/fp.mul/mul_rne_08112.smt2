...
(assert (= x (fp #b0 #b00000000 #b11000100111010000101011)))
;; x should be Float32(0x0062742B [Rational(6452267, 713623846352979940529142984724747568191373312), 0.000000])
