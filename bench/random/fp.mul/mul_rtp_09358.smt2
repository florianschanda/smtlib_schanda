...
(assert (= y (fp #b1 #b00000000 #b11111100111010110100100)))
;; y should be Float32(0x807E75A4 [Rational(-2071913, 178405961588244985132285746181186892047843328), -0.000000])
