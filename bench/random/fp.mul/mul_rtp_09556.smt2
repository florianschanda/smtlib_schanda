...
(assert (= y (fp #b0 #b00000000 #b10100011001100010101101)))
;; y should be Float32(0x005198AD [Rational(5347501, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #xC0233159))))
(check-sat)
(exit)
