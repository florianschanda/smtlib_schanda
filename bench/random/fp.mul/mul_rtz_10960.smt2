...
(assert (= y (fp #b1 #b00000000 #b01000010011110111101111)))
;; y should be Float32(0x80213DEF [Rational(-2178543, 713623846352979940529142984724747568191373312), -0.000000])
