...
(assert (= x (fp #b1 #b00000100 #b00100001100000101110110)))
;; x should be Float32(0x8210C176 [Rational(-4743355, 44601490397061246283071436545296723011960832), -0.000000])
