...
(assert (= x (fp #b1 #b10010101 #b01111010011010011010011)))
;; x should be Float32(0xCABD34D3 [Rational(-12399827, 2), -6199913.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x005E9A6A))))
(check-sat)
(exit)
