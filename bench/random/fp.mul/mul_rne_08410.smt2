...
(assert (= x (fp #b1 #b00000000 #b01100101110011100000000)))
;; x should be Float32(0x8032E700 [Rational(-13031, 2787593149816327892691964784081045188247552), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFCB9BFF)))
(check-sat)
(exit)
