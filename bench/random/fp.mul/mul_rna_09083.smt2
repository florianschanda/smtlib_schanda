...
(assert (= x (fp #b1 #b00000000 #b01010001000000000001101)))
;; x should be Float32(0x8028800D [Rational(-2654221, 713623846352979940529142984724747568191373312), -0.000000])
