...
(assert (= y (fp #b0 #b00000000 #b11110010011000111100101)))
;; y should be Float32(0x007931E5 [Rational(7942629, 713623846352979940529142984724747568191373312), 0.000000])
