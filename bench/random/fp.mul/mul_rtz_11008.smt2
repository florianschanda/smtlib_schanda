...
(assert (= x ((_ to_fp 8 24) #x804D5B2D)))
;; x should be Float32(0x804D5B2D [Rational(-5069613, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC01AB659))))
(check-sat)
(exit)
