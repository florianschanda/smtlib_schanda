...
(assert (= y (fp #b1 #b10010010 #b01001010000010011001000)))
;; y should be Float32(0xC92504C8 [Rational(-1351833, 2), -675916.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result (fp #b1 #b00000000 #b00010100101000001001100))))
(check-sat)
(exit)
