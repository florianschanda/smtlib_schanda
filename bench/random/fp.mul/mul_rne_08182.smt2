...
(assert (= x (fp #b1 #b10010100 #b11001101011100000100110)))
;; x should be Float32(0xCA66B826 [Rational(-7560211, 2), -3780105.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B66B824))))
(check-sat)
(exit)
