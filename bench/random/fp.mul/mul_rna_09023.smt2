...
(assert (= x (fp #b1 #b10000011 #b01111100011000001011100)))
;; x should be Float32(0xC1BE305C [Rational(-3116055, 131072), -23.773613])
...
(assert (not (= result ((_ to_fp 8 24) #x82BE305B))))
(check-sat)
(exit)
