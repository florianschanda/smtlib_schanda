...
(assert (= y ((_ to_fp 8 24) #x80454BFE)))
;; y should be Float32(0x80454BFE [Rational(-2270719, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #xC00A97FB))))
(check-sat)
(exit)
