...
(assert (= y (fp #b0 #b00000000 #b11000000010000011100010)))
;; y should be Float32(0x006020E2 [Rational(3149937, 356811923176489970264571492362373784095686656), 0.000000])
