...
(assert (= x ((_ to_fp 8 24) #x000A7AE4)))
;; x should be Float32(0x000A7AE4 [Rational(171705, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3EA7AE3F))))
(check-sat)
(exit)
