...
(assert (= y (fp #b0 #b00000000 #b00101110010111011101101)))
;; y should be Float32(0x00172EED [Rational(1519341, 713623846352979940529142984724747568191373312), 0.000000])
