...
(assert (= y (fp #b1 #b00011101 #b00001011110001111111011)))
;; y should be Float32(0x8E85E3FB [Rational(-8774651, 2658455991569831745807614120560689152), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x4E85E3FB))))
(check-sat)
(exit)
