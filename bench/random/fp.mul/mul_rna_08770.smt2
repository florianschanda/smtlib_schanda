...
(assert (= x (fp #b0 #b00000000 #b10101001110110101101010)))
;; x should be Float32(0x0054ED6A [Rational(2782901, 356811923176489970264571492362373784095686656), 0.000000])
