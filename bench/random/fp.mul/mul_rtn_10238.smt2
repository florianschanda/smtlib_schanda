...
(assert (= y ((_ to_fp 8 24) #xCA9A819B)))
;; y should be Float32(0xCA9A819B [Rational(-10125723, 2), -5062861.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result (fp #b0 #b00010111 #b00110101000000110011001)))
(check-sat)
(exit)
