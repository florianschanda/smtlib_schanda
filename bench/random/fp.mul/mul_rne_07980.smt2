...
(assert (= y ((_ to_fp 8 24) #x47CB9ACE)))
;; y should be Float32(0x47CB9ACE [Rational(6671719, 64), 104245.609375])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b0 #b00010001 #b10010111001101011001100))))
(check-sat)
(exit)
