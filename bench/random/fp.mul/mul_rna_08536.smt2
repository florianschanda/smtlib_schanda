...
(assert (= x ((_ to_fp 8 24) #x4A2E740E)))
;; x should be Float32(0x4A2E740E [Rational(5716487, 2), 2858243.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b01011100111010000001101))))
(check-sat)
(exit)
