...
(assert (= x (fp #b1 #b10010100 #b10001100111100010010010)))
;; x should be Float32(0xCA467892 [Rational(-6503497, 2), -3251748.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B467890))))
(check-sat)
(exit)
