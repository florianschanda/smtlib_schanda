...
(assert (= x ((_ to_fp 8 24) #xB034F9E2)))
;; x should be Float32(0xB034F9E2 [Rational(-5930225, 9007199254740992), -0.000000])
...
(assert (not (= result (fp #b1 #b11100000 #b01101001111100111100010))))
(check-sat)
(exit)
