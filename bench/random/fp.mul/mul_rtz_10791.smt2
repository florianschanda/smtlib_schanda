...
(assert (= x (fp #b1 #b10010101 #b11100100111100001001011)))
;; x should be Float32(0xCAF2784B [Rational(-15890507, 2), -7945253.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100100111100001001001)))
(check-sat)
(exit)
