...
(assert (= x (fp #b0 #b00010000 #b01010010111100010111010)))
;; x should be Float32(0x082978BA [Rational(5553245, 10889035741470030830827987437816582766592), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x482978B9)))
(check-sat)
(exit)
