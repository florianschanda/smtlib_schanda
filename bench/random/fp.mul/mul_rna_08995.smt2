...
(assert (= y (fp #b0 #b00000000 #b01111110010010101000100)))
;; y should be Float32(0x003F2544 [Rational(1034577, 178405961588244985132285746181186892047843328), 0.000000])
