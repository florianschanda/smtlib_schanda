...
(assert (= y (fp #b0 #b00000000 #b00001101010110010001100)))
;; y should be Float32(0x0006AC8C [Rational(109347, 178405961588244985132285746181186892047843328), 0.000000])
