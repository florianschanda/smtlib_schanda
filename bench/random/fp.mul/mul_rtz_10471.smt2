...
(assert (= x (fp #b0 #b10010101 #b10101001010010111110001)))
;; x should be Float32(0x4AD4A5F1 [Rational(13936113, 2), 6968056.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x006A52F8))))
(check-sat)
(exit)
