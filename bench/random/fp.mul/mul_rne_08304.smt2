...
(assert (= y (fp #b0 #b10010101 #b11001011101111011001001)))
;; y should be Float32(0x4AE5DEC9 [Rational(15064777, 2), 7532388.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result ((_ to_fp 8 24) #x8BE5DEC9)))
(check-sat)
(exit)
