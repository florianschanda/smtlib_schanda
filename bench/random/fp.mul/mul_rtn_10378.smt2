...
(assert (= x (fp #b1 #b00000000 #b11100101001011010111101)))
;; x should be Float32(0x807296BD [Rational(-7509693, 713623846352979940529142984724747568191373312), -0.000000])
