...
(assert (= x (fp #b1 #b00000000 #b11101110010010111101110)))
;; x should be Float32(0x807725EE [Rational(-3904247, 356811923176489970264571492362373784095686656), -0.000000])
