...
(assert (= y (fp #b0 #b00000100 #b11110100110100100101011)))
;; y should be Float32(0x027A692B [Rational(16410923, 89202980794122492566142873090593446023921664), 0.000000])
