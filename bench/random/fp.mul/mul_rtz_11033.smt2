...
(assert (= x (fp #b1 #b00000000 #b01001011011000110101100)))
;; x should be Float32(0x8025B1AC [Rational(-617579, 178405961588244985132285746181186892047843328), -0.000000])
