...
(assert (= y ((_ to_fp 8 24) #xCAD1D911)))
;; y should be Float32(0xCAD1D911 [Rational(-13752593, 2), -6876296.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result (fp #b1 #b00010111 #b10100011101100100001111)))
(check-sat)
(exit)
