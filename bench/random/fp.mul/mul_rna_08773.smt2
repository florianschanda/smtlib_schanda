...
(assert (= x (fp #b0 #b00000000 #b11111001001101011110111)))
;; x should be Float32(0x007C9AF7 [Rational(8166135, 713623846352979940529142984724747568191373312), 0.000000])
