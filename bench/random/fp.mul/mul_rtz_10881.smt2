...
(assert (= y ((_ to_fp 8 24) #x38DED239)))
;; y should be Float32(0x38DED239 [Rational(14602809, 137438953472), 0.000106])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (not (= result (fp #b1 #b00000000 #b00000000000001101111011))))
(check-sat)
(exit)
