...
(assert (= x (fp #b1 #b00000000 #b01101010101110000010010)))
;; x should be Float32(0x80355C12 [Rational(-1748489, 356811923176489970264571492362373784095686656), -0.000000])
