...
(assert (= y (fp #b0 #b00000000 #b10110111001111100111110)))
;; y should be Float32(0x005B9F3E [Rational(3002271, 356811923176489970264571492362373784095686656), 0.000000])
