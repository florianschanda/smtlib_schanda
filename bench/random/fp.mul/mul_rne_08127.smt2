...
(assert (= x ((_ to_fp 8 24) #x0055AB60)))
;; x should be Float32(0x0055AB60 [Rational(175451, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b01010110101011010111111))))
(check-sat)
(exit)
