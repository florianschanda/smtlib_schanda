...
(assert (= x ((_ to_fp 8 24) #x80386A72)))
;; x should be Float32(0x80386A72 [Rational(-1848633, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FE1A9C7)))
(check-sat)
(exit)
