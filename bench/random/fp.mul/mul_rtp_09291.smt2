...
(assert (= y (fp #b1 #b00000000 #b00000100100110010011111)))
;; y should be Float32(0x80024C9F [Rational(-150687, 713623846352979940529142984724747568191373312), -0.000000])
