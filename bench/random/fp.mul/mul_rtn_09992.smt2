...
(assert (= y (fp #b1 #b10010010 #b01000110110100011111000)))
;; y should be Float32(0xC92368F8 [Rational(-1338655, 2), -669327.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result (fp #b1 #b00000000 #b00010100011011010010000)))
(check-sat)
(exit)
