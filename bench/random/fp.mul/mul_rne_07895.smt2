...
(assert (= x ((_ to_fp 8 24) #x4AA60FEF)))
;; x should be Float32(0x4AA60FEF [Rational(10883055, 2), 5441527.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01001100000111111101110))))
(check-sat)
(exit)
