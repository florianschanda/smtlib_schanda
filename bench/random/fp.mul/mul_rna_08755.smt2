...
(assert (= x (fp #b0 #b00000000 #b01110110100101010110001)))
;; x should be Float32(0x003B4AB1 [Rational(3885745, 713623846352979940529142984724747568191373312), 0.000000])
