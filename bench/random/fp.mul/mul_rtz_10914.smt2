...
(assert (= y (fp #b0 #b00000000 #b01011000011001000011010)))
;; y should be Float32(0x002C321A [Rational(1448205, 356811923176489970264571492362373784095686656), 0.000000])
