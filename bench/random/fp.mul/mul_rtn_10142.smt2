...
(assert (= x (fp #b1 #b10001110 #b10001101011101110000000)))
;; x should be Float32(0xC746BB80 [Rational(-101751, 2), -50875.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0846BB7E))))
(check-sat)
(exit)
