...
(assert (= x (fp #b1 #b00000000 #b00101010011110111101011)))
;; x should be Float32(0x80153DEB [Rational(-1392107, 713623846352979940529142984724747568191373312), -0.000000])
