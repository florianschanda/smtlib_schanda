...
(assert (= y ((_ to_fp 8 24) #x8012961D)))
;; y should be Float32(0x8012961D [Rational(-1218077, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (= result ((_ to_fp 8 24) #xBF14B0E7)))
(check-sat)
(exit)
