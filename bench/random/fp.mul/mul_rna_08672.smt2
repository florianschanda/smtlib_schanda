...
(assert (= y (fp #b1 #b10000010 #b01010101101100101010101)))
;; y should be Float32(0xC12AD955 [Rational(-11196757, 1048576), -10.678060])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x822AD955))))
(check-sat)
(exit)
