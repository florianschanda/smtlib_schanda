...
(assert (= x (fp #b1 #b00000001 #b11011010110101110011000)))
;; x should be Float32(0x80ED6B98 [Rational(-1944947, 89202980794122492566142873090593446023921664), -0.000000])
