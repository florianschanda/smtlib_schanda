...
(assert (= y (fp #b1 #b00000000 #b01001100100110010100100)))
;; y should be Float32(0x80264CA4 [Rational(-627497, 178405961588244985132285746181186892047843328), -0.000000])
