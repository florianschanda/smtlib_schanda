...
(assert (= y (fp #b0 #b00000000 #b00001001011111000111010)))
;; y should be Float32(0x0004BE3A [Rational(155421, 356811923176489970264571492362373784095686656), 0.000000])
