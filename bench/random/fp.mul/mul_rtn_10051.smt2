...
(assert (= x ((_ to_fp 8 24) #x003B3F71)))
;; x should be Float32(0x003B3F71 [Rational(3882865, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b11011001111110111000011))))
(check-sat)
(exit)
