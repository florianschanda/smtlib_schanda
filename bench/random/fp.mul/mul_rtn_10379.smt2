...
(assert (= x (fp #b1 #b00000000 #b00111001010110010001011)))
;; x should be Float32(0x801CAC8B [Rational(-1879179, 713623846352979940529142984724747568191373312), -0.000000])
