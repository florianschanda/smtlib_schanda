...
(assert (= y (fp #b1 #b00011110 #b10001000111111100111101)))
;; y should be Float32(0x8F447F3D [Rational(-12877629, 1329227995784915872903807060280344576), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result ((_ to_fp 8 24) #x4F447F3C)))
(check-sat)
(exit)
