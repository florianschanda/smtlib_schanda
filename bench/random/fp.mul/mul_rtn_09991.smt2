...
(assert (= y (fp #b1 #b10010101 #b01001100110011011101101)))
;; y should be Float32(0xCAA666ED [Rational(-10905325, 2), -5452662.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (not (= result (fp #b1 #b00000000 #b10100110011001101110111))))
(check-sat)
(exit)
