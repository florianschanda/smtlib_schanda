...
(assert (= x (fp #b0 #b00000000 #b11010110001000011100011)))
;; x should be Float32(0x006B10E3 [Rational(7016675, 713623846352979940529142984724747568191373312), 0.000000])
