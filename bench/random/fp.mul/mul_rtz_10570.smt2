...
(assert (= y (fp #b0 #b10010101 #b01000111000010110000011)))
;; y should be Float32(0x4AA38583 [Rational(10716547, 2), 5358273.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x0BA38581)))
(check-sat)
(exit)
