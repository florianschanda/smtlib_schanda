...
(assert (= y (fp #b0 #b10010010 #b10000011000101110001000)))
;; y should be Float32(0x49418B88 [Rational(1585521, 2), 792760.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (= result (fp #b1 #b00010100 #b10000011000101110000110)))
(check-sat)
(exit)
