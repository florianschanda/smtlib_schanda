...
(assert (= x ((_ to_fp 8 24) #xCAECAD4F)))
;; x should be Float32(0xCAECAD4F [Rational(-15510863, 2), -7755431.500000])
...
(assert (= result (fp #b0 #b00000000 #b11101100101011010100111)))
(check-sat)
(exit)
