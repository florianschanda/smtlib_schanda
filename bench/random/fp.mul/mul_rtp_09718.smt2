...
(assert (= x (fp #b1 #b00000000 #b01001101010001001101100)))
;; x should be Float32(0x8026A26C [Rational(-632987, 178405961588244985132285746181186892047843328), -0.000000])
