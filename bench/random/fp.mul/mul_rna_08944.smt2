...
(assert (= y (fp #b1 #b00000000 #b10011001010001001011110)))
;; y should be Float32(0x804CA25E [Rational(-2511151, 356811923176489970264571492362373784095686656), -0.000000])
