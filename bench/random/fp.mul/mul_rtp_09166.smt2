...
(assert (= x (fp #b0 #b10010101 #b00000111011010110001001)))
;; x should be Float32(0x4A83B589 [Rational(8631689, 2), 4315844.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00000111011010110001000))))
(check-sat)
(exit)
