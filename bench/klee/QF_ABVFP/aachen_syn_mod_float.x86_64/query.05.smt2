...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_mod_float.x86_64/query.05.smt2
|)
...
(assert
 (let ((?x15 (concat (select f0 (_ bv2 32)) (concat (select f0 (_ bv1 32)) (select f0 (_ bv0 32))))))
 (let ((?x19 ((_ to_fp 8 24) (concat (select f0 (_ bv3 32)) ?x15))))
 (= ((_ to_fp 11 53) roundNearestTiesToEven ?x19) ((_ to_fp 11 53) fresh_to_ieee_bv_!0)))))
(assert
 (let ((?x34 (concat (select g1 (_ bv2 32)) (concat (select g1 (_ bv1 32)) (select g1 (_ bv0 32))))))
 (let ((?x37 ((_ to_fp 8 24) (concat (select g1 (_ bv3 32)) ?x34))))
...
(let (($x62 (bvsle (bvxor ?x51 (bvand ?x51 (_ bv2147483648 32))) (bvand ((_ extract 63 32) fresh_to_ieee_bv_!1) (_ bv2147483647 32)))))
(not $x62))))
(check-sat)
(exit)
