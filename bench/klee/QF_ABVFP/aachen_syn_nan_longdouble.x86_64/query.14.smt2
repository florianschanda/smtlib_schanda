...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_nan_longdouble.x86_64/query.14.smt2
|)
...
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x53 ?x53))))))))))))
(check-sat)
(exit)
