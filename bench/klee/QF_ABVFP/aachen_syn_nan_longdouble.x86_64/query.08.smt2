...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_nan_longdouble.x86_64/query.08.smt2
|)
...
(not (not (not (fp.isNaN (fp.div roundNearestTiesToEven ?x88 ?x79)))))))))))))))))
(check-sat)
(exit)
