...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.281.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float_20 (_ bv3 32)) (concat (select symbolic_0_float_20 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x111 (fp.sub roundNearestTiesToEven ?x19 ?x66)))
 ...
 (let ((?x112 (fp.sub roundNearestTiesToEven ?x110 ?x111)))
...
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x111 (fp.sub roundNearestTiesToEven ?x19 ?x66)))
(let ((?x151 (fp.add roundNearestTiesToEven ?x111 ?x97)))
