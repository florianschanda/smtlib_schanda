...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.368.smt2
|)
...
(assert
 ...
 (let ((?x147 (fp.sub roundNearestTiesToEven ?x146 ?x70)))
...
(assert
 ...
 (let ((?x89 ((_ to_fp 8 24) ?x88)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x170 (fp.sub roundNearestTiesToEven ?x49 ?x89)))
 (not (fp.isNaN ?x170))))))))
(assert
 (let ((?x84 (concat (select symbolic_0_float_35 (_ bv1 32)) (select symbolic_0_float_35 (_ bv0 32)))))
 (let ((?x88 (concat (select symbolic_0_float_35 (_ bv3 32)) (concat (select symbolic_0_float_35 (_ bv2 32)) ?x84))))
