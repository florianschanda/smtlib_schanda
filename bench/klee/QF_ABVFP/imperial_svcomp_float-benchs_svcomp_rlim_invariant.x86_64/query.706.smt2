...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.706.smt2
|)
...
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x160 (fp.sub roundNearestTiesToEven ?x141 (fp.sub roundNearestTiesToEven ?x124 ?x112))))
(not (or (or (fp.isNaN ?x160) (fp.isNaN ?x156)) (fp.lt ?x160 ?x156)))))))))))))))))))))))))))
(check-sat)
(exit)
