...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.172.smt2
|)
...
(let ((?x119 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x115))))
(let ((?x120 ((_ to_fp 8 24) ?x119)))
(let ((?x141 (fp.sub roundNearestTiesToEven ?x120 (fp.add roundNearestTiesToEven ?x102 ?x88))))
