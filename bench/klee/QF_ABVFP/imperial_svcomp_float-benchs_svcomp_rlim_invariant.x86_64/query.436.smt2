...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.436.smt2
|)
...
(assert
 ...
 (let ((?x161 ((_ to_fp 8 24) ?x160)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x26 ?x161)))
 (let ((?x112 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x116 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x112))))
 (let ((?x117 ((_ to_fp 8 24) ?x116)))
 (let ((?x83 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x145 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x141))))
 (let ((?x146 ((_ to_fp 8 24) ?x145)))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x146 (fp.sub roundNearestTiesToEven ?x129 ?x117))))
 (or (or (fp.isNaN ?x165) (fp.isNaN ?x167)) (fp.gt ?x165 ?x167))))))))))))))))))))))))))))
(assert
 (let ((?x148 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
