...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.152.smt2
|)
...
(assert
 ...
 (let ((?x129 ((_ to_fp 8 24) ?x128)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x135 (fp.sub roundNearestTiesToEven ?x26 ?x129)))
 (let ((?x80 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 (let ((?x84 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x80))))
 (let ((?x85 ((_ to_fp 8 24) ?x84)))
 (let ((?x51 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 ...
 (let ((?x113 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x109))))
 (let ((?x114 ((_ to_fp 8 24) ?x113)))
 (let ((?x133 (fp.sub roundNearestTiesToEven ?x114 (fp.sub roundNearestTiesToEven ?x97 ?x85))))
 (or (or (fp.isNaN ?x133) (fp.isNaN ?x135)) (fp.gt ?x133 ?x135))))))))))))))))))))))))
(assert
 (let ((?x116 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
...
(let ((?x114 ((_ to_fp 8 24) ?x113)))
(let ((?x133 (fp.sub roundNearestTiesToEven ?x114 (fp.sub roundNearestTiesToEven ?x97 ?x85))))
(not (or (or (fp.isNaN ?x133) (fp.isNaN ?x129)) (fp.lt ?x133 ?x129)))))))))))))))))))))))
(check-sat)
(exit)
