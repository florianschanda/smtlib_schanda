...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.255.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x118 (concat (select symbolic_0_float_66 (_ bv1 32)) (select symbolic_0_float_66 (_ bv0 32)))))
 (let ((?x122 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x118))))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x129 (concat (select symbolic_0_float_77 (_ bv1 32)) (select symbolic_0_float_77 (_ bv0 32)))))
 (let ((?x133 (concat (select symbolic_0_float_77 (_ bv3 32)) (concat (select symbolic_0_float_77 (_ bv2 32)) ?x129))))
...
(assert
 ...
 (let ((?x134 ((_ to_fp 8 24) ?x133)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x140 (fp.sub roundNearestTiesToEven ?x31 ?x134)))
 (let ((?x86 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 (let ((?x90 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x86))))
 (let ((?x91 ((_ to_fp 8 24) ?x90)))
 (let ((?x53 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 ...
 (let ((?x122 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x118))))
 (let ((?x123 ((_ to_fp 8 24) ?x122)))
 (let ((?x138 (fp.sub roundNearestTiesToEven ?x123 (fp.add roundNearestTiesToEven ?x105 ?x91))))
 (or (or (fp.isNaN ?x138) (fp.isNaN ?x140)) (fp.gt ?x138 ?x140))))))))))))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x35 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x39 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x35))))
...
(let ((?x123 ((_ to_fp 8 24) ?x122)))
(let ((?x138 (fp.sub roundNearestTiesToEven ?x123 (fp.add roundNearestTiesToEven ?x105 ?x91))))
(not (or (or (fp.isNaN ?x138) (fp.isNaN ?x134)) (fp.lt ?x138 ?x134)))))))))))))))))))))
(check-sat)
(exit)
