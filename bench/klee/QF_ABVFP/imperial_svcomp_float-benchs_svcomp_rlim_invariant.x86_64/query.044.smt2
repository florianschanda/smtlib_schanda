...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.044.smt2
|)
...
(let ((?x85 ((_ to_fp 8 24) ?x84)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x85 (fp.sub roundNearestTiesToEven ?x68 ?x56))))
(not (or (or (fp.isNaN ?x104) (fp.isNaN ?x100)) (fp.lt ?x104 ?x100)))))))))))))))))))
(check-sat)
(exit)
