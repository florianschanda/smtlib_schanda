...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.293.smt2
|)
...
(assert
 ...
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x20 ?x19)))
 (let ((?x97 (fp.add roundNearestTiesToEven ?x65 ?x51)))
 (let ((?x121 (concat (select symbolic_0_float_67 (_ bv1 32)) (select symbolic_0_float_67 (_ bv0 32)))))
 (let ((?x125 (concat (select symbolic_0_float_67 (_ bv3 32)) (concat (select symbolic_0_float_67 (_ bv2 32)) ?x121))))
 (let ((?x126 ((_ to_fp 8 24) ?x125)))
 (let ((?x128 (fp.sub roundNearestTiesToEven ?x126 (fp.add roundNearestTiesToEven ?x97 ?x83))))
 (not (fp.isNaN ?x128)))))))))))))))))))
(assert
 (let ((?x110 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x114 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x110))))
 (let ((?x115 ((_ to_fp 8 24) ?x114)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x131 (fp.sub roundNearestTiesToEven ?x26 ?x115)))
 (not (fp.isNaN ?x131))))))))
(assert
 (let ((?x110 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x114 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x110))))
