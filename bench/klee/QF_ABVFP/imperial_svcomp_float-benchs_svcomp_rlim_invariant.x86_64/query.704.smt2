...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.704.smt2
|)
...
(let ((?x156 ((_ to_fp 8 24) ?x155)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x173 (fp.sub roundNearestTiesToEven ?x26 ?x156)))
(let ((?x107 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
(let ((?x111 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x107))))
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(let ((?x140 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x136))))
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x170 (fp.sub roundNearestTiesToEven ?x141 (fp.sub roundNearestTiesToEven ?x124 ?x112))))
