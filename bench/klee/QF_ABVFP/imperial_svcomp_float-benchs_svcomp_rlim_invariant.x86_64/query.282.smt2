...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.282.smt2
|)
...
(let ((?x109 ((_ to_fp 8 24) ?x108)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x143 (fp.sub roundNearestTiesToEven ?x41 ?x109)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
(let ((?x67 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x63))))
(let ((?x68 ((_ to_fp 8 24) ?x67)))
(let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
...
(let ((?x97 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x93))))
(let ((?x98 ((_ to_fp 8 24) ?x97)))
(let ((?x141 (fp.sub roundNearestTiesToEven ?x98 (fp.sub roundNearestTiesToEven ?x19 ?x68))))
