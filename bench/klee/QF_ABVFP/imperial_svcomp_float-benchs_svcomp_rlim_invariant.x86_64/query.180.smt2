...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.180.smt2
|)
...
(let ((?x111 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x107))))
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x139 (fp.sub roundNearestTiesToEven ?x112 (fp.add roundNearestTiesToEven ?x94 ?x80))))
