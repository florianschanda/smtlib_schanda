...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.401.smt2
|)
...
(assert
 ...
 (let ((?x43 ((_ to_fp 8 24) ?x42)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x153 (fp.sub roundNearestTiesToEven ?x49 ?x43)))
 (let ((?x29 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 ...
 (let ((?x164 (fp.sub roundNearestTiesToEven ?x163 ?x34)))
...
(let ((?x107 ((_ to_fp 8 24) ?x106)))
(let ((?x122 (fp.sub roundNearestTiesToEven ?x107 (fp.sub roundNearestTiesToEven ?x19 ?x76))))
(let (($x187 (and (and (not (fp.isNaN ?x122)) (not (fp.isNaN ?x118))) (not (fp.lt ?x122 ?x118)))))
(not $x187))))))))))))))))
(check-sat)
(exit)
