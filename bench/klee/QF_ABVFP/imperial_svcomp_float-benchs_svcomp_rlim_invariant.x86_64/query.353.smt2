...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.353.smt2
|)
...
(assert
 ...
 (let ((?x142 (fp.sub roundNearestTiesToEven ?x140 (fp.sub roundNearestTiesToEven ?x110 ?x98))))
