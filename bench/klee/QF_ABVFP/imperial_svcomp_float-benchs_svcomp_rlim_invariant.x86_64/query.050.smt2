...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.050.smt2
|)
...
(assert
 ...
 (let ((?x95 ((_ to_fp 8 24) ?x94)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x26 ?x95)))
 (let ((?x46 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x50 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x46))))
 (let ((?x51 ((_ to_fp 8 24) ?x50)))
 (let ((?x12 (concat (select symbolic_0_float_10 (_ bv1 32)) (select symbolic_0_float_10 (_ bv0 32)))))
 ...
 (let ((?x79 (concat (select symbolic_0_float_44 (_ bv3 32)) (concat (select symbolic_0_float_44 (_ bv2 32)) ?x75))))
 (let ((?x80 ((_ to_fp 8 24) ?x79)))
 (let ((?x99 (fp.sub roundNearestTiesToEven ?x80 (fp.sub roundNearestTiesToEven ?x63 ?x51))))
 (or (or (fp.isNaN ?x99) (fp.isNaN ?x101)) (fp.gt ?x99 ?x101))))))))))))))))))))
(assert
 (let ((?x82 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
...
(let ((?x80 ((_ to_fp 8 24) ?x79)))
(let ((?x99 (fp.sub roundNearestTiesToEven ?x80 (fp.sub roundNearestTiesToEven ?x63 ?x51))))
(let (($x118 (and (and (not (fp.isNaN ?x99)) (not (fp.isNaN ?x95))) (not (fp.lt ?x99 ?x95)))))
(not $x118))))))))))))))))))
(check-sat)
(exit)
