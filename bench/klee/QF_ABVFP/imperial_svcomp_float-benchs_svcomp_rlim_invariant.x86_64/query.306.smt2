...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.306.smt2
|)
...
(assert
 ...
 (let ((?x156 ((_ to_fp 8 24) ?x155)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x26 ?x156)))
 (let ((?x104 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x108 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x104))))
 (let ((?x109 ((_ to_fp 8 24) ?x108)))
 (let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x140 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 (let ((?x160 (fp.sub roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x123 ?x109))))
 (or (or (fp.isNaN ?x160) (fp.isNaN ?x162)) (fp.gt ?x160 ?x162))))))))))))))))))))))))))))
(assert
 (let ((?x143 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
...
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x160 (fp.sub roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x123 ?x109))))
(let (($x183 (and (and (not (fp.isNaN ?x160)) (not (fp.isNaN ?x156))) (not (fp.lt ?x160 ?x156)))))
(not $x183))))))))))))))))))))))))))
(check-sat)
(exit)
