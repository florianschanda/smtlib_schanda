...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.453.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x135 ?x120)))))))))))))))))))))))
(assert
 (let ((?x154 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x152 ?x154))))))
(assert
 (let ((?x157 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x147 (concat (select symbolic_0_float_88 (_ bv1 32)) (select symbolic_0_float_88 (_ bv0 32)))))
 (let ((?x151 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x147))))
 (let ((?x152 ((_ to_fp 8 24) ?x151)))
 (fp.leq ?x152 ?x157))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x162 (concat (select symbolic_0_float_99 (_ bv1 32)) (select symbolic_0_float_99 (_ bv0 32)))))
 (let ((?x166 (concat (select symbolic_0_float_99 (_ bv3 32)) (concat (select symbolic_0_float_99 (_ bv2 32)) ?x162))))
...
(assert
 ...
 (let ((?x167 ((_ to_fp 8 24) ?x166)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x173 (fp.sub roundNearestTiesToEven ?x26 ?x167)))
 (let ((?x115 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x119 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x115))))
 (let ((?x120 ((_ to_fp 8 24) ?x119)))
 (let ((?x83 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x151 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x147))))
 (let ((?x152 ((_ to_fp 8 24) ?x151)))
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x152 (fp.add roundNearestTiesToEven ?x134 ?x120))))
 (or (or (fp.isNaN ?x171) (fp.isNaN ?x173)) (fp.gt ?x171 ?x173))))))))))))))))))))))))))))
(assert
 (let ((?x154 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
...
(let ((?x152 ((_ to_fp 8 24) ?x151)))
(let ((?x171 (fp.sub roundNearestTiesToEven ?x152 (fp.add roundNearestTiesToEven ?x134 ?x120))))
(not (or (or (fp.isNaN ?x171) (fp.isNaN ?x167)) (fp.lt ?x171 ?x167)))))))))))))))))))))))))))
(check-sat)
(exit)
