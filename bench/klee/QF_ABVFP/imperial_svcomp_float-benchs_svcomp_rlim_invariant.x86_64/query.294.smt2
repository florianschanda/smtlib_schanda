...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.294.smt2
|)
...
(assert
 ...
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x20 ?x19)))
 (let ((?x97 (fp.add roundNearestTiesToEven ?x65 ?x51)))
 (let ((?x127 (fp.add roundNearestTiesToEven ?x97 ?x83)))
 ...
 (let ((?x128 (fp.sub roundNearestTiesToEven ?x126 ?x127)))
 (not (fp.isNaN ?x128))))))))))))))))))))
(assert
 (let ((?x110 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x114 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x110))))
...
(let ((?x97 (fp.add roundNearestTiesToEven ?x65 ?x51)))
(let ((?x127 (fp.add roundNearestTiesToEven ?x97 ?x83)))
(let ((?x150 (fp.sub roundNearestTiesToEven ?x127 ?x115)))
