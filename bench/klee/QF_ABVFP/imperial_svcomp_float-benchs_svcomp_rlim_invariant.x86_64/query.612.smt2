...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.612.smt2
|)
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
 (let ((?x128 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
 (let ((?x160 (fp.add roundNearestTiesToEven ?x128 ?x114)))
