...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.383.smt2
|)
...
(assert
 ...
 (let ((?x109 ((_ to_fp 8 24) ?x108)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x39 ?x109)))
 (not (fp.isNaN ?x171))))))))
(assert
 (let ((?x104 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
 (let ((?x108 (concat (select symbolic_0_float_36 (_ bv3 32)) (concat (select symbolic_0_float_36 (_ bv2 32)) ?x104))))
