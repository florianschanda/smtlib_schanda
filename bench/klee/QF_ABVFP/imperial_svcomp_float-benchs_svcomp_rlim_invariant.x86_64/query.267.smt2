...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.267.smt2
|)
...
(let ((?x127 ((_ to_fp 8 24) ?x126)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x141 (fp.sub roundNearestTiesToEven ?x26 ?x127)))
(let ((?x78 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
(let ((?x82 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x78))))
(let ((?x83 ((_ to_fp 8 24) ?x82)))
(let ((?x46 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x111 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x107))))
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x139 (fp.sub roundNearestTiesToEven ?x112 (fp.sub roundNearestTiesToEven ?x95 ?x83))))
(not (or (or (fp.isNaN ?x139) (fp.isNaN ?x141)) (fp.gt ?x139 ?x141)))))))))))))))))))))))))
(check-sat)
(exit)
