...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.480.smt2
|)
...
(let ((?x146 ((_ to_fp 8 24) ?x145)))
(let ((?x161 (fp.sub roundNearestTiesToEven ?x146 (fp.sub roundNearestTiesToEven ?x129 ?x117))))
(not (or (or (fp.isNaN ?x161) (fp.isNaN ?x157)) (fp.lt ?x161 ?x157)))))))))))))))))))))))))
(check-sat)
(exit)
