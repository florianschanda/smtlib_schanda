...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.308.smt2
|)
...
(assert
 ...
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x63 ?x51)))
 (let ((?x123 (fp.sub roundNearestTiesToEven ?x92 ?x80)))
 (let ((?x153 (fp.add roundNearestTiesToEven ?x123 ?x109)))
