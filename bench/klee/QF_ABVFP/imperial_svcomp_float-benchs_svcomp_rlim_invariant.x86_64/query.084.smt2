...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.084.smt2
|)
...
(assert
 ...
 (not (fp.gt ?x96 ?x99)))))))))))))))))))))
(assert
 (let ((?x105 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.geq ?x39 ?x105))))))
(assert
 (let ((?x108 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.leq ?x39 ?x108))))))
...
(let ((?x65 (fp.sub roundNearestTiesToEven ?x20 ?x19)))
(let ((?x95 (fp.add roundNearestTiesToEven ?x65 ?x51)))
(let ((?x116 (fp.sub roundNearestTiesToEven ?x95 ?x83)))
(not (and (fp.geq ?x116 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x116 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))))
(check-sat)
(exit)
