...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.422.smt2
|)
...
(assert
 ...
 (let ((?x129 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x125))))
 (let ((?x130 ((_ to_fp 8 24) ?x129)))
 (let ((?x145 (fp.sub roundNearestTiesToEven ?x130 (fp.add roundNearestTiesToEven ?x112 ?x98))))
...
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x145 (fp.sub roundNearestTiesToEven ?x130 (fp.add roundNearestTiesToEven ?x112 ?x98))))
(let (($x185 (and (and (not (fp.isNaN ?x145)) (not (fp.isNaN ?x141))) (not (fp.lt ?x145 ?x141)))))
(not $x185))))))))))))))))))))
(check-sat)
(exit)
