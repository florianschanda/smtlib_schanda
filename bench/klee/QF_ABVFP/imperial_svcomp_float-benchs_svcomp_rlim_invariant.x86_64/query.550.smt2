...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.550.smt2
|)
...
(assert
 ...
 (let ((?x157 (fp.sub roundNearestTiesToEven ?x155 (fp.add roundNearestTiesToEven ?x126 ?x112))))
 (not (fp.isNaN ?x157)))))))))))))))))))))))
(assert
 (let ((?x139 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x143 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x139))))
