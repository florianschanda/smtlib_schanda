...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.122.smt2
|)
...
(assert
 ...
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x101 (concat (select symbolic_0_float6 (_ bv1 32)) (select symbolic_0_float6 (_ bv0 32)))))
 (let ((?x105 (concat (select symbolic_0_float6 (_ bv3 32)) (concat (select symbolic_0_float6 (_ bv2 32)) ?x101))))
 (let ((?x106 ((_ to_fp 8 24) ?x105)))
 (let ((?x107 (fp.sub roundNearestTiesToEven ?x106 ?x26)))
...
(assert
 ...
 (let ((?x46 ((_ to_fp 8 24) ?x45)))
 (let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x130 (fp.sub roundNearestTiesToEven ?x51 ?x46)))
 (not (fp.isNaN ?x130))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
...
(let ((?x89 ((_ to_fp 8 24) ?x88)))
(let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x143 (fp.sub roundNearestTiesToEven ?x51 ?x89)))
(let ((?x12 (concat (select symbolic_0_float_40 (_ bv1 32)) (select symbolic_0_float_40 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float_40 (_ bv3 32)) (concat (select symbolic_0_float_40 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x73 (concat (select symbolic_0_float_64 (_ bv1 32)) (select symbolic_0_float_64 (_ bv0 32)))))
