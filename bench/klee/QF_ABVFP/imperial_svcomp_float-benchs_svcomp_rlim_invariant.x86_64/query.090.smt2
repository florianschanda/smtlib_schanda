...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.090.smt2
|)
...
(assert
 ...
 (let ((?x106 (fp.sub roundNearestTiesToEven ?x104 (fp.add roundNearestTiesToEven ?x19 ?x58))))
