...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.189.smt2
|)
...
(let ((?x117 ((_ to_fp 8 24) ?x116)))
(let ((?x136 (fp.sub roundNearestTiesToEven ?x117 (fp.sub roundNearestTiesToEven ?x100 ?x88))))
(let (($x155 (and (and (not (fp.isNaN ?x136)) (not (fp.isNaN ?x132))) (not (fp.lt ?x136 ?x132)))))
(not $x155))))))))))))))))))))))
(check-sat)
(exit)
