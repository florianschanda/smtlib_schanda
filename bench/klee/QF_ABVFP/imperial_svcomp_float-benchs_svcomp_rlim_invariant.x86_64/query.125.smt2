...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.125.smt2
|)
...
(assert
 ...
 (let ((?x134 (fp.sub roundNearestTiesToEven ?x133 ?x37)))
 (not (fp.isNaN ?x134))))))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
 (let ((?x46 ((_ to_fp 8 24) ?x45)))
 (let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x137 (fp.sub roundNearestTiesToEven ?x51 ?x46)))
 (not (fp.isNaN ?x137))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
...
(let ((?x78 ((_ to_fp 8 24) ?x77)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x78 ?x19)))
(let (($x154 (and (and (not (fp.isNaN ?x94)) (not (fp.isNaN ?x89))) (not (fp.lt ?x94 ?x89)))))
(not $x154)))))))))))))
(check-sat)
(exit)
