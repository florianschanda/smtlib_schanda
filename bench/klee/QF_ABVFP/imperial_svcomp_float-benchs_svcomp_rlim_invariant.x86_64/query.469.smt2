...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.469.smt2
|)
...
(assert
 ...
 (let ((?x144 (fp.sub roundNearestTiesToEven ?x142 (fp.sub roundNearestTiesToEven ?x112 ?x100))))
