...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.038.smt2
|)
...
(let ((?x70 (fp.add roundNearestTiesToEven ?x20 ?x19)))
(let ((?x100 (fp.add roundNearestTiesToEven ?x70 ?x56)))
(let ((?x119 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
