...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.258.smt2
|)
...
(assert
 ...
 (let ((?x138 (fp.sub roundNearestTiesToEven ?x136 (fp.add roundNearestTiesToEven ?x105 ?x91))))
