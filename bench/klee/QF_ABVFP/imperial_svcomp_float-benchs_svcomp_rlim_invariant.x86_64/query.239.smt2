...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.239.smt2
|)
...
(assert
 ...
 (let ((?x33 (concat (select symbolic_0_float_21 (_ bv3 32)) (concat (select symbolic_0_float_21 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x34 (fp.add roundNearestTiesToEven ?x78 ?x93))))
...
(assert
 ...
 (let ((?x130 (fp.sub roundNearestTiesToEven ?x129 ?x78)))
 (or (fp.isNaN ?x119) (fp.gt ?x130 ?x119)))))))))))))
(assert
 (let ((?x78 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x124 (concat (select symbolic_0_float7 (_ bv1 32)) (select symbolic_0_float7 (_ bv0 32)))))
 (let ((?x128 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x124))))
...
(let ((?x77 ((_ to_fp 8 24) ?x76)))
(let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x146 (fp.sub roundNearestTiesToEven ?x39 ?x77)))
(let ((?x12 (concat (select symbolic_0_float_40 (_ bv1 32)) (select symbolic_0_float_40 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float_40 (_ bv3 32)) (concat (select symbolic_0_float_40 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x61 (concat (select symbolic_0_float_63 (_ bv1 32)) (select symbolic_0_float_63 (_ bv0 32)))))
(let ((?x65 (concat (select symbolic_0_float_63 (_ bv3 32)) (concat (select symbolic_0_float_63 (_ bv2 32)) ?x61))))
(let ((?x66 ((_ to_fp 8 24) ?x65)))
(let ((?x143 (fp.sub roundNearestTiesToEven ?x66 ?x19)))
