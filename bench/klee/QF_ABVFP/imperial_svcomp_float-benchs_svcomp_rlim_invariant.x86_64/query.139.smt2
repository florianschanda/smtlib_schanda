...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.139.smt2
|)
...
(assert
 ...
 (let ((?x112 ((_ to_fp 8 24) ?x111)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x118 (fp.sub roundNearestTiesToEven ?x41 ?x112)))
 (let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x67 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x63))))
 (let ((?x68 ((_ to_fp 8 24) ?x67)))
 (let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
 ...
 (let ((?x100 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x96))))
 (let ((?x101 ((_ to_fp 8 24) ?x100)))
 (let ((?x116 (fp.sub roundNearestTiesToEven ?x101 (fp.add roundNearestTiesToEven ?x19 ?x68))))
 (or (or (fp.isNaN ?x116) (fp.isNaN ?x118)) (fp.gt ?x116 ?x118))))))))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x30 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x34 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x30))))
...
(assert
 ...
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x125 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x116 (fp.sub roundNearestTiesToEven ?x101 (fp.add roundNearestTiesToEven ?x19 ?x68))))
(let (($x157 (and (and (not (fp.isNaN ?x116)) (not (fp.isNaN ?x112))) (not (fp.lt ?x116 ?x112)))))
(not $x157))))))))))))))))
(check-sat)
(exit)
