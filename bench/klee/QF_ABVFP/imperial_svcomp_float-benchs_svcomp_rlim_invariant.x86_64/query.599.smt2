...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.599.smt2
|)
...
(assert
 ...
 (let ((?x120 ((_ to_fp 8 24) ?x119)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x136 (fp.sub roundNearestTiesToEven ?x26 ?x120)))
 (not (fp.isNaN ?x136))))))))
(assert
 (let ((?x115 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x119 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x115))))
...
(assert
 ...
 (let ((?x148 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x144))))
 (let ((?x149 ((_ to_fp 8 24) ?x148)))
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x149 (fp.sub roundNearestTiesToEven ?x132 ?x120))))
