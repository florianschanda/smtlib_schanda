...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.363.smt2
|)
...
(assert
 ...
 (let ((?x101 (concat (select symbolic_0_float_25 (_ bv3 32)) (concat (select symbolic_0_float_25 (_ bv2 32)) ?x97))))
 (let ((?x102 ((_ to_fp 8 24) ?x101)))
 (let ((?x139 (fp.sub roundNearestTiesToEven ?x102 (fp.sub roundNearestTiesToEven ?x67 ?x137))))
...
(assert
 ...
 (let ((?x175 (fp.sub roundNearestTiesToEven ?x174 ?x67)))
 (not (fp.gt ?x175 ?x163)))))))))))))
(assert
 (let ((?x67 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x144 (concat (select symbolic_0_float_38 (_ bv1 32)) (select symbolic_0_float_38 (_ bv0 32)))))
