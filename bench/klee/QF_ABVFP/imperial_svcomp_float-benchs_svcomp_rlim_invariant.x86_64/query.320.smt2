...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.320.smt2
|)
...
(assert
 ...
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x166 ?x88)))
 (not (fp.gt ?x167 ?x155)))))))))))))
(assert
 (let ((?x88 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x117 (concat (select symbolic_0_float_37 (_ bv1 32)) (select symbolic_0_float_37 (_ bv0 32)))))
...
(let ((?x76 ((_ to_fp 8 24) ?x75)))
(let ((?x93 (fp.sub roundNearestTiesToEven ?x76 ?x19)))
(let (($x184 (and (and (not (fp.isNaN ?x93)) (not (fp.isNaN ?x87))) (not (fp.lt ?x93 ?x87)))))
(not $x184)))))))))))))
(check-sat)
(exit)
