...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.129.smt2
|)
...
(assert
 ...
 (let ((?x129 (fp.sub roundNearestTiesToEven ?x128 ?x26)))
 (not (fp.gt ?x129 ?x117)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x143 (fp.sub roundNearestTiesToEven ?x41 ?x112)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
(let ((?x67 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x63))))
(let ((?x68 ((_ to_fp 8 24) ?x67)))
(let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
...
(let ((?x100 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x96))))
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x141 (fp.sub roundNearestTiesToEven ?x101 (fp.add roundNearestTiesToEven ?x19 ?x68))))
(not (or (or (fp.isNaN ?x141) (fp.isNaN ?x143)) (fp.gt ?x141 ?x143)))))))))))))))))))
(check-sat)
(exit)
