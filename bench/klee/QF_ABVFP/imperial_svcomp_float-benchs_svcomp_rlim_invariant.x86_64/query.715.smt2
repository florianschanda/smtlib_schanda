...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.715.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float_80 (_ bv3 32)) (concat (select symbolic_0_float_80 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x19 (fp.add roundNearestTiesToEven ?x55 ?x64))))
...
(assert
 ...
 (let ((?x64 ((_ to_fp 8 24) ?x63)))
 (let ((?x69 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x156 (fp.sub roundNearestTiesToEven ?x69 ?x64)))
 (let ((?x49 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x53 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x49))))
 (let ((?x54 ((_ to_fp 8 24) ?x53)))
 (let ((?x38 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 ...
 (let ((?x45 (fp.sub roundNearestTiesToEven ?x34 ?x43)))
 (let ((?x55 (fp.add roundNearestTiesToEven ?x45 ?x54)))
 (let ((?x161 (concat (select symbolic_0_float_69 (_ bv1 32)) (select symbolic_0_float_69 (_ bv0 32)))))
 (let ((?x165 (concat (select symbolic_0_float_69 (_ bv3 32)) (concat (select symbolic_0_float_69 (_ bv2 32)) ?x161))))
 (let ((?x166 ((_ to_fp 8 24) ?x165)))
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x166 ?x55)))
