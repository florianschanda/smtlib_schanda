...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.507.smt2
|)
...
(assert
 ...
 (let ((?x118 ((_ to_fp 8 24) ?x117)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x124 (fp.sub roundNearestTiesToEven ?x49 ?x118)))
 (let ((?x71 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
 (let ((?x75 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x71))))
 (let ((?x76 ((_ to_fp 8 24) ?x75)))
 (let ((?x12 (concat (select symbolic_0_float_40 (_ bv1 32)) (select symbolic_0_float_40 (_ bv0 32)))))
 ...
 (let ((?x106 (concat (select symbolic_0_float_86 (_ bv3 32)) (concat (select symbolic_0_float_86 (_ bv2 32)) ?x102))))
 (let ((?x107 ((_ to_fp 8 24) ?x106)))
 (let ((?x122 (fp.sub roundNearestTiesToEven ?x107 (fp.sub roundNearestTiesToEven ?x19 ?x76))))
 (or (or (fp.isNaN ?x122) (fp.isNaN ?x124)) (fp.gt ?x122 ?x124))))))))))))))))))
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x29 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x29))))
...
(assert
 ...
 (fp.leq ?x34 ?x24))))))
(assert
 (let ((?x136 (concat (select symbolic_0_float_18 (_ bv1 32)) (select symbolic_0_float_18 (_ bv0 32)))))
 (let ((?x140 (concat (select symbolic_0_float_18 (_ bv3 32)) (concat (select symbolic_0_float_18 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x142 (fp.sub roundNearestTiesToEven ?x49 ?x141)))
 (let ((?x77 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x29 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x131 (fp.sub roundNearestTiesToEven ?x34 ?x77)))
 (or (or (fp.isNaN ?x131) (fp.isNaN ?x142)) (fp.gt ?x131 ?x142)))))))))))))
(assert
 (let ((?x136 (concat (select symbolic_0_float_18 (_ bv1 32)) (select symbolic_0_float_18 (_ bv0 32)))))
 (let ((?x140 (concat (select symbolic_0_float_18 (_ bv3 32)) (concat (select symbolic_0_float_18 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 ...
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x131 (fp.sub roundNearestTiesToEven ?x34 ?x77)))
 (or (or (fp.isNaN ?x131) (fp.isNaN ?x141)) (fp.lt ?x131 ?x141)))))))))))
(assert
 (let ((?x77 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x38 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x42 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x38))))
...
(assert
 ...
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x161 ?x34)))
 (not (fp.isNaN ?x162))))))))))
(assert
 (let ((?x38 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x42 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x38))))
 (let ((?x43 ((_ to_fp 8 24) ?x42)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x49 ?x43)))
 (not (fp.isNaN ?x165))))))))
(assert
 (let ((?x38 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x42 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x38))))
...
(let ((?x107 ((_ to_fp 8 24) ?x106)))
(let ((?x122 (fp.sub roundNearestTiesToEven ?x107 (fp.sub roundNearestTiesToEven ?x19 ?x76))))
(let (($x184 (and (and (not (fp.isNaN ?x122)) (not (fp.isNaN ?x118))) (not (fp.lt ?x122 ?x118)))))
(not $x184))))))))))))))))
(check-sat)
(exit)
