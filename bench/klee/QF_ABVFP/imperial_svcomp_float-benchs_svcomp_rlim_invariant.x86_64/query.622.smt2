...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.622.smt2
|)
...
(assert
 ...
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x164 ?x45)))
 (not (fp.isNaN ?x165))))))))))))))
(assert
 (let ((?x49 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x53 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x49))))
 (let ((?x54 ((_ to_fp 8 24) ?x53)))
 (let ((?x59 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x59 ?x54)))
 (not (fp.isNaN ?x168))))))))
(assert
 (let ((?x49 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x53 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x49))))
...
(let ((?x86 ((_ to_fp 8 24) ?x85)))
(let ((?x103 (fp.sub roundNearestTiesToEven ?x86 ?x19)))
(let (($x187 (and (and (not (fp.isNaN ?x103)) (not (fp.isNaN ?x97))) (not (fp.lt ?x103 ?x97)))))
(not $x187)))))))))))))
(check-sat)
(exit)
