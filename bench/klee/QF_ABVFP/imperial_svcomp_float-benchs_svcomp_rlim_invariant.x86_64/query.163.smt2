...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.163.smt2
|)
...
(let ((?x102 (fp.add roundNearestTiesToEven ?x70 ?x56)))
(let ((?x134 (fp.add roundNearestTiesToEven ?x102 ?x88)))
(let ((?x156 (fp.add roundNearestTiesToEven ?x134 ?x120)))
(not (and (fp.geq ?x156 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x156 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))))))))
(check-sat)
(exit)
