...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.322.smt2
|)
...
(assert
 ...
 (let ((?x67 (concat (select symbolic_0_float_23 (_ bv3 32)) (concat (select symbolic_0_float_23 (_ bv2 32)) ?x63))))
 (let ((?x68 ((_ to_fp 8 24) ?x67)))
 (let ((?x116 (fp.sub roundNearestTiesToEven ?x68 (fp.sub roundNearestTiesToEven ?x99 ?x114))))
...
(assert
 ...
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x170 ?x99)))
 (not (fp.gt ?x171 ?x159)))))))))))))
(assert
 (let ((?x99 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x121 (concat (select symbolic_0_float_37 (_ bv1 32)) (select symbolic_0_float_37 (_ bv0 32)))))
