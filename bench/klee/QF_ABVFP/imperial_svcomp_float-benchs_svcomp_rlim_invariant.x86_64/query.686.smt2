...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.686.smt2
|)
...
(assert
 ...
 (let ((?x99 (concat (select symbolic_0_float_25 (_ bv3 32)) (concat (select symbolic_0_float_25 (_ bv2 32)) ?x95))))
 (let ((?x100 ((_ to_fp 8 24) ?x99)))
 (let ((?x135 (fp.sub roundNearestTiesToEven ?x100 (fp.add roundNearestTiesToEven ?x78 ?x133))))
...
(assert
 ...
 (let ((?x170 (fp.sub roundNearestTiesToEven ?x169 ?x78)))
