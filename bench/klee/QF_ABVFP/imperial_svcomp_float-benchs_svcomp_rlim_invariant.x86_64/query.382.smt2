...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.382.smt2
|)
...
(assert
 ...
 (let ((?x67 (concat (select symbolic_0_float_43 (_ bv3 32)) (concat (select symbolic_0_float_43 (_ bv2 32)) ?x63))))
 (let ((?x68 ((_ to_fp 8 24) ?x67)))
 (let ((?x116 (fp.sub roundNearestTiesToEven ?x68 (fp.sub roundNearestTiesToEven ?x105 ?x114))))
...
(assert
 ...
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x170 ?x105)))
 (not (fp.isNaN ?x171))))))))))))
(assert
 (let ((?x109 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
 (let ((?x113 (concat (select symbolic_0_float_36 (_ bv3 32)) (concat (select symbolic_0_float_36 (_ bv2 32)) ?x109))))
 (let ((?x114 ((_ to_fp 8 24) ?x113)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x174 (fp.sub roundNearestTiesToEven ?x39 ?x114)))
 (not (fp.isNaN ?x174))))))))
(assert
 (let ((?x109 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
 (let ((?x113 (concat (select symbolic_0_float_36 (_ bv3 32)) (concat (select symbolic_0_float_36 (_ bv2 32)) ?x109))))
