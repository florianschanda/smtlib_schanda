...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.610.smt2
|)
...
(assert
 ...
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x157 (fp.add roundNearestTiesToEven ?x128 ?x114))))
 (not (fp.isNaN ?x159)))))))))))))))))))))))
(assert
 (let ((?x141 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x145 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x141))))
