...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.352.smt2
|)
...
(assert
 ...
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x110 (fp.sub roundNearestTiesToEven ?x19 ?x68)))
 (let ((?x139 (fp.sub roundNearestTiesToEven ?x110 ?x98)))
 ...
 (let ((?x140 (fp.sub roundNearestTiesToEven ?x138 ?x139)))
 (not (fp.isNaN ?x140))))))))))))))))))
(assert
 (let ((?x122 (concat (select symbolic_0_float_97 (_ bv1 32)) (select symbolic_0_float_97 (_ bv0 32)))))
 (let ((?x126 (concat (select symbolic_0_float_97 (_ bv3 32)) (concat (select symbolic_0_float_97 (_ bv2 32)) ?x122))))
 (let ((?x127 ((_ to_fp 8 24) ?x126)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x143 (fp.sub roundNearestTiesToEven ?x41 ?x127)))
 (not (fp.isNaN ?x143))))))))
(assert
 (let ((?x122 (concat (select symbolic_0_float_97 (_ bv1 32)) (select symbolic_0_float_97 (_ bv0 32)))))
 (let ((?x126 (concat (select symbolic_0_float_97 (_ bv3 32)) (concat (select symbolic_0_float_97 (_ bv2 32)) ?x122))))
...
(assert
 ...
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x150 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (not (fp.isNaN ?x150))))))))
(assert
 (let ((?x30 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x34 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x30))))
 ...
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x161 ?x26)))
 (not (fp.gt ?x162 ?x150)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x110 (fp.sub roundNearestTiesToEven ?x19 ?x68)))
(let ((?x139 (fp.sub roundNearestTiesToEven ?x110 ?x98)))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x139 ?x127)))
