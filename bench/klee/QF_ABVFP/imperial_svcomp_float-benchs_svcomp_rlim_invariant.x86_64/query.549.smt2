...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.549.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x127 ?x112)))))))))))))))))))))))
(assert
 (let ((?x146 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x144 ?x146))))))
(assert
 (let ((?x149 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x139 (concat (select symbolic_0_float_88 (_ bv1 32)) (select symbolic_0_float_88 (_ bv0 32)))))
 (let ((?x143 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x139))))
 (let ((?x144 ((_ to_fp 8 24) ?x143)))
 (fp.leq ?x144 ?x149))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x154 (concat (select symbolic_0_float_99 (_ bv1 32)) (select symbolic_0_float_99 (_ bv0 32)))))
 (let ((?x158 (concat (select symbolic_0_float_99 (_ bv3 32)) (concat (select symbolic_0_float_99 (_ bv2 32)) ?x154))))
...
(let ((?x159 ((_ to_fp 8 24) ?x158)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x26 ?x159)))
(let ((?x107 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
(let ((?x111 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x107))))
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(let ((?x143 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x139))))
(let ((?x144 ((_ to_fp 8 24) ?x143)))
(let ((?x173 (fp.sub roundNearestTiesToEven ?x144 (fp.add roundNearestTiesToEven ?x126 ?x112))))
