...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.682.smt2
|)
...
(assert
 ...
 (fp.leq ?x78 ?x24))))))
(assert
 (let ((?x142 (concat (select symbolic_0_float_38 (_ bv1 32)) (select symbolic_0_float_38 (_ bv0 32)))))
 (let ((?x146 (concat (select symbolic_0_float_38 (_ bv3 32)) (concat (select symbolic_0_float_38 (_ bv2 32)) ?x142))))
 (let ((?x147 ((_ to_fp 8 24) ?x146)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x148 (fp.sub roundNearestTiesToEven ?x49 ?x147)))
 ...
 (let ((?x77 (concat (select symbolic_0_float_24 (_ bv3 32)) (concat (select symbolic_0_float_24 (_ bv2 32)) ?x73))))
 (let ((?x78 ((_ to_fp 8 24) ?x77)))
 (let ((?x137 (fp.sub roundNearestTiesToEven ?x78 ?x136)))
 (or (or (fp.isNaN ?x137) (fp.isNaN ?x148)) (fp.gt ?x137 ?x148)))))))))))))))
(assert
 (let ((?x142 (concat (select symbolic_0_float_38 (_ bv1 32)) (select symbolic_0_float_38 (_ bv0 32)))))
 (let ((?x146 (concat (select symbolic_0_float_38 (_ bv3 32)) (concat (select symbolic_0_float_38 (_ bv2 32)) ?x142))))
 (let ((?x147 ((_ to_fp 8 24) ?x146)))
 ...
 (let ((?x78 ((_ to_fp 8 24) ?x77)))
 (let ((?x137 (fp.sub roundNearestTiesToEven ?x78 ?x136)))
 (or (or (fp.isNaN ?x137) (fp.isNaN ?x147)) (fp.lt ?x137 ?x147)))))))))))))
(assert
 (let ((?x99 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x84 (concat (select symbolic_0_float_55 (_ bv1 32)) (select symbolic_0_float_55 (_ bv0 32)))))
 (let ((?x88 (concat (select symbolic_0_float_55 (_ bv3 32)) (concat (select symbolic_0_float_55 (_ bv2 32)) ?x84))))
...
(assert
 ...
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x174 (fp.sub roundNearestTiesToEven ?x49 ?x173)))
 (let ((?x99 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x131 (concat (select symbolic_0_float7 (_ bv1 32)) (select symbolic_0_float7 (_ bv0 32)))))
 (let ((?x135 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x131))))
 (let ((?x136 ((_ to_fp 8 24) ?x135)))
 (let ((?x163 (fp.sub roundNearestTiesToEven ?x136 ?x99)))
