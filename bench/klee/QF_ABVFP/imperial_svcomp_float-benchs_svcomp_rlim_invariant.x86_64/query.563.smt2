...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.563.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x128 (concat (select symbolic_0_float_87 (_ bv1 32)) (select symbolic_0_float_87 (_ bv0 32)))))
 (let ((?x132 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x128))))
...
(assert
 ...
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x149 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (not (fp.isNaN ?x149))))))))
(assert
 (let ((?x30 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x34 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x30))))
 ...
 (let ((?x149 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x155 (concat (select symbolic_0_float9 (_ bv1 32)) (select symbolic_0_float9 (_ bv0 32)))))
 (let ((?x159 (concat (select symbolic_0_float9 (_ bv3 32)) (concat (select symbolic_0_float9 (_ bv2 32)) ?x155))))
 (let ((?x160 ((_ to_fp 8 24) ?x159)))
 (let ((?x161 (fp.sub roundNearestTiesToEven ?x160 ?x26)))
 (not (fp.gt ?x161 ?x149)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x144 ((_ to_fp 8 24) ?x143)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x41 ?x144)))
(let ((?x96 (concat (select symbolic_0_float_75 (_ bv1 32)) (select symbolic_0_float_75 (_ bv0 32)))))
(let ((?x100 (concat (select symbolic_0_float_75 (_ bv3 32)) (concat (select symbolic_0_float_75 (_ bv2 32)) ?x96))))
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
...
(let ((?x132 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x128))))
(let ((?x133 ((_ to_fp 8 24) ?x132)))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x133 (fp.add roundNearestTiesToEven ?x115 ?x101))))
(not (or (or (fp.isNaN ?x175) (fp.isNaN ?x177)) (fp.gt ?x175 ?x177)))))))))))))))))))))))
(check-sat)
(exit)
