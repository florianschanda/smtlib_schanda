...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.494.smt2
|)
...
(let ((?x146 ((_ to_fp 8 24) ?x145)))
(let ((?x165 (fp.sub roundNearestTiesToEven ?x146 (fp.sub roundNearestTiesToEven ?x129 ?x117))))
(not (or (or (fp.isNaN ?x165) (fp.isNaN ?x161)) (fp.lt ?x165 ?x161)))))))))))))))))))))))))))
(check-sat)
(exit)
