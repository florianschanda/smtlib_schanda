...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.642.smt2
|)
...
(assert
 ...
 (let ((?x147 (fp.sub roundNearestTiesToEven ?x146 ?x26)))
 (not (fp.gt ?x147 ?x135)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(assert
 ...
 (let ((?x161 (fp.sub roundNearestTiesToEven ?x160 ?x37)))
 (not (fp.isNaN ?x161))))))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
 (let ((?x46 ((_ to_fp 8 24) ?x45)))
 (let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x164 (fp.sub roundNearestTiesToEven ?x51 ?x46)))
 (not (fp.isNaN ?x164))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
...
(let ((?x111 ((_ to_fp 8 24) ?x110)))
(let ((?x126 (fp.sub roundNearestTiesToEven ?x111 (fp.add roundNearestTiesToEven ?x19 ?x78))))
(let (($x185 (and (and (not (fp.isNaN ?x126)) (not (fp.isNaN ?x122))) (not (fp.lt ?x126 ?x122)))))
(not $x185))))))))))))))))
(check-sat)
(exit)
