...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.629.smt2
|)
...
(assert
 ...
 (let ((?x54 ((_ to_fp 8 24) ?x53)))
 (let ((?x69 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x149 (fp.sub roundNearestTiesToEven ?x69 ?x54)))
 (not (fp.isNaN ?x149))))))))
(assert
 (let ((?x49 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x53 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x49))))
