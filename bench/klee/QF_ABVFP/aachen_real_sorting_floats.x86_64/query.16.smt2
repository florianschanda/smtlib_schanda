...
(let ((?x367 (concat (select ?x362 (_ bv10 32)) (concat (select ?x362 (_ bv9 32)) (select ?x362 (_ bv8 32))))))
(let ((?x375 (concat (select ?x362 (_ bv6 32)) (concat (select ?x362 (_ bv5 32)) (select ?x362 (_ bv4 32))))))
(let (($x379 (fp.lt ((_ to_fp 8 24) (concat (select ?x362 (_ bv7 32)) ?x375)) ((_ to_fp 8 24) (concat (select ?x362 (_ bv11 32)) ?x367)))))
(let ((?x380 (ite $x379 (_ bv1 32) (_ bv2 32))))
(let ((?x387 (concat (select ?x362 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x380))))) (select ?x362 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x380)))))))
(let ((?x390 (concat (select ?x362 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x380))))) ?x387)))
(let ((?x393 (concat (select ?x362 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x380))))) ?x390)))
(let ((?x396 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x362 (_ bv11 32)) ?x367)) ((_ to_fp 8 24) ?x393)) (_ bv2 32) ?x380)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x396)) (_ bv37 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
