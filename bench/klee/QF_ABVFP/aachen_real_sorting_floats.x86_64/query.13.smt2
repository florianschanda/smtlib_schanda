...
(let ((?x294 (ite (fp.lt ((_ to_fp 8 24) (_ bv1077936128 32)) ((_ to_fp 8 24) ?x291)) (_ bv6 32) ?x278)))
(let ((?x301 (concat (select ?x201 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x294))))) (select ?x201 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x294)))))))
(let ((?x304 (concat (select ?x201 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x294))))) ?x301)))
(let ((?x307 (concat (select ?x201 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x294))))) ?x304)))
(let (($x309 (fp.lt ((_ to_fp 8 24) (concat ?x45 (concat ?x42 (concat ?x39 ?x37)))) ((_ to_fp 8 24) ?x307))))
(let ((?x310 (ite $x309 (_ bv7 32) ?x294)))
(let ((?x317 (concat (select ?x201 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x310))))) (select ?x201 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x310)))))))
(let ((?x320 (concat (select ?x201 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x310))))) ?x317)))
(let ((?x323 (concat (select ?x201 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x310))))) ?x320)))
(let ((?x328 (bvmul (_ bv4 64) ((_ sign_extend 32) (ite (fp.lt ((_ to_fp 8 24) (_ bv1065353216 32)) ((_ to_fp 8 24) ?x323)) (_ bv8 32) ?x310)))))
(not (bvult ?x328 (_ bv37 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
