...
(assert
 ...
 (let ((?x18 (concat ?x17 (concat ?x14 (concat (select sym0 (_ bv5 32)) (select sym0 (_ bv4 32)))))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x61 (fp.add roundNearestTiesToEven ?x19 ?x33)))
 (= ?x61 ((_ to_fp 8 24) fresh_to_ieee_bv_!0))))))))))))
(assert
 (let ((?x28 (select sym0 (_ bv10 32))))
 (let ((?x31 (select sym0 (_ bv11 32))))
 (let ((?x32 (concat ?x31 (concat ?x28 (concat (select sym0 (_ bv9 32)) (select sym0 (_ bv8 32)))))))
 ...
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x61 (fp.add roundNearestTiesToEven ?x19 ?x33)))
 (= ?x61 ((_ to_fp 8 24) fresh_to_ieee_bv_!1))))))))))))
(assert
 (let ((?x28 (select sym0 (_ bv10 32))))
 (let ((?x31 (select sym0 (_ bv11 32))))
 (let ((?x32 (concat ?x31 (concat ?x28 (concat (select sym0 (_ bv9 32)) (select sym0 (_ bv8 32)))))))
 ...
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x61 (fp.add roundNearestTiesToEven ?x19 ?x33)))
 (= ?x61 ((_ to_fp 8 24) fresh_to_ieee_bv_!2))))))))))))
(assert
 (let ((?x28 (select sym0 (_ bv10 32))))
 (let ((?x31 (select sym0 (_ bv11 32))))
 (let ((?x32 (concat ?x31 (concat ?x28 (concat (select sym0 (_ bv9 32)) (select sym0 (_ bv8 32)))))))
 ...
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (let ((?x61 (fp.add roundNearestTiesToEven ?x19 ?x33)))
 (= ?x61 ((_ to_fp 8 24) fresh_to_ieee_bv_!3))))))))))))
(assert
 (let ((?x14 (select sym0 (_ bv6 32))))
(let ((?x17 (select sym0 (_ bv7 32))))
(let ((?x18 (concat ?x17 (concat ?x14 (concat (select sym0 (_ bv5 32)) (select sym0 (_ bv4 32)))))))
...
(let ((?x33 ((_ to_fp 8 24) ?x32)))
(let ((?x61 (fp.add roundNearestTiesToEven ?x19 ?x33)))
(let ((?x65 (ite (fp.lt ?x61 ?x19) (_ bv0 32) (_ bv1 32))))
(let ((?x69 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x65)))))
(let ((?x45 (select sym0 (_ bv15 32))))
(let ((?x42 (select sym0 (_ bv14 32))))
...
(let ((?x165 (store (store ?x163 (_ bv0 32) ((_ extract 7 0) fresh_to_ieee_bv_!3)) (_ bv1 32) ((_ extract 15 8) fresh_to_ieee_bv_!2))))
(let ((?x167 (store (store ?x165 (_ bv2 32) ((_ extract 23 16) fresh_to_ieee_bv_!1)) (_ bv3 32) ((_ extract 31 24) fresh_to_ieee_bv_!0))))
...
(let ((?x210 (concat (select ?x203 (bvadd (_ bv2 32) ?x69)) (concat (select ?x203 (bvadd (_ bv1 32) ?x69)) (select ?x203 ?x69)))))
(let ((?x216 (ite (fp.lt ?x19 ((_ to_fp 8 24) (concat (select ?x203 (bvadd (_ bv3 32) ?x69)) ?x210))) (_ bv1 32) ?x65)))
