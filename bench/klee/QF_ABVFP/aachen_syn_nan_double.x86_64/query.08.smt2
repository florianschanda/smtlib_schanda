...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_nan_double.x86_64/query.08.smt2
|)
...
(let (($x44 (not (not (fp.isNaN (fp.div roundNearestTiesToEven ?x40 ((_ to_fp 11 53) (_ bv0 64))))))))
(not $x44)))))))
(check-sat)
(exit)
