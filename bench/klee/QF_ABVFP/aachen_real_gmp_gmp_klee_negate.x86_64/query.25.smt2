...
(let ((?x56 (bvmul (_ bv8 64) (bvadd (_ bv18446744073709551615 64) (ite (bvslt (_ bv4294967295 32) ?x49) ?x51 (bvsub (_ bv0 64) ?x51))))))
...
(not (bvult (concat (_ bv0 32) (bvsub (_ bv64 32) ?x1062)) (_ bv64 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
