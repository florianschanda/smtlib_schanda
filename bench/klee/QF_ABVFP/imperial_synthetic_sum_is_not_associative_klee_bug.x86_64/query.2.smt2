...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sum_is_not_associative_klee_bug.x86_64/query.2.smt2
|)
...
(assert
 ...
 (= (_ bv0 32) (bvand (ite (fp.isNaN ?x74) (_ bv1 32) (_ bv0 32)) (ite (fp.isNaN ?x81) (_ bv1 32) (_ bv0 32))))))))))))))))))))
(assert
 (let ((?x69 (concat (select data0 (_ bv2 32)) (concat (select data0 (_ bv1 32)) (select data0 (_ bv0 32))))))
 (let ((?x57 (concat (select data0 (_ bv6 32)) (concat (select data0 (_ bv5 32)) (select data0 (_ bv4 32))))))
 (let ((?x44 (concat (select data0 (_ bv10 32)) (concat (select data0 (_ bv9 32)) (select data0 (_ bv8 32))))))
