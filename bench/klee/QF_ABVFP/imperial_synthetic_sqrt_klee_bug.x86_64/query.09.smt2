...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.09.smt2
|)
...
(let ((?x22 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x42 (ite $x41 ?x22 ?x33)))
(let (($x52 (and (not (fp.isNaN ?x42)) (not (fp.isNaN ((_ to_fp 8 24) (ite $x41 fresh_to_ieee_bv_!0 ?x18)))))))
(let (($x55 (and $x52 (not (fp.gt ?x42 ((_ to_fp 8 24) (ite $x41 fresh_to_ieee_bv_!0 ?x18)))))))
(not $x55)))))))))))
(check-sat)
(exit)
