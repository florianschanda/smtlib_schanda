...
(let ((?x186 (ite (fp.lt ((_ to_fp 11 53) ?x62) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32))))
...
(let ((?x187 (ite $x71 ?x109 ?x186)))
(let ((?x189 ((_ sign_extend 32) ?x187)))
(let ((?x191 (ite (bvslt (_ bv4294967295 32) ?x187) ?x189 (bvsub (_ bv0 64) ?x189))))
(let ((?x192 (ite $x71 ?x186 ?x109)))
(let ((?x194 ((_ sign_extend 32) ?x192)))
(let ((?x196 (ite (bvslt (_ bv4294967295 32) ?x192) ?x194 (bvsub (_ bv0 64) ?x194))))
(let ((?x201 (bvsub (bvsub ?x196 (bvsub (ite $x71 ?x70 ?x60) (ite $x71 ?x60 ?x70))) ?x191)))
...
(let (($x204 (and (not (= (_ bv55299360 64) (concat (select ?x158 (bvadd (_ bv7 32) ?x76)) ?x177))) (bvslt ?x191 (bvsub ?x196 ?x201)))))
(not (not $x204))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
