...
(let ((?x30 (concat (select d0 (_ bv7 32)) (concat (select d0 (_ bv6 32)) ?x24))))
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x67 (bvsdiv (bvadd (_ bv3074 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) (bvor ?x30 (_ bv1 64)))) (_ bv2047 64))) (_ bv64 64))))
...
(let (($x71 (bvslt ((_ sign_extend 32) ((_ extract 31 0) ?x58)) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) ?x67))))))
(let ((?x80 (ite $x71 (ite (fp.lt ((_ to_fp 11 53) (bvor ?x30 (_ bv1 64))) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)) (ite (fp.lt ?x31 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)))))
(let ((?x82 ((_ sign_extend 32) ?x80)))
(not (= (_ bv2 64) (ite (bvslt (_ bv4294967295 32) ?x80) ?x82 (bvsub (_ bv0 64) ?x82))))))))))))))
(check-sat)
(exit)
