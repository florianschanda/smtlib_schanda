...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.14.smt2
|)
...
(assert
 ...
 (let ((?x74 (ite (fp.gt ((_ to_fp 11 53) ?x60) ((_ to_fp 11 53) ?x71)) ?x60 ?x71)))
 (let ((?x77 (ite (fp.gt ((_ to_fp 11 53) (_ bv4625844209755933901 64)) ((_ to_fp 11 53) ?x74)) (_ bv4625844209755933901 64) ?x74)))
 (let (($x84 (fp.gt ((_ to_fp 11 53) (ite (fp.gt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x77)) (_ bv4623282787467866931 64) ?x77)) ((_ to_fp 11 53) (_ bv4626322717216342016 64)))))
 (not $x84))))))))))))
(assert
 (let ((?x15 (concat (select data0 (_ bv2 32)) (concat (select data0 (_ bv1 32)) (select data0 (_ bv0 32))))))
 (let ((?x24 (concat (select data0 (_ bv5 32)) (concat (select data0 (_ bv4 32)) (concat (select data0 (_ bv3 32)) ?x15)))))
...
(assert
 ...
 (not $x100))))))))))))
(assert
 (let ((?x103 ((_ to_fp 11 53) (_ bv0 64))))
(let ((?x15 (concat (select data0 (_ bv2 32)) (concat (select data0 (_ bv1 32)) (select data0 (_ bv0 32))))))
(let ((?x24 (concat (select data0 (_ bv5 32)) (concat (select data0 (_ bv4 32)) (concat (select data0 (_ bv3 32)) ?x15)))))
(let ((?x30 (concat (select data0 (_ bv7 32)) (concat (select data0 (_ bv6 32)) ?x24))))
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x108 (fp.div roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x31 ?x103) ((_ to_fp 11 53) (_ bv4607182418800017408 64)))))
(let ((?x109 (fp.add roundNearestTiesToEven ?x103 ?x108)))
...
(let ((?x130 (fp.sub roundNearestTiesToEven ?x31 ?x129)))
(let ((?x132 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x130 ?x130) ?x103)))
(let ((?x134 (fp.add roundNearestTiesToEven ?x103 (fp.div roundNearestTiesToEven ?x132 ((_ to_fp 11 53) (_ bv4607182418800017408 64))))))
(let ((?x135 (fp.sub roundNearestTiesToEven ?x69 ?x129)))
(let ((?x137 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x135 ?x135) ?x134)))
(let ((?x139 (fp.add roundNearestTiesToEven ?x134 (fp.div roundNearestTiesToEven ?x137 ((_ to_fp 11 53) (_ bv4611686018427387904 64))))))
(let ((?x140 (fp.sub roundNearestTiesToEven ?x61 ?x129)))
(let ((?x142 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x140 ?x140) ?x139)))
(let ((?x144 (fp.add roundNearestTiesToEven ?x139 (fp.div roundNearestTiesToEven ?x142 ((_ to_fp 11 53) (_ bv4613937818241073152 64))))))
(let ((?x145 (fp.sub roundNearestTiesToEven ?x67 ?x129)))
(let ((?x147 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x145 ?x145) ?x144)))
(let ((?x149 (fp.add roundNearestTiesToEven ?x144 (fp.div roundNearestTiesToEven ?x147 ((_ to_fp 11 53) (_ bv4616189618054758400 64))))))
(let ((?x150 (fp.sub roundNearestTiesToEven ?x65 ?x129)))
(let ((?x152 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x150 ?x150) ?x149)))
(let ((?x154 (fp.add roundNearestTiesToEven ?x149 (fp.div roundNearestTiesToEven ?x152 ((_ to_fp 11 53) (_ bv4617315517961601024 64))))))
(let ((?x157 (fp.mul roundNearestTiesToEven ?x154 ((_ to_fp 11 53) (_ bv4608308318706860032 64)))))
(not (and (not (fp.isNaN ?x157)) (not (fp.lt ?x157 ?x103)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
