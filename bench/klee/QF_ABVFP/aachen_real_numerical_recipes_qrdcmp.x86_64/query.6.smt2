...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_qrdcmp.x86_64/query.6.smt2
|)
...
(assert
 ...
 (fp.eq (fp.sub roundNearestTiesToEven ?x37 ?x56) ((_ to_fp 8 24) (_ bv0 32)))))))))))))
(assert
 (let ((?x15 (concat (select sym_f0 (_ bv2 32)) (concat (select sym_f0 (_ bv1 32)) (select sym_f0 (_ bv0 32))))))
(let ((?x19 ((_ to_fp 8 24) (concat (select sym_f0 (_ bv3 32)) ?x15))))
(not (fp.eq ?x19 ((_ to_fp 8 24) (_ bv1098907648 32)))))))
(check-sat)
(exit)
