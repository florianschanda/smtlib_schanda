...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_meter_ft.x86_64/query.0.smt2
|)
...
(not (not (fp.geq ?x31 ((_ to_fp 11 53) (_ bv0 64)))))))))
(check-sat)
(exit)
