...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.058.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (not (fp.gt ((_ to_fp 8 24) (_ bv973078528 32)) ?x19))))))
(assert
 (let ((?x12 (concat (select symbolic_0_float0 (_ bv1 32)) (select symbolic_0_float0 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x68 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv981467136 32))) ((_ to_fp 8 24) (_ bv1023410176 32)))))
(let (($x70 (not (fp.isNaN ?x68))))
(let (($x80 (and (and $x70 (not (fp.lt ?x68 ((_ to_fp 8 24) (_ bv0 32))))) (and $x70 (not (fp.gt ?x68 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x80))))))))
(check-sat)
(exit)
