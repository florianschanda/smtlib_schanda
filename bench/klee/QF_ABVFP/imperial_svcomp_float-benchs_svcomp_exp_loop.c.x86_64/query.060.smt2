...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.060.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (not (fp.gt ((_ to_fp 8 24) (_ bv981467136 32)) ?x19))))))
(assert
 (let ((?x12 (concat (select symbolic_0_float0 (_ bv1 32)) (select symbolic_0_float0 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x65 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv989855744 32))) ((_ to_fp 8 24) (_ bv1031798784 32)))))
(let (($x67 (not (fp.isNaN ?x65))))
(let (($x77 (and (and $x67 (not (fp.lt ?x65 ((_ to_fp 8 24) (_ bv0 32))))) (and $x67 (not (fp.gt ?x65 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x77))))))))
(check-sat)
(exit)
