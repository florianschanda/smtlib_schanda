...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.065.smt2
|)
...
(let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x71 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv973078528 32))) ((_ to_fp 8 24) (_ bv1023410176 32)))))
(let (($x73 (not (fp.isNaN ?x71))))
(let (($x83 (and (and $x73 (not (fp.lt ?x71 ((_ to_fp 8 24) (_ bv0 32))))) (and $x73 (not (fp.gt ?x71 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x83))))))))
(check-sat)
(exit)
