...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.01.smt2
|)
...
(let ((?x19 ((_ to_fp 8 24) (concat (select sym_f0 (_ bv3 32)) ?x15))))
(let ((?x26 (fp.abs ?x19)))
(not (or (fp.isNaN ?x26) (fp.lt ?x26 ((_ to_fp 8 24) (_ bv1082130432 32)))))))))
(check-sat)
(exit)
