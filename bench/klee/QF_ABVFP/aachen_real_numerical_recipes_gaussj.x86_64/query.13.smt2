...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.13.smt2
|)
...
(assert
 ...
 (let ((?x39 (fp.sub roundNearestTiesToEven ?x21 ?x38)))
 (let ((?x40 (fp.abs ?x39)))
 (not (fp.isNaN ?x40)))))))))))
(assert
 (let ((?x15 (concat (select sym_f0 (_ bv2 32)) (concat (select sym_f0 (_ bv1 32)) (select sym_f0 (_ bv0 32))))))
