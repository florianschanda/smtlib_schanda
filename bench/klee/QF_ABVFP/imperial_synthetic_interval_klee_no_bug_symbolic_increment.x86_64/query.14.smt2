...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_interval_klee_no_bug_symbolic_increment.x86_64/query.14.smt2
|)
...
(let (($x52 (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven (fp.add roundTowardPositive ?x19 ?x30)) ?x51)))
(not $x52))))))))
(check-sat)
(exit)
