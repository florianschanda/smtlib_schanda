...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1483.smt2
|)
...
(let ((?x24 (concat (select x0 (_ bv37 32)) (concat (select x0 (_ bv36 32)) (concat (select x0 (_ bv35 32)) ?x15)))))
(let ((?x31 ((_ to_fp 11 53) (concat (select x0 (_ bv39 32)) (concat (select x0 (_ bv38 32)) ?x24)))))
(let (($x178 (and (not (fp.isNaN ?x133)) (or (or (fp.isNaN ?x31) (fp.isNaN ?x133)) (fp.gt ?x31 ?x133)))))
(not (not $x178))))))))))
(check-sat)
(exit)
