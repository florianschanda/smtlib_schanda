...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0366.smt2
|)
...
(let (($x178 (fp.lt ((_ to_fp 11 53) (concat (select x0 (_ bv47 32)) (concat (select x0 (_ bv46 32)) ?x167))) ?x31)))
(let (($x175 (fp.isNaN ((_ to_fp 11 53) (concat (select x0 (_ bv47 32)) (concat (select x0 (_ bv46 32)) ?x167))))))
(not (or (or $x175 (fp.isNaN ?x31)) $x178))))))))))
(check-sat)
(exit)
