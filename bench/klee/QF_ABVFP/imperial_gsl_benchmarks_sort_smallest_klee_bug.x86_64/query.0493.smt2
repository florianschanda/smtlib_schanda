...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0493.smt2
|)
...
(assert
 (let ((?x155 (concat (select x0 (_ bv42 32)) (concat (select x0 (_ bv41 32)) (select x0 (_ bv40 32))))))
 (let ((?x164 (concat (select x0 (_ bv45 32)) (concat (select x0 (_ bv44 32)) (concat (select x0 (_ bv43 32)) ?x155)))))
 (let (($x175 (fp.isNaN ((_ to_fp 11 53) (concat (select x0 (_ bv47 32)) (concat (select x0 (_ bv46 32)) ?x164))))))
 (not $x175)))))
(assert
 (let ((?x15 (concat (select x0 (_ bv18 32)) (concat (select x0 (_ bv17 32)) (select x0 (_ bv16 32))))))
(let ((?x24 (concat (select x0 (_ bv21 32)) (concat (select x0 (_ bv20 32)) (concat (select x0 (_ bv19 32)) ?x15)))))
