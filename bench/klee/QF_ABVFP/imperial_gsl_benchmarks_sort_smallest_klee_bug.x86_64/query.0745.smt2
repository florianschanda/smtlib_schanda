...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0745.smt2
|)
...
(assert
 (let ((?x152 (concat (select x0 (_ bv42 32)) (concat (select x0 (_ bv41 32)) (select x0 (_ bv40 32))))))
 (let ((?x161 (concat (select x0 (_ bv45 32)) (concat (select x0 (_ bv44 32)) (concat (select x0 (_ bv43 32)) ?x152)))))
 (let (($x177 (fp.isNaN ((_ to_fp 11 53) (concat (select x0 (_ bv47 32)) (concat (select x0 (_ bv46 32)) ?x161))))))
 (not $x177)))))
(assert
 (let ((?x119 (concat (select x0 (_ bv34 32)) (concat (select x0 (_ bv33 32)) (select x0 (_ bv32 32))))))
(let ((?x128 (concat (select x0 (_ bv37 32)) (concat (select x0 (_ bv36 32)) (concat (select x0 (_ bv35 32)) ?x119)))))
...
(let ((?x31 ((_ to_fp 11 53) (concat (select x0 (_ bv23 32)) (concat (select x0 (_ bv22 32)) ?x24)))))
(let (($x136 (fp.isNaN ?x135)))
(not (and (not $x136) (or $x136 (fp.gt ?x31 ?x135))))))))))))
(check-sat)
(exit)
