...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1264.smt2
|)
...
(not (and (not $x138) (or $x138 (fp.gt ?x31 ?x137))))))))))))
(check-sat)
(exit)
