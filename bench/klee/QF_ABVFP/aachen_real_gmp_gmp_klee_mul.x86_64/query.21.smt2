...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.21.smt2
|)
...
(let ((?x49 (concat (select d21 (_ bv5 32)) (concat (select d21 (_ bv4 32)) (concat (select d21 (_ bv3 32)) ?x43)))))
(let ((?x54 ((_ to_fp 11 53) (concat (select d21 (_ bv7 32)) (concat (select d21 (_ bv6 32)) ?x49)))))
(let ((?x70 (ite (fp.lt ?x54 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32))))
(let ((?x72 ((_ sign_extend 32) ?x70)))
(let ((?x15 (concat (select d10 (_ bv2 32)) (concat (select d10 (_ bv1 32)) (select d10 (_ bv0 32))))))
(let ((?x24 (concat (select d10 (_ bv5 32)) (concat (select d10 (_ bv4 32)) (concat (select d10 (_ bv3 32)) ?x15)))))
(let ((?x31 ((_ to_fp 11 53) (concat (select d10 (_ bv7 32)) (concat (select d10 (_ bv6 32)) ?x24)))))
(let ((?x62 (ite (fp.lt ?x31 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32))))
(let ((?x64 ((_ sign_extend 32) ?x62)))
(let (($x77 (and (not (= (_ bv0 64) (ite (bvslt (_ bv4294967295 32) ?x62) ?x64 (bvsub (_ bv0 64) ?x64)))) (not (= (_ bv0 64) (ite (bvslt (_ bv4294967295 32) ?x70) ?x72 (bvsub (_ bv0 64) ?x72)))))))
(not $x77)))))))))))))
(check-sat)
(exit)
