...
(let ((?x1637 (ite (= (_ bv0 64) (concat (select ?x1602 (bvadd (_ bv7 32) ?x1613)) ?x1632)) (_ bv1 64) (_ bv0 64))))
(let ((?x1638 (bvsub ?x1610 ?x1637)))
(let ((?x1765 ((_ extract 31 0) (ite (bvslt (_ bv4294967295 32) (bvxor ?x1605 ?x1359)) ?x1638 (bvsub (_ bv0 64) ?x1638)))))
(let ((?x1767 ((_ sign_extend 32) ?x1765)))
(let (($x1771 (bvslt (bvadd (_ bv18446744073709551615 64) (ite (bvslt (_ bv4294967295 32) ?x1765) ?x1767 (bvsub (_ bv0 64) ?x1767))) (_ bv2 64))))
(not (not $x1771))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
