...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.23.smt2
|)
...
(not (= (_ bv32 64) (concat ((_ extract 60 0) ?x74) (_ bv0 3))))))))))))))))
(check-sat)
(exit)
