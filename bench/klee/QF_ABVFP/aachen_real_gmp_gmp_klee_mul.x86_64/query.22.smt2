...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.22.smt2
|)
...
(let ((?x73 (bvadd (ite (bvslt (_ bv4294967295 32) ?x62) ?x64 (bvsub (_ bv0 64) ?x64)) (ite (bvslt (_ bv4294967295 32) ?x68) ?x70 (bvsub (_ bv0 64) ?x70)))))
(not (bvult (concat ((_ extract 60 0) ?x73) (_ bv0 3)) (_ bv32513 64)))))))))))))))
(check-sat)
(exit)
