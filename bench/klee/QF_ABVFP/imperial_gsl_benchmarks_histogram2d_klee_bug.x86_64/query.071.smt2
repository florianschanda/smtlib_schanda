...
(assert
 ...
 (let ((?x1027 (store (store (store (store ?x1020 (_ bv488 32) (_ bv0 8)) (_ bv489 32) (_ bv0 8)) (_ bv490 32) (_ bv0 8)) (_ bv491 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv490 32)) (concat (select ?x1709 (_ bv489 32)) (select ?x1709 (_ bv488 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv493 32)) (concat (select ?x1709 (_ bv492 32)) (concat (select ?x1709 (_ bv491 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv495 32)) (concat (select ?x1709 (_ bv494 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
