...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_memcpy_and_check_all_ones_significand_klee_float.x86_64/query.1.smt2
|)
...
(assert
 (not (not (= (_ bv2139095040 32) (bvand fresh_to_ieee_bv_!0 (_ bv2139095040 32))))))
(check-sat)
(exit)
