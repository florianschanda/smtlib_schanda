...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.40.smt2
|)
...
(not (= (_ bv0 32) ((_ extract 31 0) (concat (_ bv0 32) ((_ extract 63 32) ((_ sign_extend 32) ?x67)))))))))))))))
(check-sat)
(exit)
