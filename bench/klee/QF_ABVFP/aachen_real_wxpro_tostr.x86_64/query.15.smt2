...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.15.smt2
|)
...
(let ((?x41 ((_ sign_extend 32) ((_ fp.to_sbv 32) roundTowardZero (fp.abs ?x31)))))
(let ((?x47 ((_ extract 31 0) (concat (_ bv0 32) ((_ extract 63 32) ?x41)))))
(let ((?x60 (bvor (bvudiv (bvudiv (bvudiv (bvudiv ((_ extract 31 0) ?x41) (_ bv10 32)) (_ bv10 32)) (_ bv10 32)) (_ bv10 32)) ?x47)))
(not (= (_ bv0 32) ?x60)))))))))
(check-sat)
(exit)
