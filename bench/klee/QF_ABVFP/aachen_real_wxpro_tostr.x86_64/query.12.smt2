...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.12.smt2
|)
...
(let ((?x41 ((_ sign_extend 32) ((_ fp.to_sbv 32) roundTowardZero (fp.abs ?x31)))))
(let ((?x44 (bvudiv ((_ extract 31 0) ?x41) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x44 (_ bv10 32)))))))))))))
(check-sat)
(exit)
