...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.58.smt2
|)
...
(let ((?x69 ((_ sign_extend 32) ?x68)))
(let ((?x71 (bvudiv ((_ extract 31 0) ?x69) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x71 (_ bv10 32))))))))))))))))))
(check-sat)
(exit)
