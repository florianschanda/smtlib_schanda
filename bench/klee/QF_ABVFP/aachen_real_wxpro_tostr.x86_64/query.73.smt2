...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.73.smt2
|)
...
(let ((?x78 ((_ sign_extend 32) (bvadd ((_ fp.to_sbv 32) roundTowardZero ?x62) (bvmul (_ bv4294967196 32) ?x64)))))
(let ((?x80 (bvudiv ((_ extract 31 0) ?x78) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x80 (_ bv10 32))))))))))))))))))
(check-sat)
(exit)
