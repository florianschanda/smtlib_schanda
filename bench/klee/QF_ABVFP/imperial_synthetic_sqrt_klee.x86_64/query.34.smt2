...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.34.smt2
|)
...
(assert
 ...
 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x106 ?x19)) ?x38))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x32 ((_ to_fp 8 24) (_ bv1056964608 32))))
 (let ((?x22 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
...
(let ((?x105 (fp.mul roundNearestTiesToEven ?x104 ?x32)))
(let ((?x106 (fp.mul roundNearestTiesToEven ?x105 ?x105)))
(not (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x19 ?x106)) ?x38)))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
