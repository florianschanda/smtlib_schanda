...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.33.smt2
|)
...
(let ((?x112 (ite $x111 ?x103 ?x105)))
(let (($x122 (and (not (fp.isNaN ?x112)) (not (fp.isNaN ((_ to_fp 8 24) (ite $x111 fresh_to_ieee_bv_!5 ?x101)))))))
(let (($x125 (and $x122 (not (fp.gt ?x112 ((_ to_fp 8 24) (ite $x111 fresh_to_ieee_bv_!5 ?x101)))))))
(not $x125))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
