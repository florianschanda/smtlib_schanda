...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.10.smt2
|)
...
(not (not (fp.lt (fp.abs ?x51) ((_ to_fp 8 24) (_ bv869711765 32))))))))))))))))
(check-sat)
(exit)
