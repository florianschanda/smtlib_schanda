...
(let ((?x124 (bvsdiv (bvadd (ite $x120 (ite $x98 (_ bv0 32) (_ bv2 32)) ?x102) (ite $x120 ?x102 ?x100)) (_ bv2 32))))
(let ((?x127 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x124)))))
(let ((?x134 (concat (select data0 (bvadd (_ bv2 32) ?x127)) (concat (select data0 (bvadd (_ bv1 32) ?x127)) (select data0 ?x127)))))
(not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x127)) ?x134)) ?x94)))))))))))))))))
(check-sat)
(exit)
