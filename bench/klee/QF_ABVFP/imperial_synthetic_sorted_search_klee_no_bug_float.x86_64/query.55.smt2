...
(let ((?x229 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) (bvsdiv ?x225 (_ bv2 32)))))))
(let ((?x236 (concat (select data0 (bvadd (_ bv2 32) ?x229)) (concat (select data0 (bvadd (_ bv1 32) ?x229)) (select data0 ?x229)))))
(let (($x242 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x229)) ?x236)) ?x94))))
(not $x242)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
