...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.05.smt2
|)
...
(let ((?x19 ((_ to_fp 8 24) (concat (select f0 (_ bv3 32)) ?x15))))
(let ((?x28 (fp.abs ?x19)))
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x28 ?x28)))))))
(check-sat)
(exit)
