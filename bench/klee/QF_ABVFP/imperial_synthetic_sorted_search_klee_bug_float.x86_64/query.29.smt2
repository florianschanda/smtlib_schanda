...
(let ((?x104 (ite $x102 (_ bv2 32) (_ bv5 32))))
(let ((?x106 (bvsdiv (bvadd (ite $x102 (_ bv0 32) (_ bv2 32)) ?x104) (_ bv2 32))))
(let ((?x114 (concat (select data0 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x106))))) (select data0 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x106)))))))
(let ((?x117 (concat (select data0 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x106))))) ?x114)))
(let ((?x120 (concat (select data0 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x106))))) ?x117)))
(let (($x122 (fp.gt ((_ to_fp 8 24) ?x120) ?x94)))
(let ((?x126 (bvsdiv (bvadd (ite $x122 (ite $x102 (_ bv0 32) (_ bv2 32)) ?x106) (ite $x122 ?x106 ?x104)) (_ bv2 32))))
(let ((?x129 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x126)))))
(let ((?x136 (concat (select data0 (bvadd (_ bv2 32) ?x129)) (concat (select data0 (bvadd (_ bv1 32) ?x129)) (select data0 ?x129)))))
(not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x129)) ?x136)) ?x94)))))))))))))))))
(check-sat)
(exit)
