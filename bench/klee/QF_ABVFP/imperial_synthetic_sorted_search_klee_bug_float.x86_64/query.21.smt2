...
(let ((?x45 (concat (select data0 (_ bv10 32)) (concat (select data0 (_ bv9 32)) (select data0 (_ bv8 32))))))
(let ((?x49 ((_ to_fp 8 24) (concat (select data0 (_ bv11 32)) ?x45))))
(let (($x100 (fp.gt ?x49 ?x94)))
(let ((?x105 ((_ sign_extend 32) (bvsdiv (bvadd (ite $x100 (_ bv0 32) (_ bv2 32)) (ite $x100 (_ bv2 32) (_ bv5 32))) (_ bv2 32)))))
(let ((?x108 ((_ extract 31 0) (bvmul (_ bv4 64) ?x105))))
(let ((?x115 (concat (select data0 (bvadd (_ bv2 32) ?x108)) (concat (select data0 (bvadd (_ bv1 32) ?x108)) (select data0 ?x108)))))
(not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x108)) ?x115)) ?x94)))))))))))
(check-sat)
(exit)
