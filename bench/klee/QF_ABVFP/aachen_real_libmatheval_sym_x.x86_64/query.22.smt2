...
(assert
 ...
 (let ((?x18 (select x0 (_ bv7 32))))
 (let ((?x46 ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35)))))))
 (fp.gt (fp.abs ?x46) ((_ to_fp 11 53) (_ bv6909133974169121856 64)))))))))))
(assert
 (let ((?x32 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
(let ((?x35 (concat (select x0 (_ bv3 32)) ?x32)))
(let ((?x10 (select x0 (_ bv4 32))))
...
(let ((?x18 (select x0 (_ bv7 32))))
(let ((?x46 ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35)))))))
(let ((?x63 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4614162998222441677 64)) (fp.mul roundNearestTiesToEven ?x46 ?x46))))
(let ((?x67 (ite (fp.isInfinite ?x63) (ite (fp.gt ?x63 ((_ to_fp 11 53) (_ bv0 64))) (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32))))
(not (not (= (_ bv0 32) ?x67)))))))))))))
(check-sat)
(exit)
