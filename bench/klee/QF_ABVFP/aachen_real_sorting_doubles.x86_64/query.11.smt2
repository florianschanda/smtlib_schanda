...
(let ((?x29 (select a0 (_ bv7 32))))
(let ((?x31 ((_ to_fp 11 53) (concat ?x29 (concat ?x26 (concat ?x23 (concat ?x20 ?x18)))))))
(let ((?x70 (ite (fp.lt ((_ to_fp 11 53) (_ bv4621819117588971520 64)) ?x31) (_ bv0 32) (_ bv1 32))))
(let ((?x74 ((_ extract 31 0) (bvmul (_ bv8 64) ((_ sign_extend 32) ?x70)))))
(let ((?x48 (select b1 (_ bv7 32))))
(let ((?x46 (select b1 (_ bv6 32))))
(let ((?x44 (select b1 (_ bv5 32))))
(let ((?x42 (select b1 (_ bv4 32))))
...
(let ((?x350 (concat (select ?x343 (bvadd (_ bv2 32) ?x74)) (concat (select ?x343 (bvadd (_ bv1 32) ?x74)) (select ?x343 ?x74)))))
(let ((?x356 (concat (select ?x343 (bvadd (_ bv4 32) ?x74)) (concat (select ?x343 (bvadd (_ bv3 32) ?x74)) ?x350))))
(let ((?x362 (concat (select ?x343 (bvadd (_ bv6 32) ?x74)) (concat (select ?x343 (bvadd (_ bv5 32) ?x74)) ?x356))))
(let ((?x368 (ite (fp.lt ?x31 ((_ to_fp 11 53) (concat (select ?x343 (bvadd (_ bv7 32) ?x74)) ?x362))) (_ bv1 32) ?x70)))
