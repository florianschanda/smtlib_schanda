...
(let ((?x631 (concat (select ?x626 (_ bv10 32)) (concat (select ?x626 (_ bv9 32)) (select ?x626 (_ bv8 32))))))
(let ((?x637 (concat (select ?x626 (_ bv13 32)) (concat (select ?x626 (_ bv12 32)) (concat (select ?x626 (_ bv11 32)) ?x631)))))
(let (($x659 (fp.lt ((_ to_fp 11 53) (concat (select ?x626 (_ bv15 32)) (concat (select ?x626 (_ bv14 32)) ?x637))) ((_ to_fp 11 53) (concat (select ?x626 (_ bv23 32)) (concat (select ?x626 (_ bv22 32)) ?x653))))))
(not (bvult (bvmul (_ bv8 64) ((_ sign_extend 32) (ite $x659 (_ bv1 32) (_ bv2 32)))) (_ bv73 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
