...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_blas_klee_bug.x86_64/query.2.smt2
|)
...
(not (not (fp.eq ?x51 ((_ to_fp 11 53) (_ bv4645177318531305308 64)))))))))))
(check-sat)
(exit)
