...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_integer.x86_64/query.12.smt2
|)
...
(let (($x451 (bvsle (ite (bvslt (_ bv4294967295 32) ?x441) ?x443 (bvsub (_ bv0 64) ?x443)) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) (bvsdiv ?x50 (_ bv64 64))))))))
(not (not $x451))))))))))
(check-sat)
(exit)
