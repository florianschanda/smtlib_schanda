...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_float.x86_64/query.26.smt2
|)
...
(assert
 ...
 (= (fp.add roundTowardNegative ?x9 ?x12) ((_ to_fp 8 24) fresh_to_ieee_bv_!2)))))
(assert
 (not (bvslt fresh_to_ieee_bv_!2 (_ bv0 32))))
(check-sat)
(exit)
