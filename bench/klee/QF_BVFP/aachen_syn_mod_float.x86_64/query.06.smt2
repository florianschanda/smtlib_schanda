...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_mod_float.x86_64/query.06.smt2
|)
...
(assert
 ...
 (fp.gt ?x21 ?x9))))
(assert
 (= ((_ to_fp 11 53) roundNearestTiesToEven ((_ to_fp 8 24) f_ackermann!0)) ((_ to_fp 11 53) fresh_to_ieee_bv_!2)))
(assert
