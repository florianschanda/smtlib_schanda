...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_integer.x86_64/query.14.smt2
|)
...
(assert
 ...
 (fp.lt ?x8 ((_ to_fp 11 53) (_ bv4613937818241073152 64)))))
(assert
 (let ((?x8 ((_ to_fp 11 53) d_ackermann!0)))
 (fp.gt ?x8 ((_ to_fp 11 53) (_ bv4607182418800017408 64)))))
(assert
 (let ((?x35 (concat ((_ extract 0 0) (bvor (concat ((_ extract 52 0) d_ackermann!0) (_ bv0 11)) (_ bv9223372036854775808 64))) (_ bv0 63))))
 (let ((?x27 (bvadd (_ bv3074 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) d_ackermann!0)) (_ bv2047 64)))))
 (let ((?x32 (concat (_ bv0 32) (bvand ((_ extract 31 0) ?x27) (_ bv63 32)))))
...
(assert
 (let ((?x27 (bvadd (_ bv3074 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) d_ackermann!0)) (_ bv2047 64)))))
(let ((?x420 (ite (fp.lt ((_ to_fp 11 53) d_ackermann!0) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32))))
(let ((?x422 ((_ sign_extend 32) ?x420)))
(let (($x431 (bvsle (bvadd (_ bv18446744073709551615 64) (ite (bvslt (_ bv4294967295 32) ?x420) ?x422 (bvsub (_ bv0 64) ?x422))) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) (bvsdiv ?x27 (_ bv64 64))))))))
(not $x431))))))
(check-sat)
(exit)
