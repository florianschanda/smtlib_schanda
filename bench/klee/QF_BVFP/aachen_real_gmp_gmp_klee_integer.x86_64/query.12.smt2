...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_integer.x86_64/query.12.smt2
|)
...
(assert
 ...
 (not (= (_ bv0 64) (ite (bvult ?x32 (_ bv64 64)) (ite (= ?x32 (_ bv0 64)) ?x20 ?x407) (_ bv0 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x27 (bvadd (_ bv3074 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) d_ackermann!0)) (_ bv2047 64)))))
...
(let (($x430 (bvsle (ite (bvslt (_ bv4294967295 32) ?x420) ?x422 (bvsub (_ bv0 64) ?x422)) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) (bvsdiv ?x27 (_ bv64 64))))))))
(not (not $x430)))))))
(check-sat)
(exit)
