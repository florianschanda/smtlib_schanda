...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_qrdcmp.x86_64/query.7.smt2
|)
...
(let ((?x46 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x42 ((_ to_fp 8 24) (_ bv1075285470 32))) ((_ to_fp 8 24) (_ bv3204448256 32)))))
(let ((?x47 (fp.sub roundNearestTiesToEven ?x26 ?x46)))
(not (= (_ bv4 32) (ite (fp.isNormal ?x47) (_ bv4 32) (_ bv3 32))))))))))))))
(check-sat)
(exit)
