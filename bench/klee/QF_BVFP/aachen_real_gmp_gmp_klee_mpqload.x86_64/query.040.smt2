...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.040.smt2
|)
...
(let (($x55 (bvslt (_ bv0 64) (bvadd (_ bv2 64) (bvadd ?x48 (ite (bvslt (_ bv0 64) ?x50) ?x50 (_ bv0 64)))))))
(let (($x62 (= (_ bv32 64) (concat ((_ extract 60 0) (bvadd (ite $x55 (bvadd (_ bv2 64) ?x38) (_ bv0 64)) ?x38)) (_ bv0 3)))))
(not $x62))))))))))))
(check-sat)
(exit)
