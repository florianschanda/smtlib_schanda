...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.036.smt2
|)
...
(let ((?x48 (bvadd (ite (bvslt (_ bv0 64) (bvadd (_ bv1 64) ?x43)) (bvadd (_ bv2 64) ?x38) (_ bv0 64)) ?x38)))
(not (bvult (concat ((_ extract 60 0) ?x48) (_ bv0 3)) (_ bv32513 64))))))))
(check-sat)
(exit)
