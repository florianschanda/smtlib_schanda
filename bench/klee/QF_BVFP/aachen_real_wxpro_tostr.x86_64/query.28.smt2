...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.28.smt2
|)
...
(let ((?x43 ((_ sign_extend 32) ?x42)))
(let ((?x45 (bvudiv ((_ extract 31 0) ?x43) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x45 (_ bv10 32))))))))))))))))
(check-sat)
(exit)
