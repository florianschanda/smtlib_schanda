...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.58.smt2
|)
...
(assert
 ...
 (let ((?x49 (bvudiv ((_ extract 31 0) ?x47) (_ bv10 32))))
 (not (= (_ bv0 32) (bvor ?x49 ((_ extract 31 0) (concat (_ bv0 32) ((_ extract 63 32) ?x47)))))))))))))))
(assert
 (let ((?x8 ((_ to_fp 11 53) meters_ackermann!0)))
(let ((?x16 (fp.abs ?x8)))
(let ((?x18 ((_ fp.to_sbv 32) roundTowardZero ?x16)))
...
(let ((?x47 ((_ sign_extend 32) ?x46)))
(let ((?x49 (bvudiv ((_ extract 31 0) ?x47) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x49 (_ bv10 32))))))))))))))))
(check-sat)
(exit)
