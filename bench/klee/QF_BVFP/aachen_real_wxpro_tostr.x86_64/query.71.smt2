...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.71.smt2
|)
...
(let ((?x42 ((_ fp.to_sbv 32) roundTowardZero (fp.div roundNearestTiesToEven ?x40 ((_ to_fp 11 53) (_ bv4636737291354636288 64))))))
(let ((?x56 ((_ sign_extend 32) (bvadd ((_ fp.to_sbv 32) roundTowardZero ?x40) (bvmul (_ bv4294967196 32) ?x42)))))
(let ((?x57 ((_ extract 31 0) ?x56)))
(not (not (= (_ bv45 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x57 (_ bv10 32))))))))))))))))
(check-sat)
(exit)
