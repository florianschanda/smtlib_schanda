...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.65.smt2
|)
...
(let ((?x40 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x34 ((_ to_fp 11 53) (_ bv4636737291354636288 64))) ((_ to_fp 11 53) (_ bv4633641066610819072 64)))))
(let ((?x42 ((_ fp.to_sbv 32) roundTowardZero (fp.div roundNearestTiesToEven ?x40 ((_ to_fp 11 53) (_ bv4636737291354636288 64))))))
(let ((?x57 ((_ sign_extend 32) (bvadd ((_ fp.to_sbv 32) roundTowardZero ?x40) (bvmul (_ bv4294967196 32) ?x42)))))
(not (not (bvult (_ bv9223372036854775807 64) ?x57)))))))))))
(check-sat)
(exit)
