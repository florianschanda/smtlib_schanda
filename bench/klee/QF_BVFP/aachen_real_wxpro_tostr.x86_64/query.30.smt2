...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.30.smt2
|)
...
(not (= (_ bv0 32) ((_ extract 31 0) (concat (_ bv0 32) ((_ extract 63 32) ((_ sign_extend 32) ?x44)))))))))))))
(check-sat)
(exit)
