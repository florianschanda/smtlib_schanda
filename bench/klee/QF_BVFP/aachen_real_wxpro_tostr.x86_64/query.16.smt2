...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.16.smt2
|)
...
(let ((?x29 (bvudiv ?x22 (_ bv10 32))))
(let ((?x33 (bvudiv ?x29 (_ bv10 32))))
(not (not (= (_ bv45 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x33 (_ bv10 32))))))))))))
(check-sat)
(exit)
