...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_double.x86_64/query.28.smt2
|)
...
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x20 ?x20)))))))
(check-sat)
(exit)
