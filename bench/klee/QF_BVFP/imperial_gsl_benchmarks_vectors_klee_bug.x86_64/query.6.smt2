...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_vectors_klee_bug.x86_64/query.6.smt2
|)
...
(let ((?x12 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) temp_ackermann!0) ((_ to_fp 11 53) (_ bv4612451630364040888 64)))))
(let ((?x23 (ite (fp.gt ((_ to_fp 11 53) (_ bv4617957280908501320 64)) ?x12) (_ bv4617957280908501320 64) fresh_to_ieee_bv_!1)))
