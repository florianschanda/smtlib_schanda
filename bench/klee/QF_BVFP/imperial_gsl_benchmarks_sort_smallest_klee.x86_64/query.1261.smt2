...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1261.smt2
|)
...
(assert
 ...
 (or (or $x32 (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))) (fp.lt ?x31 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
...
(let (($x47 (fp.isNaN ?x13)))
(not (not (and (not $x47) $x47))))))
(check-sat)
(exit)
