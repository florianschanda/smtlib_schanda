...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2157.smt2
|)
...
(assert
 ...
 (or (or $x35 (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))) (fp.lt ?x34 ((_ to_fp 11 53) x_ackermann!0))))))
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x34 ?x14))))
...
(assert
 (let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x35 (fp.isNaN ?x34)))
(let (($x45 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x35) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x34))))
(not (not (and (not $x35) $x45)))))))
(check-sat)
(exit)
