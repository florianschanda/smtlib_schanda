...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1766.smt2
|)
...
(let ((?x31 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x32 (fp.isNaN ?x31)))
(not (not (and (not $x40) (or $x32 $x40)))))))))
(check-sat)
(exit)
