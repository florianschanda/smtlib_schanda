...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2439.smt2
|)
...
(assert
 (let ((?x36 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x37 (fp.isNaN ?x36)))
(let (($x48 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x37) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x36))))
