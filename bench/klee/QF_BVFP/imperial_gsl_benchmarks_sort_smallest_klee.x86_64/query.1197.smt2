...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1197.smt2
|)
...
(assert
 ...
 (or $x31 (fp.lt ?x30 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x30 ?x13))))
...
(let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(not (not (and (not $x31) (or (or $x14 $x31) (fp.gt ?x13 ?x30))))))))))
(check-sat)
(exit)
