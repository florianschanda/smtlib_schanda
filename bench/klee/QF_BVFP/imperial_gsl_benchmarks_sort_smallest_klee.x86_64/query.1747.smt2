...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1747.smt2
|)
...
(assert
 (let ((?x35 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x36 (fp.isNaN ?x35)))
(let (($x45 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x36) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x35))))
(not (not (and (not $x36) $x45)))))))
(check-sat)
(exit)
