...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2162.smt2
|)
...
(let ((?x38 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x39 (fp.isNaN ?x38)))
(not (not (and (not $x46) (or $x39 $x46)))))))))
(check-sat)
(exit)
