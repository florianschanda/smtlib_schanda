...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1487.smt2
|)
...
(assert
 ...
 (or (or $x31 (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))) (fp.lt ?x30 ((_ to_fp 11 53) x_ackermann!4))))))
(assert
 (let ((?x20 ((_ to_fp 11 53) x_ackermann!2)))
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x30 ?x20))))
