...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0321.smt2
|)
...
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(let (($x42 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) $x14) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x13))))
(not $x42)))))
(check-sat)
(exit)
