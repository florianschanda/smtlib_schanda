...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1866.smt2
|)
...
(assert
 (let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x35 (fp.isNaN ?x34)))
(let (($x48 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x35) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x34))))
(not (not (and (not $x35) $x48)))))))
(check-sat)
(exit)
