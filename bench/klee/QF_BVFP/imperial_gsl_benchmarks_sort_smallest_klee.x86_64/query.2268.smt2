...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2268.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 11 53) x_ackermann!3)))
(let (($x22 (fp.isNaN ?x21)))
(let (($x50 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x22) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x21))))
(not (not (and (not $x22) $x50)))))))
(check-sat)
(exit)
