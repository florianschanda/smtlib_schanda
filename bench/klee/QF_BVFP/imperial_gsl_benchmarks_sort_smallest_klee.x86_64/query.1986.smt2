...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1986.smt2
|)
...
(assert
 ...
 (or (or $x36 (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))) (fp.lt ?x35 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
...
(let ((?x35 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x36 (fp.isNaN ?x35)))
(not (not (and (not $x44) (or $x36 $x44)))))))))
(check-sat)
(exit)
