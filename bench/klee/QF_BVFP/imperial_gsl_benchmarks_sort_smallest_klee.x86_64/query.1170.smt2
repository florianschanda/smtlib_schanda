...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1170.smt2
|)
...
(assert
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x31 (fp.isNaN ?x30)))
(let (($x49 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x31) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x30))))
(not (not (and (not $x31) $x49)))))))
(check-sat)
(exit)
