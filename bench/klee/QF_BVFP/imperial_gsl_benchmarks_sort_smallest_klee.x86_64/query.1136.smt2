...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1136.smt2
|)
...
(assert
 ...
 (or $x30 (fp.lt ?x29 ((_ to_fp 11 53) x_ackermann!3))))))
(assert
 (not (fp.gt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1))))
(assert
 (let ((?x29 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x29 ((_ to_fp 11 53) x_ackermann!0))))
(assert
 (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))))
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
(let (($x38 (fp.isNaN ?x14)))
(let ((?x29 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x30 (fp.isNaN ?x29)))
(not (not (and (not $x38) (or $x30 $x38)))))))))
(check-sat)
(exit)
