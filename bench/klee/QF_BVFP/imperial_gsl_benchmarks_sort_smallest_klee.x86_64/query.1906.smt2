...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1906.smt2
|)
...
(assert
 (let ((?x40 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x41 (fp.isNaN ?x40)))
(let (($x50 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x41) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x40))))
(not (not (and (not $x41) $x50)))))))
(check-sat)
(exit)
