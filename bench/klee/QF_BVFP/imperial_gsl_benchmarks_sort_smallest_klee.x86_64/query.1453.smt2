...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1453.smt2
|)
...
(assert
 (let ((?x17 ((_ to_fp 11 53) x_ackermann!2)))
(let (($x41 (fp.isNaN ?x17)))
(let (($x46 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x41) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x17))))
(not (not (and (not $x41) $x46)))))))
(check-sat)
(exit)
