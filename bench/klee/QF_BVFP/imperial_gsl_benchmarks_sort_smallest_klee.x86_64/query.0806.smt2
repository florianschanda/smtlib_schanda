...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0806.smt2
|)
...
(assert
 (let ((?x27 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x27 ((_ to_fp 11 53) x_ackermann!0))))
(assert
...
(let ((?x27 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x28 (fp.isNaN ?x27)))
(not (not (and (not $x38) (or $x28 $x38)))))))))
(check-sat)
(exit)
