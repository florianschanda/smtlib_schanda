...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2252.smt2
|)
...
(assert
 ...
 (or (or $x38 (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))) (fp.lt ?x37 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
...
(let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x38 (fp.isNaN ?x37)))
(not (not (and (not $x46) (or $x38 $x46)))))))))
(check-sat)
(exit)
