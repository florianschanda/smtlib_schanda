...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0490.smt2
|)
...
(assert
 ...
 (fp.gt ?x24 ?x13))))
(assert
 (let (($x34 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)))))
 (or $x34 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1)))))
(assert
 (let ((?x24 ((_ to_fp 11 53) x_ackermann!4)))
...
(assert
 (let ((?x24 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x25 (fp.isNaN ?x24)))
(let (($x44 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x25) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x24))))
(not (not (and (not $x25) $x44)))))))
(check-sat)
(exit)
