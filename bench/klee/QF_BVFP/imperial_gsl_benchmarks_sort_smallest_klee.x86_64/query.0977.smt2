...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0977.smt2
|)
...
(assert
 ...
 (fp.gt ?x23 ?x14))))
(assert
 (let (($x33 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)))))
 (or $x33 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!4)))
...
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x24 (fp.isNaN ?x23)))
(let (($x43 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x24) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x23))))
(not (not (and (not $x24) $x43)))))))
(check-sat)
(exit)
