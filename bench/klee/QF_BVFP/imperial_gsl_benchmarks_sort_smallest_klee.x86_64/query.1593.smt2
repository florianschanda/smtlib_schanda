...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1593.smt2
|)
...
(assert
 ...
 (or $x35 (fp.lt ?x34 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
...
(let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x35 (fp.isNaN ?x34)))
(not (not (and (not $x43) (or $x35 $x43)))))))))
(check-sat)
(exit)
