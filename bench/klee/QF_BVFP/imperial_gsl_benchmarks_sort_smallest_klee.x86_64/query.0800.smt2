...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0800.smt2
|)
...
(assert
 (let ((?x31 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x32 (fp.isNaN ?x31)))
(let (($x44 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x32) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x31))))
