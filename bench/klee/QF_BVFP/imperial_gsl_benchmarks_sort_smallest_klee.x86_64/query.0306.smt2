...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0306.smt2
|)
...
(assert
 (let (($x41 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (not (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0))))))
(not $x41)))
(check-sat)
(exit)
