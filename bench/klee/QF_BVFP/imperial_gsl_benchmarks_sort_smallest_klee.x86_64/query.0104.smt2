...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0104.smt2
|)
...
(assert
 ...
 (or (or $x20 (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))) (fp.lt ?x19 ((_ to_fp 11 53) x_ackermann!0))))))
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!2)))
 (let ((?x19 ((_ to_fp 11 53) x_ackermann!3)))
 (fp.gt ?x19 ?x15))))
