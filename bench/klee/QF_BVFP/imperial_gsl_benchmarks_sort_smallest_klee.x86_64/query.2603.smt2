...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2603.smt2
|)
...
(let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x38 (fp.isNaN ?x37)))
(not (not (and (not $x45) (or $x38 $x45)))))))))
(check-sat)
(exit)
