...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2315.smt2
|)
...
(assert
 ...
 (or (or $x29 (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))) (fp.lt ?x28 ((_ to_fp 11 53) x_ackermann!4))))))
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x28 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x28 ?x15))))
(assert
 (let ((?x28 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x29 (fp.isNaN ?x28)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x29) (fp.lt ((_ to_fp 11 53) x_ackermann!2) ?x28)))))
(assert
