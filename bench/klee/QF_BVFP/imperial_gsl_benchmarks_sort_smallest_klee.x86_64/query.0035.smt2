...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0035.smt2
|)
...
(assert
 (fp.gt ((_ to_fp 11 53) x_ackermann!1) ((_ to_fp 11 53) x_ackermann!3)))
(assert
 (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))))
(assert
 (let (($x27 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!4)) (fp.lt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!0)))))
(not $x27)))
(check-sat)
(exit)
