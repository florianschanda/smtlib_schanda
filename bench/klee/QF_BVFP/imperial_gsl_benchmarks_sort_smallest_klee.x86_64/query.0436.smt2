...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0436.smt2
|)
...
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x35 (fp.isNaN ?x13)))
(let (($x40 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x35) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x13))))
(not (not (and (not $x35) $x40)))))))
(check-sat)
(exit)
