...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2559.smt2
|)
...
(let ((?x32 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x33 (fp.isNaN ?x32)))
(not (not (and (not $x14) (or $x33 $x14)))))))))
(check-sat)
(exit)
