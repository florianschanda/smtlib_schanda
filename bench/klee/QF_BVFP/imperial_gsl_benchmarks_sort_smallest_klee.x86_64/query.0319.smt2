...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0319.smt2
|)
...
(assert
 (let ((?x22 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x23 (fp.isNaN ?x22)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!4)) $x23) (fp.lt ((_ to_fp 11 53) x_ackermann!4) ?x22)))))
(assert
...
(assert
 ...
 (fp.gt ?x29 ?x17))))
(assert
 (let (($x40 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)))))
(not (or $x40 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0))))))
(check-sat)
(exit)
