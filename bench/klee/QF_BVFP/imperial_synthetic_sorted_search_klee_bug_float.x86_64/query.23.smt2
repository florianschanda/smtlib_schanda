...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_bug_float.x86_64/query.23.smt2
|)
...
(let (($x44 (fp.gt ?x13 ?x25)))
(let ((?x52 ((_ sign_extend 32) (bvsdiv (bvadd (ite $x44 (_ bv0 32) (_ bv2 32)) (ite $x44 (_ bv2 32) (_ bv5 32))) (_ bv2 32)))))
(not (bvult (bvmul (_ bv4 64) ?x52) (_ bv17 64))))))))
(check-sat)
(exit)
