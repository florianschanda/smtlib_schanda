...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_bug_float.x86_64/query.12.smt2
|)
...
(assert
 ...
 (fp.eq ?x16 ((_ to_fp 8 24) elem_ackermann!5))))
(assert
