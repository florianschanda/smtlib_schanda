...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_double.x86_64/query.25.smt2
|)
...
(assert
 ...
 (= (_ bv0 32) ?x39)))
(assert
 (= (fp.add roundTowardZero ((_ to_fp 11 53) f_ackermann!0) ((_ to_fp 11 53) g_ackermann!1)) ((_ to_fp 11 53) fresh_to_ieee_bv_!2)))
(assert
