...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.23.smt2
|)
...
(not (= (_ bv32 64) (concat ((_ extract 60 0) ?x37) (_ bv0 3))))))))))
(check-sat)
(exit)
