...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_non_terminating_klee_no_bug.x86_64/query.33.smt2
|)
...
(not (fp.gt (fp.sub roundNearestTiesToEven ?x47 ?x8) ((_ to_fp 8 24) (_ bv0 32)))))))))))))))))))))
(check-sat)
(exit)
