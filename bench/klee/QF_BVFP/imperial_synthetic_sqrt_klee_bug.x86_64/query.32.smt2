...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.32.smt2
|)
...
(let (($x108 (fp.eq (ite $x101 ?x93 ?x95) ((_ to_fp 8 24) (ite $x101 fresh_to_ieee_bv_!6 ?x91)))))
(not (not $x108)))))))))))))))))))))))))))))
(check-sat)
(exit)
