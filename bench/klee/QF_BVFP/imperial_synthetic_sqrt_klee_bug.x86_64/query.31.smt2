...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.31.smt2
|)
...
(assert
 ...
 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x95 ?x8)) ?x27))))))))))))))))))))))))))))
(assert
 (let ((?x22 ((_ to_fp 8 24) (_ bv1056964608 32))))
...
(let ((?x94 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) (ite $x87 fresh_to_ieee_bv_!5 ?x77)) (ite $x87 ?x79 ?x81))))
(let ((?x95 (fp.mul roundNearestTiesToEven ?x94 ?x22)))
(not (and (not (fp.isNaN ?x95)) (not (fp.gt ?x95 ?x8))))))))))))))))))))))))))))))
(check-sat)
(exit)
