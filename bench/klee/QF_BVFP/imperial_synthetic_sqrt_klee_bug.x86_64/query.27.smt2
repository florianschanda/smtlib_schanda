...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.27.smt2
|)
...
(assert
 ...
 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x81 ?x8)) ?x27)))))))))))))))))))))))
(assert
 (let ((?x22 ((_ to_fp 8 24) (_ bv1056964608 32))))
...
(let ((?x78 ((_ to_fp 8 24) (ite $x73 fresh_to_ieee_bv_!4 (ite $x59 fresh_to_ieee_bv_!3 ?x49)))))
(let ((?x81 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x78 (ite $x73 ?x65 ?x67)) ?x22)))
(not (and (not (fp.isNaN ?x81)) (not (fp.gt ?x81 ?x8)))))))))))))))))))))))))
(check-sat)
(exit)
