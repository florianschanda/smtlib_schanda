...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.08.smt2
|)
...
(let ((?x8 ((_ to_fp 8 24) x_ackermann!0)))
(let ((?x30 (fp.sub roundNearestTiesToEven ?x8 (fp.mul roundNearestTiesToEven ?x23 ?x23))))
(not (fp.lt (fp.abs ?x30) ((_ to_fp 8 24) (_ bv869711765 32))))))))
(check-sat)
(exit)
