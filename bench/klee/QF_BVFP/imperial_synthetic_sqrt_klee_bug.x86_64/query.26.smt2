...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.26.smt2
|)
...
(let (($x94 (fp.eq (ite $x87 (ite $x73 ?x65 ?x67) ?x81) ((_ to_fp 8 24) (ite $x87 fresh_to_ieee_bv_!5 ?x77)))))
(not (not $x94))))))))))))))))))))))))
(check-sat)
(exit)
