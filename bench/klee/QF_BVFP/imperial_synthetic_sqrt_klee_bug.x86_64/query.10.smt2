...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.10.smt2
|)
...
(let ((?x40 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x38 ((_ to_fp 8 24) (_ bv1056964608 32))) ?x8)))
(not (not (fp.lt (fp.abs ?x40) ((_ to_fp 8 24) (_ bv869711765 32))))))))))))
(check-sat)
(exit)
