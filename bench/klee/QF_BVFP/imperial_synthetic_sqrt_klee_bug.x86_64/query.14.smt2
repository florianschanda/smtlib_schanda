...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.14.smt2
|)
...
(let ((?x46 (ite $x45 ?x37 ?x39)))
(let (($x56 (and (not (fp.isNaN ?x46)) (not (fp.isNaN ((_ to_fp 8 24) (ite $x45 fresh_to_ieee_bv_!2 ?x35)))))))
(let (($x59 (and $x56 (not (fp.gt ?x46 ((_ to_fp 8 24) (ite $x45 fresh_to_ieee_bv_!2 ?x35)))))))
(not $x59)))))))))))))
(check-sat)
(exit)
