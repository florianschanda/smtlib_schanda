...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_inv_arg.x86_64/query.13.smt2
|)
...
(assert
 (let (($x29 (not (= (_ bv0 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) fresh_to_ieee_bv_!1)) (_ bv2047 64))))))
(not $x29)))
(check-sat)
(exit)
