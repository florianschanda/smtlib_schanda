...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_inv_arg.x86_64/query.14.smt2
|)
...
(not (not (= (_ bv0 32) (bvand ?x30 (_ bv63 32)))))))
(check-sat)
(exit)
