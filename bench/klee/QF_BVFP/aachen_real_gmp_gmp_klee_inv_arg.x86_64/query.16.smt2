...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_inv_arg.x86_64/query.16.smt2
|)
...
(not (bvult (concat (_ bv0 32) (bvand ?x29 (_ bv63 32))) (_ bv64 64)))))
(check-sat)
(exit)
