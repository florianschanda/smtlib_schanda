...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.021.smt2
|)
...
(assert
 (let ((?x38 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x45 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x38)))
 (let ((?x11 ((_ to_fp 8 24) symbolic_0_float_ackermann!3)))
 (let ((?x35 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x43 (fp.sub roundNearestTiesToEven ?x35 ?x11)))
 (or (or (fp.isNaN ?x43) (fp.isNaN ?x45)) (fp.gt ?x43 ?x45))))))))
(assert
 (let ((?x19 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!2)))
 (fp.geq ?x25 ?x19))))
...
(let ((?x35 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x43 (fp.sub roundNearestTiesToEven ?x35 ?x11)))
(not (or (or (fp.isNaN ?x43) (fp.isNaN ?x38)) (fp.lt ?x43 ?x38))))))))
(check-sat)
(exit)
