...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.677.smt2
|)
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x29 ?x78)))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x24 ?x75)))
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x75 ?x42)))
...
(let ((?x59 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x66 (fp.sub roundNearestTiesToEven ?x59 (fp.add roundNearestTiesToEven ?x17 ?x40))))
(let (($x116 (and (and (not (fp.isNaN ?x66)) (not (fp.isNaN ?x62))) (not (fp.lt ?x66 ?x62)))))
(not $x116))))))))
(check-sat)
(exit)
