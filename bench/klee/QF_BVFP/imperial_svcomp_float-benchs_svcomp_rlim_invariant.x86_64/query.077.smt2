...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.077.smt2
|)
...
(assert
 ...
 (let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x57 (fp.sub roundNearestTiesToEven ?x13 ?x37)))
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
 (let ((?x58 (fp.sub roundNearestTiesToEven ?x56 ?x57)))
 (or (fp.isNaN ?x54) (fp.gt ?x58 ?x54)))))))))))
(assert
 (let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x57 (fp.sub roundNearestTiesToEven ?x13 ?x37)))
...
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
(let ((?x57 (fp.sub roundNearestTiesToEven ?x13 ?x37)))
(let ((?x73 (fp.add roundNearestTiesToEven ?x57 ?x51)))
