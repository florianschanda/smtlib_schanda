...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.453.smt2
|)
...
(let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x98 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x77 ?x71))))
(not (or (or (fp.isNaN ?x98) (fp.isNaN ?x94)) (fp.lt ?x98 ?x94)))))))))))))))
(check-sat)
(exit)
