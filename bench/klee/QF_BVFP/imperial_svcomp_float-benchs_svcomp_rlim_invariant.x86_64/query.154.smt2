...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.154.smt2
|)
...
(assert
 ...
 (let ((?x26 (fp.add roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x26 ?x27)))
 (let ((?x74 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
 (let ((?x75 (fp.sub roundNearestTiesToEven ?x74 ?x28)))
 (not (fp.isNaN ?x75))))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x78))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (fp.leq ?x74 ?x20))))
(assert
 (let (($x97 (and (fp.geq ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1) ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1) ((_ to_fp 8 24) (_ bv1124139008 32))))))
(not $x97)))
(check-sat)
(exit)
