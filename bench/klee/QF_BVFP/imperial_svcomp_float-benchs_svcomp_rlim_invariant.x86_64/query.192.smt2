...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.192.smt2
|)
...
(assert
 ...
 (let ((?x28 (fp.add roundNearestTiesToEven ?x26 ?x27)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
...
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x34 ?x27)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 (fp.add roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x65 ?x26)))
...
(assert
 ...
 (let ((?x26 (fp.add roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x28 (fp.add roundNearestTiesToEven ?x26 ?x27)))
 (let ((?x77 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x77 ?x28)))
 (not (fp.isNaN ?x78))))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x81))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
