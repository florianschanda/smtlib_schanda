...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.093.smt2
|)
...
(let ((?x39 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x47 (fp.sub roundNearestTiesToEven ?x39 ?x13)))
(let (($x78 (and (and (not (fp.isNaN ?x47)) (not (fp.isNaN ?x42))) (not (fp.lt ?x47 ?x42)))))
(not $x78)))))))
(check-sat)
(exit)
