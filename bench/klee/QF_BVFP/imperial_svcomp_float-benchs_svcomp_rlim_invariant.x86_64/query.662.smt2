...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.662.smt2
|)
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x58 (fp.sub roundNearestTiesToEven ?x31 ?x57)))
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x24 ?x54)))
...
(assert
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x70 (fp.sub roundNearestTiesToEven ?x69 ?x24)))
 (not (fp.isNaN ?x70))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x31 ?x25)))
 (not (fp.isNaN ?x73))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x31 ?x84)))
 (let ((?x47 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x54 ?x47)))
...
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x31 ?x45)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x42 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x100 (fp.sub roundNearestTiesToEven ?x42 ?x17)))
