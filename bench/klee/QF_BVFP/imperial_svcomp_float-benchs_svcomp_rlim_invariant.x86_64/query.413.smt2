...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.413.smt2
|)
...
(assert
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x34 ?x59)))
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x17 ?x45)))
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x64 ?x65)))
 (or (fp.isNaN ?x62) (fp.gt ?x66 ?x62)))))))))))
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x17 ?x45)))
...
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x25 ?x26)))
...
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x65 (fp.sub roundNearestTiesToEven ?x17 ?x45)))
(let ((?x110 (fp.add roundNearestTiesToEven ?x65 ?x59)))
