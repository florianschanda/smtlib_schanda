...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.426.smt2
|)
...
(assert
 ...
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x76 (fp.add roundNearestTiesToEven ?x63 ?x57))))
 (not (fp.isNaN ?x78)))))))))
(assert
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
