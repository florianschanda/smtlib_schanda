...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.377.smt2
|)
...
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (not (fp.isNaN ?x84))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
