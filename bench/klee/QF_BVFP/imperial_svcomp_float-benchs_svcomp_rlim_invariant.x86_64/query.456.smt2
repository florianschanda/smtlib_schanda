...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.456.smt2
|)
...
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x90 (fp.sub roundNearestTiesToEven ?x25 ?x87)))
 (let ((?x71 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x55 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 ...
 (let ((?x61 (fp.add roundNearestTiesToEven ?x45 ?x39)))
 (let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
 (let ((?x93 (fp.add roundNearestTiesToEven ?x77 ?x71)))
 (let ((?x92 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x92 ?x93)))
 (or (fp.isNaN ?x90) (fp.gt ?x94 ?x90)))))))))))))))))
(assert
 (let ((?x71 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x55 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 ...
 (not (fp.lt ?x94 ?x87)))))))))))))))
(assert
 (let ((?x104 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.geq ?x29 ?x104))))
(assert
 (let ((?x107 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.leq ?x29 ?x107))))
(assert
 (let ((?x104 ((_ to_fp 8 24) (_ bv3271557120 32))))
...
(let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
(let ((?x93 (fp.add roundNearestTiesToEven ?x77 ?x71)))
(let ((?x117 (fp.add roundNearestTiesToEven ?x93 ?x87)))
