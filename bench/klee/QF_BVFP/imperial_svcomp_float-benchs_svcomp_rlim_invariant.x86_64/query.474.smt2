...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.474.smt2
|)
...
(let ((?x44 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x54 (fp.sub roundNearestTiesToEven ?x44 ?x17)))
(not (or (or (fp.isNaN ?x54) (fp.isNaN ?x47)) (fp.lt ?x54 ?x47))))))))
(check-sat)
(exit)
