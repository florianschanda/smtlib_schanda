...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.109.smt2
|)
...
(assert
 ...
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x30 ?x24)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x74 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x75 (fp.sub roundNearestTiesToEven ?x74 ?x23)))
 (not (fp.gt ?x75 ?x71)))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
