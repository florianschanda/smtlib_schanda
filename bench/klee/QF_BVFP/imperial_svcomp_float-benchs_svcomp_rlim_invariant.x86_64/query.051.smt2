...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.051.smt2
|)
...
(assert
 ...
 (let ((?x48 (fp.sub roundNearestTiesToEven ?x46 (fp.sub roundNearestTiesToEven ?x34 ?x30))))
 (not (fp.isNaN ?x48)))))))))
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x51 (fp.sub roundNearestTiesToEven ?x21 ?x43)))
 (not (fp.isNaN ?x51))))))
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (not (fp.gt ?x48 ?x51))))))))))))
(assert
 (let ((?x57 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (fp.geq ?x26 ?x57))))
(assert
 (let ((?x60 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (fp.leq ?x26 ?x60))))
(assert
 (let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
