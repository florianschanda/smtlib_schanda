...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.680.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x24 ?x77)))
...
(assert
 ...
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x29 ?x100)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x77 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x77 ?x42)))
...
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x65 (fp.add roundNearestTiesToEven ?x17 ?x40)))
(let ((?x114 (fp.add roundNearestTiesToEven ?x65 ?x59)))
