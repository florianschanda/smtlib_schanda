...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.350.smt2
|)
...
(assert
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x32 ?x73)))
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x17 ?x43)))
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x70 (fp.sub roundNearestTiesToEven ?x61 ?x57))))
 (or (or (fp.isNaN ?x77) (fp.isNaN ?x79)) (fp.gt ?x77 ?x79))))))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (fp.geq ?x26 ?x25))))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x32 ?x26)))
 (not (fp.isNaN ?x86))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (let ((?x90 (fp.sub roundNearestTiesToEven ?x89 ?x25)))
 (not (fp.gt ?x90 ?x86)))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
