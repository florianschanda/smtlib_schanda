...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.063.smt2
|)
...
(assert
 ...
 (fp.leq ?x20 ?x18))))
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x51 (fp.sub roundNearestTiesToEven ?x25 ?x50)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x20 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x48 (fp.sub roundNearestTiesToEven ?x20 ?x41)))
 (or (or (fp.isNaN ?x48) (fp.isNaN ?x51)) (fp.gt ?x48 ?x51)))))))))
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x20 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x48 (fp.sub roundNearestTiesToEven ?x20 ?x41)))
 (or (or (fp.isNaN ?x48) (fp.isNaN ?x50)) (fp.lt ?x48 ?x50)))))))
(assert
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x26 ?x41))))
...
(assert
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x67 (fp.sub roundNearestTiesToEven ?x25 ?x39)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x36 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x64 (fp.sub roundNearestTiesToEven ?x36 ?x13)))
(let (($x73 (and (and (not (fp.isNaN ?x64)) (not (fp.isNaN ?x67))) (not (fp.gt ?x64 ?x67)))))
(not $x73)))))))))
(check-sat)
(exit)
