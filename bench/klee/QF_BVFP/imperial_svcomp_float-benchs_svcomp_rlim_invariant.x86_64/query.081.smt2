...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.081.smt2
|)
...
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x54 (fp.sub roundNearestTiesToEven ?x30 ?x25)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 (fp.sub roundNearestTiesToEven ?x21 ?x22)))
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x57 (fp.sub roundNearestTiesToEven ?x56 ?x24)))
 (or (fp.isNaN ?x54) (fp.gt ?x57 ?x54)))))))))))
(assert
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 (fp.sub roundNearestTiesToEven ?x21 ?x22)))
