...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.710.smt2
|)
...
(assert
 ...
 (let ((?x53 (fp.sub roundNearestTiesToEven ?x38 ?x34)))
 (let ((?x67 (fp.add roundNearestTiesToEven ?x53 ?x47)))
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x67 ?x63)))
