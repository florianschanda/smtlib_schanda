...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.527.smt2
|)
...
(assert
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x32 ?x76)))
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x66 (fp.add roundNearestTiesToEven ?x17 ?x43)))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x32 ?x26)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x96 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x96 ?x25)))
...
(let ((?x66 (fp.add roundNearestTiesToEven ?x17 ?x43)))
(let ((?x82 (fp.add roundNearestTiesToEven ?x66 ?x60)))
(let ((?x116 (fp.add roundNearestTiesToEven ?x82 ?x76)))
