...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.282.smt2
|)
...
(assert
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x30 ?x24)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
...
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x30 ?x58)))
(let ((?x41 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x55 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x82 (fp.sub roundNearestTiesToEven ?x55 (fp.sub roundNearestTiesToEven ?x15 ?x41))))
