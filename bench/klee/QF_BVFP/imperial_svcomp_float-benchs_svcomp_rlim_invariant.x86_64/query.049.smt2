...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.049.smt2
|)
...
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x62 (fp.sub roundNearestTiesToEven ?x21 ?x50)))
(let ((?x30 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
(let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x34 (fp.sub roundNearestTiesToEven ?x15 ?x13)))
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x60 (fp.sub roundNearestTiesToEven ?x43 (fp.sub roundNearestTiesToEven ?x34 ?x30))))
(not (or (or (fp.isNaN ?x60) (fp.isNaN ?x62)) (fp.gt ?x60 ?x62)))))))))))))
(check-sat)
(exit)
