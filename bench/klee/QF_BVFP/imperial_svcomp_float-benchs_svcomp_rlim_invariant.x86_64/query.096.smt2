...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.096.smt2
|)
...
(assert
 ...
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x60 ?x21)))
...
(assert
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x76 (fp.add roundNearestTiesToEven ?x13 ?x39)))
