...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.323.smt2
|)
...
(assert
 ...
 (let ((?x44 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x44 ?x63))))
...
(assert
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x109 (fp.add roundNearestTiesToEven ?x17 ?x42)))
