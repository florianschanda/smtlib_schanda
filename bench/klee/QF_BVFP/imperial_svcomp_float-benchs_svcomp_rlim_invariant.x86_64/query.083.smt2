...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.083.smt2
|)
...
(assert
 ...
 (let ((?x51 (fp.sub roundNearestTiesToEven ?x49 (fp.add roundNearestTiesToEven ?x36 ?x30))))
 (not (fp.isNaN ?x51)))))))))
(assert
 (let ((?x46 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
