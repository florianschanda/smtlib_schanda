...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.446.smt2
|)
...
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x38 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x38 ?x33)))
 (not (fp.isNaN ?x93))))))
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x38 ((_ to_fp 8 24) (_ bv2147483648 32))))
