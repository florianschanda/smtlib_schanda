...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.643.smt2
|)
...
(assert
 ...
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x65 (fp.add roundNearestTiesToEven ?x17 ?x45))))
 (not (fp.isNaN ?x67)))))))
(assert
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
