...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.061.smt2
|)
...
(assert
 ...
 (let ((?x20 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x42 (fp.sub roundNearestTiesToEven ?x20 (fp.sub roundNearestTiesToEven ?x39 ?x40))))
...
(assert
 ...
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x25 ?x40)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x63 ?x39)))
 (not (fp.gt ?x64 ?x60)))))))))
(assert
 (let ((?x39 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
