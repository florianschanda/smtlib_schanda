...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.286.smt2
|)
...
(assert
 ...
 (let ((?x41 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x15 ?x41)))
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x75 ?x23)))
...
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x61 (fp.sub roundNearestTiesToEven ?x15 ?x41)))
(let ((?x93 (fp.add roundNearestTiesToEven ?x61 ?x55)))
