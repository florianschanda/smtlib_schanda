...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.505.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x61 ?x62))))
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x96 ?x61)))
 (not (fp.isNaN ?x97))))))
(assert
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x29 ?x62)))
 (not (fp.isNaN ?x100))))))
(assert
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
