...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.241.smt2
|)
...
(assert
 ...
 (let ((?x43 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x22 (fp.add roundNearestTiesToEven ?x43 ?x57))))
...
(assert
 ...
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x77 ?x43)))
...
(let ((?x38 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x48 (fp.sub roundNearestTiesToEven ?x38 ?x15)))
(not (or (or (fp.isNaN ?x48) (fp.isNaN ?x41)) (fp.lt ?x48 ?x41))))))))
(check-sat)
(exit)
