...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.404.smt2
|)
...
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x31 ?x45)))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x94 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x94 ?x44)))
