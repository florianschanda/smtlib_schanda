...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.293.smt2
|)
...
(assert
 ...
 (let ((?x38 (fp.sub roundNearestTiesToEven ?x17 ?x15)))
 (let ((?x54 (fp.add roundNearestTiesToEven ?x38 ?x32)))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x67 (fp.add roundNearestTiesToEven ?x54 ?x48))))
 (not (fp.isNaN ?x69)))))))))))
(assert
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x72 (fp.sub roundNearestTiesToEven ?x23 ?x64)))
 (not (fp.isNaN ?x72))))))
(assert
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
