...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.204.smt2
|)
...
(assert
 ...
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x32 ?x24)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x63 ?x23)))
 (not (fp.gt ?x64 ?x60)))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x32 ?x27)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 (fp.sub roundNearestTiesToEven ?x23 ?x24)))
...
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x51 (fp.sub roundNearestTiesToEven ?x43 ?x15)))
(not (or (or (fp.isNaN ?x51) (fp.isNaN ?x46)) (fp.lt ?x51 ?x46))))))))
(check-sat)
(exit)
