...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.500.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x59 ?x60))))
...
(assert
 ...
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x92 ?x59)))
 (not (fp.isNaN ?x93))))))
(assert
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x29 ?x60)))
 (not (fp.isNaN ?x96))))))
(assert
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x50 (fp.sub roundNearestTiesToEven ?x40 ?x17)))
(let (($x113 (and (and (not (fp.isNaN ?x50)) (not (fp.isNaN ?x43))) (not (fp.lt ?x50 ?x43)))))
(not $x113)))))))
(check-sat)
(exit)
