...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.153.smt2
|)
...
(assert
 ...
 (let ((?x41 (fp.add roundNearestTiesToEven ?x17 ?x15)))
 (let ((?x54 (fp.sub roundNearestTiesToEven ?x41 ?x37)))
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x54 ?x50)))
...
(assert
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x23 ?x63)))
 (not (fp.isNaN ?x71))))))
(assert
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (not (fp.gt ?x68 ?x71)))))))))))))))
(assert
 (let ((?x77 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (fp.geq ?x27 ?x77))))
(assert
 (let ((?x80 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (fp.leq ?x27 ?x80))))
(assert
 (let ((?x77 ((_ to_fp 8 24) (_ bv3271557120 32))))
...
(let ((?x54 (fp.sub roundNearestTiesToEven ?x41 ?x37)))
(let ((?x67 (fp.sub roundNearestTiesToEven ?x54 ?x50)))
(let ((?x88 (fp.sub roundNearestTiesToEven ?x67 ?x63)))
