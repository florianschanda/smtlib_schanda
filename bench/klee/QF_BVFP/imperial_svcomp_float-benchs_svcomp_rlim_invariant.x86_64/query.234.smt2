...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.234.smt2
|)
...
(let ((?x38 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x48 (fp.sub roundNearestTiesToEven ?x38 ?x15)))
(let (($x96 (and (and (not (fp.isNaN ?x48)) (not (fp.isNaN ?x41))) (not (fp.lt ?x48 ?x41)))))
(not $x96)))))))
(check-sat)
(exit)
