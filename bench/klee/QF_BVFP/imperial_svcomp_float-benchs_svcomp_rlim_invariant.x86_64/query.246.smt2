...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.246.smt2
|)
...
(assert
 ...
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x62 ?x26)))
 (not (fp.isNaN ?x63))))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x32 ?x27)))
 (not (fp.isNaN ?x66))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x46 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x81 (fp.sub roundNearestTiesToEven ?x32 ?x46)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x79 (fp.sub roundNearestTiesToEven ?x43 ?x15)))
(not (or (or (fp.isNaN ?x79) (fp.isNaN ?x81)) (fp.gt ?x79 ?x81))))))))))
(check-sat)
(exit)
