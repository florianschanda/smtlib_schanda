...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.384.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x62 (fp.add roundNearestTiesToEven ?x42 ?x61)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x62 ?x63))))
...
(assert
 ...
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x85 ?x42)))
...
(assert
 ...
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x97 ?x62)))
 (not (fp.isNaN ?x98))))))))
(assert
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x29 ?x63)))
 (not (fp.isNaN ?x101))))))
(assert
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
