...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.082.smt2
|)
...
(assert
 ...
 (fp.leq ?x56 ?x18))))
(assert
 (let (($x80 (and (fp.geq ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3) ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3) ((_ to_fp 8 24) (_ bv1124139008 32))))))
(not $x80)))
(check-sat)
(exit)
