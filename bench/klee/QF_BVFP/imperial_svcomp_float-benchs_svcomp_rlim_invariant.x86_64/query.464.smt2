...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.464.smt2
|)
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x83 (fp.sub roundNearestTiesToEven ?x29 ?x82)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x24 ?x42)))
...
(assert
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x29 ?x75)))
(let ((?x59 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
(let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
(let ((?x72 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x101 (fp.sub roundNearestTiesToEven ?x72 (fp.sub roundNearestTiesToEven ?x63 ?x59))))
