...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.627.smt2
|)
...
(assert
 (let ((?x41 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x62 (fp.add roundNearestTiesToEven ?x17 ?x41)))
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
...
(assert
 ...
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x62 (fp.add roundNearestTiesToEven ?x17 ?x41)))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x62 ?x58)))
...
(assert
 ...
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x62 ?x58)))
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x77 ?x71))))
...
(let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x77 ?x71))))
(let (($x115 (and (and (not (fp.isNaN ?x94)) (not (fp.isNaN ?x90))) (not (fp.lt ?x94 ?x90)))))
(not $x115))))))))))))
(check-sat)
(exit)
