...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.085.smt2
|)
...
(assert
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x68 (fp.sub roundNearestTiesToEven ?x26 ?x57)))
(let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
(let ((?x54 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x65 (fp.sub roundNearestTiesToEven ?x54 (fp.add roundNearestTiesToEven ?x13 ?x37))))
(let (($x74 (and (and (not (fp.isNaN ?x65)) (not (fp.isNaN ?x68))) (not (fp.gt ?x65 ?x68)))))
(not $x74))))))))))
(check-sat)
(exit)
