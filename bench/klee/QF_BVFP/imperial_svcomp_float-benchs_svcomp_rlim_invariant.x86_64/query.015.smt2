...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.015.smt2
|)
...
(assert
 (let ((?x11 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!2)))
 (let ((?x13 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x37 (fp.add roundNearestTiesToEven ?x13 ?x11)))
 (let ((?x36 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x38 (fp.sub roundNearestTiesToEven ?x36 ?x37)))
 (not (fp.isNaN ?x38))))))))
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x41 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x33)))
 (not (fp.isNaN ?x41)))))
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x41 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x33)))
...
(assert
 (let ((?x36 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (fp.geq ?x36 ((_ to_fp 8 24) (_ bv3271557120 32)))))
(assert
 (let ((?x36 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (fp.leq ?x36 ((_ to_fp 8 24) (_ bv1124073472 32)))))
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x11 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!2)))
(let ((?x13 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x37 (fp.add roundNearestTiesToEven ?x13 ?x11)))
(let ((?x54 (fp.sub roundNearestTiesToEven ?x37 ?x33)))
