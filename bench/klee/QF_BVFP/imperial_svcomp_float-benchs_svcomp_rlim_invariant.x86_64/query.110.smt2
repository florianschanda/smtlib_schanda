...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.110.smt2
|)
...
(let ((?x55 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x62 (fp.sub roundNearestTiesToEven ?x55 (fp.sub roundNearestTiesToEven ?x15 ?x41))))
(not (or (or (fp.isNaN ?x62) (fp.isNaN ?x58)) (fp.lt ?x62 ?x58)))))))))
(check-sat)
(exit)
