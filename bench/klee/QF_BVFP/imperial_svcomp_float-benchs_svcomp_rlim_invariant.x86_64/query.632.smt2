...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.632.smt2
|)
...
(assert
 ...
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x90 (fp.add roundNearestTiesToEven ?x77 ?x71))))
 (not (fp.isNaN ?x92)))))))))))
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
