...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.089.smt2
|)
...
(assert
 (let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x58 (fp.add roundNearestTiesToEven ?x13 ?x37)))
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x57 ?x58)))
 (not (fp.isNaN ?x59))))))))
(assert
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x26 ?x54)))
 (not (fp.isNaN ?x62))))))
(assert
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
(let ((?x58 (fp.add roundNearestTiesToEven ?x13 ?x37)))
(let ((?x73 (fp.sub roundNearestTiesToEven ?x58 ?x54)))
