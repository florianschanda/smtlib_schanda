...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.221.smt2
|)
...
(assert
 ...
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x60 (fp.add roundNearestTiesToEven ?x15 ?x39)))
 (let ((?x75 (fp.sub roundNearestTiesToEven ?x60 ?x56)))
