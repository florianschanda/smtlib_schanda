...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.709.smt2
|)
...
(assert
 ...
 (let ((?x83 (fp.sub roundNearestTiesToEven ?x81 (fp.sub roundNearestTiesToEven ?x67 ?x63))))
