...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.052.smt2
|)
...
(assert
 ...
 (let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x34 (fp.sub roundNearestTiesToEven ?x15 ?x13)))
 (let ((?x47 (fp.sub roundNearestTiesToEven ?x34 ?x30)))
 (let ((?x46 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
 (let ((?x48 (fp.sub roundNearestTiesToEven ?x46 ?x47)))
 (not (fp.isNaN ?x48))))))))))
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x34 (fp.sub roundNearestTiesToEven ?x15 ?x13)))
(let ((?x47 (fp.sub roundNearestTiesToEven ?x34 ?x30)))
(let ((?x68 (fp.sub roundNearestTiesToEven ?x47 ?x43)))
(not (and (fp.geq ?x68 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x68 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))
(check-sat)
(exit)
