...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.507.smt2
|)
...
(assert
 ...
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x88 ?x24)))
 (not (fp.isNaN ?x89))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x31 ?x25)))
 (not (fp.isNaN ?x92))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x58 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x65 (fp.sub roundNearestTiesToEven ?x58 (fp.sub roundNearestTiesToEven ?x17 ?x42))))
(let (($x111 (and (and (not (fp.isNaN ?x65)) (not (fp.isNaN ?x61))) (not (fp.lt ?x65 ?x61)))))
(not $x111))))))))
(check-sat)
(exit)
