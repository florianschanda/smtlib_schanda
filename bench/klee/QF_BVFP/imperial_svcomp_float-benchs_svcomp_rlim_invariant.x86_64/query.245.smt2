...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.245.smt2
|)
...
(assert
 ...
 (let ((?x40 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x22 (fp.add roundNearestTiesToEven ?x40 ?x59))))
...
(assert
 ...
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x81 ?x40)))
...
(assert
 (let ((?x38 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x95 (fp.add roundNearestTiesToEven ?x15 ?x38)))
