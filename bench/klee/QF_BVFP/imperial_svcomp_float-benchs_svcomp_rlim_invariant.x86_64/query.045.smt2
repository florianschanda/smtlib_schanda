...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.045.smt2
|)
...
(assert
 ...
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 (fp.add roundNearestTiesToEven ?x21 ?x22)))
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x59 ?x24)))
 (not (fp.isNaN ?x60))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x30 ?x25)))
 (not (fp.isNaN ?x63))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
