...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.658.smt2
|)
...
(assert
 ...
 (let ((?x64 (fp.add roundNearestTiesToEven ?x17 ?x41)))
 (let ((?x78 (fp.add roundNearestTiesToEven ?x64 ?x58)))
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x78 ?x74)))
...
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x30 ?x87)))
 (not (fp.isNaN ?x95))))))
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x78 (fp.add roundNearestTiesToEven ?x64 ?x58)))
(let ((?x91 (fp.sub roundNearestTiesToEven ?x78 ?x74)))
(let ((?x110 (fp.sub roundNearestTiesToEven ?x91 ?x87)))
