...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.135.smt2
|)
...
(assert
 ...
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x79 ?x23)))
 (not (fp.gt ?x80 ?x76)))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x64 (fp.add roundNearestTiesToEven ?x15 ?x41)))
(let ((?x93 (fp.add roundNearestTiesToEven ?x64 ?x58)))
