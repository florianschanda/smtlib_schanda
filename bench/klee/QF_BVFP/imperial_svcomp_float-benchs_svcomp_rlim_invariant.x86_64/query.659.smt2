...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.659.smt2
|)
...
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x35 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x35 ?x28)))
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x27 (fp.add roundNearestTiesToEven ?x24 ?x25)))
...
(assert
 ...
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x94 ?x29)))
 (not (fp.isNaN ?x95))))))))))
(assert
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x35 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x35 ?x30)))
 (not (fp.isNaN ?x98))))))
(assert
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x35 ((_ to_fp 8 24) (_ bv2147483648 32))))
