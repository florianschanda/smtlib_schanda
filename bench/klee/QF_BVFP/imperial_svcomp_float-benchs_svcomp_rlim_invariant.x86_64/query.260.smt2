...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.260.smt2
|)
...
(assert
 ...
 (fp.leq ?x22 ?x20))))
(assert
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x27 ?x67)))
 (let ((?x40 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x22 ?x40)))
...
(assert
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x87 (fp.sub roundNearestTiesToEven ?x27 ?x60)))
(let ((?x38 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x57 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x57 (fp.add roundNearestTiesToEven ?x15 ?x38))))
