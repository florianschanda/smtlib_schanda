...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.620.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x72 ?x24)))
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x27 (fp.add roundNearestTiesToEven ?x24 ?x25)))
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x84 ?x27)))
 (not (fp.isNaN ?x85))))))))
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x33 ?x28)))
 (not (fp.isNaN ?x88))))))
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x103 (fp.sub roundNearestTiesToEven ?x33 ?x47)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x44 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
