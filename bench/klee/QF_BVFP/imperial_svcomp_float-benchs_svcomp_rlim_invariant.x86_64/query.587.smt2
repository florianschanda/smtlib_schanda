...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.587.smt2
|)
...
(assert
 ...
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x29 ?x83)))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x63 ?x80)))
...
(assert
 ...
 (fp.leq ?x80 ?x22))))
(assert
 (let ((?x99 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x29 ?x99)))
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x80 ?x56)))
 (or (or (fp.isNaN ?x97) (fp.isNaN ?x100)) (fp.gt ?x97 ?x100)))))))))
(assert
 (let ((?x99 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x80 ?x56)))
 (or (or (fp.isNaN ?x97) (fp.isNaN ?x99)) (fp.lt ?x97 ?x99)))))))
(assert
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x83 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x83 ?x56))))
