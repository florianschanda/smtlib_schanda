...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.466.smt2
|)
...
(assert
 (let ((?x19 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (fp.geq ?x72 ?x19))))
(assert
 (let ((?x22 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
...
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (fp.geq ?x75 ?x42))))
(assert
 (let ((?x45 ((_ to_fp 8 24) (_ bv1098907648 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
...
(assert
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x29 ?x75)))
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x72 (fp.sub roundNearestTiesToEven ?x63 ?x59))))
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x90 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x29 ?x90)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x24 ?x42)))
 (or (or (fp.isNaN ?x88) (fp.isNaN ?x91)) (fp.gt ?x88 ?x91)))))))))
(assert
 (let ((?x90 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x24 ?x42)))
 (or (or (fp.isNaN ?x88) (fp.isNaN ?x90)) (fp.lt ?x88 ?x90)))))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x30 ?x42))))
