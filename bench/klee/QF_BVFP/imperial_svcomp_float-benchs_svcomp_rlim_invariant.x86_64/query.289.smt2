...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.289.smt2
|)
...
(assert
 (let ((?x71 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x23 ?x71)))
(let ((?x48 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x32 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x54 (fp.add roundNearestTiesToEven ?x38 ?x32)))
(let ((?x64 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x64 (fp.add roundNearestTiesToEven ?x54 ?x48))))
