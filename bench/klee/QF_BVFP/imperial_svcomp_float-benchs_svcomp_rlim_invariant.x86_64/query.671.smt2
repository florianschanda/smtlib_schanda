...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.671.smt2
|)
...
(let ((?x56 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x63 (fp.sub roundNearestTiesToEven ?x56 (fp.sub roundNearestTiesToEven ?x17 ?x40))))
(not (or (or (fp.isNaN ?x63) (fp.isNaN ?x59)) (fp.lt ?x63 ?x59)))))))))
(check-sat)
(exit)
