...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.482.smt2
|)
...
(assert
 ...
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x17 ?x41)))
 (let ((?x72 (fp.sub roundNearestTiesToEven ?x59 ?x55)))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x72 ?x68)))
...
(assert
 (let ((?x81 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x30 ?x81)))
 (not (fp.isNaN ?x89))))))
(assert
 (let ((?x81 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x72 (fp.sub roundNearestTiesToEven ?x59 ?x55)))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x72 ?x68)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x85 ?x81)))
