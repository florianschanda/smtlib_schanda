...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.256.smt2
|)
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x31 ?x26)))
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x25 (fp.add roundNearestTiesToEven ?x22 ?x23)))
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
