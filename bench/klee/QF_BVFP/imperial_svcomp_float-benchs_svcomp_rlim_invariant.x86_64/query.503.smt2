...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.503.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x42 (fp.sub roundNearestTiesToEven ?x63 ?x64))))
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x96 ?x63)))
 (not (fp.isNaN ?x97))))))
(assert
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x29 ?x64)))
 (not (fp.isNaN ?x100))))))
(assert
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
