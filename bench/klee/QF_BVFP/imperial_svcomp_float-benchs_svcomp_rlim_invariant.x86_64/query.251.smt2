...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.251.smt2
|)
...
(assert
 ...
 (let ((?x43 (fp.sub roundNearestTiesToEven ?x41 ?x42)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
...
(assert
 ...
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x27 ?x42)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x67 ?x41)))
 (not (fp.gt ?x68 ?x64)))))))))
(assert
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 ...
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x73 ?x43)))
 (not (fp.isNaN ?x74))))))))
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x27 ?x44)))
 (not (fp.isNaN ?x77))))))
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (fp.leq ?x73 ?x20))))
(assert
 (let (($x96 (and (fp.geq ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1) ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1) ((_ to_fp 8 24) (_ bv1124139008 32))))))
(not $x96)))
(check-sat)
(exit)
