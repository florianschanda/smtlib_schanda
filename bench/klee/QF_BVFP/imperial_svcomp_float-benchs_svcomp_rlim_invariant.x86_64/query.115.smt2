...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.115.smt2
|)
...
(assert
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x23 ?x73)))
(let ((?x50 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x56 (fp.sub roundNearestTiesToEven ?x41 ?x37)))
(let ((?x66 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x66 (fp.add roundNearestTiesToEven ?x56 ?x50))))
(not (or (or (fp.isNaN ?x83) (fp.isNaN ?x85)) (fp.gt ?x83 ?x85)))))))))))))))
(check-sat)
(exit)
