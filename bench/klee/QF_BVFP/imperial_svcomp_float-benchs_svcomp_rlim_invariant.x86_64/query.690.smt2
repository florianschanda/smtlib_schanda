...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.690.smt2
|)
...
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x36 ?x31)))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.add roundNearestTiesToEven ?x25 ?x26)))
...
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x108 (fp.sub roundNearestTiesToEven ?x36 ?x50)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x105 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
(let (($x114 (and (and (not (fp.isNaN ?x105)) (not (fp.isNaN ?x108))) (not (fp.gt ?x105 ?x108)))))
(not $x114)))))))))
(check-sat)
(exit)
