...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.546.smt2
|)
...
(assert
 ...
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x74 ?x68))))
 (not (fp.isNaN ?x89)))))))))))))
(assert
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
