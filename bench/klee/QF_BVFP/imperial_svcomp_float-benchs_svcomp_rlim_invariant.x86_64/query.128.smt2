...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.128.smt2
|)
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x64 ?x23)))
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 (fp.add roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x76 ?x26)))
 (not (fp.isNaN ?x77))))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x32 ?x27)))
 (not (fp.isNaN ?x80))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x93 (fp.add roundNearestTiesToEven ?x15 ?x43)))
