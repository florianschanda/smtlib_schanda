...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.038.smt2
|)
...
(assert
 ...
 (let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x41 (fp.add roundNearestTiesToEven ?x15 ?x13)))
 (let ((?x55 (fp.add roundNearestTiesToEven ?x41 ?x35)))
...
(assert
 (let ((?x51 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x21 ?x51)))
 (not (fp.isNaN ?x59))))))
(assert
 (let ((?x51 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x41 (fp.add roundNearestTiesToEven ?x15 ?x13)))
(let ((?x55 (fp.add roundNearestTiesToEven ?x41 ?x35)))
(let ((?x74 (fp.sub roundNearestTiesToEven ?x55 ?x51)))
