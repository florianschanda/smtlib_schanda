...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.427.smt2
|)
...
(assert
 ...
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x17 ?x43)))
 (let ((?x77 (fp.add roundNearestTiesToEven ?x63 ?x57)))
