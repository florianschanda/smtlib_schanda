...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.058.smt2
|)
...
(assert
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x70 (fp.sub roundNearestTiesToEven ?x13 ?x39)))
