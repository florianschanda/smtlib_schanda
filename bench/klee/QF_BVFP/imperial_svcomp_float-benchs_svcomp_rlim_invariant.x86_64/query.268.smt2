...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.268.smt2
|)
...
(assert
 ...
 (let ((?x52 (fp.add roundNearestTiesToEven ?x38 ?x32)))
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x72 (fp.sub roundNearestTiesToEven ?x61 (fp.sub roundNearestTiesToEven ?x52 ?x48))))
