...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.526.smt2
|)
...
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x33 ?x25)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x68 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
...
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x33 ?x28)))
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x27 (fp.add roundNearestTiesToEven ?x24 ?x25)))
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
 (let ((?x83 (fp.sub roundNearestTiesToEven ?x82 ?x27)))
...
(assert
 (let ((?x48 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x33 ?x48)))
 (let ((?x47 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x98 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x99 (fp.sub roundNearestTiesToEven ?x98 ?x47)))
...
(assert
 ...
 (fp.leq ?x98 ?x22))))
(assert
 (let (($x122 (and (fp.geq ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9) ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9) ((_ to_fp 8 24) (_ bv1124139008 32))))))
(not $x122)))
(check-sat)
(exit)
