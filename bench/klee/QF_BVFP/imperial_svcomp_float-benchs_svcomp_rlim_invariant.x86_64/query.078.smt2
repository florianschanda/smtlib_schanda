...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.078.smt2
|)
...
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x65 (fp.sub roundNearestTiesToEven ?x21 ?x53)))
(let ((?x30 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
(let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x36 (fp.sub roundNearestTiesToEven ?x15 ?x13)))
(let ((?x46 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x63 (fp.sub roundNearestTiesToEven ?x46 (fp.add roundNearestTiesToEven ?x36 ?x30))))
(not (or (or (fp.isNaN ?x63) (fp.isNaN ?x65)) (fp.gt ?x63 ?x65)))))))))))))
(check-sat)
(exit)
