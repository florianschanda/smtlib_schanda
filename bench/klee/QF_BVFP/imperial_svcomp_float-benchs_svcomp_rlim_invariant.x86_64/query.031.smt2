...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.031.smt2
|)
...
(assert
 ...
 (let ((?x33 (fp.sub roundNearestTiesToEven ?x31 (fp.sub roundNearestTiesToEven ?x13 ?x11))))
 (not (fp.isNaN ?x33)))))))
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
