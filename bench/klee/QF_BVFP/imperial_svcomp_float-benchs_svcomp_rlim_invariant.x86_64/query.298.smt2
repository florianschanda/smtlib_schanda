...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.298.smt2
|)
...
(assert
 ...
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x66 ?x28)))
 (not (fp.isNaN ?x67))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x70 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (not (fp.isNaN ?x70))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x77 ?x30)))
 (not (fp.isNaN ?x78))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x36 ?x31)))
 (not (fp.isNaN ?x81))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x98 (fp.sub roundNearestTiesToEven ?x36 ?x50)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x96 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
(not (or (or (fp.isNaN ?x96) (fp.isNaN ?x98)) (fp.gt ?x96 ?x98))))))))))
(check-sat)
(exit)
