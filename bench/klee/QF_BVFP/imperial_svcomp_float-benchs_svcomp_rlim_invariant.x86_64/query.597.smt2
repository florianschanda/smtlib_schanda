...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.597.smt2
|)
...
(assert
 ...
 (let ((?x74 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x42 ?x74))))
...
(assert
 (let ((?x74 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x29 ?x74)))
 (not (fp.isNaN ?x96))))))
(assert
 (let ((?x74 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x99 ?x42)))
 (not (fp.gt ?x100 ?x96)))))))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
(let ((?x109 (fp.sub roundNearestTiesToEven ?x63 ?x59)))
