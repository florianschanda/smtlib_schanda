...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.357.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x58 (fp.sub roundNearestTiesToEven ?x42 ?x77))))
...
(assert
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x108 (fp.sub roundNearestTiesToEven ?x17 ?x40)))
