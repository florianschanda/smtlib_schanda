...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.263.smt2
|)
...
(let ((?x57 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x64 (fp.sub roundNearestTiesToEven ?x57 (fp.add roundNearestTiesToEven ?x15 ?x38))))
(not (or (or (fp.isNaN ?x64) (fp.isNaN ?x60)) (fp.lt ?x64 ?x60)))))))))
(check-sat)
(exit)
