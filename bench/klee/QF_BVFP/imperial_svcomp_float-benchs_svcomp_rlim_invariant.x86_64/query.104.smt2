...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.104.smt2
|)
...
(assert
 ...
 (let ((?x36 (fp.sub roundNearestTiesToEven ?x17 ?x15)))
 (let ((?x49 (fp.sub roundNearestTiesToEven ?x36 ?x32)))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x49 ?x45)))
...
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x23 ?x58)))
 (not (fp.isNaN ?x66))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (not (fp.gt ?x63 ?x66)))))))))))))))
(assert
 (let ((?x72 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (fp.geq ?x28 ?x72))))
(assert
 (let ((?x75 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (fp.leq ?x28 ?x75))))
(assert
 (let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x49 (fp.sub roundNearestTiesToEven ?x36 ?x32)))
(let ((?x62 (fp.sub roundNearestTiesToEven ?x49 ?x45)))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x62 ?x58)))
