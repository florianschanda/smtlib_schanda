...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.280.smt2
|)
...
(assert
 ...
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x59 (fp.sub roundNearestTiesToEven ?x15 ?x38))))
