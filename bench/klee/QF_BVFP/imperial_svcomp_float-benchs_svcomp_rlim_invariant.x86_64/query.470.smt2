...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.470.smt2
|)
...
(assert
 ...
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x63 ?x59)))
...
(let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
(let ((?x78 (fp.sub roundNearestTiesToEven ?x63 ?x59)))
(let ((?x112 (fp.add roundNearestTiesToEven ?x78 ?x72)))
