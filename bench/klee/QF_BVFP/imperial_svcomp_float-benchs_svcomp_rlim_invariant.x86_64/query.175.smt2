...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.175.smt2
|)
...
(assert
 ...
 (let ((?x25 (fp.sub roundNearestTiesToEven ?x22 ?x23)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x15 (fp.add roundNearestTiesToEven ?x25 ?x26))))
...
(assert
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x62 ?x22)))
 (not (fp.isNaN ?x63))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x31 ?x23)))
 (not (fp.isNaN ?x66))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x31 ?x26)))
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x25 (fp.sub roundNearestTiesToEven ?x22 ?x23)))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x75 ?x25)))
