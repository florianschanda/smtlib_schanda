...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.328.smt2
|)
...
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x55 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
(let (($x112 (and (and (not (fp.isNaN ?x55)) (not (fp.isNaN ?x50))) (not (fp.lt ?x55 ?x50)))))
(not $x112)))))))
(check-sat)
(exit)
