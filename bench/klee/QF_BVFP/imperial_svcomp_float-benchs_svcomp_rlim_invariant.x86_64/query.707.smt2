...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.707.smt2
|)
...
(assert
 ...
 (let ((?x53 (fp.sub roundNearestTiesToEven ?x38 ?x34)))
 (let ((?x67 (fp.add roundNearestTiesToEven ?x53 ?x47)))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x67 ?x63)))
...
(assert
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x25 ?x76)))
 (not (fp.isNaN ?x84))))))
(assert
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x67 (fp.add roundNearestTiesToEven ?x53 ?x47)))
(let ((?x80 (fp.sub roundNearestTiesToEven ?x67 ?x63)))
(let ((?x105 (fp.sub roundNearestTiesToEven ?x80 ?x76)))
