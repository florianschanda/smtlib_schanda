...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.108.smt2
|)
...
(assert
 ...
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x66 ?x23)))
 (not (fp.gt ?x67 ?x63)))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x82 (fp.sub roundNearestTiesToEven ?x30 ?x58)))
(let ((?x41 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x55 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x79 (fp.sub roundNearestTiesToEven ?x55 (fp.sub roundNearestTiesToEven ?x15 ?x41))))
