...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.261.smt2
|)
...
(assert
 (let ((?x38 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x61 (fp.add roundNearestTiesToEven ?x15 ?x38)))
...
(assert
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x27 ?x57)))
 (not (fp.isNaN ?x65))))))
(assert
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x61 (fp.add roundNearestTiesToEven ?x15 ?x38)))
(let ((?x92 (fp.sub roundNearestTiesToEven ?x61 ?x57)))
