...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.014.smt2
|)
...
(let ((?x33 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x44 (fp.sub roundNearestTiesToEven ?x33 (fp.add roundNearestTiesToEven ?x13 ?x11))))
(not (or (or (fp.isNaN ?x44) (fp.isNaN ?x40)) (fp.lt ?x44 ?x40)))))))))
(check-sat)
(exit)
