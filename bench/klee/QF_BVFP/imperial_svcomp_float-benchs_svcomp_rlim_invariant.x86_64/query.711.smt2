...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.711.smt2
|)
...
(let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
(let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x77 ?x71))))
