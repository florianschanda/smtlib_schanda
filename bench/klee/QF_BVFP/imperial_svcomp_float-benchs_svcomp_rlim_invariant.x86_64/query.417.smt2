...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.417.smt2
|)
...
(assert
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x30 ?x84)))
 (not (fp.isNaN ?x92))))))
(assert
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x74 (fp.sub roundNearestTiesToEven ?x59 ?x55)))
(let ((?x88 (fp.add roundNearestTiesToEven ?x74 ?x68)))
(let ((?x107 (fp.sub roundNearestTiesToEven ?x88 ?x84)))
