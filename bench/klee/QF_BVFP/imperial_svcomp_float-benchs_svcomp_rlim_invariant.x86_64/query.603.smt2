...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.603.smt2
|)
...
(assert
 ...
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x89 (fp.sub roundNearestTiesToEven ?x75 ?x71))))
