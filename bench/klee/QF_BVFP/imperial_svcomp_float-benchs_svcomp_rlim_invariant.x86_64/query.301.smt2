...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.301.smt2
|)
...
(assert
 ...
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x72 ?x28)))
 (not (fp.isNaN ?x73))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (not (fp.isNaN ?x76))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x87 (fp.sub roundNearestTiesToEven ?x36 ?x31)))
 (not (fp.isNaN ?x87))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x17 ?x47)))
(not (and (fp.geq ?x104 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x104 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))
(check-sat)
(exit)
