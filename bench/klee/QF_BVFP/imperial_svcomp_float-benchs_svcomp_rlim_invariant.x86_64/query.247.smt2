...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.247.smt2
|)
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 (fp.sub roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x70 (fp.sub roundNearestTiesToEven ?x69 ?x26)))
 (not (fp.isNaN ?x70))))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x51 (fp.sub roundNearestTiesToEven ?x43 ?x15)))
(let (($x92 (and (and (not (fp.isNaN ?x51)) (not (fp.isNaN ?x46))) (not (fp.lt ?x51 ?x46)))))
(not $x92)))))))
(check-sat)
(exit)
