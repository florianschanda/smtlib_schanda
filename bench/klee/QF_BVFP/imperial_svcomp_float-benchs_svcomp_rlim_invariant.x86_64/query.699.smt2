...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.699.smt2
|)
...
(assert
 ...
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x30 (fp.sub roundNearestTiesToEven ?x28 ?x29)))
 (let ((?x86 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x87 (fp.sub roundNearestTiesToEven ?x86 ?x30)))
