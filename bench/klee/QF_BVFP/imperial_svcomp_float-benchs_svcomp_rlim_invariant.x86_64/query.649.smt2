...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.649.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x24 (fp.add roundNearestTiesToEven ?x58 ?x59))))
...
(assert
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x29 ?x59)))
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x95 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x95 ?x58)))
