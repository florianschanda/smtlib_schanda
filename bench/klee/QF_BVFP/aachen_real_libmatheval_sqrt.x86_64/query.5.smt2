...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_libmatheval_sqrt.x86_64/query.5.smt2
|)
...
(assert
 (let ((?x13 ((_ to_fp 11 53) y_ackermann!1)))
(let ((?x9 ((_ to_fp 11 53) x_ackermann!0)))
(let ((?x32 (fp.sqrt roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x9 ?x13))))
(not (fp.isNaN ?x32))))))
(check-sat)
(exit)
