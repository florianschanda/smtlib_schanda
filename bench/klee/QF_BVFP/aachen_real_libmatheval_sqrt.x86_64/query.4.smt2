...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_libmatheval_sqrt.x86_64/query.4.smt2
|)
...
(assert
 ...
 (not (= (_ bv0 32) ?x26))))
(assert
 (not (not (fp.eq ((_ to_fp 11 53) x_ackermann!0) ((_ to_fp 11 53) y_ackermann!1)))))
(check-sat)
(exit)
