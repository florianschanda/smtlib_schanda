...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.133.smt2
|)
...
(assert
 (not (fp.gt ((_ to_fp 8 24) (_ bv796917760 32)) ((_ to_fp 8 24) symbolic_0_float_ackermann!0))))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x120 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv805306368 32))) ((_ to_fp 8 24) (_ bv939524096 32)))))
(let (($x122 (not (fp.isNaN ?x120))))
(let (($x133 (and (and $x122 (not (fp.lt ?x120 ((_ to_fp 8 24) (_ bv0 32))))) (and $x122 (not (fp.gt ?x120 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x133))))))
(check-sat)
(exit)
