...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.018.smt2
|)
...
(assert
 (not (not (fp.gt ((_ to_fp 8 24) (_ bv1107296256 32)) ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))))
(check-sat)
(exit)
