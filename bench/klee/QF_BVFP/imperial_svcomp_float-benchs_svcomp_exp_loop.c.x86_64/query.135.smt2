...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.135.smt2
|)
...
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
 (fp.gt ((_ to_fp 8 24) (_ bv1325400064 32)) ?x8)))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x147 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv1325400064 32))) ((_ to_fp 8 24) (_ bv1191182336 32)))))
(let (($x149 (not (fp.isNaN ?x147))))
(let (($x160 (and (and $x149 (not (fp.lt ?x147 ((_ to_fp 8 24) (_ bv0 32))))) (and $x149 (not (fp.gt ?x147 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x160))))))
(check-sat)
(exit)
