...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.138.smt2
|)
...
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
 (fp.gt ((_ to_fp 8 24) (_ bv1342177280 32)) ?x8)))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x155 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv1342177280 32))) ((_ to_fp 8 24) (_ bv1199570944 32)))))
(let (($x157 (not (fp.isNaN ?x155))))
(let (($x168 (and (and $x157 (not (fp.lt ?x155 ((_ to_fp 8 24) (_ bv0 32))))) (and $x157 (not (fp.gt ?x155 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x168))))))
(check-sat)
(exit)
