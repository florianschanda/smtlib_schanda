...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.139.smt2
|)
...
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x158 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv1350565888 32))) ((_ to_fp 8 24) (_ bv1207959552 32)))))
(let (($x160 (not (fp.isNaN ?x158))))
(let (($x171 (and (and $x160 (not (fp.lt ?x158 ((_ to_fp 8 24) (_ bv0 32))))) (and $x160 (not (fp.gt ?x158 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x171))))))
(check-sat)
(exit)
