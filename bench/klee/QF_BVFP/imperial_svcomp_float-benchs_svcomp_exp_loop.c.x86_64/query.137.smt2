...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.137.smt2
|)
...
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x122 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv788529152 32))) ((_ to_fp 8 24) (_ bv931135488 32)))))
(let (($x124 (not (fp.isNaN ?x122))))
(let (($x135 (and (and $x124 (not (fp.lt ?x122 ((_ to_fp 8 24) (_ bv0 32))))) (and $x124 (not (fp.gt ?x122 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x135))))))
(check-sat)
(exit)
