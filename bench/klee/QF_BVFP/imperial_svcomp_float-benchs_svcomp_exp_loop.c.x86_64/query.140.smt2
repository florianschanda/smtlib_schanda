...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.140.smt2
|)
...
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
 (fp.gt ((_ to_fp 8 24) (_ bv1333788672 32)) ?x8)))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x151 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv1333788672 32))) ((_ to_fp 8 24) (_ bv1199570944 32)))))
(let (($x153 (not (fp.isNaN ?x151))))
(let (($x164 (and (and $x153 (not (fp.lt ?x151 ((_ to_fp 8 24) (_ bv0 32))))) (and $x153 (not (fp.gt ?x151 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x164))))))
(check-sat)
(exit)
