...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_longdouble.x86_64/query.11.smt2
|)
...
(let ((?x14 (concat (concat ((_ extract 79 79) ld_ackermann!0) ((_ extract 78 64) ld_ackermann!0)) ((_ extract 62 0) ld_ackermann!0))))
(let ((?x15 ((_ to_fp 15 64) ?x14)))
(let ((?x65 (fp.add roundNearestTiesToEven (fp.abs ?x15) ?x56)))
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x65 ?x65)))))))))
(check-sat)
(exit)
