...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_longdouble.x86_64/query.12.smt2
|)
...
(assert
 (let ((?x72 (concat (concat ((_ extract 79 79) (concat (_ bv65534 16) (_ bv18446744073709551615 64))) ((_ extract 78 64) (concat (_ bv65534 16) (_ bv18446744073709551615 64)))) ((_ extract 62 0) (concat (_ bv65534 16) (_ bv18446744073709551615 64))))))
 (let ((?x73 ((_ to_fp 15 64) ?x72)))
 (= ((_ extract 63 63) (concat (_ bv65534 16) (_ bv18446744073709551615 64))) (ite (or (fp.isSubnormal ?x73) (fp.isZero ?x73)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x72 (concat (concat ((_ extract 79 79) (concat (_ bv65534 16) (_ bv18446744073709551615 64))) ((_ extract 78 64) (concat (_ bv65534 16) (_ bv18446744073709551615 64)))) ((_ extract 62 0) (concat (_ bv65534 16) (_ bv18446744073709551615 64))))))
(let ((?x73 ((_ to_fp 15 64) ?x72)))
(let ((?x55 (concat (concat ((_ extract 79 79) (concat (_ bv16383 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16383 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16383 16) (_ bv9223372036854775808 64))))))
...
(let ((?x14 (concat (concat ((_ extract 79 79) ld_ackermann!0) ((_ extract 78 64) ld_ackermann!0)) ((_ extract 62 0) ld_ackermann!0))))
(let ((?x15 ((_ to_fp 15 64) ?x14)))
(let ((?x83 (fp.add roundNearestTiesToEven (fp.add roundNearestTiesToEven (fp.abs ?x15) ?x56) ?x73)))
(not (not (fp.isNaN ?x83)))))))))))
(check-sat)
(exit)
