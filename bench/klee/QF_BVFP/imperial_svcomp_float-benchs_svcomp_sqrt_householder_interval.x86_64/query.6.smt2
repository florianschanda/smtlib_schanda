...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sqrt_householder_interval.x86_64/query.6.smt2
|)
...
(let ((?x27 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x8 ((_ to_fp 11 53) (_ bv4613937818241073152 64))) ?x21)))
(let ((?x31 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x21 ?x27) ((_ to_fp 11 53) (_ bv13845191154443747328 64)))))
(let ((?x23 (fp.mul roundNearestTiesToEven ?x21 (fp.mul roundNearestTiesToEven ?x8 ?x21))))
(let ((?x35 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x23 ?x31) ((_ to_fp 11 53) (_ bv4624633867356078080 64)))))
(let ((?x39 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x21 ?x35) ((_ to_fp 11 53) (_ bv4593671619917905920 64)))))
(let ((?x47 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4517329193108106637 64)) (fp.add roundNearestTiesToEven ?x39 ?x39))))
(let ((?x43 (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x39 ?x21) ((_ to_fp 11 53) (_ bv4611686018427387904 64)))))
