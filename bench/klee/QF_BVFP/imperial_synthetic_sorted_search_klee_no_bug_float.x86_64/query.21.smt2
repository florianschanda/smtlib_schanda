...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_no_bug_float.x86_64/query.21.smt2
|)
...
(assert
 ...
 (let ((?x19 ((_ to_fp 8 24) data_ackermann!2)))
 (fp.eq ?x19 ?x26))))
(assert
...
(let (($x44 (fp.gt ?x13 ?x26)))
(not (not (= (ite $x44 (_ bv0 32) (_ bv2 32)) (ite $x44 (_ bv2 32) (_ bv5 32)))))))))
(check-sat)
(exit)
