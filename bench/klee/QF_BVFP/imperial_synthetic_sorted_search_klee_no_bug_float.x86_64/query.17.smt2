...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_no_bug_float.x86_64/query.17.smt2
|)
...
(assert
 ...
 (let ((?x25 ((_ to_fp 8 24) data_ackermann!4)))
 (fp.eq ?x25 ?x26))))
(assert
...
(let (($x40 (fp.gt ?x13 ?x26)))
(let ((?x48 ((_ sign_extend 32) (bvsdiv (bvadd (ite $x40 (_ bv0 32) (_ bv2 32)) (ite $x40 (_ bv2 32) (_ bv5 32))) (_ bv2 32)))))
(not (bvult (bvmul (_ bv4 64) ?x48) (_ bv17 64))))))))
(check-sat)
(exit)
