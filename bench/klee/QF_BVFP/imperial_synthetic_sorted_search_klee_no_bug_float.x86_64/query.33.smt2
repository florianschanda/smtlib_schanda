...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_no_bug_float.x86_64/query.33.smt2
|)
...
(not (not (= (ite $x47 (_ bv0 32) (_ bv2 32)) (ite $x47 (_ bv2 32) (_ bv5 32)))))))))
(check-sat)
(exit)
