...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_no_bug_float.x86_64/query.10.smt2
|)
...
(assert
 (not (fp.lt ((_ to_fp 8 24) data_ackermann!1) ((_ to_fp 8 24) data_ackermann!0))))
(assert
 (not (fp.lt ((_ to_fp 8 24) data_ackermann!2) ((_ to_fp 8 24) data_ackermann!1))))
(assert
