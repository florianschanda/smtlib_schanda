...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_full_sym_klee.x86_64/query.16.smt2
|)
...
(assert
 ...
 (fp.leq ?x28 ?x17))))
(assert
 (let ((?x46 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!1) ((_ to_fp 11 53) data_ackermann!0)) data_ackermann!1 data_ackermann!0)))
(let ((?x49 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!2) ((_ to_fp 11 53) ?x46)) data_ackermann!2 ?x46)))
(let ((?x52 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!3) ((_ to_fp 11 53) ?x49)) data_ackermann!3 ?x49)))
(let ((?x55 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!4) ((_ to_fp 11 53) ?x52)) data_ackermann!4 ?x52)))
...
(let (($x62 (and (and (not (fp.isNaN ((_ to_fp 11 53) ?x41))) (not (fp.isNaN ((_ to_fp 11 53) ?x55)))) (not (fp.lt ((_ to_fp 11 53) ?x41) ((_ to_fp 11 53) ?x55))))))
(not $x62)))))))))))
(check-sat)
(exit)
