...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.17.smt2
|)
...
(let (($x66 (fp.eq (ite $x59 (ite $x45 ?x37 ?x39) ?x53) ((_ to_fp 8 24) (ite $x59 fresh_to_ieee_bv_!3 ?x49)))))
(not (not $x66)))))))))))))))))))
(check-sat)
(exit)
