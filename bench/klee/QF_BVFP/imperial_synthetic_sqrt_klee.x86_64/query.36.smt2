...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.36.smt2
|)
...
(declare-fun fresh_to_ieee_bv_!7 () (_ BitVec 32))
(assert
...
(assert
 ...
 (let ((?x107 (ite $x101 ?x93 ?x95)))
 (let ((?x91 (ite $x87 fresh_to_ieee_bv_!5 ?x77)))
 (let ((?x105 (ite $x101 fresh_to_ieee_bv_!6 ?x91)))
 (let ((?x109 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x105) ?x107) ?x22)))
 (let ((?x110 (fp.mul roundNearestTiesToEven ?x109 ?x109)))
 (not (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x110 ?x8)) ?x28))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x22 ((_ to_fp 8 24) (_ bv1056964608 32))))
...
(assert
 ...
 (let ((?x105 (ite $x101 fresh_to_ieee_bv_!6 ?x91)))
 (let ((?x109 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x105) ?x107) ?x22)))
 (= ?x109 ((_ to_fp 8 24) fresh_to_ieee_bv_!7))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x8 ((_ to_fp 8 24) x_ackermann!0)))
(let ((?x22 ((_ to_fp 8 24) (_ bv1056964608 32))))
(let ((?x23 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv0 32))) ?x22)))
...
(let (($x101 (fp.gt ?x96 ?x8)))
(let ((?x105 (ite $x101 fresh_to_ieee_bv_!6 ?x91)))
(let ((?x109 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x105) (ite $x101 ?x93 ?x95)) ?x22)))
(let ((?x110 (fp.mul roundNearestTiesToEven ?x109 ?x109)))
(let (($x115 (fp.gt ?x110 ?x8)))
(let (($x122 (fp.eq (ite $x115 (ite $x101 ?x93 ?x95) ?x109) ((_ to_fp 8 24) (ite $x115 fresh_to_ieee_bv_!7 ?x105)))))
(not (not $x122)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
