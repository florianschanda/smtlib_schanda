...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.37.smt2
|)
...
(let ((?x106 ((_ to_fp 8 24) (ite $x101 fresh_to_ieee_bv_!6 (ite $x87 fresh_to_ieee_bv_!5 ?x77)))))
(let ((?x109 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x106 (ite $x101 ?x93 ?x95)) ?x22)))
(not (and (not (fp.isNaN ?x109)) (not (fp.gt ?x109 ?x8))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
