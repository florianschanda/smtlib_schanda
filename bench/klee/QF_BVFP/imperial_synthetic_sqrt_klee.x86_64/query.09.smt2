...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.09.smt2
|)
...
(assert
 ...
 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x24 ?x8)) ((_ to_fp 8 24) (_ bv869711765 32)))))))
(assert
...
(let ((?x24 (fp.mul roundNearestTiesToEven ?x23 ?x23)))
(let ((?x8 ((_ to_fp 8 24) x_ackermann!0)))
(let (($x32 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x8 ?x24)) ((_ to_fp 8 24) (_ bv869711765 32)))))
(not $x32))))))
(check-sat)
(exit)
