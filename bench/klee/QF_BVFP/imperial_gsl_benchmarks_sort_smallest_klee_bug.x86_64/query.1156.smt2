...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1156.smt2
|)
...
(assert
 (let ((?x33 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x34 (fp.isNaN ?x33)))
(let (($x47 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x34) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x33))))
(not (and (not $x34) $x47))))))
(check-sat)
(exit)
