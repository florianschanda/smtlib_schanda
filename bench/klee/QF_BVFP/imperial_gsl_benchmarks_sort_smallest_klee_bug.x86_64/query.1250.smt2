...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1250.smt2
|)
...
(assert
 ...
 (let (($x40 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x35) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x13))))
 (let (($x36 (not $x35)))
 (not (and $x36 $x40)))))))
(assert
