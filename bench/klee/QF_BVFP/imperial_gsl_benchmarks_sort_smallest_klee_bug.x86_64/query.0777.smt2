...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0777.smt2
|)
...
(assert
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x31 (fp.isNaN ?x30)))
(let (($x46 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x31) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x30))))
(not (and (not $x31) $x46))))))
(check-sat)
(exit)
