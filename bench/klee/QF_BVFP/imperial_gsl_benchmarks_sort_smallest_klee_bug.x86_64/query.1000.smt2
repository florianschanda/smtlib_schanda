...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1000.smt2
|)
...
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x31 (fp.isNaN ?x23)))
 (or (or $x31 (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (fp.lt ?x23 ((_ to_fp 11 53) x_ackermann!5))))))
(assert
