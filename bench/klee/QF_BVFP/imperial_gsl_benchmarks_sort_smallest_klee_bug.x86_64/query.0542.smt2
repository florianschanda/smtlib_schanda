...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0542.smt2
|)
...
(assert
 ...
 (let (($x34 (not $x33)))
 (not (and $x34 (or $x33 (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x13))))))))
(assert
