...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1944.smt2
|)
...
(assert
 (let ((?x31 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x32 (fp.isNaN ?x31)))
(not (not (and (not $x32) (or $x32 (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x31))))))))
(check-sat)
(exit)
