...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.2132.smt2
|)
...
(assert
 ...
 (let (($x49 (fp.isNaN ?x40)))
 (not $x49))))
(assert
 (let ((?x40 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x49 (fp.isNaN ?x40)))
 (or $x49 (fp.gt ((_ to_fp 11 53) x_ackermann!4) ?x40)))))
(assert
 (not false))
(check-sat)
(exit)
