...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0846.smt2
|)
...
(assert
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x38 (fp.isNaN ?x30)))
 (not $x38))))
(assert
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x38 (fp.isNaN ?x30)))
 (or $x38 (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x30)))))
(assert
