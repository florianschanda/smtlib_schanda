...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0790.smt2
|)
...
(assert
 ...
 (let (($x39 (fp.isNaN ?x30)))
 (not $x39))))
(assert
 (let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x39 (fp.isNaN ?x30)))
 (or $x39 (fp.gt ((_ to_fp 11 53) x_ackermann!4) ?x30)))))
(assert
