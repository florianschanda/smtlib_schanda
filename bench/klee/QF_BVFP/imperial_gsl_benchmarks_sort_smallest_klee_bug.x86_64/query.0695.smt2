...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0695.smt2
|)
...
(assert
 ...
 (let (($x37 (fp.isNaN ?x25)))
 (not $x37))))
(assert
 (let ((?x25 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x37 (fp.isNaN ?x25)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x37) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x25)))))
(assert
