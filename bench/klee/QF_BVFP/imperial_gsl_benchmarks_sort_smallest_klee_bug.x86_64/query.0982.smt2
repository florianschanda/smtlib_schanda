...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0982.smt2
|)
...
(assert
 ...
 (let (($x36 (fp.isNaN ?x13)))
 (let (($x41 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x36) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x13))))
 (let (($x37 (not $x36)))
 (not (and $x37 $x41)))))))
(assert
 (let ((?x17 ((_ to_fp 11 53) x_ackermann!2)))
