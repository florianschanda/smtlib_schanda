...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1436.smt2
|)
...
(assert
 (let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x38 (fp.isNaN ?x37)))
 (or $x38 (fp.lt ((_ to_fp 11 53) x_ackermann!3) ?x37)))))
(assert
