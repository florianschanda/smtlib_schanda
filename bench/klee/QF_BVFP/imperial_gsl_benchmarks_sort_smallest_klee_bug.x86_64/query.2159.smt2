...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.2159.smt2
|)
...
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
(let (($x50 (fp.isNaN ?x14)))
(not (not (and (not $x50) $x50))))))
(check-sat)
(exit)
