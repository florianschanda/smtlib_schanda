...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0515.smt2
|)
...
(assert
 (let (($x34 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!4)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)))))
 (or $x34 (fp.lt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!2)))))
(assert
...
(assert
 ...
 (fp.gt ?x31 ?x21))))
(assert
 (let (($x45 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))))))
(not (and $x45 (not (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))))
(check-sat)
(exit)
