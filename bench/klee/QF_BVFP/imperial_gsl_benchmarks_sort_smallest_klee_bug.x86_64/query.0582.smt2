...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0582.smt2
|)
...
(assert
 ...
 (fp.gt ?x20 ?x23))))
(assert
 (let (($x43 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))))))
(not (and $x43 (not (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))))
(check-sat)
(exit)
