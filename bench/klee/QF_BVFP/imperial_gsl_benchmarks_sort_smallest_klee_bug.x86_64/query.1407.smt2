...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1407.smt2
|)
...
(assert
 (let (($x38 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)))))
 (or $x38 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!2)))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
...
(assert
 (let ((?x28 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x42 (fp.isNaN ?x28)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x42) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x28)))))
(assert
 (not false))
(check-sat)
(exit)
