...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1404.smt2
|)
...
(assert
 (let ((?x31 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x44 (fp.isNaN ?x31)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x44) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x31)))))
(assert
 (not false))
(check-sat)
(exit)
