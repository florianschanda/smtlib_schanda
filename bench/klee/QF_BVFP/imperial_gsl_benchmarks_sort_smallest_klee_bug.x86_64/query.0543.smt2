...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0543.smt2
|)
...
(assert
 ...
 (fp.gt ?x20 ?x13))))
(assert
 (let (($x32 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!4)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)))))
 (or $x32 (fp.lt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!2)))))
(assert
...
(assert
 (let ((?x20 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x21 (fp.isNaN ?x20)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) $x21) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x20)))))
(assert
