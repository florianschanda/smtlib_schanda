...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1760.smt2
|)
...
(assert
 ...
 (fp.gt ?x21 ?x16))))
(assert
 (let (($x33 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!4)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)))))
 (or $x33 (fp.lt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!1)))))
(assert
...
(assert
 (let ((?x39 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x46 (fp.isNaN ?x39)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x46) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x39)))))
(assert
 (not false))
(check-sat)
(exit)
