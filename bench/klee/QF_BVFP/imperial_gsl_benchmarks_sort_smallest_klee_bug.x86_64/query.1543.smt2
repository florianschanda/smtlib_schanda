...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1543.smt2
|)
...
(assert
 (let ((?x24 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x25 (fp.isNaN ?x24)))
 (or $x25 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x24)))))
(assert
