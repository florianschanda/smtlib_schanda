...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_inf_nan_zeros_klee_long_double.x86_64/query.10.smt2
|)
...
(assert
 ...
 (let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
 (let ((?x14 ((_ to_fp 15 64) ?x13)))
 (let (($x47 (= (_ bv0 32) (ite (fp.isInfinite ?x14) (ite (fp.gt ?x14 ?x33) (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32)))))
 (not $x47)))))))
(assert
 (let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
 (let ((?x14 ((_ to_fp 15 64) ?x13)))
...
(let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
(let ((?x14 ((_ to_fp 15 64) ?x13)))
(let ((?x49 (fp.sqrt roundNearestTiesToEven ?x14)))
(let (($x54 (= (_ bv1 32) (ite (fp.isInfinite ?x49) (ite (fp.gt ?x49 ?x33) (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32)))))
(not $x54))))))))
(check-sat)
(exit)
