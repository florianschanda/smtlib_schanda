...
(declare-fun main_~y~6_const_259353146 () (_ FloatingPoint 8 24))
(assert (not (exists ((main_~x~6 (_ FloatingPoint 8 24))) (and (fp.leq main_~x~6 (fp.neg ((_ to_fp 8 24) RNE 0.00000000000000000001))) (fp.geq main_~x~6 (fp.neg ((_ to_fp 8 24) RNE 1.0))) (= (fp.mul RNE main_~x~6 main_~x~6) main_~y~6_const_259353146)))))
(assert (exists ((v_prenex_1 (_ FloatingPoint 8 24))) (and (fp.geq v_prenex_1 ((_ to_fp 8 24) RNE 0.00000000000000000001)) (= (fp.mul RNE v_prenex_1 v_prenex_1) main_~y~6_const_259353146) (fp.leq v_prenex_1 ((_ to_fp 8 24) RNE 1.0)))))
(check-sat)
(exit)
