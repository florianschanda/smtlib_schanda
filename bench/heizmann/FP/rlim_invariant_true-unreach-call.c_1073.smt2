...
(declare-fun main_~R~6_const_259455441 () (_ FloatingPoint 8 24))
(declare-fun main_~Y~6_const_259330586 () (_ FloatingPoint 8 24))
(declare-fun main_~D~6_const_259433799 () (_ FloatingPoint 8 24))
(assert (exists ((main_~X~6 (_ FloatingPoint 8 24))) (= main_~R~6_const_259455441 (fp.sub RNE main_~X~6 main_~S~6_const_259456400))))
(assert (fp.leq main_~D~6_const_259433799 ((_ to_fp 8 24) RNE 16.0)))
(assert (exists ((v_prenex_2 (_ FloatingPoint 8 24))) (and (fp.leq v_prenex_2 ((_ to_fp 8 24) RNE 16.0)) (fp.geq v_prenex_2 (_ +zero 8 24)) (= main_~S~6_const_259456400 (fp.sub RNE ((_ to_fp 8 24) RNE (_ bv0 32)) v_prenex_2)))))
