...
(set-info :status sat) ;; OK, at least I think it is
...
(define-const valid_result__first Float32 ((_ to_fp 8 24) RNE (- 1.0)))
(define-const valid_result__last  Float32 ((_ to_fp 8 24) RNE    1.0))
