...
(define-fun spoon_23 ((kitten_23 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_23) (fp.leq kitten_23 (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23))))))
...
(define-fun spoon_30 ((kitten_25 (_ FloatingPoint 8 24)) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23)))) (spoon_23 kitten_25)))
...
(declare-fun cat_36 () (_ FloatingPoint 8 24))
(declare-fun cat_37 () (_ FloatingPoint 8 24))
(declare-fun cat_38 () (_ FloatingPoint 8 24))
(declare-fun cat_39 () (_ FloatingPoint 8 24))
(declare-fun cat_40 () (_ FloatingPoint 8 24))
(declare-fun cat_41 () (_ FloatingPoint 8 24))
(declare-fun cat_42 () (_ FloatingPoint 8 24))
(declare-fun cat_43 () (_ FloatingPoint 8 24))
(declare-fun cat_44 () (_ FloatingPoint 8 24))
(assert (spoon_23 cat_31))
(assert (spoon_23 cat_33))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23))) (spoon_23 cat_36)))
(assert (=> (fp.lt cat_31 cat_33) (= cat_38 cat_36)))
(assert (=> (fp.lt cat_31 cat_33) (= cat_39 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_31 cat_33))) (=> (not (fp.lt cat_31 cat_33)) (and (= cat_37 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_40 cat_36)))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_41 cat_37)))
(assert (=> (not (fp.lt cat_31 cat_33)) (= cat_39 cat_41)))
(assert (= cat_42 cat_43))
(assert (= cat_42 cat_39))
(assert (= (mk_potato_10 cat_44) (mk_potato_10 cat_43)))
(assert (not (fp.eq cat_44 (fp.max (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp.sub roundNearestTiesToEven cat_31 cat_33)))))
(check-sat)
(exit)
