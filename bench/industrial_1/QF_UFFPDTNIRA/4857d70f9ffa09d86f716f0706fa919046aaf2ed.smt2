...
(declare-fun cat_46 () (_ FloatingPoint 8 24))
(declare-fun cat_47 () (_ FloatingPoint 8 24))
(declare-fun cat_48 () (_ FloatingPoint 8 24))
...
(assert (= cat_47 (fp.add roundNearestTiesToEven cat_31 cat_33)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_47 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))) (=> (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47) (and (= cat_45 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47) (= cat_48 cat_47)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47) (= cat_49 cat_45)))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_47 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))) (=> (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47)) (=> (fp.lt cat_47 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_46 _let_0) (spoon_1 _let_0))))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47)) (=> (fp.lt cat_47 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_50 cat_47))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47)) (=> (fp.lt cat_47 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_51 cat_46))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47)) (=> (not (fp.lt cat_47 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_51 cat_47))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_47)) (= cat_49 cat_51)))
(assert (not (spoon_23 cat_49)))
(check-sat)
(exit)
