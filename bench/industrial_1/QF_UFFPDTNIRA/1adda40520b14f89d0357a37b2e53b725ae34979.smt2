...
(define-fun spoon_23 ((kitten_23 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (and (spoon_1 kitten_23) (and (fp.leq (fp.neg _let_0) kitten_23) (fp.leq kitten_23 _let_0)))))
...
(define-fun spoon_30 ((kitten_25 (_ FloatingPoint 8 24)) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (or (= kitten_26 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_23 kitten_25))))
...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_23 cat_36))))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) (fp.add roundNearestTiesToEven cat_31 cat_33))))
(assert (fp.lt (fp.add roundNearestTiesToEven cat_31 cat_33) (fp.neg (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))))
(assert (not (spoon_23 (fp.add roundNearestTiesToEven (fp.add roundNearestTiesToEven cat_31 cat_33) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
