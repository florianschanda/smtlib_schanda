...
(assert (not (fp.lt (fp.add roundNearestTiesToEven cat_31 cat_33) (fp.neg (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23))))))
(assert (not (spoon_23 (fp.add roundNearestTiesToEven cat_31 cat_33))))
(check-sat)
(exit)
