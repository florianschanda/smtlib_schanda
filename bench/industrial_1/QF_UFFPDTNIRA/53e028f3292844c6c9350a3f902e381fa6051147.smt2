...
(define-fun spoon_23 ((kitten_23 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (and (spoon_1 kitten_23) (and (fp.leq (fp.neg _let_0) kitten_23) (fp.leq kitten_23 _let_0)))))
...
(define-fun spoon_30 ((kitten_25 (_ FloatingPoint 8 24)) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (=> (or (= kitten_26 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_23 kitten_25))))
(declare-sort potato_13 0)
(define-fun spoon_31 ((kitten_30 (_ FloatingPoint 8 24))) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) kitten_30) (fp.leq kitten_30 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
...
(define-fun spoon_38 ((kitten_32 (_ FloatingPoint 8 24)) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (spoon_31 kitten_32)))
...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))) (spoon_31 cat_42)))
(assert (not (fp.lt cat_39 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (not (spoon_31 cat_39)))
(check-sat)
(exit)
