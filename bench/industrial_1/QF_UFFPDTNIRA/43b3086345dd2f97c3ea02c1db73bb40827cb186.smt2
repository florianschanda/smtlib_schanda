...
(assert (not (fp.leq (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_45)))
(assert (fp.lt cat_45 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (not (spoon_35 (fp.add roundNearestTiesToEven cat_45 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
