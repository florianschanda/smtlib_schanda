...
(define-fun spoon_31 ((kitten_30 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (and (spoon_1 kitten_30) (and (fp.leq (fp.neg _let_0) kitten_30) (fp.leq kitten_30 _let_0)))))
(declare-fun spoon_32 (potato_13 potato_13) Bool)
(declare-fun spoon_33 ((_ FloatingPoint 8 24)) potato_5)
(declare-fun spoon_34 (potato_5) Bool)
(declare-fun spoon_35 (potato_5) (_ FloatingPoint 8 24))
(declare-fun cat_36 () potato_13)
(declare-datatypes ((potato_14 0)) (((mk_potato_14 (get_potato_14_a potato_13)))))

(define-fun spoon_37 ((kitten_31 potato_14)) potato_13 (get_potato_14_a kitten_31))
(define-fun spoon_38 ((kitten_32 (_ FloatingPoint 8 24)) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (=> (or (= kitten_33 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_31 kitten_32))))
(declare-fun cat_39 () (_ FloatingPoint 8 24))
(declare-fun cat_40 () Int)
(declare-fun cat_41 () Int)
(declare-fun cat_42 () (_ FloatingPoint 8 24))
(assert (spoon_31 cat_39))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))) (spoon_23 cat_42)))
(assert (not (fp.lt cat_39 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
