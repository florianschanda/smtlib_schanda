...
(define-fun spoon_14 ((kitten_8 (_ FloatingPoint 8 24))) Bool (and (fp.isInfinite kitten_8) (fp.isPositive kitten_8)))
(define-fun spoon_15 ((kitten_9 (_ FloatingPoint 8 24))) Bool (and (fp.isInfinite kitten_9) (fp.isNegative kitten_9)))
(define-fun spoon_16 ((kitten_10 (_ FloatingPoint 8 24))) Bool (and (fp.isZero kitten_10) (fp.isPositive kitten_10)))
(define-fun spoon_17 ((kitten_11 (_ FloatingPoint 8 24))) Bool (and (fp.isZero kitten_11) (fp.isNegative kitten_11)))
...
(define-fun spoon_21 ((kitten_14 (_ FloatingPoint 8 24)) (kitten_15 (_ FloatingPoint 8 24))) Bool (or (and (fp.isPositive kitten_14) (fp.isPositive kitten_15)) (and (fp.isNegative kitten_14) (fp.isNegative kitten_15))))
(define-fun spoon_22 ((kitten_16 (_ FloatingPoint 8 24)) (kitten_17 (_ FloatingPoint 8 24))) Bool (or (and (fp.isPositive kitten_16) (fp.isNegative kitten_17)) (and (fp.isNegative kitten_16) (fp.isPositive kitten_17))))
(define-fun spoon_23 ((kitten_18 (_ FloatingPoint 8 24)) (kitten_19 (_ FloatingPoint 8 24)) (kitten_20 (_ FloatingPoint 8 24))) Bool (and (=> (spoon_21 kitten_19 kitten_20) (fp.isPositive kitten_18)) (=> (spoon_22 kitten_19 kitten_20) (fp.isNegative kitten_18))))
(define-fun spoon_24 ((kitten_21 Real)) Real (* kitten_21 kitten_21))
(declare-fun spoon_25 (Real) Real)
(define-fun spoon_26 ((kitten_22 (_ FloatingPoint 8 24)) (kitten_23 Real)) Bool (let ((_let_0 (/ 0 1))) (or (and (fp.isPositive kitten_22) (< _let_0 kitten_23)) (and (fp.isNegative kitten_22) (< kitten_23 _let_0)))))
...
(assert true)
(assert (forall ((kitten_38 potato_15) (kitten_39 potato_15)) (! (let ((_let_0 (get_potato_15_a kitten_38))) (let ((_let_1 (get_potato_15_a kitten_39))) (let ((_let_2 (fp (_ bv0 1) (_ bv119 8) (_ bv2348810 23)))) (= (= (spoon_54 kitten_38 kitten_39) true) (and (fp.leq (fp.abs (fp.sub roundNearestTiesToEven (spoon_34 (get_potato_13_a _let_0)) (spoon_34 (get_potato_13_a _let_1)))) _let_2) (fp.leq (fp.abs (fp.sub roundNearestTiesToEven (spoon_34 (get_potato_13_b _let_0)) (spoon_34 (get_potato_13_b _let_1)))) _let_2)))))) :pattern ((spoon_54 kitten_38 kitten_39)))))
(declare-sort potato_17 0)
(declare-fun spoon_56 (potato_17) Int)
(assert (forall ((kitten_40 potato_17)) (let ((_let_0 (spoon_56 kitten_40))) (and (<= 3 _let_0) (<= _let_0 30))) ))
...
(declare-datatypes ((potato_19 0)) (((mk_potato_19 (get_potato_19_a (Array Int potato_15))))))
...
(declare-fun cat_68 () (Array Int potato_15))
...
(declare-datatypes ((potato_20 0)) (((mk_potato_20 (get_potato_20_a potato_17) (get_potato_20_b (Array Int potato_15))))))
...
(define-fun spoon_80 ((kitten_74 potato_22) (kitten_75 potato_22)) Bool (let ((_let_0 (get_potato_22_a kitten_74))) (let ((_let_1 (get_potato_22_a kitten_75))) (ite (and (= (spoon_64 (get_potato_20_a _let_0)) (spoon_64 (get_potato_20_a _let_1))) (= (spoon_67 (get_potato_20_b _let_0) 1 30 (get_potato_20_b _let_1) 1 30) true)) true false))))
...
(assert (forall ((kitten_79 potato_24)) (let ((_let_0 (spoon_94 kitten_79))) (and (<= 1 _let_0) (<= _let_0 30))) ))
...
(define-fun spoon_108 ((kitten_82 (_ FloatingPoint 8 24)) (kitten_83 Bool) (kitten_84 Bool) (kitten_85 Bool) (kitten_86 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_83 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_27 kitten_82))))
