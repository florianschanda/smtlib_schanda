...
(declare-fun cat_158 () Bool)
(assert (= cat_154 cat_152))
(assert (= cat_155 0))
(assert (spoon_118 cat_155))
(assert (=> (<= 1 100) (spoon_105 cat_153)))
(assert (= cat_156 cat_153))
(assert (= cat_157 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_158 (spoon_102 (select _let_0 1) (select _let_0 cat_157)))))
(assert (= cat_158 true))
(assert (not (spoon_105 (- cat_157 1))))
(check-sat)
(exit)
