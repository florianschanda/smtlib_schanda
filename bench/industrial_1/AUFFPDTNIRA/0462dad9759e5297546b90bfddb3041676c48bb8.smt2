...
(assert (< (- cat_135 1000) (spoon_96 (get_potato_26_b (get_potato_28_a (get_potato_30_b (get_potato_32_a cat_137)))))))
(assert (not (<= 149000 (spoon_96 (get_potato_26_b (get_potato_28_a (get_potato_30_b (get_potato_32_a cat_137))))))))
(assert (not (spoon_89 (+ (spoon_96 (get_potato_26_b (get_potato_28_a (get_potato_30_b (get_potato_32_a cat_137))))) 1000))))
(check-sat)
(exit)
