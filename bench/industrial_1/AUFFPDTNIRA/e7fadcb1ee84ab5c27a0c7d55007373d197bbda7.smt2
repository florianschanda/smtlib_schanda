...
(declare-fun cat_197 () potato_15)
(declare-fun cat_198 () Int)
(declare-fun cat_199 () potato_6)
(declare-fun cat_200 () Int)
(declare-fun cat_201 () potato_16)
(declare-fun cat_202 () potato_15)
(declare-fun cat_203 () Bool)
(declare-fun cat_204 () potato_6)
(declare-fun cat_205 () Int)
(declare-fun cat_206 () Bool)
(declare-fun cat_207 () potato_6)
(declare-fun cat_208 () Int)
(declare-fun cat_209 () potato_16)
(declare-fun cat_210 () potato_15)
(define-fun spoon_211 () potato_15 (mk_potato_15 cat_184 cat_185))
(define-fun spoon_212 () potato_15 (mk_potato_15 cat_178 cat_179))
(assert (= cat_169 cat_153))
(assert (= cat_170 0))
(assert (spoon_118 cat_170))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_171 cat_154))
(assert (= cat_172 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_173 (spoon_102 (select _let_0 1) (select _let_0 cat_172)))))
(assert (let ((_let_0 (- cat_172 1))) (=> (= cat_173 true) (and (= cat_160 _let_0) (spoon_105 _let_0)))))
...
(assert (= spoon_212 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_175))))
(assert (= cat_175 cat_131))
(assert (spoon_105 cat_131))
(assert (= cat_180 cat_159))
(assert (= cat_181 1))
(assert (<= 1 cat_181))
(assert (<= cat_181 cat_131))
(assert (= cat_182 cat_157))
(assert (= cat_183 cat_158))
(assert (= spoon_211 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_181))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_179) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_185)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_212) (mk_potato_17 spoon_211) cat_113)) (spoon_94 cat_161))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_179) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_185)) (= cat_186 (ite (= cat_161 0) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_179) _let_0) (=> (not (fp.lt _let_0 (spoon_44 cat_185))) (= cat_186 false)))))
(assert (let ((_let_0 (+ cat_170 1))) (=> (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_186 true) (and (= cat_162 _let_0) (spoon_118 _let_0))))))
(assert (=> (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_186 true) (= cat_187 cat_170))))
(assert (=> (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_186 true) (= cat_188 cat_162))))
(assert (=> (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_186 true)) (= cat_188 cat_170))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_179) _let_0)) (=> (fp.leq (spoon_44 cat_185) _let_0) (and (= cat_163 (spoon_92 (mk_potato_17 spoon_212) (mk_potato_17 spoon_211) cat_113)) (spoon_94 cat_163))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_179) _let_0)) (=> (fp.leq (spoon_44 cat_185) _let_0) (= cat_189 (ite (= cat_163 2) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_179) _let_0)) (=> (not (fp.leq (spoon_44 cat_185) _let_0)) (= cat_189 false)))))
(assert (let ((_let_0 (- cat_170 1))) (=> (not (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_189 true) (and (= cat_164 _let_0) (spoon_118 _let_0))))))
(assert (=> (not (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_189 true) (= cat_190 cat_170))))
(assert (=> (not (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_189 true) (= cat_191 cat_164))))
(assert (=> (not (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (= cat_189 true)) (= cat_191 cat_170))))
(assert (=> (not (fp.leq (spoon_44 cat_179) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_188 cat_191)))
(assert (= cat_192 cat_178))
(assert (= cat_193 cat_179))
(assert (= cat_194 spoon_211))
(assert (and (<= (- cat_198) cat_195) (<= cat_195 cat_198)))
(assert (and (and (=> (<= 1 cat_131) (spoon_143 1 cat_131 cat_198)) (=> (<= (- 30) 30) (spoon_118 cat_195))) (and (<= 1 cat_198) (<= cat_198 cat_131))))
(assert (not (= cat_198 cat_131)))
(assert (= cat_199 (mk_potato_6 cat_198)))
(assert (= cat_200 (+ cat_198 1)))
(assert (= cat_201 (mk_potato_16 cat_197)))
(assert (= cat_202 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_200))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0) (=> (fp.lt _let_0 (spoon_44 (get_potato_15_b cat_202))) (and (= cat_165 (spoon_92 (mk_potato_17 cat_196) (mk_potato_17 cat_202) cat_113)) (spoon_94 cat_165))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0) (=> (fp.lt _let_0 (spoon_44 (get_potato_15_b cat_202))) (= cat_203 (ite (= cat_165 0) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0) (=> (not (fp.lt _let_0 (spoon_44 (get_potato_15_b cat_202)))) (= cat_203 false)))))
(assert (let ((_let_0 (+ cat_195 1))) (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_203 true) (and (= cat_166 _let_0) (spoon_118 _let_0))))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_203 true) (= cat_204 (mk_potato_6 cat_195)))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_203 true) (= cat_205 cat_166))))
(assert (=> (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (not (= cat_203 true)) (= cat_205 cat_195))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0)) (=> (fp.leq (spoon_44 (get_potato_15_b cat_202)) _let_0) (and (= cat_167 (spoon_92 (mk_potato_17 cat_196) (mk_potato_17 cat_202) cat_113)) (spoon_94 cat_167))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0)) (=> (fp.leq (spoon_44 (get_potato_15_b cat_202)) _let_0) (= cat_206 (ite (= cat_167 2) true false))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) _let_0)) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_202)) _let_0)) (= cat_206 false)))))
(assert (let ((_let_0 (- cat_195 1))) (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_206 true) (and (= cat_168 _let_0) (spoon_118 _let_0))))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_206 true) (= cat_207 (mk_potato_6 cat_195)))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_206 true) (= cat_208 cat_168))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (= cat_206 true)) (= cat_208 cat_195))))
(assert (=> (not (fp.leq (spoon_44 (get_potato_15_b cat_196)) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (= cat_205 cat_208)))
(assert (= cat_209 (mk_potato_16 cat_196)))
