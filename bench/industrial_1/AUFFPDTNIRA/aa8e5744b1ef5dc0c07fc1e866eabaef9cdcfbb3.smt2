...
(assert (= cat_137 1))
(assert (<= 1 cat_137))
(assert (<= cat_137 (- (spoon_45 (get_potato_22_a (get_potato_24_a cat_128))) 1)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv147 8) (_ bv56192 23))) (spoon_29 cat_138)))
(assert (<= 1 cat_139))
(assert (<= cat_139 (- (spoon_45 (get_potato_22_a (get_potato_24_a cat_128))) 1)))
(assert (not (spoon_113 (+ cat_139 1))))
(check-sat)
(exit)
