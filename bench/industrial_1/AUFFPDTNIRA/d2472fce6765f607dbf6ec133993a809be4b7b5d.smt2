...
(assert (forall ((kitten_8 potato_10)) (let ((_let_0 (spoon_13 kitten_8))) (and (<= 3 _let_0) (<= _let_0 100))) ))
...
(define-fun spoon_78 ((kitten_72 potato_22) (kitten_73 potato_22)) Bool (let ((_let_0 (get_potato_22_a kitten_72))) (let ((_let_1 (get_potato_22_a kitten_73))) (ite (and (= (spoon_21 (get_potato_20_a _let_0)) (spoon_21 (get_potato_20_a _let_1))) (= (spoon_65 (get_potato_20_b _let_0) 1 100 (get_potato_20_b _let_1) 1 100) true)) true false))))
...
(assert (forall ((kitten_77 potato_24)) (let ((_let_0 (spoon_94 kitten_77))) (and (<= 1 _let_0) (<= _let_0 100))) ))
...
(assert (not (<= (spoon_21 (get_potato_20_a (get_potato_22_a cat_104))) 100)))
(check-sat)
(exit)
