...
(declare-fun cat_166 () Bool)
(declare-fun cat_167 () Int)
(declare-fun cat_168 () Int)
(declare-fun cat_169 () potato_13)
(declare-fun cat_170 () potato_13)
(declare-fun cat_171 () potato_13)
...
(declare-fun cat_179 () Bool)
(define-fun spoon_180 () potato_15 (mk_potato_15 cat_177 cat_178))
(define-fun spoon_181 () potato_15 (mk_potato_15 cat_171 cat_172))
(assert (= cat_162 cat_153))
(assert (= cat_163 0))
(assert (spoon_118 cat_163))
(assert (=> (<= 1 30) (spoon_105 cat_154)))
(assert (= cat_164 cat_154))
(assert (= cat_165 (spoon_35 (get_potato_20_a (get_potato_22_a cat_115)))))
(assert (let ((_let_0 (get_potato_20_b (get_potato_22_a cat_115)))) (= cat_166 (spoon_102 (select _let_0 1) (select _let_0 cat_165)))))
(assert (let ((_let_0 (- cat_165 1))) (=> (= cat_166 true) (and (= cat_160 _let_0) (spoon_105 _let_0)))))
...
(assert (= spoon_181 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_168))))
(assert (= cat_168 cat_131))
...
(assert (= spoon_180 (get_potato_17_a (select (get_potato_20_b (get_potato_22_a cat_115)) cat_174))))
(assert (fp.leq (spoon_44 cat_172) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_178)) (and (= cat_161 (spoon_92 (mk_potato_17 spoon_181) (mk_potato_17 spoon_180) cat_113)) (spoon_94 cat_161))))
(assert (=> (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_178)) (= cat_179 (ite (= cat_161 0) true false))))
(assert (=> (not (fp.lt (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))) (spoon_44 cat_178))) (= cat_179 false)))
(assert (= cat_179 true))
(assert (not (spoon_118 (+ cat_163 1))))
(check-sat)
(exit)
