...
(assert (forall ((kitten_77 potato_24)) (let ((_let_0 (spoon_92 kitten_77))) (and (<= 3 _let_0) (<= _let_0 30))) ))
...
(declare-fun cat_102 () (Array Int potato_17))
...
(declare-datatypes ((potato_26 0)) (((mk_potato_26 (get_potato_26_a potato_24) (get_potato_26_b (Array Int potato_17))))))
...
(define-fun spoon_114 ((kitten_91 potato_28) (kitten_92 potato_28)) Bool (let ((_let_0 (get_potato_28_a kitten_91))) (let ((_let_1 (get_potato_28_a kitten_92))) (ite (and (= (spoon_100 (get_potato_26_a _let_0)) (spoon_100 (get_potato_26_a _let_1))) (= (spoon_65 (get_potato_26_b _let_0) 1 30 (get_potato_26_b _let_1) 1 30) true)) true false))))
...
(assert (forall ((kitten_96 potato_30)) (let ((_let_0 (spoon_128 kitten_96))) (and (<= 1 _let_0) (<= _let_0 30))) ))
...
(declare-fun cat_136 () potato_28)
(declare-fun cat_137 () Int)
(declare-fun cat_138 () Int)
(declare-fun cat_139 () Int)
(define-fun spoon_140 ((kitten_99 (_ FloatingPoint 8 24)) (kitten_100 Bool) (kitten_101 Bool) (kitten_102 Bool) (kitten_103 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (or (= kitten_100 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_37 kitten_99))))
