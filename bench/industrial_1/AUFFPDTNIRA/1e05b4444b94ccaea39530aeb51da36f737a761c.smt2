...
(declare-fun cat_197 () potato_16)
(declare-fun cat_198 () potato_15)
(declare-fun cat_199 () Bool)
...
(assert (let ((_let_0 (- cat_168 1))) (=> (= cat_169 true) (and (= cat_159 _let_0) (spoon_105 _let_0)))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_175) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_181)) (and (= cat_160 (spoon_92 (mk_potato_17 spoon_201) (mk_potato_17 spoon_200) cat_113)) (spoon_94 cat_160))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (fp.leq (spoon_44 cat_175) _let_0) (=> (fp.lt _let_0 (spoon_44 cat_181)) (= cat_182 (ite (= cat_160 0) true false))))))
...
(assert (let ((_let_0 (+ cat_166 1))) (=> (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113)))) (=> (= cat_182 true) (and (= cat_161 _let_0) (spoon_118 _let_0))))))
...
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_175) _let_0)) (=> (fp.leq (spoon_44 cat_181) _let_0) (and (= cat_162 (spoon_92 (mk_potato_17 spoon_201) (mk_potato_17 spoon_200) cat_113)) (spoon_94 cat_162))))))
(assert (let ((_let_0 (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (not (fp.leq (spoon_44 cat_175) _let_0)) (=> (fp.leq (spoon_44 cat_181) _let_0) (= cat_185 (ite (= cat_162 2) true false))))))
...
(assert (let ((_let_0 (- cat_166 1))) (=> (not (fp.leq (spoon_44 cat_175) (spoon_44 (get_potato_15_b (get_potato_17_a cat_113))))) (=> (= cat_185 true) (and (= cat_163 _let_0) (spoon_118 _let_0))))))
