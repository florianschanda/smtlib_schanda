...
(declare-fun spoon_102 (potato_22 potato_22) Bool)
(declare-fun spoon_103 (Bool potato_22 potato_22) Bool)
(assert true)
(declare-sort potato_26 0)
(declare-fun spoon_104 (potato_26) Int)
(assert (forall ((kitten_88 potato_26)) (let ((_let_0 (spoon_104 kitten_88))) (and (<= 1 _let_0) (<= _let_0 100))) ))
(define-fun spoon_105 ((kitten_89 Int)) Bool (and (<= 1 kitten_89) (<= kitten_89 100)))
...
(define-fun spoon_123 ((kitten_96 Int) (kitten_97 Bool) (kitten_98 Bool) (kitten_99 Bool) (kitten_100 Bool)) Bool (=> (or (= kitten_97 true) (<= 1 100)) (spoon_105 kitten_96)))
(define-fun spoon_124 ((kitten_101 Int) (kitten_102 Bool) (kitten_103 Bool) (kitten_104 Bool) (kitten_105 Bool)) Bool (=> (or (= kitten_102 true) (<= 3 100)) (spoon_28 kitten_101)))
...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_94 cat_125)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_94 cat_126)))
(assert (= cat_127 (spoon_102 cat_112 cat_114)))
...
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23))) (spoon_94 cat_133)))
...
(assert (not (<= (spoon_35 (get_potato_20_a (get_potato_22_a cat_114))) 100)))
(check-sat)
(exit)
