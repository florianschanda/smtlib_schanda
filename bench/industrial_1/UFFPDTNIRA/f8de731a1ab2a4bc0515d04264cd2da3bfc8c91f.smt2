...
(declare-fun cat_237 () potato_7)
(declare-fun cat_238 () Bool)
(declare-fun cat_239 () potato_29)
...
(assert (= cat_242 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_248 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_242))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_248 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.mul roundNearestTiesToEven cat_233 cat_254)))
