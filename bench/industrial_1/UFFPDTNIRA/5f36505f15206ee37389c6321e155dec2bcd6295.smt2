...
(assert (= cat_118 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_114)))
(assert (spoon_1 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_114)))
(assert (= cat_119 (fp.mul roundNearestTiesToEven cat_118 cat_115)))
(assert (= cat_120 cat_119))
(assert (spoon_1 cat_119))
(assert (= cat_121 cat_120))
(assert (= (spoon_75 cat_122) cat_121))
