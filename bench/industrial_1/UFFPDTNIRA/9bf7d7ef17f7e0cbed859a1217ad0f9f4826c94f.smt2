...
(declare-fun cat_260 () potato_7)
(declare-fun cat_261 () Bool)
(declare-fun cat_262 () potato_29)
(declare-fun cat_263 () potato_28)
...
(declare-fun cat_270 () potato_11)
(declare-fun cat_271 () (_ FloatingPoint 11 53))
(declare-fun cat_272 () potato_11)
(declare-fun cat_273 () (_ FloatingPoint 11 53))
(declare-fun cat_274 () potato_11)
(declare-fun cat_275 () (_ FloatingPoint 11 53))
(declare-fun cat_276 () potato_11)
(declare-fun cat_277 () (_ FloatingPoint 11 53))
(declare-fun cat_278 () potato_11)
(declare-fun cat_279 () (_ FloatingPoint 11 53))
(declare-fun cat_280 () potato_11)
(declare-fun cat_281 () (_ FloatingPoint 11 53))
(declare-fun cat_282 () potato_11)
(declare-fun cat_283 () (_ FloatingPoint 11 53))
(declare-fun cat_284 () potato_11)
(declare-fun cat_285 () (_ FloatingPoint 11 53))
(declare-fun cat_286 () potato_11)
(declare-fun cat_287 () (_ FloatingPoint 11 53))
(declare-fun cat_288 () potato_11)
(declare-fun cat_289 () (_ FloatingPoint 11 53))
(declare-fun cat_290 () potato_11)
(declare-fun cat_291 () (_ FloatingPoint 11 53))
...
(assert (= cat_259 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_259))
...
(assert (= cat_261 (distinct 1 0)))
(assert (= cat_262 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_263 (get_potato_30_a cat_138)))
(assert (= cat_264 (mk_potato_11 cat_206)))
(assert (= cat_265 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_271 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_265))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_271 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_277)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_273 cat_267))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_269)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_275)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_273 cat_267))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_269)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_280 (mk_potato_11 cat_214)))
(assert (= cat_281 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_279 cat_281))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_282 (mk_potato_11 cat_212)))
(assert (= cat_283 cat_246))
(assert (=> (fp.lt cat_283 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_284 spoon_292)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_283 _let_0) (= cat_285 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_283) (= cat_286 spoon_292)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_283) (= cat_287 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_283)) (and (= cat_247 cat_283) (spoon_3 cat_283))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_283)) (= cat_288 spoon_292)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_283)) (= cat_289 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_283 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_283)) (= cat_287 cat_289)))))
(assert (=> (not (fp.lt cat_283 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_285 cat_287)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_271 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_290 (mk_potato_11 cat_216)))
(assert (= cat_291 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_271 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_275)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_273 cat_267))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_269)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_277)))
(assert (and (= cat_256 cat_252) (spoon_3 cat_252)))
(assert (= cat_257 (fp.sub roundNearestTiesToEven cat_256 cat_255)))
(assert (not (spoon_3 cat_257)))
(check-sat)
(exit)
