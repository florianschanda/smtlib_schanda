...
(declare-fun cat_230 () Bool)
(declare-fun cat_231 () Bool)
...
(declare-fun cat_242 () Bool)
(declare-fun cat_243 () Bool)
(declare-fun cat_244 () potato_28)
...
(declare-fun cat_259 () potato_10)
(declare-fun cat_260 () (_ FloatingPoint 8 24))
(declare-fun cat_261 () potato_7)
(declare-fun cat_262 () Bool)
(declare-fun cat_263 () (_ FloatingPoint 8 24))
(declare-fun cat_264 () (_ FloatingPoint 8 24))
(declare-fun cat_265 () Bool)
(declare-fun cat_266 () Bool)
(declare-fun cat_267 () (_ FloatingPoint 8 24))
...
(assert (= cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_236))
(assert (= cat_237 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_237))
(assert (= cat_238 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_238))
(assert (= cat_239 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_239))
(assert (= cat_240 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_154 cat_240))
(assert (= cat_241 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_86 cat_241))
...
(assert (= cat_242 (ite (not (= cat_200 true)) true false)))
(assert (= cat_242 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (= cat_243 true) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_244))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201))))))
(assert (=> (= cat_243 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_244))) (= cat_245 (mk_potato_10 cat_241)))))
(assert (=> (= cat_243 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_244))) (= cat_246 cat_201))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_247 (mk_potato_10 cat_241))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_248 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_249 (mk_potato_10 cat_241))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_250 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_244)))) (=> (= cat_243 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_248 cat_250)))))))
(assert (=> (= cat_243 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_244)))) (= cat_246 cat_248))))
(assert (=> (= cat_243 true) (= cat_251 (mk_potato_10 cat_240))))
(assert (=> (= cat_243 true) (= cat_252 (fp.mul roundNearestTiesToEven cat_170 cat_170))))
(assert (=> (= cat_243 true) (= cat_253 (mk_potato_10 cat_237))))
(assert (=> (= cat_243 true) (= cat_254 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166))))))
(assert (=> (= cat_243 true) (= cat_255 (mk_potato_10 cat_236))))
(assert (=> (= cat_243 true) (= cat_256 (fp.sqrt roundNearestTiesToEven cat_254))))
(assert (=> (not (= cat_243 true)) (= cat_246 cat_241)))
(assert (=> (not (= cat_243 true)) (= cat_252 cat_240)))
(assert (=> (not (= cat_243 true)) (= cat_254 cat_237)))
(assert (=> (not (= cat_243 true)) (= cat_256 cat_236)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_254 cat_252))) (=> (= cat_243 true) (and (= cat_205 _let_0) (spoon_1 _let_0)))))
(assert (=> (= cat_243 true) (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_246 cat_246)))))
(assert (=> (= cat_243 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_243 true) (= cat_257 (mk_potato_10 cat_239))))
(assert (=> (= cat_243 true) (= cat_258 cat_207)))
(assert (=> (= cat_243 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258) (= cat_259 (mk_potato_10 cat_238)))))
(assert (=> (= cat_243 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258) (= cat_260 (fp.sqrt roundNearestTiesToEven cat_258)))))
(assert (=> (= cat_243 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258) (= cat_262 cat_243))))
(assert (=> (= cat_243 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258)) (= cat_261 (mk_potato_7 cat_243)))))
(assert (=> (= cat_243 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258)) (= cat_262 (distinct 0 0)))))
(assert (=> (= cat_243 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_258)) (= cat_260 cat_238))))
(assert (=> (not (= cat_243 true)) (= cat_258 cat_239)))
(assert (=> (not (= cat_243 true)) (= cat_260 cat_238)))
(assert (=> (not (= cat_243 true)) (= cat_262 cat_243)))
(assert (= cat_262 true))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_260 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_260 cat_170)))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_256 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_252))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_256 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_252))))
(assert (= cat_209 (fp.mul roundNearestTiesToEven cat_208 cat_246)))
...
(assert (= cat_263 cat_213))
(assert (spoon_1 cat_212))
(assert (= cat_214 (fp.mul roundNearestTiesToEven cat_260 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_260 cat_170)))
(assert (= cat_215 (fp.mul roundNearestTiesToEven cat_214 cat_246)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul roundNearestTiesToEven cat_256 cat_258)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_256 cat_258)))
(assert (= cat_218 (fp.sub roundNearestTiesToEven cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_264 cat_219))
(assert (spoon_1 cat_218))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_264))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (and (= cat_228 _let_0) (spoon_1 _let_0)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (and (= cat_229 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (= cat_230 (ite (fp.leq cat_229 cat_228) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (and (= cat_226 _let_0) (spoon_1 _let_0)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))) cat_264))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (and (= cat_227 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (= cat_231 (ite (fp.leq cat_227 cat_226) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264) (= cat_266 (ite (= cat_231 true) cat_230 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_264)) (= cat_266 false)))
(assert (=> (= cat_266 true) (= cat_265 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))) cat_264))) (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_222 _let_0) (spoon_1 _let_0))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263))) (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_223 _let_0) (spoon_1 _let_0))))))
(assert (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_224 (ite (fp.leq cat_223 cat_222) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263))) (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_220 _let_0) (spoon_1 _let_0))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_264))) (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_221 _let_0) (spoon_1 _let_0))))))
(assert (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_225 (ite (fp.leq cat_221 cat_220) true false)))))
(assert (=> (not (= cat_266 true)) (=> (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_265 (ite (= cat_225 true) cat_224 false)))))
(assert (=> (not (= cat_266 true)) (=> (not (fp.lt cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_265 false))))
(assert (= cat_265 true))
(assert (= cat_232 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_263)))
(assert (= cat_233 (fp.div roundNearestTiesToEven cat_232 cat_264)))
(assert (= cat_234 cat_233))
(assert (spoon_1 cat_233))
(assert (= cat_235 cat_234))
(assert (= cat_267 cat_235))
(assert (spoon_1 cat_234))
(assert (not (spoon_104 (fp.add roundNearestTiesToEven (spoon_111 (get_potato_28_a cat_244)) cat_267))))
(assert (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) (fp.add roundNearestTiesToEven (spoon_111 (get_potato_28_a cat_244)) cat_267)))
(assert (not (spoon_104 (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) (fp.add roundNearestTiesToEven (spoon_111 (get_potato_28_a cat_244)) cat_267)))))
(check-sat)
(exit)
