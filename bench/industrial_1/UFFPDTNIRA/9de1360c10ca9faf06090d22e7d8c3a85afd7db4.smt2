...
(declare-fun cat_176 () potato_22)
(declare-fun cat_177 () potato_21)
(declare-fun cat_178 () potato_22)
(declare-fun cat_179 () potato_21)
(declare-fun cat_180 () potato_22)
(declare-fun cat_181 () potato_21)
(declare-fun cat_182 () potato_22)
(declare-fun cat_183 () potato_21)
(declare-fun cat_184 () potato_10)
(declare-fun cat_185 () (_ FloatingPoint 8 24))
(declare-fun cat_186 () potato_10)
(declare-fun cat_187 () (_ FloatingPoint 8 24))
(declare-fun cat_188 () potato_10)
...
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) (spoon_63 (get_potato_21_b cat_177))))))
...
(assert (let ((_let_0 (spoon_63 (get_potato_21_b cat_177)))) (let ((_let_1 (mk_potato_23 cat_177))) (let ((_let_2 (spoon_63 (get_potato_21_a cat_177)))) (and (= cat_169 (spoon_83 _let_1 _let_1)) (and (spoon_85 cat_169) (= cat_169 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_2 _let_2) (fp.mul roundNearestTiesToEven _let_0 _let_0)))))))))
(assert (= cat_184 (mk_potato_10 cat_143)))
(assert (= cat_185 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_181) (mk_potato_23 cat_179))) (and (spoon_85 cat_170) (= cat_170 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_181)) (spoon_63 (get_potato_21_a cat_179))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_181)) (spoon_63 (get_potato_21_b cat_179))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_183) (mk_potato_23 cat_179))) (and (spoon_85 cat_171) (= cat_171 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_183)) (spoon_63 (get_potato_21_a cat_179))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_183)) (spoon_63 (get_potato_21_b cat_179))))))))
(assert (= cat_172 (fp.sub roundNearestTiesToEven cat_171 cat_170)))
(assert (= cat_186 (mk_potato_10 cat_145)))
(assert (= cat_187 cat_172))
(assert (let ((_let_0 (fp.sqrt roundNearestTiesToEven cat_185))) (and (= cat_173 _let_0) (spoon_1 _let_0))))
(assert (= cat_188 (mk_potato_10 cat_146)))
(assert (= cat_189 cat_173))
(assert (=> (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187)) (= cat_190 spoon_194)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)))) (=> (fp.leq (fp.mul roundNearestTiesToEven _let_0 cat_189) (fp.abs cat_187)) (= cat_191 _let_0))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven (fp.abs cat_187) cat_189))) (=> (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187))) (and (= cat_174 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187))) (and (= cat_175 cat_174) (spoon_1 cat_174))))
(assert (=> (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187))) (= cat_192 spoon_194)))
(assert (=> (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187))) (= cat_193 cat_175)))
(assert (=> (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_189) (fp.abs cat_187))) (= cat_191 cat_193)))
(assert (not (fp.lt cat_191 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv140 8) (_ bv3489792 23)) cat_191)))
