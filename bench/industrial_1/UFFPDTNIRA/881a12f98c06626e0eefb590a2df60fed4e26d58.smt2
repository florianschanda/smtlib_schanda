...
(declare-fun cat_213 () Bool)
(declare-fun cat_214 () Bool)
(declare-fun cat_215 () potato_28)
...
(assert (= cat_213 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (= cat_214 true) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_215))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201))))))
(assert (=> (= cat_214 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_215))) (= cat_216 (mk_potato_10 cat_212)))))
(assert (=> (= cat_214 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_215))) (= cat_217 cat_201))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_218 (mk_potato_10 cat_212))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_219 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_220 (mk_potato_10 cat_212))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_221 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_215)))) (=> (= cat_214 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_219 cat_221)))))))
(assert (=> (= cat_214 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_215)))) (= cat_217 cat_219))))
(assert (=> (= cat_214 true) (= cat_222 (mk_potato_10 cat_211))))
(assert (=> (= cat_214 true) (= cat_223 (fp.mul roundNearestTiesToEven cat_170 cat_170))))
(assert (=> (= cat_214 true) (= cat_224 (mk_potato_10 cat_208))))
(assert (=> (= cat_214 true) (= cat_225 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166))))))
(assert (=> (= cat_214 true) (= cat_226 (mk_potato_10 cat_207))))
(assert (=> (= cat_214 true) (= cat_227 (fp.sqrt roundNearestTiesToEven cat_225))))
...
(assert (= cat_214 true))
(assert (= cat_205 (fp.sub roundNearestTiesToEven cat_225 cat_223)))
(assert (spoon_1 (fp.sub roundNearestTiesToEven cat_225 cat_223)))
(assert (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_217 cat_217))))
