...
(declare-fun cat_104 () potato_12)
(declare-fun cat_105 () (_ FloatingPoint 11 53))
(declare-fun cat_106 () (_ FloatingPoint 11 53))
(declare-fun cat_107 () potato_11)
(declare-fun cat_108 () (_ FloatingPoint 11 53))
...
(assert (= cat_106 ((_ to_fp 11 53) roundNearestTiesToEven (fp.add roundNearestTiesToEven (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_69)))))))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_106)))
(assert (fp.lt cat_106 (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))))
...
(assert (= (spoon_47 cat_104) ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven (spoon_47 (get_potato_14_b (get_potato_16_a cat_69)))) cat_108))))
(assert (not (spoon_40 (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
