...
(declare-fun spoon_30 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) (_ FloatingPoint 8 24))
(declare-fun spoon_31 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) Bool)
(assert (forall ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (spoon_30 kitten_29 kitten_30))) (=> (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (and (fp.lt _let_0 kitten_30) (fp.leq (fp.abs kitten_29) (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))))) (and (=> (fp.eq kitten_29 _let_0) (fp.eq _let_1 _let_0)) (spoon_29 _let_1 true false true true))))) :pattern ((spoon_30 kitten_29 kitten_30)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_32 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (and (spoon_1 kitten_32) (and (fp.leq (fp.neg _let_0) kitten_32) (fp.leq kitten_32 _let_0)))))
(declare-fun spoon_33 (potato_13 potato_13) Bool)
(declare-fun spoon_34 ((_ FloatingPoint 8 24)) potato_5)
(declare-fun spoon_35 (potato_5) Bool)
(declare-fun spoon_36 (potato_5) (_ FloatingPoint 8 24))
(declare-fun cat_37 () potato_13)
...
(define-fun spoon_39 ((kitten_34 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (and (spoon_1 kitten_34) (and (fp.leq (fp.neg _let_0) kitten_34) (fp.leq kitten_34 _let_0)))))
...
(define-fun spoon_46 ((kitten_36 (_ FloatingPoint 8 24)) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (=> (or (= kitten_37 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_39 kitten_36))))
(declare-fun cat_47 () (_ FloatingPoint 8 24))
(declare-fun cat_48 () Int)
(declare-fun cat_49 () Int)
(define-fun spoon_50 ((kitten_41 (_ FloatingPoint 8 24)) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (=> (or (= kitten_42 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_32 kitten_41))))
(declare-fun cat_51 () (_ FloatingPoint 8 24))
(declare-fun cat_52 () (_ FloatingPoint 8 24))
(declare-fun cat_53 () (_ FloatingPoint 8 24))
(declare-fun cat_54 () (_ FloatingPoint 8 24))
(declare-fun cat_55 () (_ FloatingPoint 8 24))
(declare-fun cat_56 () (_ FloatingPoint 8 24))
(declare-fun cat_57 () (_ FloatingPoint 8 24))
(assert (spoon_39 cat_47))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv254 8) (_ bv8388607 23)))) (=> (fp.leq (fp.neg _let_0) _let_0) (spoon_1 cat_51))))
(assert (= cat_52 (spoon_30 cat_47 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))))
(assert (spoon_1 cat_52))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.eq cat_47 _let_0) (fp.eq cat_52 _let_0))))
(assert (= cat_53 cat_52))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_53) (= cat_54 cat_53)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (=> (fp.lt _let_0 cat_53) (= cat_55 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (=> (not (fp.lt _let_0 cat_53)) (=> (fp.lt cat_53 (fp.neg _let_0)) (= cat_56 cat_53)))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_53)) (=> (fp.lt cat_53 _let_0) (= cat_57 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)))) (=> (not (fp.lt _let_0 cat_53)) (=> (not (fp.lt cat_53 (fp.neg _let_0))) (= cat_57 cat_53)))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_53)) (= cat_55 cat_57)))
