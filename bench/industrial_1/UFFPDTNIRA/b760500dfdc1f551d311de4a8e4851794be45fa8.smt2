...
(declare-fun spoon_30 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) (_ FloatingPoint 8 24))
(declare-fun spoon_31 ((_ FloatingPoint 8 24) (_ FloatingPoint 8 24) (_ FloatingPoint 8 24) (_ FloatingPoint 8 24)) Bool)
(assert (forall ((kitten_29 (_ FloatingPoint 8 24)) (kitten_30 (_ FloatingPoint 8 24)) (kitten_31 (_ FloatingPoint 8 24))) (! (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.eq kitten_29 _let_0))) (let ((_let_2 (spoon_30 kitten_29 kitten_30 kitten_31))) (=> (and (and (and (spoon_29 kitten_29 true true true true) (spoon_29 kitten_30 true true true true)) (spoon_29 kitten_31 true true true true)) (and (fp.lt _let_0 kitten_31) (or (not (fp.eq kitten_30 _let_0)) (not _let_1)))) (and (=> (and (fp.lt _let_0 kitten_30) _let_1) (fp.eq _let_2 _let_0)) (spoon_29 _let_2 true false true true)))))) :pattern ((spoon_30 kitten_29 kitten_30 kitten_31)))))
(declare-sort potato_13 0)
(define-fun spoon_32 ((kitten_33 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (and (spoon_1 kitten_33) (and (fp.leq (fp.neg _let_0) kitten_33) (fp.leq kitten_33 _let_0)))))
...
(define-fun spoon_39 ((kitten_35 (_ FloatingPoint 8 24))) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)))) (and (spoon_1 kitten_35) (and (fp.leq (fp.neg _let_0) kitten_35) (fp.leq kitten_35 _let_0)))))
...
(define-fun spoon_46 ((kitten_37 (_ FloatingPoint 8 24)) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv3489792 23)))) (=> (or (= kitten_38 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_39 kitten_37))))
(declare-fun cat_47 () (_ FloatingPoint 8 24))
(declare-fun cat_48 () Int)
(declare-fun cat_49 () Int)
(define-fun spoon_50 ((kitten_42 (_ FloatingPoint 8 24)) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (or (= kitten_43 true) (fp.leq (fp.neg _let_0) _let_0)) (spoon_32 kitten_42))))
...
(assert (= cat_52 (spoon_30 cat_47 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))))
(assert (spoon_1 cat_52))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (and (fp.lt _let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) (fp.eq cat_47 _let_0)) (fp.eq cat_52 _let_0))))
(assert (= cat_53 cat_52))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)) cat_53) (= cat_54 cat_53)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)))) (=> (fp.lt _let_0 cat_53) (= cat_55 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)))) (=> (not (fp.lt _let_0 cat_53)) (=> (fp.lt cat_53 (fp.neg _let_0)) (= cat_56 cat_53)))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23))))) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)) cat_53)) (=> (fp.lt cat_53 _let_0) (= cat_57 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)))) (=> (not (fp.lt _let_0 cat_53)) (=> (not (fp.lt cat_53 (fp.neg _let_0))) (= cat_57 cat_53)))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406561 23)) cat_53)) (= cat_55 cat_57)))
