...
(declare-fun cat_269 () potato_7)
(declare-fun cat_270 () Bool)
(declare-fun cat_271 () potato_29)
(declare-fun cat_272 () potato_28)
...
(declare-fun cat_303 () Bool)
(declare-fun cat_304 () Bool)
...
(assert (= cat_268 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_274 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_280 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_274))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_280 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_286)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_282 cat_276))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_278)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_284)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_282 cat_276))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_278)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_289 (mk_potato_11 cat_214)))
(assert (= cat_290 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_288 cat_290))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_291 (mk_potato_11 cat_212)))
(assert (= cat_292 cat_246))
(assert (=> (fp.lt cat_292 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_293 spoon_305)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_292 _let_0) (= cat_294 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_292) (= cat_295 spoon_305)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_292) (= cat_296 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_292)) (and (= cat_247 cat_292) (spoon_3 cat_292))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_292)) (= cat_297 spoon_305)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_292)) (= cat_298 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_292 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_292)) (= cat_296 cat_298)))))
(assert (=> (not (fp.lt cat_292 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_294 cat_296)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_280 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_299 (mk_potato_11 cat_216)))
(assert (= cat_300 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_280 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_284)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_282 cat_276))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_278)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_286)))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_302))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302) (and (= cat_264 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302) (= cat_265 (ite (fp.leq cat_300 cat_264) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_302))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302) (and (= cat_263 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302) (= cat_266 (ite (fp.leq cat_263 cat_300) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302) (= cat_304 (ite (= cat_266 true) cat_265 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_302)) (= cat_304 false)))
(assert (=> (= cat_304 true) (= cat_303 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_302))) (=> (not (= cat_304 true)) (=> (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_260 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_304 true)) (=> (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_261 (ite (fp.leq cat_300 cat_260) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_302))) (=> (not (= cat_304 true)) (=> (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_259 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_304 true)) (=> (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_262 (ite (fp.leq cat_259 cat_300) true false)))))
(assert (=> (not (= cat_304 true)) (=> (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_303 (ite (= cat_262 true) cat_261 false)))))
(assert (=> (not (= cat_304 true)) (=> (not (fp.lt cat_302 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_303 false))))
(assert (= cat_303 true))
(assert (not (spoon_3 (fp.div roundNearestTiesToEven cat_300 cat_302))))
(check-sat)
(exit)
