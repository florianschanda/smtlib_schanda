...
(assert (let ((_let_0 (get_potato_19_a cat_88))) (let ((_let_1 (get_potato_19_a cat_86))) (= cat_153 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a _let_1)) (spoon_48 (get_potato_17_a _let_0))) (fp.neg cat_149)) (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b _let_1)) (spoon_48 (get_potato_17_b _let_0))) cat_148))))))
...
(assert (not (spoon_1 (fp.div roundNearestTiesToEven (fp.abs cat_153) cat_154))))
(check-sat)
(exit)
