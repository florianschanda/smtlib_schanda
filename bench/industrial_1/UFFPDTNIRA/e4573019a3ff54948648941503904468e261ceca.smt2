...
(assert (= cat_169 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= (spoon_104 cat_165) (fp.sub roundNearestTiesToEven (spoon_59 (get_potato_19_b (get_potato_21_a cat_110))) (spoon_59 (get_potato_19_b (get_potato_21_a cat_108))))))
(assert (= (spoon_104 cat_166) (fp.sub roundNearestTiesToEven (spoon_59 (get_potato_19_a (get_potato_21_a cat_110))) (spoon_59 (get_potato_19_a (get_potato_21_a cat_108))))))
...
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_170))
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_171))
(assert (not (not (fp.isZero (fp.mul roundNearestTiesToEven cat_170 cat_171)))))
(check-sat)
(exit)
