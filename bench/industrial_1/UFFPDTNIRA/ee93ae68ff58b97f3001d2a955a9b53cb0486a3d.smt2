...
(assert (= cat_68 (fp.sub roundNearestTiesToEven (spoon_30 (get_potato_13_a (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_a (get_potato_15_a cat_52))))))
(assert (= cat_69 (fp.sub roundNearestTiesToEven (spoon_30 (get_potato_13_b (get_potato_15_a cat_50))) (spoon_30 (get_potato_13_b (get_potato_15_a cat_52))))))
(assert (=> (fp.leq cat_68 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (= cat_70 cat_68)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))) (=> (fp.leq cat_68 _let_0) (= cat_71 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_68 (fp.neg _let_0))) (=> (fp.leq _let_0 cat_68) (= cat_72 cat_68)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_68 (fp.neg _let_0))) (=> (fp.leq _let_0 cat_68) (= cat_73 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_68 (fp.neg _let_0))) (=> (not (fp.leq _let_0 cat_68)) (= cat_73 cat_68)))))
(assert (=> (not (fp.leq cat_68 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))) (= cat_71 cat_73)))
(assert (=> (fp.leq cat_69 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (= cat_74 cat_69)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))) (=> (fp.leq cat_69 _let_0) (= cat_75 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_69 (fp.neg _let_0))) (=> (fp.leq _let_0 cat_69) (= cat_76 cat_69)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_69 (fp.neg _let_0))) (=> (fp.leq _let_0 cat_69) (= cat_77 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (=> (not (fp.leq cat_69 (fp.neg _let_0))) (=> (not (fp.leq _let_0 cat_69)) (= cat_77 cat_69)))))
(assert (=> (not (fp.leq cat_69 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))) (= cat_75 cat_77)))
