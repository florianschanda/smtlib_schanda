...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_229 cat_233))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_237)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_227 cat_231))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1024 11) (_ bv0 52)) cat_156) cat_235))) (and (= cat_215 _let_0) (spoon_3 _let_0))))
(assert (= cat_216 (fp.mul roundNearestTiesToEven cat_215 cat_229)))
(assert (and (= cat_217 cat_216) (spoon_3 cat_216)))
(assert (= cat_240 (mk_potato_11 cat_189)))
(assert (= cat_241 cat_217))
(assert (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_239)))
(assert (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_239))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_239))) (and (= cat_218 _let_0) (spoon_3 _let_0))))
(assert (= cat_219 (ite (fp.leq cat_241 cat_218) true false)))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52))) cat_239))))
(check-sat)
(exit)
