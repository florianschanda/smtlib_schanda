...
(declare-fun cat_265 () potato_7)
(declare-fun cat_266 () Bool)
(declare-fun cat_267 () potato_29)
(declare-fun cat_268 () potato_28)
...
(declare-fun cat_297 () potato_11)
(declare-fun cat_298 () (_ FloatingPoint 11 53))
(declare-fun cat_299 () Bool)
...
(assert (= cat_264 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_270 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_276 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_270))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_276 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_282)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_278 cat_272))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_274)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_280)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_278 cat_272))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_274)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_285 (mk_potato_11 cat_214)))
(assert (= cat_286 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_284 cat_286))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_287 (mk_potato_11 cat_212)))
(assert (= cat_288 cat_246))
(assert (=> (fp.lt cat_288 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_289 spoon_300)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_288 _let_0) (= cat_290 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_288) (= cat_291 spoon_300)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_288) (= cat_292 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_288)) (and (= cat_247 cat_288) (spoon_3 cat_288))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_288)) (= cat_293 spoon_300)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_288)) (= cat_294 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_288 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_288)) (= cat_292 cat_294)))))
(assert (=> (not (fp.lt cat_288 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_290 cat_292)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_276 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_295 (mk_potato_11 cat_216)))
(assert (= cat_296 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_276 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_280)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_278 cat_272))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_274)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_282)))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_298))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298) (and (= cat_260 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298) (= cat_261 (ite (fp.leq cat_296 cat_260) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_298))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298) (and (= cat_259 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298) (= cat_262 (ite (fp.leq cat_259 cat_296) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298) (= cat_299 (ite (= cat_262 true) cat_261 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_298)) (= cat_299 false)))
(assert (not (= cat_299 true)))
(assert (fp.lt cat_298 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_298))))
(check-sat)
(exit)
