...
(declare-fun cat_240 () potato_29)
(declare-fun cat_241 () potato_28)
...
(assert (= cat_243 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_249 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_243))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_249 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.mul roundNearestTiesToEven cat_233 cat_255)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (not (spoon_3 (fp.sub roundNearestTiesToEven cat_251 cat_245))))
(check-sat)
(exit)
