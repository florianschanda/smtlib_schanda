...
(assert (fp.leq cat_107 (fp.neg (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))))
(assert (not (spoon_60 (fp.add roundNearestTiesToEven cat_107 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
