...
(declare-fun cat_221 () (_ FloatingPoint 11 53))
...
(assert (= cat_215 cat_178))
(assert (= cat_216 cat_192))
...
(assert (= cat_218 cat_193))
(assert (and (= cat_194 (spoon_60 (spoon_86 (get_potato_22_a (get_potato_24_a cat_154))))) (spoon_42 cat_194)))
(assert (= cat_219 cat_179))
(assert (= cat_220 cat_194))
(assert (and (= cat_195 (spoon_40 cat_216)) (spoon_50 cat_195)))
(assert (= cat_196 ((_ to_fp 11 53) roundNearestTiesToEven cat_195)))
(assert (= cat_221 cat_180))
(assert (= cat_222 cat_196))
(assert (and (= cat_197 (spoon_58 cat_216)) (spoon_50 cat_197)))
(assert (= cat_198 ((_ to_fp 11 53) roundNearestTiesToEven cat_197)))
(assert (= cat_223 cat_181))
(assert (= cat_224 cat_198))
(assert (and (= cat_199 (spoon_40 cat_220)) (spoon_50 cat_199)))
(assert (= cat_200 ((_ to_fp 11 53) roundNearestTiesToEven cat_199)))
(assert (= cat_225 (mk_potato_11 cat_182)))
(assert (= cat_226 cat_200))
(assert (and (= cat_201 (spoon_58 cat_220)) (spoon_50 cat_201)))
(assert (= cat_202 ((_ to_fp 11 53) roundNearestTiesToEven cat_201)))
(assert (= cat_227 (mk_potato_11 cat_183)))
(assert (= cat_228 cat_202))
(assert (and (= cat_203 (spoon_40 cat_218)) (spoon_50 cat_203)))
(assert (= cat_204 ((_ to_fp 11 53) roundNearestTiesToEven cat_203)))
(assert (= cat_229 (mk_potato_11 cat_184)))
(assert (= cat_230 cat_204))
(assert (and (= cat_205 (spoon_58 cat_218)) (spoon_50 cat_205)))
(assert (= cat_206 ((_ to_fp 11 53) roundNearestTiesToEven cat_205)))
(assert (= cat_231 (mk_potato_11 cat_185)))
(assert (= cat_232 cat_206))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_224 cat_228))) (and (= cat_209 _let_0) (spoon_3 _let_0))))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_209 cat_232)))
(assert (and (= cat_211 cat_210) (spoon_3 cat_210)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_222 cat_226))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
...
(assert (= cat_234 cat_214))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1024 11) (_ bv0 52)) cat_156) cat_230))))
(check-sat)
(exit)
