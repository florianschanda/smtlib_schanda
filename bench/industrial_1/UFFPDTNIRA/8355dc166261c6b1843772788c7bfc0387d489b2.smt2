...
(declare-fun cat_243 () potato_7)
(declare-fun cat_244 () Bool)
...
(assert (spoon_1 cat_219))
(assert (= cat_220 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_220))
(assert (= cat_221 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_221))
(assert (= cat_222 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_154 cat_222))
(assert (= cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_86 cat_223))
...
(assert (= cat_224 (ite (not (= cat_200 true)) true false)))
(assert (= cat_224 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (= cat_225 true) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_226))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201))))))
(assert (=> (= cat_225 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_226))) (= cat_227 (mk_potato_10 cat_223)))))
(assert (=> (= cat_225 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_226))) (= cat_228 cat_201))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_229 (mk_potato_10 cat_223))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_230 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_231 (mk_potato_10 cat_223))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_232 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_226)))) (=> (= cat_225 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_230 cat_232)))))))
(assert (=> (= cat_225 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_226)))) (= cat_228 cat_230))))
(assert (=> (= cat_225 true) (= cat_233 (mk_potato_10 cat_222))))
(assert (=> (= cat_225 true) (= cat_234 (fp.mul roundNearestTiesToEven cat_170 cat_170))))
(assert (=> (= cat_225 true) (= cat_235 (mk_potato_10 cat_219))))
(assert (=> (= cat_225 true) (= cat_236 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166))))))
(assert (=> (= cat_225 true) (= cat_237 (mk_potato_10 cat_218))))
(assert (=> (= cat_225 true) (= cat_238 (fp.sqrt roundNearestTiesToEven cat_236))))
(assert (=> (not (= cat_225 true)) (= cat_228 cat_223)))
(assert (=> (not (= cat_225 true)) (= cat_234 cat_222)))
(assert (=> (not (= cat_225 true)) (= cat_236 cat_219)))
(assert (=> (not (= cat_225 true)) (= cat_238 cat_218)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_236 cat_234))) (=> (= cat_225 true) (and (= cat_205 _let_0) (spoon_1 _let_0)))))
(assert (=> (= cat_225 true) (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_228 cat_228)))))
(assert (=> (= cat_225 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_225 true) (= cat_239 (mk_potato_10 cat_221))))
(assert (=> (= cat_225 true) (= cat_240 cat_207)))
(assert (=> (= cat_225 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240) (= cat_241 (mk_potato_10 cat_220)))))
(assert (=> (= cat_225 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240) (= cat_242 (fp.sqrt roundNearestTiesToEven cat_240)))))
(assert (=> (= cat_225 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240) (= cat_244 cat_225))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240)) (= cat_243 (mk_potato_7 cat_225)))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240)) (= cat_244 (distinct 0 0)))))
(assert (=> (= cat_225 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_240)) (= cat_242 cat_220))))
(assert (=> (not (= cat_225 true)) (= cat_240 cat_221)))
(assert (=> (not (= cat_225 true)) (= cat_242 cat_220)))
(assert (=> (not (= cat_225 true)) (= cat_244 cat_225)))
(assert (= cat_244 true))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_242 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_242 cat_170)))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_238 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_234))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_238 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_234))))
(assert (= cat_209 (fp.mul roundNearestTiesToEven cat_208 cat_228)))
...
(assert (= cat_213 (fp.mul roundNearestTiesToEven cat_242 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_242 cat_170)))
(assert (= cat_214 (fp.mul roundNearestTiesToEven cat_213 cat_228)))
(assert (= cat_215 cat_214))
(assert (spoon_1 cat_214))
(assert (= cat_216 (fp.mul roundNearestTiesToEven cat_238 cat_240)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_238 cat_240)))
(assert (= cat_217 (fp.sub roundNearestTiesToEven cat_216 cat_215)))
(assert (not (spoon_1 cat_217)))
(check-sat)
(exit)
