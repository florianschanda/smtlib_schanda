...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_218 cat_222))) (and (= cat_207 _let_0) (spoon_3 _let_0))))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_207 cat_226)))
