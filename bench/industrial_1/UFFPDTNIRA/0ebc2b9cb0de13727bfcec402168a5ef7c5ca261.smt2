...
(declare-fun cat_207 () Bool)
(declare-fun cat_208 () potato_28)
...
(assert (= cat_201 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_201))
(assert (= cat_202 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_202))
(assert (= cat_203 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_203))
(assert (= cat_204 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_204))
(assert (= cat_205 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_154 cat_205))
(assert (= cat_206 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_86 cat_206))
...
(assert (= cat_207 (ite (not (= cat_200 true)) true false)))
(assert (= cat_207 true))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_208)))))
(assert (not (fp.lt (spoon_111 (get_potato_28_a cat_208)) (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))))
(assert (not (spoon_78 (spoon_111 (get_potato_28_a cat_208)))))
(check-sat)
(exit)
