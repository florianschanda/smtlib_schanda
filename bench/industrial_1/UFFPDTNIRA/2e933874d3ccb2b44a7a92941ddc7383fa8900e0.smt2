...
(assert (not (spoon_3 (fp.div roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))) (spoon_47 (get_potato_14_b (get_potato_16_a cat_67))))) ((_ to_fp 11 53) roundNearestTiesToEven (spoon_47 (get_potato_14_b cat_128)))))))
(check-sat)
(exit)
