...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (let ((_let_1 (fp.neg _let_0))) (=> (=> (not (fp.lt cat_71 _let_1)) (=> (not (fp.lt _let_0 cat_71)) (=> (not (fp.lt cat_72 _let_1)) (fp.lt _let_0 cat_72)))) (and (and (and (fp.leq _let_1 cat_73) (fp.leq cat_73 _let_0)) (and (fp.leq _let_1 cat_74) (fp.leq cat_74 _let_0))) (and (spoon_60 cat_74) (spoon_60 cat_73)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (let ((_let_1 (fp.neg _let_0))) (=> (not (=> (not (fp.lt cat_71 _let_1)) (=> (not (fp.lt _let_0 cat_71)) (=> (not (fp.lt cat_72 _let_1)) (fp.lt _let_0 cat_72))))) (= cat_74 cat_72)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))) (let ((_let_1 (fp.neg _let_0))) (=> (not (=> (not (fp.lt cat_71 _let_1)) (=> (not (fp.lt _let_0 cat_71)) (=> (not (fp.lt cat_72 _let_1)) (fp.lt _let_0 cat_72))))) (= cat_73 cat_71)))))
(assert (not (spoon_27 cat_74)))
(check-sat)
(exit)
