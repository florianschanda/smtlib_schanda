...
(declare-fun cat_257 () (_ FloatingPoint 8 24))
(declare-fun cat_258 () potato_7)
(declare-fun cat_259 () Bool)
(declare-fun cat_260 () potato_29)
(declare-fun cat_261 () potato_28)
...
(define-fun spoon_290 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_256 cat_215))
(assert (= cat_257 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_257))
...
(assert (= cat_258 (mk_potato_7 cat_203)))
(assert (= cat_259 (distinct 1 0)))
(assert (= cat_260 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_261 (get_potato_30_a cat_138)))
(assert (= cat_262 (mk_potato_11 cat_206)))
(assert (= cat_263 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_264 (mk_potato_11 cat_204)))
(assert (= cat_265 cat_224))
...
(assert (= cat_266 (mk_potato_11 cat_205)))
(assert (= cat_267 cat_225))
(assert (= cat_268 (mk_potato_11 cat_207)))
(assert (= cat_269 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_263))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
(assert (= cat_270 (mk_potato_11 cat_208)))
(assert (= cat_271 cat_226))
...
(assert (= cat_274 (mk_potato_11 cat_210)))
(assert (= cat_275 cat_232))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_269 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_275)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_271 cat_265))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_267)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_273)))
...
(assert (= cat_276 (mk_potato_11 cat_213)))
(assert (= cat_277 cat_242))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_271 cat_265))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_267)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_278 (mk_potato_11 cat_214)))
(assert (= cat_279 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_277 cat_279))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_280 (mk_potato_11 cat_212)))
(assert (= cat_281 cat_246))
(assert (=> (fp.lt cat_281 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_282 spoon_290)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_281 _let_0) (= cat_283 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_281) (= cat_284 spoon_290)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_281) (= cat_285 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_281)) (and (= cat_247 cat_281) (spoon_3 cat_281))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_281)) (= cat_286 spoon_290)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_281)) (= cat_287 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_281 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_281)) (= cat_285 cat_287)))))
(assert (=> (not (fp.lt cat_281 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_283 cat_285)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_269 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_288 (mk_potato_11 cat_216)))
(assert (= cat_289 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_269 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_273)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_271 cat_265))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_267)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_275)))
(assert (not (spoon_3 cat_252)))
(check-sat)
(exit)
