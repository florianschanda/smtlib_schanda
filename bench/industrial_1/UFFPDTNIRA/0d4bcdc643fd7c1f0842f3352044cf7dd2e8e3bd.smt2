...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)))) (not (not (fp.eq (fp.abs (fp.rem cat_51 _let_0)) (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv125 8) (_ bv0 23)) _let_0))))))
(check-sat)
(exit)
