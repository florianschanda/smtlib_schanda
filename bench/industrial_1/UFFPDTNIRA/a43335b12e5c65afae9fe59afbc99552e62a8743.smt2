...
(assert (= cat_147 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_148 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_149 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_147 cat_147) (fp.mul roundNearestTiesToEven cat_148 cat_148))))
(assert (not (fp.lt cat_149 (fp (_ bv0 1) (_ bv113 8) (_ bv5355287 23)))))
(assert (let ((_let_0 (get_potato_19_a cat_88))) (let ((_let_1 (get_potato_19_a cat_86))) (= cat_150 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a _let_1)) (spoon_48 (get_potato_17_a _let_0))) cat_147) (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b _let_1)) (spoon_48 (get_potato_17_b _let_0))) cat_148))))))
(assert (= cat_143 (fp.div roundNearestTiesToEven cat_150 cat_149)))
(assert (spoon_1 (fp.div roundNearestTiesToEven cat_150 cat_149)))
(assert (= cat_144 cat_143))
(assert (= cat_151 cat_144))
(assert (spoon_1 cat_143))
(assert (not (fp.leq cat_151 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (not (fp.leq (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_151)))
(assert (= cat_145 cat_149))
