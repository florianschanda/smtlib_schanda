...
(assert (not (not (fp.isZero (fp.sub roundNearestTiesToEven (spoon_40 (get_potato_15_a (get_potato_17_a cat_62))) (spoon_40 (get_potato_15_a (get_potato_17_a cat_60))))))))
(check-sat)
(exit)
