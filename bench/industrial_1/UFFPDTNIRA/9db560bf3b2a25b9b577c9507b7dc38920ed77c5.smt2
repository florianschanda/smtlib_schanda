...
(assert (not (fp.lt cat_77 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))))
(assert (fp.lt (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)) cat_77))
(assert (= (mk_potato_10 cat_84) (mk_potato_10 cat_77)))
(assert (= cat_85 (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))))
