...
(assert (= cat_215 true))
(assert (= cat_205 (fp.sub roundNearestTiesToEven cat_226 cat_224)))
(assert (spoon_1 (fp.sub roundNearestTiesToEven cat_226 cat_224)))
(assert (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_218 cat_218))))
(assert (= cat_207 cat_206))
(assert (= cat_229 cat_207))
(assert (spoon_1 cat_206))
(assert (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_229))
