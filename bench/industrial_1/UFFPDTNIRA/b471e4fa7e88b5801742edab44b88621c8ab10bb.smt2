...
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (spoon_37 (get_potato_15_b (get_potato_17_a cat_64))) (spoon_37 (get_potato_15_b (get_potato_17_a cat_66)))))) (not (spoon_1 (fp.mul roundNearestTiesToEven _let_0 _let_0)))))
(check-sat)
(exit)
