...
(assert (= cat_119 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_115)))
(assert (spoon_1 (fp.div roundNearestTiesToEven (spoon_75 cat_113) cat_115)))
(assert (= cat_120 (fp.mul roundNearestTiesToEven cat_119 cat_114)))
