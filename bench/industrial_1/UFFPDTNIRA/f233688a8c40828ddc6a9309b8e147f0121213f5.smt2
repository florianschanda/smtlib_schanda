...
(declare-fun cat_253 () potato_29)
(declare-fun cat_254 () potato_28)
...
(define-fun spoon_283 () potato_11 (mk_potato_11 cat_211))
...
(assert (= cat_249 cat_215))
(assert (= cat_250 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_250))
...
(assert (= cat_251 (mk_potato_7 cat_203)))
(assert (= cat_252 (distinct 1 0)))
(assert (= cat_253 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_254 (get_potato_30_a cat_138)))
(assert (= cat_255 (mk_potato_11 cat_206)))
(assert (= cat_256 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_257 (mk_potato_11 cat_204)))
(assert (= cat_258 cat_224))
...
(assert (= cat_259 (mk_potato_11 cat_205)))
(assert (= cat_260 cat_225))
(assert (= cat_261 (mk_potato_11 cat_207)))
(assert (= cat_262 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_256))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
(assert (= cat_263 (mk_potato_11 cat_208)))
(assert (= cat_264 cat_226))
...
(assert (= cat_265 (mk_potato_11 cat_209)))
(assert (= cat_266 cat_229))
...
(assert (= cat_267 (mk_potato_11 cat_210)))
(assert (= cat_268 cat_232))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_262 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_268)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_264 cat_258))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_260)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_266)))
...
(assert (= cat_269 (mk_potato_11 cat_213)))
(assert (= cat_270 cat_242))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_264 cat_258))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_260)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_271 (mk_potato_11 cat_214)))
(assert (= cat_272 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_270 cat_272))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_273 (mk_potato_11 cat_212)))
(assert (= cat_274 cat_246))
(assert (=> (fp.lt cat_274 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_275 spoon_283)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_274 _let_0) (= cat_276 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_274) (= cat_277 spoon_283)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_274) (= cat_278 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_274)) (and (= cat_247 cat_274) (spoon_3 cat_274))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_274)) (= cat_279 spoon_283)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_274)) (= cat_280 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_274 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_274)) (= cat_278 cat_280)))))
(assert (=> (not (fp.lt cat_274 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_276 cat_278)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_262 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_281 (mk_potato_11 cat_216)))
(assert (= cat_282 cat_248))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven cat_262 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))))
(check-sat)
(exit)
