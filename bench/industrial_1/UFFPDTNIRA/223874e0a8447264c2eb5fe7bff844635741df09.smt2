...
(assert (= cat_109 cat_103))
(assert (= cat_104 (spoon_50 cat_70 cat_72)))
(assert (spoon_52 cat_104))
(assert (= cat_110 cat_104))
(assert (= cat_111 (fp.sub roundNearestTiesToEven cat_110 cat_109)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_111 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))) (=> (fp.leq (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_111) (and (= cat_105 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_111) (= cat_112 cat_97)))
(assert (=> (fp.leq (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_111) (= cat_113 cat_105)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven cat_111 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))) (=> (not (fp.leq _let_0 cat_111)) (=> (fp.leq cat_111 (fp.neg _let_0)) (and (= cat_106 _let_1) (spoon_1 _let_1)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (fp.leq cat_111 (fp.neg _let_0)) (= cat_114 cat_97)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (fp.leq cat_111 (fp.neg _let_0)) (= cat_115 cat_106)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (not (fp.leq cat_111 (fp.neg _let_0))) (and (= cat_107 cat_111) (spoon_1 cat_111))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (not (fp.leq cat_111 (fp.neg _let_0))) (= cat_116 cat_97)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (not (fp.leq cat_111 (fp.neg _let_0))) (= cat_117 cat_107)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)))) (=> (not (fp.leq _let_0 cat_111)) (=> (not (fp.leq cat_111 (fp.neg _let_0))) (= cat_115 cat_117)))))
(assert (=> (not (fp.leq (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_111)) (= cat_113 cat_115)))
(assert (= cat_118 (fp.div roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv134 8) (_ bv3407872 23)) cat_113) (fp (_ bv0 1) (_ bv128 8) (_ bv0 23)))))
(assert (= cat_108 (fp.add roundNearestTiesToEven cat_110 cat_118)))
(assert (= cat_119 cat_108))
(assert (spoon_1 (fp.add roundNearestTiesToEven cat_110 cat_118)))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23)) cat_119)))
(assert (not (spoon_52 cat_119)))
(check-sat)
(exit)
