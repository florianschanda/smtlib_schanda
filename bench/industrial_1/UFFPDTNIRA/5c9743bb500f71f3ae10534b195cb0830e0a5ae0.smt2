...
(assert (= cat_144 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_88))))))
(assert (= cat_145 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b (get_potato_19_a cat_90))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_88))))))
(assert (= cat_146 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_144 cat_144) (fp.mul roundNearestTiesToEven cat_145 cat_145))))
(assert (not (fp.lt cat_146 (fp (_ bv0 1) (_ bv113 8) (_ bv5355287 23)))))
(assert (let ((_let_0 (get_potato_19_a cat_88))) (let ((_let_1 (get_potato_19_a cat_86))) (= cat_147 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a _let_1)) (spoon_48 (get_potato_17_a _let_0))) cat_144) (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b _let_1)) (spoon_48 (get_potato_17_b _let_0))) cat_145))))))
(assert (= cat_143 (fp.div roundNearestTiesToEven cat_147 cat_146)))
(assert (spoon_1 (fp.div roundNearestTiesToEven cat_147 cat_146)))
(assert (not (spoon_100 cat_143)))
(check-sat)
(exit)
