...
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_124) (= (mk_potato_11 cat_125) spoon_136)))
...
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_124) (= cat_127 spoon_135)))
...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))) (=> (not (fp.lt _let_0 cat_124)) (=> (fp.lt cat_124 (fp.neg _let_0)) (= cat_129 spoon_136)))))
...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))) (=> (not (fp.lt _let_0 cat_124)) (=> (fp.lt cat_124 (fp.neg _let_0)) (= cat_131 spoon_135)))))
...
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))) (=> (not (fp.lt _let_0 cat_124)) (=> (not (fp.lt cat_124 (fp.neg _let_0))) (= cat_133 spoon_135)))))
...
(assert (not (spoon_40 (fp.add roundNearestTiesToEven (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a cat_128))))))
(check-sat)
(exit)
