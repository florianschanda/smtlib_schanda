...
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_253)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_253)))
(assert (not (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_254))))
(check-sat)
(exit)
