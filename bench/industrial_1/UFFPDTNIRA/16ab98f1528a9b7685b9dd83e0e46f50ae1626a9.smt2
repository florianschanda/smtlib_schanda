...
(declare-fun cat_238 () Bool)
(declare-fun cat_239 () Bool)
(declare-fun cat_240 () potato_28)
...
(declare-fun cat_257 () potato_7)
(declare-fun cat_258 () Bool)
(declare-fun cat_259 () (_ FloatingPoint 8 24))
(declare-fun cat_260 () (_ FloatingPoint 8 24))
(declare-fun cat_261 () Bool)
...
(assert (= cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_232))
(assert (= cat_233 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_233))
(assert (= cat_234 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_234))
(assert (= cat_235 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_1 cat_235))
(assert (= cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_154 cat_236))
(assert (= cat_237 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_86 cat_237))
...
(assert (= cat_238 (ite (not (= cat_200 true)) true false)))
(assert (= cat_238 true))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (=> (= cat_239 true) (=> (fp.lt _let_0 (spoon_111 (get_potato_28_a cat_240))) (and (= cat_201 (spoon_76 _let_0)) (spoon_86 cat_201))))))
(assert (=> (= cat_239 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_240))) (= cat_241 (mk_potato_10 cat_237)))))
(assert (=> (= cat_239 true) (=> (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_240))) (= cat_242 cat_201))))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23))))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) _let_1)) (=> (fp.lt _let_1 _let_0) (and (= cat_202 (spoon_76 _let_0)) (spoon_86 cat_202))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_243 (mk_potato_10 cat_237))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (fp.lt _let_1 (fp.neg _let_0)) (= cat_244 cat_202)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_203 _let_1) (spoon_1 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (and (= cat_204 (spoon_76 cat_203)) (spoon_86 cat_204))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_245 (mk_potato_10 cat_237))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_246 cat_204)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)))) (let ((_let_1 (spoon_111 (get_potato_28_a cat_240)))) (=> (= cat_239 true) (=> (not (fp.lt _let_0 _let_1)) (=> (not (fp.lt _let_1 (fp.neg _let_0))) (= cat_244 cat_246)))))))
(assert (=> (= cat_239 true) (=> (not (fp.lt (fp (_ bv0 1) (_ bv133 8) (_ bv3406568 23)) (spoon_111 (get_potato_28_a cat_240)))) (= cat_242 cat_244))))
(assert (=> (= cat_239 true) (= cat_247 (mk_potato_10 cat_236))))
(assert (=> (= cat_239 true) (= cat_248 (fp.mul roundNearestTiesToEven cat_170 cat_170))))
(assert (=> (= cat_239 true) (= cat_249 (mk_potato_10 cat_233))))
(assert (=> (= cat_239 true) (= cat_250 ((_ to_fp 8 24) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) (fp.mul roundNearestTiesToEven cat_166 cat_166))))))
(assert (=> (= cat_239 true) (= cat_251 (mk_potato_10 cat_232))))
(assert (=> (= cat_239 true) (= cat_252 (fp.sqrt roundNearestTiesToEven cat_250))))
(assert (=> (not (= cat_239 true)) (= cat_242 cat_237)))
(assert (=> (not (= cat_239 true)) (= cat_248 cat_236)))
(assert (=> (not (= cat_239 true)) (= cat_250 cat_233)))
(assert (=> (not (= cat_239 true)) (= cat_252 cat_232)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_250 cat_248))) (=> (= cat_239 true) (and (= cat_205 _let_0) (spoon_1 _let_0)))))
(assert (=> (= cat_239 true) (= cat_206 (fp.add roundNearestTiesToEven cat_205 (fp.mul roundNearestTiesToEven cat_242 cat_242)))))
(assert (=> (= cat_239 true) (and (= cat_207 cat_206) (spoon_1 cat_206))))
(assert (=> (= cat_239 true) (= cat_253 (mk_potato_10 cat_235))))
(assert (=> (= cat_239 true) (= cat_254 cat_207)))
(assert (=> (= cat_239 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254) (= cat_255 (mk_potato_10 cat_234)))))
(assert (=> (= cat_239 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254) (= cat_256 (fp.sqrt roundNearestTiesToEven cat_254)))))
(assert (=> (= cat_239 true) (=> (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254) (= cat_258 cat_239))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254)) (= cat_257 (mk_potato_7 cat_239)))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254)) (= cat_258 (distinct 0 0)))))
(assert (=> (= cat_239 true) (=> (not (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_254)) (= cat_256 cat_234))))
(assert (=> (not (= cat_239 true)) (= cat_254 cat_235)))
(assert (=> (not (= cat_239 true)) (= cat_256 cat_234)))
(assert (=> (not (= cat_239 true)) (= cat_258 cat_239)))
(assert (= cat_258 true))
(assert (= cat_210 (fp.mul roundNearestTiesToEven cat_256 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_256 cat_170)))
(assert (= cat_208 (fp.mul roundNearestTiesToEven cat_252 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_248))))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_252 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_166 cat_166)) cat_248))))
(assert (= cat_209 (fp.mul roundNearestTiesToEven cat_208 cat_242)))
...
(assert (= cat_259 cat_213))
(assert (spoon_1 cat_212))
(assert (= cat_214 (fp.mul roundNearestTiesToEven cat_256 cat_170)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_256 cat_170)))
(assert (= cat_215 (fp.mul roundNearestTiesToEven cat_214 cat_242)))
(assert (= cat_216 cat_215))
(assert (spoon_1 cat_215))
(assert (= cat_217 (fp.mul roundNearestTiesToEven cat_252 cat_254)))
(assert (spoon_1 (fp.mul roundNearestTiesToEven cat_252 cat_254)))
(assert (= cat_218 (fp.sub roundNearestTiesToEven cat_217 cat_216)))
(assert (= cat_219 cat_218))
(assert (= cat_260 cat_219))
(assert (spoon_1 cat_218))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_260))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (and (= cat_228 _let_0) (spoon_1 _let_0)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_259))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (and (= cat_229 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (= cat_230 (ite (fp.leq cat_229 cat_228) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_259))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (and (= cat_226 _let_0) (spoon_1 _let_0)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))) cat_260))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (and (= cat_227 _let_0) (spoon_1 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (= cat_231 (ite (fp.leq cat_227 cat_226) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260) (= cat_262 (ite (= cat_231 true) cat_230 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_260)) (= cat_262 false)))
(assert (=> (= cat_262 true) (= cat_261 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23))) cat_260))) (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_222 _let_0) (spoon_1 _let_0))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_259))) (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_223 _let_0) (spoon_1 _let_0))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_224 (ite (fp.leq cat_223 cat_222) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_259))) (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_220 _let_0) (spoon_1 _let_0))))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv133 8) (_ bv3407872 23)) cat_260))) (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (and (= cat_221 _let_0) (spoon_1 _let_0))))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_225 (ite (fp.leq cat_221 cat_220) true false)))))
(assert (=> (not (= cat_262 true)) (=> (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_261 (ite (= cat_225 true) cat_224 false)))))
(assert (=> (not (= cat_262 true)) (=> (not (fp.lt cat_260 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_261 false))))
(assert (= cat_261 true))
(assert (not (spoon_1 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv132 8) (_ bv6631136 23)) cat_259))))
(check-sat)
(exit)
