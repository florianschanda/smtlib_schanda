...
(assert (= cat_174 (mk_potato_22 (mk_potato_21 cat_141 cat_142))))
(assert (= cat_175 (mk_potato_21 cat_152 cat_153)))
(assert (= (spoon_63 cat_154) (fp.neg (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) (spoon_63 (get_potato_21_b cat_175))))))
(assert (= cat_154 cat_155))
(assert (= (get_potato_21_a cat_175) cat_156))
(assert (= cat_157 cat_155))
(assert (= cat_158 cat_156))
(assert (= cat_176 (mk_potato_22 (mk_potato_21 cat_139 cat_140))))
(assert (= cat_177 (mk_potato_21 cat_157 cat_158)))
...
(assert (= cat_178 (mk_potato_22 (mk_potato_21 cat_135 cat_136))))
(assert (= cat_179 (mk_potato_21 cat_163 cat_164)))
...
(assert (= cat_180 (mk_potato_22 (mk_potato_21 cat_137 cat_138))))
(assert (= cat_181 (get_potato_23_a cat_168)))
(assert (let ((_let_0 (spoon_63 (get_potato_21_b cat_175)))) (let ((_let_1 (mk_potato_23 cat_175))) (let ((_let_2 (spoon_63 (get_potato_21_a cat_175)))) (and (= cat_169 (spoon_83 _let_1 _let_1)) (and (spoon_85 cat_169) (= cat_169 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_2 _let_2) (fp.mul roundNearestTiesToEven _let_0 _let_0)))))))))
(assert (= cat_182 (mk_potato_10 cat_143)))
(assert (= cat_183 cat_169))
(assert (and (= cat_170 (spoon_83 (mk_potato_23 cat_179) (mk_potato_23 cat_177))) (and (spoon_85 cat_170) (= cat_170 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_179)) (spoon_63 (get_potato_21_a cat_177))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_179)) (spoon_63 (get_potato_21_b cat_177))))))))
(assert (and (= cat_171 (spoon_83 (mk_potato_23 cat_181) (mk_potato_23 cat_177))) (and (spoon_85 cat_171) (= cat_171 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_a cat_181)) (spoon_63 (get_potato_21_a cat_177))) (fp.mul roundNearestTiesToEven (spoon_63 (get_potato_21_b cat_181)) (spoon_63 (get_potato_21_b cat_177))))))))
(assert (= cat_172 (fp.sub roundNearestTiesToEven cat_171 cat_170)))
(assert (= cat_184 (mk_potato_10 cat_145)))
(assert (= cat_185 cat_172))
(assert (let ((_let_0 (fp.sqrt roundNearestTiesToEven cat_183))) (and (= cat_173 _let_0) (spoon_1 _let_0))))
(assert (= cat_186 (mk_potato_10 cat_146)))
(assert (= cat_187 cat_173))
(assert (not (fp.leq (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv182 8) (_ bv0 23)) cat_187) (fp.abs cat_185))))
