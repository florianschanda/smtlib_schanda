...
(declare-fun cat_178 () potato_27)
(declare-fun cat_179 () potato_27)
(declare-fun cat_180 () potato_31)
...
(assert (= cat_177 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_89 cat_177))
...
(assert (= cat_167 cat_178))
(assert (= cat_168 cat_179))
...
(assert (= cat_180 (mk_potato_31 cat_173 cat_174)))
(assert (= cat_181 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_104 cat_178) (spoon_104 (get_potato_31_a cat_180))) (fp.mul roundNearestTiesToEven (spoon_104 cat_179) (spoon_104 (get_potato_31_b cat_180))))))
(assert (= cat_175 (spoon_79 cat_108 cat_106)))
(assert (spoon_81 cat_175))
(assert (= cat_182 cat_175))
(assert (= cat_176 (spoon_79 cat_108 cat_110)))
(assert (spoon_81 cat_176))
(assert (= cat_183 cat_176))
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_182))
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_183))
(assert (not (spoon_1 (fp.div roundNearestTiesToEven cat_181 (fp.mul roundNearestTiesToEven cat_182 cat_183)))))
(check-sat)
(exit)
