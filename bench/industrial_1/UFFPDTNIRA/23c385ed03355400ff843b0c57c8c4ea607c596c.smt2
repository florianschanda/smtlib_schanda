...
(declare-fun cat_181 () potato_27)
(declare-fun cat_182 () potato_31)
...
(assert (= cat_179 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_183 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_104 cat_180) (spoon_104 (get_potato_31_a cat_182))) (fp.mul roundNearestTiesToEven (spoon_104 cat_181) (spoon_104 (get_potato_31_b cat_182))))))
...
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_185))
(assert (= cat_177 (fp.div roundNearestTiesToEven cat_183 (fp.mul roundNearestTiesToEven cat_184 cat_185))))
(assert (spoon_1 (fp.div roundNearestTiesToEven cat_183 (fp.mul roundNearestTiesToEven cat_184 cat_185))))
(assert (= cat_178 cat_177))
(assert (= cat_186 cat_178))
(assert (spoon_1 cat_177))
(assert (not (fp.lt cat_186 (fp.neg (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))))))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_186)))
