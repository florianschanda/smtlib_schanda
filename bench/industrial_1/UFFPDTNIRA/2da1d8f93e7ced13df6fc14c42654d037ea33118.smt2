...
(assert (not (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_138)))
(assert (fp.lt cat_138 (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))))
(assert (fp.lt (spoon_47 (get_potato_14_b cat_130)) (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))) (spoon_47 (get_potato_14_b (get_potato_16_a cat_67))))) ((_ to_fp 11 53) roundNearestTiesToEven (spoon_47 (get_potato_14_b cat_130)))))) (and (= cat_122 _let_0) (spoon_3 _let_0))))
(assert (and (= cat_123 cat_122) (spoon_3 cat_122)))
(assert (= cat_139 (mk_potato_11 cat_128)))
(assert (= cat_140 cat_123))
(assert (not (spoon_40 (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))) (spoon_47 (get_potato_14_b (get_potato_16_a cat_67)))))))
(check-sat)
(exit)
