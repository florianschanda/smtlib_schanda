...
(declare-fun cat_102 () (_ FloatingPoint 11 53))
(declare-fun cat_103 () (_ FloatingPoint 11 53))
...
(assert (= cat_103 ((_ to_fp 11 53) roundNearestTiesToEven (fp.add roundNearestTiesToEven (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_69)))))))
(assert (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_103))
(assert (not (fp.lt (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))))))
(check-sat)
(exit)
