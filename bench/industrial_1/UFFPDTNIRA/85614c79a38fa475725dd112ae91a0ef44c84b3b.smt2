...
(declare-fun cat_171 () potato_21)
(declare-fun cat_172 () potato_21)
(declare-fun cat_173 () potato_23)
(declare-fun cat_174 () potato_25)
(declare-fun cat_175 () potato_21)
(declare-fun cat_176 () potato_21)
(declare-fun cat_177 () potato_23)
(declare-fun cat_178 () potato_25)
(declare-fun cat_179 () potato_21)
(declare-fun cat_180 () potato_21)
(declare-fun cat_181 () potato_23)
(declare-fun cat_182 () potato_25)
...
(declare-fun cat_190 () (_ FloatingPoint 8 24))
(declare-fun cat_191 () (_ FloatingPoint 8 24))
(declare-fun cat_192 () (_ FloatingPoint 8 24))
(declare-fun cat_193 () potato_13)
(declare-fun cat_194 () potato_15)
(declare-fun cat_195 () potato_17)
(declare-fun cat_196 () potato_24)
(declare-fun cat_197 () potato_23)
(declare-fun cat_198 () potato_24)
(declare-fun cat_199 () potato_23)
(declare-fun cat_200 () potato_24)
(declare-fun cat_201 () potato_23)
...
(declare-fun cat_264 () potato_10)
(declare-fun cat_265 () (_ FloatingPoint 8 24))
(declare-fun cat_266 () potato_10)
(declare-fun cat_267 () (_ FloatingPoint 8 24))
(declare-fun cat_268 () potato_10)
(declare-fun cat_269 () (_ FloatingPoint 8 24))
(declare-fun cat_270 () potato_16)
(declare-fun cat_271 () potato_15)
(define-fun spoon_272 () potato_10 (mk_potato_10 cat_166))
(define-fun spoon_273 () potato_10 (mk_potato_10 cat_164))
(define-fun spoon_274 () potato_10 (mk_potato_10 cat_151))
(define-fun spoon_275 () potato_10 (mk_potato_10 cat_150))
...
(assert (= (spoon_73 cat_171) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_114))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))))))
(assert (= (spoon_73 cat_172) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_114))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))))))
(assert (= cat_173 (mk_potato_23 cat_172 cat_171)))
(assert (= cat_174 (mk_potato_25 cat_173)))
(assert (= cat_196 (mk_potato_24 (mk_potato_23 cat_153 cat_154))))
(assert (= cat_197 (get_potato_25_a cat_174)))
(assert (= (spoon_73 cat_175) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_118))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_116))))))
(assert (= (spoon_73 cat_176) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_118))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_116))))))
(assert (= cat_177 (mk_potato_23 cat_176 cat_175)))
(assert (= cat_178 (mk_potato_25 cat_177)))
(assert (= cat_198 (mk_potato_24 (mk_potato_23 cat_155 cat_156))))
(assert (= cat_199 (get_potato_25_a cat_178)))
(assert (= (spoon_73 cat_179) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_116))))))
(assert (= (spoon_73 cat_180) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_116))))))
(assert (= cat_181 (mk_potato_23 cat_180 cat_179)))
(assert (= cat_182 (mk_potato_25 cat_181)))
(assert (= cat_200 (mk_potato_24 (mk_potato_23 cat_157 cat_158))))
(assert (= cat_201 (get_potato_25_a cat_182)))
(assert (let ((_let_0 (mk_potato_25 cat_197))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_197)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_197)))) (and (= cat_183 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_183) (= cat_183 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_202 (mk_potato_10 cat_159)))
(assert (= cat_203 cat_183))
(assert (and (= cat_184 (spoon_93 (mk_potato_25 cat_197) (mk_potato_25 cat_199))) (and (spoon_95 cat_184) (= cat_184 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_197)) (spoon_73 (get_potato_23_a cat_199))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_197)) (spoon_73 (get_potato_23_b cat_199))))))))
(assert (= cat_204 (mk_potato_10 cat_160)))
(assert (= cat_205 cat_184))
(assert (let ((_let_0 (mk_potato_25 cat_199))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_199)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_199)))) (and (= cat_185 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_185) (= cat_185 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_206 (mk_potato_10 cat_161)))
(assert (= cat_207 cat_185))
(assert (and (= cat_186 (spoon_93 (mk_potato_25 cat_197) (mk_potato_25 cat_201))) (and (spoon_95 cat_186) (= cat_186 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_197)) (spoon_73 (get_potato_23_a cat_201))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_197)) (spoon_73 (get_potato_23_b cat_201))))))))
(assert (= cat_208 (mk_potato_10 cat_162)))
(assert (= cat_209 cat_186))
(assert (and (= cat_187 (spoon_93 (mk_potato_25 cat_199) (mk_potato_25 cat_201))) (and (spoon_95 cat_187) (= cat_187 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_199)) (spoon_73 (get_potato_23_a cat_201))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_199)) (spoon_73 (get_potato_23_b cat_201))))))))
(assert (= cat_210 (mk_potato_10 cat_163)))
(assert (= cat_211 cat_187))
(assert (= cat_212 (mk_potato_10 cat_168)))
(assert (= cat_213 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_203 cat_207) (fp.mul roundNearestTiesToEven cat_205 cat_205))))
(assert (= cat_214 (mk_potato_10 cat_165)))
(assert (= cat_215 cat_213))
(assert (= cat_216 (mk_potato_10 cat_167)))
(assert (= cat_217 cat_213))
(assert (=> (fp.lt cat_213 cat_131) (= cat_218 spoon_273)))
(assert (=> (fp.lt cat_213 cat_131) (= cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (=> (fp.lt cat_213 cat_131) (= cat_220 (mk_potato_10 cat_215))))
(assert (=> (fp.lt cat_213 cat_131) (= cat_221 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))))
(assert (=> (fp.lt cat_213 cat_131) (= cat_222 spoon_272)))
(assert (=> (fp.lt cat_213 cat_131) (= cat_223 cat_211)))
(assert (=> (fp.lt cat_213 cat_131) (= cat_224 (mk_potato_10 cat_217))))
(assert (=> (fp.lt cat_213 cat_131) (= cat_225 cat_207)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_226 spoon_273)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_227 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_205 cat_211) (fp.mul roundNearestTiesToEven cat_207 cat_209)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_228 spoon_272)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_229 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_203 cat_211) (fp.mul roundNearestTiesToEven cat_205 cat_209)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_230 (mk_potato_10 cat_227)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 _let_0) (= cat_231 _let_0)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_232 (mk_potato_10 cat_229)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_233 cat_211))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_234 (mk_potato_10 cat_217)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_235 cat_207))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_236 (mk_potato_10 cat_227))))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_237 cat_215)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_238 (mk_potato_10 cat_229))))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_239 (fp.add roundNearestTiesToEven cat_211 cat_205))))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_240 (mk_potato_10 cat_217))))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 cat_227) (= cat_241 cat_207)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 cat_227)) (= cat_241 cat_217)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 cat_227)) (= cat_239 cat_229)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 cat_227)) (= cat_237 cat_227)))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_235 cat_241))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_233 cat_239))))
(assert (=> (not (fp.lt cat_213 cat_131)) (=> (not (fp.lt cat_227 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_231 cat_237))))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_225 cat_235)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_223 cat_233)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_221 cat_215)))
(assert (=> (not (fp.lt cat_213 cat_131)) (= cat_219 cat_231)))
(assert (=> (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_242 (mk_potato_10 cat_223))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_223 _let_0) (= cat_243 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_223 _let_0) (=> (fp.lt (fp.neg cat_209) _let_0) (= cat_244 (mk_potato_10 cat_219))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_223 _let_0) (=> (fp.lt (fp.neg cat_209) _let_0) (= cat_245 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_223 _let_0) (=> (fp.lt (fp.neg cat_209) _let_0) (= cat_251 cat_221)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_246 (mk_potato_10 cat_219))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_247 cat_221)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_251 cat_221)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_248 (mk_potato_10 cat_219))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_249 _let_1)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_250 (mk_potato_10 cat_221))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_251 cat_203)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_209))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_247 cat_249)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_223 _let_0) (=> (not (fp.lt (fp.neg cat_209) _let_0)) (= cat_245 cat_247)))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_225 cat_223) (= cat_252 (mk_potato_10 cat_223)))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_225 cat_223) (= cat_253 cat_225))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205) _let_0) (= cat_254 (mk_potato_10 cat_219)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205) _let_0) (= cat_255 _let_0))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205) _let_0) (= cat_261 cat_221))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_256 (mk_potato_10 cat_219)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_257 cat_221))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_203 _let_1) (= cat_261 cat_221))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_258 (mk_potato_10 cat_219)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_259 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_260 (mk_potato_10 cat_221)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_261 cat_203))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_203 _let_1)) (= cat_257 cat_259))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_223 _let_0)) (=> (fp.lt cat_225 cat_223) (=> (not (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_209) cat_205) _let_0)) (= cat_255 cat_257))))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_225 cat_223)) (= cat_253 cat_223))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_225 cat_223)) (= cat_261 cat_221))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_225 cat_223)) (= cat_255 cat_219))))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_243 cat_253)))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_251 cat_261)))
(assert (=> (not (fp.lt cat_223 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_245 cat_255)))
(assert (=> (fp.lt cat_251 cat_131) (= cat_262 spoon_275)))
(assert (=> (fp.lt cat_251 cat_131) (= cat_263 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_245 cat_251))) (=> (not (fp.lt cat_251 cat_131)) (and (= cat_188 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.lt cat_251 cat_131)) (and (= cat_189 cat_188) (spoon_1 cat_188))))
(assert (=> (not (fp.lt cat_251 cat_131)) (= cat_264 spoon_275)))
(assert (=> (not (fp.lt cat_251 cat_131)) (= cat_265 cat_189)))
(assert (=> (not (fp.lt cat_251 cat_131)) (= cat_263 cat_265)))
(assert (=> (fp.lt cat_225 cat_131) (= cat_266 spoon_274)))
(assert (=> (fp.lt cat_225 cat_131) (= cat_267 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_243 cat_225))) (=> (not (fp.lt cat_225 cat_131)) (and (= cat_190 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.lt cat_225 cat_131)) (and (= cat_191 cat_190) (spoon_1 cat_190))))
(assert (=> (not (fp.lt cat_225 cat_131)) (= cat_268 spoon_274)))
(assert (=> (not (fp.lt cat_225 cat_131)) (= cat_269 cat_191)))
(assert (=> (not (fp.lt cat_225 cat_131)) (= cat_267 cat_269)))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))) (fp.mul roundNearestTiesToEven cat_263 (spoon_73 (get_potato_23_a cat_197)))))) (and (= cat_192 _let_0) (spoon_1 _let_0))))
(assert (= (spoon_36 cat_193) cat_192))
(assert (= cat_194 (mk_potato_15 cat_193 cat_170)))
(assert (= cat_195 (mk_potato_17 cat_194)))
(assert (= cat_270 (mk_potato_16 (mk_potato_15 cat_169 cat_170))))
(assert (= cat_271 (get_potato_17_a cat_195)))
(assert (not (spoon_29 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))) (fp.mul roundNearestTiesToEven cat_263 (spoon_73 (get_potato_23_b cat_197)))))))
(check-sat)
(exit)
