...
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_117))) (and (= cat_132 _let_0) (spoon_1 _let_0))))
(assert (= cat_133 (fp.mul roundNearestTiesToEven cat_132 (fp.mul roundNearestTiesToEven cat_119 cat_119))))
(assert (and (= cat_134 cat_133) (spoon_1 cat_133)))
(assert (= cat_135 (fp.add roundNearestTiesToEven (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)) cat_134)))
(assert (and (= cat_136 cat_135) (spoon_1 cat_135)))
(assert (and (= cat_137 cat_136) (spoon_1 cat_136)))
(assert (= cat_137 cat_121))
(assert (spoon_72 cat_121))
(assert (not (or (fp.isZero cat_121) (fp.isPositive cat_121))))
(check-sat)
(exit)
