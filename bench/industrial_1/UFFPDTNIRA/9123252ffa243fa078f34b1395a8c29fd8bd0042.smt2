...
(assert (not (fp.lt (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)) cat_103)))
(assert (fp.lt cat_103 (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv0 52)))))
(assert (fp.lt (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))) (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (not (spoon_3 (fp.div roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven (fp.sub roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23))) (spoon_47 (get_potato_14_a (get_potato_16_a cat_67))))) ((_ to_fp 11 53) roundNearestTiesToEven (spoon_47 (get_potato_14_a (get_potato_16_a cat_69))))))))
(check-sat)
(exit)
