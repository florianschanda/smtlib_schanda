...
(declare-fun cat_256 () potato_7)
(declare-fun cat_257 () Bool)
(declare-fun cat_258 () potato_29)
(declare-fun cat_259 () potato_28)
...
(assert (= cat_255 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
...
(assert (= cat_261 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_267 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_261))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_267 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_273)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_269 cat_263))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_265)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_271)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_269 cat_263))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_265)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_276 (mk_potato_11 cat_214)))
(assert (= cat_277 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_275 cat_277))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_278 (mk_potato_11 cat_212)))
(assert (= cat_279 cat_246))
(assert (=> (fp.lt cat_279 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_280 spoon_288)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_279 _let_0) (= cat_281 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_279) (= cat_282 spoon_288)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_279) (= cat_283 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_279)) (and (= cat_247 cat_279) (spoon_3 cat_279))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_279)) (= cat_284 spoon_288)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_279)) (= cat_285 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_279 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_279)) (= cat_283 cat_285)))))
(assert (=> (not (fp.lt cat_279 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_281 cat_283)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_267 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_286 (mk_potato_11 cat_216)))
(assert (= cat_287 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_267 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_251 _let_0) (spoon_3 _let_0))))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_271)))
(assert (and (= cat_253 cat_252) (spoon_3 cat_252)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_269 cat_263))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_265)))
