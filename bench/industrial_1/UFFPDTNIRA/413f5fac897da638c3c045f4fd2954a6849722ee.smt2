...
(assert (let ((_let_0 (mk_potato_25 cat_189))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_189)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_189)))) (and (= cat_181 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_181) (= cat_181 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_194 (mk_potato_10 cat_159)))
(assert (= cat_195 cat_181))
(assert (and (= cat_182 (spoon_93 (mk_potato_25 cat_189) (mk_potato_25 cat_191))) (and (spoon_95 cat_182) (= cat_182 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_189)) (spoon_73 (get_potato_23_a cat_191))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_189)) (spoon_73 (get_potato_23_b cat_191))))))))
(assert (= cat_196 (mk_potato_10 cat_160)))
(assert (= cat_197 cat_182))
(assert (let ((_let_0 (mk_potato_25 cat_191))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_191)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_191)))) (and (= cat_183 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_183) (= cat_183 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_198 (mk_potato_10 cat_161)))
(assert (= cat_199 cat_183))
(assert (and (= cat_184 (spoon_93 (mk_potato_25 cat_189) (mk_potato_25 cat_193))) (and (spoon_95 cat_184) (= cat_184 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_189)) (spoon_73 (get_potato_23_a cat_193))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_189)) (spoon_73 (get_potato_23_b cat_193))))))))
(assert (= cat_200 (mk_potato_10 cat_162)))
(assert (= cat_201 cat_184))
(assert (and (= cat_185 (spoon_93 (mk_potato_25 cat_191) (mk_potato_25 cat_193))) (and (spoon_95 cat_185) (= cat_185 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_191)) (spoon_73 (get_potato_23_a cat_193))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_191)) (spoon_73 (get_potato_23_b cat_193))))))))
(assert (= cat_202 (mk_potato_10 cat_163)))
(assert (= cat_203 cat_185))
(assert (= cat_204 (mk_potato_10 cat_168)))
(assert (= cat_205 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_195 cat_199) (fp.mul roundNearestTiesToEven cat_197 cat_197))))
...
(assert (=> (fp.lt cat_205 cat_131) (= cat_211 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (=> (fp.lt cat_205 cat_131) (= cat_212 (mk_potato_10 cat_207))))
(assert (=> (fp.lt cat_205 cat_131) (= cat_213 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))))
...
(assert (=> (not (fp.lt cat_205 cat_131)) (= cat_219 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_197 cat_203) (fp.mul roundNearestTiesToEven cat_199 cat_201)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (= cat_220 spoon_258)))
(assert (=> (not (fp.lt cat_205 cat_131)) (= cat_221 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_195 cat_203) (fp.mul roundNearestTiesToEven cat_197 cat_201)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_222 (mk_potato_10 cat_219)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 _let_0) (= cat_223 _let_0)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_224 (mk_potato_10 cat_221)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_225 cat_203))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_226 (mk_potato_10 cat_209)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_227 cat_199))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_228 (mk_potato_10 cat_219))))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_229 cat_207)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_230 (mk_potato_10 cat_221))))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_231 (fp.add roundNearestTiesToEven cat_203 cat_197))))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_232 (mk_potato_10 cat_209))))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_207 cat_219) (= cat_233 cat_199)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_207 cat_219)) (= cat_233 cat_209)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_207 cat_219)) (= cat_231 cat_221)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_207 cat_219)) (= cat_229 cat_219)))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_227 cat_233))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_225 cat_231))))
(assert (=> (not (fp.lt cat_205 cat_131)) (=> (not (fp.lt cat_219 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_223 cat_229))))
...
(assert (=> (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_234 (mk_potato_10 cat_215))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 _let_0) (= cat_235 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 _let_0) (=> (fp.lt (fp.neg cat_201) _let_0) (= cat_236 (mk_potato_10 cat_211))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 _let_0) (=> (fp.lt (fp.neg cat_201) _let_0) (= cat_237 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 _let_0) (=> (fp.lt (fp.neg cat_201) _let_0) (= cat_243 cat_213)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_238 (mk_potato_10 cat_211))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_239 cat_213)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_243 cat_213)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_240 (mk_potato_10 cat_211))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_241 _let_1)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_242 (mk_potato_10 cat_213))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_243 cat_195)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_201))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_239 cat_241)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_215 _let_0) (=> (not (fp.lt (fp.neg cat_201) _let_0)) (= cat_237 cat_239)))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_217 cat_215) (= cat_244 (mk_potato_10 cat_215)))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_217 cat_215) (= cat_245 cat_217))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197) _let_0) (= cat_246 (mk_potato_10 cat_211)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197) _let_0) (= cat_247 _let_0))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197) _let_0) (= cat_253 cat_213))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_248 (mk_potato_10 cat_211)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_249 cat_213))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_195 _let_1) (= cat_253 cat_213))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_250 (mk_potato_10 cat_211)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_251 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_252 (mk_potato_10 cat_213)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_253 cat_195))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_195 _let_1)) (= cat_249 cat_251))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_215 _let_0)) (=> (fp.lt cat_217 cat_215) (=> (not (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_201) cat_197) _let_0)) (= cat_247 cat_249))))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_217 cat_215)) (= cat_245 cat_215))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_217 cat_215)) (= cat_253 cat_213))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_217 cat_215)) (= cat_247 cat_211))))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_235 cat_245)))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_243 cat_253)))
(assert (=> (not (fp.lt cat_215 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_237 cat_247)))
(assert (=> (fp.lt cat_243 cat_131) (= cat_254 spoon_260)))
(assert (=> (fp.lt cat_243 cat_131) (= cat_255 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_237 cat_243))) (=> (not (fp.lt cat_243 cat_131)) (and (= cat_186 _let_0) (spoon_1 _let_0)))))
...
(assert (not (spoon_1 (fp.div roundNearestTiesToEven cat_235 cat_217))))
(check-sat)
(exit)
