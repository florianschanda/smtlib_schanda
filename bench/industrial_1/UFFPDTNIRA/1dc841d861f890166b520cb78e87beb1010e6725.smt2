...
(assert (fp.lt cat_77 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))))
(assert (= (mk_potato_10 cat_84) (mk_potato_10 cat_77)))
(assert (= cat_85 (fp.neg (fp (_ bv0 1) (_ bv139 8) (_ bv0 23)))))
(assert (let ((_let_0 (get_potato_17_a cat_60))) (not (spoon_64 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_83 (fp.sub roundNearestTiesToEven cat_85 (spoon_40 (get_potato_15_a _let_0)))) (spoon_40 (get_potato_15_b _let_0)))))))
(check-sat)
(exit)
