...
(assert (not (fp.leq (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)) cat_254)))
(assert (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_254))
(assert (not (spoon_3 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv2046 11) (_ bv4503599627370495 52)) cat_254))))
(check-sat)
(exit)
