...
(declare-fun cat_171 () potato_16)
(declare-fun cat_172 () potato_21)
(declare-fun cat_173 () potato_21)
(declare-fun cat_174 () potato_23)
(declare-fun cat_175 () potato_25)
(declare-fun cat_176 () potato_21)
(declare-fun cat_177 () potato_21)
(declare-fun cat_178 () potato_23)
(declare-fun cat_179 () potato_25)
(declare-fun cat_180 () potato_21)
(declare-fun cat_181 () potato_21)
(declare-fun cat_182 () potato_23)
(declare-fun cat_183 () potato_25)
...
(declare-fun cat_194 () potato_13)
(declare-fun cat_195 () potato_15)
(declare-fun cat_196 () potato_17)
(declare-fun cat_197 () (_ FloatingPoint 8 24))
(declare-fun cat_198 () potato_13)
(declare-fun cat_199 () potato_15)
(declare-fun cat_200 () potato_17)
(declare-fun cat_201 () (_ FloatingPoint 8 24))
(declare-fun cat_202 () potato_13)
(declare-fun cat_203 () potato_15)
(declare-fun cat_204 () potato_17)
(declare-fun cat_205 () potato_24)
(declare-fun cat_206 () potato_23)
(declare-fun cat_207 () potato_24)
(declare-fun cat_208 () potato_23)
(declare-fun cat_209 () potato_24)
(declare-fun cat_210 () potato_23)
...
(declare-fun cat_261 () potato_10)
(declare-fun cat_262 () (_ FloatingPoint 8 24))
(declare-fun cat_263 () potato_10)
(declare-fun cat_264 () (_ FloatingPoint 8 24))
(declare-fun cat_265 () potato_10)
(declare-fun cat_266 () (_ FloatingPoint 8 24))
(declare-fun cat_267 () potato_10)
(declare-fun cat_268 () (_ FloatingPoint 8 24))
(declare-fun cat_269 () potato_10)
(declare-fun cat_270 () (_ FloatingPoint 8 24))
(declare-fun cat_271 () potato_10)
(declare-fun cat_272 () (_ FloatingPoint 8 24))
(declare-fun cat_273 () potato_10)
(declare-fun cat_274 () (_ FloatingPoint 8 24))
(declare-fun cat_275 () potato_10)
(declare-fun cat_276 () (_ FloatingPoint 8 24))
(declare-fun cat_277 () potato_10)
(declare-fun cat_278 () (_ FloatingPoint 8 24))
(declare-fun cat_279 () potato_16)
(declare-fun cat_280 () potato_15)
(declare-fun cat_281 () potato_16)
(declare-fun cat_282 () potato_15)
(declare-fun cat_283 () potato_16)
(declare-fun cat_284 () potato_15)
(define-fun spoon_285 () potato_10 (mk_potato_10 cat_166))
(define-fun spoon_286 () potato_10 (mk_potato_10 cat_164))
(define-fun spoon_287 () potato_10 (mk_potato_10 cat_151))
(define-fun spoon_288 () potato_10 (mk_potato_10 cat_150))
...
(assert (= (spoon_73 cat_172) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_114))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))))))
(assert (= (spoon_73 cat_173) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_114))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))))))
(assert (= cat_174 (mk_potato_23 cat_173 cat_172)))
(assert (= cat_175 (mk_potato_25 cat_174)))
(assert (= cat_205 (mk_potato_24 (mk_potato_23 cat_153 cat_154))))
(assert (= cat_206 (get_potato_25_a cat_175)))
(assert (= (spoon_73 cat_176) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_118))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_116))))))
(assert (= (spoon_73 cat_177) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_118))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_116))))))
(assert (= cat_178 (mk_potato_23 cat_177 cat_176)))
(assert (= cat_179 (mk_potato_25 cat_178)))
(assert (= cat_207 (mk_potato_24 (mk_potato_23 cat_155 cat_156))))
(assert (= cat_208 (get_potato_25_a cat_179)))
(assert (= (spoon_73 cat_180) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))) (spoon_36 (get_potato_15_b (get_potato_17_a cat_116))))))
(assert (= (spoon_73 cat_181) (fp.sub roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))) (spoon_36 (get_potato_15_a (get_potato_17_a cat_116))))))
(assert (= cat_182 (mk_potato_23 cat_181 cat_180)))
(assert (= cat_183 (mk_potato_25 cat_182)))
(assert (= cat_209 (mk_potato_24 (mk_potato_23 cat_157 cat_158))))
(assert (= cat_210 (get_potato_25_a cat_183)))
(assert (let ((_let_0 (mk_potato_25 cat_206))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_206)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_206)))) (and (= cat_184 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_184) (= cat_184 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_211 (mk_potato_10 cat_159)))
(assert (= cat_212 cat_184))
(assert (and (= cat_185 (spoon_93 (mk_potato_25 cat_206) (mk_potato_25 cat_208))) (and (spoon_95 cat_185) (= cat_185 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_206)) (spoon_73 (get_potato_23_a cat_208))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_206)) (spoon_73 (get_potato_23_b cat_208))))))))
(assert (= cat_213 (mk_potato_10 cat_160)))
(assert (= cat_214 cat_185))
(assert (let ((_let_0 (mk_potato_25 cat_208))) (let ((_let_1 (spoon_73 (get_potato_23_a cat_208)))) (let ((_let_2 (spoon_73 (get_potato_23_b cat_208)))) (and (= cat_186 (spoon_93 _let_0 _let_0)) (and (spoon_95 cat_186) (= cat_186 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven _let_1 _let_1) (fp.mul roundNearestTiesToEven _let_2 _let_2)))))))))
(assert (= cat_215 (mk_potato_10 cat_161)))
(assert (= cat_216 cat_186))
(assert (and (= cat_187 (spoon_93 (mk_potato_25 cat_206) (mk_potato_25 cat_210))) (and (spoon_95 cat_187) (= cat_187 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_206)) (spoon_73 (get_potato_23_a cat_210))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_206)) (spoon_73 (get_potato_23_b cat_210))))))))
(assert (= cat_217 (mk_potato_10 cat_162)))
(assert (= cat_218 cat_187))
(assert (and (= cat_188 (spoon_93 (mk_potato_25 cat_208) (mk_potato_25 cat_210))) (and (spoon_95 cat_188) (= cat_188 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_a cat_208)) (spoon_73 (get_potato_23_a cat_210))) (fp.mul roundNearestTiesToEven (spoon_73 (get_potato_23_b cat_208)) (spoon_73 (get_potato_23_b cat_210))))))))
(assert (= cat_219 (mk_potato_10 cat_163)))
(assert (= cat_220 cat_188))
(assert (= cat_221 (mk_potato_10 cat_168)))
(assert (= cat_222 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_212 cat_216) (fp.mul roundNearestTiesToEven cat_214 cat_214))))
(assert (= cat_223 (mk_potato_10 cat_165)))
(assert (= cat_224 cat_222))
(assert (= cat_225 (mk_potato_10 cat_167)))
(assert (= cat_226 cat_222))
(assert (=> (fp.lt cat_222 cat_131) (= cat_227 spoon_286)))
(assert (=> (fp.lt cat_222 cat_131) (= cat_228 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (=> (fp.lt cat_222 cat_131) (= cat_229 (mk_potato_10 cat_224))))
(assert (=> (fp.lt cat_222 cat_131) (= cat_230 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))))
(assert (=> (fp.lt cat_222 cat_131) (= cat_231 spoon_285)))
(assert (=> (fp.lt cat_222 cat_131) (= cat_232 cat_220)))
(assert (=> (fp.lt cat_222 cat_131) (= cat_233 (mk_potato_10 cat_226))))
(assert (=> (fp.lt cat_222 cat_131) (= cat_234 cat_216)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_235 spoon_286)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_236 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_214 cat_220) (fp.mul roundNearestTiesToEven cat_216 cat_218)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_237 spoon_285)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_238 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven cat_212 cat_220) (fp.mul roundNearestTiesToEven cat_214 cat_218)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_239 (mk_potato_10 cat_236)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 _let_0) (= cat_240 _let_0)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_241 (mk_potato_10 cat_238)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_242 cat_220))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_243 (mk_potato_10 cat_226)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_244 cat_216))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_245 (mk_potato_10 cat_236))))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_246 cat_224)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_247 (mk_potato_10 cat_238))))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_248 (fp.add roundNearestTiesToEven cat_220 cat_214))))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_249 (mk_potato_10 cat_226))))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_224 cat_236) (= cat_250 cat_216)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_224 cat_236)) (= cat_250 cat_226)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_224 cat_236)) (= cat_248 cat_238)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_224 cat_236)) (= cat_246 cat_236)))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_244 cat_250))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_242 cat_248))))
(assert (=> (not (fp.lt cat_222 cat_131)) (=> (not (fp.lt cat_236 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_240 cat_246))))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_234 cat_244)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_232 cat_242)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_230 cat_224)))
(assert (=> (not (fp.lt cat_222 cat_131)) (= cat_228 cat_240)))
(assert (=> (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (= cat_251 (mk_potato_10 cat_232))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_232 _let_0) (= cat_252 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_232 _let_0) (=> (fp.lt (fp.neg cat_218) _let_0) (= cat_253 (mk_potato_10 cat_228))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_232 _let_0) (=> (fp.lt (fp.neg cat_218) _let_0) (= cat_254 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_232 _let_0) (=> (fp.lt (fp.neg cat_218) _let_0) (= cat_260 cat_230)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_255 (mk_potato_10 cat_228))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_256 cat_230)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_260 cat_230)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_257 (mk_potato_10 cat_228))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_258 _let_1)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_259 (mk_potato_10 cat_230))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_260 cat_212)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.neg cat_218))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_256 cat_258)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_232 _let_0) (=> (not (fp.lt (fp.neg cat_218) _let_0)) (= cat_254 cat_256)))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_234 cat_232) (= cat_261 (mk_potato_10 cat_232)))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.lt cat_234 cat_232) (= cat_262 cat_234))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214) _let_0) (= cat_263 (mk_potato_10 cat_228)))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214) _let_0) (= cat_264 _let_0))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214) _let_0) (= cat_270 cat_230))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_265 (mk_potato_10 cat_228)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_266 cat_230))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (fp.lt cat_212 _let_1) (= cat_270 cat_230))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_267 (mk_potato_10 cat_228)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_268 _let_1))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_269 (mk_potato_10 cat_230)))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_270 cat_212))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (let ((_let_1 (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt _let_1 _let_0)) (=> (not (fp.lt cat_212 _let_1)) (= cat_266 cat_268))))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_232 _let_0)) (=> (fp.lt cat_234 cat_232) (=> (not (fp.lt (fp.add roundNearestTiesToEven (fp.neg cat_218) cat_214) _let_0)) (= cat_264 cat_266))))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_234 cat_232)) (= cat_262 cat_232))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_234 cat_232)) (= cat_270 cat_230))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (not (fp.lt cat_234 cat_232)) (= cat_264 cat_228))))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_252 cat_262)))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_260 cat_270)))
(assert (=> (not (fp.lt cat_232 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (= cat_254 cat_264)))
(assert (=> (fp.lt cat_260 cat_131) (= cat_271 spoon_288)))
(assert (=> (fp.lt cat_260 cat_131) (= cat_272 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_254 cat_260))) (=> (not (fp.lt cat_260 cat_131)) (and (= cat_189 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.lt cat_260 cat_131)) (and (= cat_190 cat_189) (spoon_1 cat_189))))
(assert (=> (not (fp.lt cat_260 cat_131)) (= cat_273 spoon_288)))
(assert (=> (not (fp.lt cat_260 cat_131)) (= cat_274 cat_190)))
(assert (=> (not (fp.lt cat_260 cat_131)) (= cat_272 cat_274)))
(assert (=> (fp.lt cat_234 cat_131) (= cat_275 spoon_287)))
(assert (=> (fp.lt cat_234 cat_131) (= cat_276 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_252 cat_234))) (=> (not (fp.lt cat_234 cat_131)) (and (= cat_191 _let_0) (spoon_1 _let_0)))))
(assert (=> (not (fp.lt cat_234 cat_131)) (and (= cat_192 cat_191) (spoon_1 cat_191))))
(assert (=> (not (fp.lt cat_234 cat_131)) (= cat_277 spoon_287)))
(assert (=> (not (fp.lt cat_234 cat_131)) (= cat_278 cat_192)))
(assert (=> (not (fp.lt cat_234 cat_131)) (= cat_276 cat_278)))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_112))) (fp.mul roundNearestTiesToEven cat_272 (spoon_73 (get_potato_23_a cat_206)))))) (and (= cat_193 _let_0) (spoon_1 _let_0))))
(assert (= (spoon_36 cat_194) cat_193))
(assert (= cat_195 (mk_potato_15 cat_194 cat_170)))
(assert (= cat_196 (mk_potato_17 cat_195)))
(assert (= cat_279 (mk_potato_16 (mk_potato_15 cat_169 cat_170))))
(assert (= cat_280 (get_potato_17_a cat_196)))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_112))) (fp.mul roundNearestTiesToEven cat_272 (spoon_73 (get_potato_23_b cat_206)))))) (and (= cat_197 _let_0) (spoon_1 _let_0))))
(assert (= (spoon_36 cat_198) cat_197))
(assert (= cat_199 (mk_potato_15 (get_potato_15_a cat_280) cat_198)))
(assert (= cat_200 (mk_potato_17 cat_199)))
(assert (= cat_281 (mk_potato_16 cat_280)))
(assert (= cat_282 (get_potato_17_a cat_200)))
(assert (let ((_let_0 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_a (get_potato_17_a cat_116))) (fp.mul roundNearestTiesToEven cat_276 (spoon_73 (get_potato_23_a cat_208)))))) (and (= cat_201 _let_0) (spoon_1 _let_0))))
(assert (= (spoon_36 cat_202) cat_201))
(assert (= cat_203 (mk_potato_15 cat_202 (get_potato_15_b (get_potato_16_a cat_171)))))
(assert (= cat_204 (mk_potato_17 cat_203)))
(assert (= cat_283 cat_171))
(assert (= cat_284 (get_potato_17_a cat_204)))
(assert (not (spoon_29 (fp.add roundNearestTiesToEven (spoon_36 (get_potato_15_b (get_potato_17_a cat_116))) (fp.mul roundNearestTiesToEven cat_276 (spoon_73 (get_potato_23_b cat_208)))))))
(check-sat)
(exit)
