...
(declare-fun cat_64 () (_ FloatingPoint 8 24))
...
(assert (fp.leq (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)) cat_64))
(assert (=> (fp.eq cat_58 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (fp.eq cat_64 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))))
(assert (=> (fp.eq cat_58 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23))) (fp.eq cat_64 cat_56)))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv127 8) (_ bv0 23)))) (=> (fp.eq cat_56 _let_0) (fp.eq cat_64 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23)))) (=> (fp.eq cat_56 _let_0) (fp.eq cat_64 _let_0))))
