...
(declare-fun cat_271 () potato_7)
(declare-fun cat_272 () Bool)
(declare-fun cat_273 () potato_29)
(declare-fun cat_274 () potato_28)
...
(declare-fun cat_299 () potato_11)
(declare-fun cat_300 () (_ FloatingPoint 11 53))
(declare-fun cat_301 () potato_11)
(declare-fun cat_302 () (_ FloatingPoint 11 53))
(declare-fun cat_303 () potato_11)
(declare-fun cat_304 () (_ FloatingPoint 11 53))
(declare-fun cat_305 () Bool)
(declare-fun cat_306 () Bool)
...
(assert (= cat_270 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (spoon_100 cat_270))
...
(assert (= cat_272 (distinct 1 0)))
(assert (= cat_273 (mk_potato_29 (mk_potato_28 cat_201 cat_202))))
(assert (= cat_274 (get_potato_30_a cat_138)))
(assert (= cat_275 (mk_potato_11 cat_206)))
(assert (= cat_276 (fp.mul roundNearestTiesToEven cat_181 cat_181)))
...
(assert (= cat_282 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_181)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1025 11) (_ bv0 52)) cat_276))) (and (= cat_226 _let_0) (spoon_3 _let_0))))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_282 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_237 _let_0) (spoon_3 _let_0))))
(assert (= cat_238 (fp.mul roundNearestTiesToEven cat_237 cat_288)))
(assert (and (= cat_239 cat_238) (spoon_3 cat_238)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_284 cat_278))) (and (= cat_233 _let_0) (spoon_3 _let_0))))
(assert (= cat_234 (fp.sub roundNearestTiesToEven cat_233 cat_280)))
(assert (and (= cat_235 cat_234) (spoon_3 cat_234)))
(assert (= cat_236 (fp.mul roundNearestTiesToEven cat_235 cat_286)))
...
(assert (let ((_let_0 (fp.add roundNearestTiesToEven cat_284 cat_278))) (and (= cat_243 _let_0) (spoon_3 _let_0))))
(assert (= cat_244 (fp.add roundNearestTiesToEven cat_243 cat_280)))
(assert (and (= cat_245 cat_244) (spoon_3 cat_244)))
(assert (= cat_291 (mk_potato_11 cat_214)))
(assert (= cat_292 cat_245))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_290 cat_292))) (and (= cat_246 _let_0) (spoon_3 _let_0))))
(assert (= cat_293 (mk_potato_11 cat_212)))
(assert (= cat_294 cat_246))
(assert (=> (fp.lt cat_294 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (= cat_295 spoon_307)))
(assert (let ((_let_0 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (=> (fp.lt cat_294 _let_0) (= cat_296 _let_0))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_294) (= cat_297 spoon_307)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (fp.lt _let_0 cat_294) (= cat_298 _let_0)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_294)) (and (= cat_247 cat_294) (spoon_3 cat_294))))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_294)) (= cat_299 spoon_307)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_294)) (= cat_300 cat_247)))))
(assert (let ((_let_0 (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52)))) (=> (not (fp.lt cat_294 (fp.neg _let_0))) (=> (not (fp.lt _let_0 cat_294)) (= cat_298 cat_300)))))
(assert (=> (not (fp.lt cat_294 (fp.neg (fp (_ bv0 1) (_ bv1023 11) (_ bv0 52))))) (= cat_296 cat_298)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_282 ((_ to_fp 11 53) roundNearestTiesToEven cat_177)))) (and (= cat_248 _let_0) (spoon_3 _let_0))))
(assert (= cat_301 (mk_potato_11 cat_216)))
(assert (= cat_302 cat_248))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven cat_282 ((_ to_fp 11 53) roundNearestTiesToEven cat_179)))) (and (= cat_253 _let_0) (spoon_3 _let_0))))
(assert (= cat_254 (fp.mul roundNearestTiesToEven cat_253 cat_286)))
(assert (and (= cat_255 cat_254) (spoon_3 cat_254)))
(assert (let ((_let_0 (fp.sub roundNearestTiesToEven cat_284 cat_278))) (and (= cat_249 _let_0) (spoon_3 _let_0))))
(assert (= cat_250 (fp.sub roundNearestTiesToEven cat_249 cat_280)))
(assert (and (= cat_251 cat_250) (spoon_3 cat_250)))
(assert (= cat_252 (fp.mul roundNearestTiesToEven cat_251 cat_288)))
...
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_304))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304) (and (= cat_264 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304) (= cat_265 (ite (fp.leq cat_302 cat_264) true false))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_304))) (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304) (and (= cat_263 _let_0) (spoon_3 _let_0)))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304) (= cat_266 (ite (fp.leq cat_263 cat_302) true false))))
(assert (=> (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304) (= cat_306 (ite (= cat_266 true) cat_265 false))))
(assert (=> (not (fp.lt (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)) cat_304)) (= cat_306 false)))
(assert (=> (= cat_306 true) (= cat_305 true)))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp.neg (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52))) cat_304))) (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_260 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_261 (ite (fp.leq cat_302 cat_260) true false)))))
(assert (let ((_let_0 (fp.mul roundNearestTiesToEven (fp (_ bv0 1) (_ bv1035 11) (_ bv1873567813730304 52)) cat_304))) (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (and (= cat_259 _let_0) (spoon_3 _let_0))))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_262 (ite (fp.leq cat_259 cat_302) true false)))))
(assert (=> (not (= cat_306 true)) (=> (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52))) (= cat_305 (ite (= cat_262 true) cat_261 false)))))
(assert (=> (not (= cat_306 true)) (=> (not (fp.lt cat_304 (fp (_ bv0 1) (_ bv0 11) (_ bv0 52)))) (= cat_305 false))))
(assert (= cat_305 true))
(assert (let ((_let_0 (fp.div roundNearestTiesToEven cat_302 cat_304))) (and (= cat_267 _let_0) (spoon_3 _let_0))))
(assert (= cat_268 ((_ to_fp 8 24) roundNearestTiesToEven cat_267)))
(assert (not (spoon_80 cat_268)))
(check-sat)
(exit)
