...
(assert (= cat_90 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_a (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_a (get_potato_19_a cat_76))))))
(assert (= cat_91 (fp.sub roundNearestTiesToEven (spoon_48 (get_potato_17_b (get_potato_19_a cat_78))) (spoon_48 (get_potato_17_b (get_potato_19_a cat_76))))))
(assert (= cat_89 (spoon_23 cat_90 cat_91)))
(assert (spoon_25 cat_89))
(assert (= cat_92 cat_89))
(assert (fp.lt cat_92 (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))
(assert (not (spoon_68 (fp.add roundNearestTiesToEven cat_92 (fp (_ bv0 1) (_ bv135 8) (_ bv3407872 23))))))
(check-sat)
(exit)
