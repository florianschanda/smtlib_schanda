...
(declare-fun cat_119 () potato_21)
(assert (spoon_60 cat_113))
(assert (spoon_60 cat_114))
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_113))
(assert (fp.lt (fp (_ bv0 1) (_ bv117 8) (_ bv201327 23)) cat_114))
(assert (fp.lt cat_114 cat_113))
(assert (= cat_115 (fp.div roundNearestTiesToEven (spoon_75 cat_112) cat_113)))
(assert (spoon_1 (fp.div roundNearestTiesToEven (spoon_75 cat_112) cat_113)))
(assert (= cat_116 (fp.mul roundNearestTiesToEven cat_115 cat_114)))
(assert (= cat_117 cat_116))
(assert (spoon_1 cat_116))
(assert (= cat_118 cat_117))
(assert (= (spoon_75 cat_119) cat_118))
