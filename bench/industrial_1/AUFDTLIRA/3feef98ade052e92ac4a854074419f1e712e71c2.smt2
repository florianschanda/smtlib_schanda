...
(declare-fun cat_52 () Bool)
(declare-fun cat_53 () potato_10)
(declare-fun cat_54 () Int)
(declare-fun cat_55 () Bool)
(declare-fun cat_56 () potato_10)
(assert (= (mk_potato_14 (mk_potato_12 (distinct 0 0) cat_48)) cat_39))
(assert (= (mk_potato_12 cat_49 cat_50) (get_potato_14_a cat_39)))
(assert (= cat_51 999))
(assert (<= 0 cat_51))
(assert (<= cat_51 999))
(assert (not (= cat_52 true)))
(assert (=> (<= 0 999) (spoon_12 cat_54)))
(assert (<= 0 cat_54))
(assert (<= cat_54 999))
(assert (not (= (select cat_43 cat_54) true)))
(assert (= (mk_potato_12 cat_55 cat_56) (mk_potato_12 cat_52 cat_53)))
(assert (not (= cat_54 0)))
(assert (not (not (= cat_55 true))))
(check-sat)
(exit)
