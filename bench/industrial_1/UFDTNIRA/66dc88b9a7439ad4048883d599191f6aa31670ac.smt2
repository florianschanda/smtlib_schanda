...
(assert (forall ((kitten_8 potato_12)) (let ((_let_0 (spoon_15 kitten_8))) (and (<= 0 _let_0) (<= _let_0 99))) ))
...
(assert (let ((_let_0 (* cat_24 10))) (and (= cat_36 _let_0) (spoon_27 _let_0))))
