...
(assert (forall ((kitten_5 potato_10)) (let ((_let_0 (spoon_7 kitten_5))) (and (<= 40 _let_0) (<= _let_0 660))) ))
...
(assert (forall ((kitten_8 potato_12)) (let ((_let_0 (spoon_15 kitten_8))) (and (<= 4 _let_0) (<= _let_0 66))) ))
...
(assert (forall ((kitten_16 potato_14)) (let ((_let_0 (spoon_26 kitten_16))) (and (<= (- 32768) _let_0) (<= _let_0 32767))) ))
