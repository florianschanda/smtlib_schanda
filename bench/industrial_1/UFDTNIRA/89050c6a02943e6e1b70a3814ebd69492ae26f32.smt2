...
(assert (forall ((kitten_11 potato_10)) (let ((_let_0 (spoon_10 kitten_11))) (and (<= (- 32768) _let_0) (<= _let_0 32767))) ))
...
(assert (forall ((kitten_14 potato_12)) (let ((_let_0 (spoon_18 kitten_14))) (and (<= 0 _let_0) (<= _let_0 999))) ))
