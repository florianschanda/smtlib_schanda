...
(assert (forall ((kitten_19 Int)) (! (let ((_let_0 (spoon_10 kitten_19))) (=> (spoon_20 kitten_19 true true true true) (and (= (spoon_9 _let_0 10) 0) (spoon_20 _let_0 true false true true)))) :pattern ((spoon_10 kitten_19)))))
(declare-sort potato_12 0)
(declare-fun spoon_21 (potato_12) Int)
(assert (forall ((kitten_21 potato_12)) (let ((_let_0 (spoon_21 kitten_21))) (and (<= 0 _let_0) (<= _let_0 99))) ))
