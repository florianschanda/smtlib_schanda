...
;; H
  (assert (=> (= result3 true) (= disttoclosestobstacle3 o10)))

;; H
  (assert
  (=> (= result3 true) (= disttoclosestobstacle4 disttoclosestobstacle3)))

;; H
  (assert
  (=> (not (= result3 true))
  (= disttoclosestobstacle4 disttoclosestobstacle2)))

;; H
  (assert (= i5 i4))

;; H
  (assert (= disttoclosestobstacle5 disttoclosestobstacle4))
