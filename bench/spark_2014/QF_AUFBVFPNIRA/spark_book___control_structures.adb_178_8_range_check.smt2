...
;; H
  (assert (=> (not (< b2 a2)) (=> (not (= a2 b2)) (= c7 abstr))))
...
;; H
  (assert (=> (not (< b2 a2)) (=> (not (= a2 b2)) (= o5 abstr))))
...
;; H
  (assert (= result1 (ite (= o12 0) true false)))

;; H
  (assert (=> (= result1 true) (= result (ite (< 2 e2) true false))))
...
;; H
  (assert (= result3 (ite (= o13 0) true false)))

;; H
  (assert (=> (= result3 true) (= result2 (ite (< 2 e2) true false))))

;; H
  (assert (=> (not (= result3 true)) (= result2 (distinct 1 0))))

;; H
  (assert (=> (< a2 0) (= result4 (ite (< b2 0) true false))))

;; H
  (assert (=> (not (< a2 0)) (= result4 (distinct 1 0))))
...
;; H
  (assert (= result5 (ite (fp.lt tolerance o19) true false)))

;; H
  (assert (=> (= result5 true) (= temp___592 approx1)))
...
;; H
  (assert (=> (= result5 true) (= o21 (fp.add RNE approx2 o20))))

;; H
  (assert (=> (= result5 true) (and (= o22 o21) (fp.isFinite32 o21))))
...
;; H
  (assert (=> (= result5 true) (= approx3 o23)))
...
;; H
  (assert (=> (= result5 true) (= o25 (fp.sub RNE x1 o24))))

;; H
  (assert (=> (= result5 true) (and (= o26 o25) (fp.isFinite32 o25))))

;; H
  (assert (=> (= result5 true) (= o27 (fp.abs o26))))

;; H
  (assert
  (=> (= result5 true) (= o28 (ite (fp.lt tolerance o27) true false))))

;; H
  (assert
  (=> (= result5 true) (= result6 (ite (not (= o28 true)) true false))))

;; H
  (assert (=> (= result5 true) (= result6 true)))

;; H
  (assert (=> (= result5 true) (= approx4 approx3)))

;; H
  (assert (=> (= result5 true) (= approx5 approx4)))

;; H
  (assert (=> (not (= result5 true)) (= approx5 approx1)))
