...
(declare-const tagged_discr__init__3__R12b__assume Bool)

(declare-const tagged_discr__init__3__R12b__assume1 Int)
...
;; H
  (assert (= (distinct 0 0) tagged_discr__init__3__R12b__assume))
