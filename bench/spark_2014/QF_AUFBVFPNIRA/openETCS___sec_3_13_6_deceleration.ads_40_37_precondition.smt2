...
;; H
  (assert
  (and (= o (to_int (fp.to_real (fp.roundToIntegral RNA v)))) (in_range2
...
;; H
  (assert (= sec_3_13_6_deceleration__a_brake_emergency__result1 o2))
...
;; H
  (assert
  (and (= o3 (to_int (fp.to_real (fp.roundToIntegral RNA v)))) (in_range2
  (to_int (fp.to_real (fp.roundToIntegral RNA v))))))
