...
;; H
  ...
  val3) (fp.leq val3 (fp.neg (fp #b0 #b01000000 #b00000000000000000000000))))
  (fp.leq val1 val2)))))

;; H
  (assert
  (and (= o (fp.div RNE val1 val3)) (fp.isFinite32 (fp.div RNE val1 val3))))

(assert
;; WP_parameter_def
 ;; File "spark-floating_point_arithmetic_lemmas.ads", line 96, characters 0-0
