...
;; H
  (assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) abstr))

;; H
  (assert (fp.leq abstr (fp #b0 #b10000010 #b11000000000000000000000)))

(declare-const abstr1 Float32)

;; H
  (assert (fp.leq abstr1 (fp #b0 #b10000010 #b11000000000000000000000)))
...
;; WP_parameter_def
 ;; File "sgs.ads", line 3, characters 0-0
  (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) abstr2)))
(check-sat)
(exit)
