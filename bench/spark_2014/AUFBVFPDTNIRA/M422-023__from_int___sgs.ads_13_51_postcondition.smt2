...
;; H
  (assert (= sgs__a__result sgs__a__result1))

;; H
  (assert (= sgs__a__result o))
...
;; H
  (assert (= o ((_ to_fp 8 24) RNE (to_real x))))

;; H
  (assert (= (mk_t__ref sgs__a__result2) (mk_t__ref sgs__a__result1)))

(assert
;; WP_parameter_def
 ;; File "sgs.ads", line 3, characters 0-0
  (not
  (fp.leq sgs__a__result2 (fp #b0 #b10000010 #b11000000000000000000000))))
(check-sat)
(exit)
