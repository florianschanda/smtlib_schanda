...
(define-fun o15 () us_rep1 (mk___rep1
                           (mk___split_fields1
                           (mk___rep (mk___split_fields o12)) o13 o14)))
...
;; H
  ...
  (= (bool_eq1
     ...
     (length
     (mk___rep2 gapvec__split_discrs
     algorithm__gap_vectors__append__container__fields))) o15) true))
...
;; H
  (assert
  (=> (fp.leq mingapwidth dist)
  (= result3 (mk___split_fields__ref2 gapvec__split_fields1))))
...
;; H
  (assert
  (=> (not (fp.leq mingapwidth dist))
  (= gapvec__split_fields2 gapvec__split_fields1)))
