...
(declare-const o5 us_split_fields6)
...
;; H
  (assert
  (and
  (= o7 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep6
                                                                  (rec__robot_iface__proxy__scan_res
                                                                  (us_split_fields11
                                                                  (rec__algorithm__controller__robot
                                                                  (let ((subject
...
;; H
  (assert (= o5 (us_split_fields7 o4)))

;; H
  (assert (= o6 (rec__gaps__gap__bearing o5)))
...
;; H
  (assert (= o2 (us_split_fields7 o1)))

;; H
  (assert (= o3 (rec__gaps__gap__bearing o2)))

;; H
  (assert (and (= o8 (ccwdiff o3 o6)) (fp.isFinite32 o8)))

;; H
  (assert (= result3 (ite (fp.lt o8 o7) true false)))
