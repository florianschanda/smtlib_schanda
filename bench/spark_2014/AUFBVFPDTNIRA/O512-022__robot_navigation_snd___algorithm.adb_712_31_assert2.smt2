...
;; H
  (assert
  (=> (= pbestvalley__attr__constrained true)
...
;; H
  (assert
  (= temp___1031 (mk___rep10 (us_split_discrs5 usq_) (us_split_fields21 usq_)
                 pbestvalley__attr__constrained)))
...
;; H
  (assert
  (= (let ((subject pbestvalley__split_discrs)) pbestvalley__split_discrs1)
  (us_split_discrs5 temp___1031)))
