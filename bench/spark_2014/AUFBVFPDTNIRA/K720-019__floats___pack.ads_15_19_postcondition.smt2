...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref pack__add__result)))

;; H
  (assert (= pack__add__result1 o))

;; H
  (assert (= (mk_t__ref pack__add__result4) (mk_t__ref pack__add__result2)))

;; H
  (assert (= pack__add__result5 pack__add__result3))

;; H
  (assert (= result1 pack__add__result4))
...
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/K720-019__floats/gnatprove/pack.mlw", line 2609, characters 5-8
  (not (fp.eq pack__add__result4 (fp.add RNE r1 r2))))
(check-sat)
(exit)
