...
;; H
  ...
  (= algorithm__buildgapvector__B_9__dist__assume (fp.sub RNE (to_rep4
                                                              (rec__algorithm__laser_scan_data__first
                                                              rayl__split_fields1))
  (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields1))))
...
;; H
  (assert (not (fp.leq mingapwidth dist1)))
...
;; H
  ...
  (and
  (fp.eq (to_rep4
         (rec__algorithm__laser_scan_data__first rayl__split_fields1))
  fmaxrange)
  (fp.lt (to_rep4
         (rec__algorithm__laser_scan_data__first rayr__split_fields1))
  fmaxrange))))
...
;; H
  (assert
  (= o (create__2
       (rec__algorithm__laser_scan_data__second rayl__split_fields1)
       (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields1))
       1)))
