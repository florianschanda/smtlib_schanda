...
(declare-datatypes ()
((float_type__ref (mk_float_type__ref (float_type__content float)))))
...
(declare-datatypes ()
((int_type__ref (mk_int_type__ref (int_type__content integer)))))
(define-fun int_type__ref___projection ((a int_type__ref)) integer (int_type__content
                                                                   a))
