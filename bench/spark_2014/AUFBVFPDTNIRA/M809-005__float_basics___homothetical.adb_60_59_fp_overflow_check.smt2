...
;; H
  (assert (= o16 (fp.div RNE o14 o15)))

;; H
  (assert (and (= o17 o16) (fp.isFinite32 o16)))

;; H
  (assert (= o18 (fp.min (to_rep (select (map__content lambda3) i1)) o17)))

;; H
  (assert (= (to_rep o19) o18))

;; H
  (assert (= o20 (store (map__content lambda3) i1 o19)))

;; H
  (assert (= result8 lambda3))
...
;; H
  (assert
  (and
  (= o21 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j2)))))
  (fp.isFinite32 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep
                                                             (select
                                                             d j2)))))))
