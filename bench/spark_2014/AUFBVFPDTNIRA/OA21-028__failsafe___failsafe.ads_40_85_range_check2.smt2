...
;; H
  ...
  (and
  (and
  (ite (bvult current_time s1) (= o (bvadd (bvsub current_time s1) #x32))
  (= o (bvsub current_time s1))) (= o1 (select battery_level_at o)))
  (= o2 (to_rep o1)))
  (= result2 (ite (fp.lt o2 battery_threshold) true false)))
  (not (= result2 true))))
  (and
  (and
  (and
  ...
  (= result2 (ite (fp.lt o2 battery_threshold) true false)))
  (and (= result2 true)
  (and (and (= o3 (bvadd res1 #x01)) (in_range2 (bvadd res1 #x01)))
  (and (= res1 result3) (= res2 o3)))))
  (and
  ...
  (=>
  (and
  (bvule (let ((temp___301 (bvsub current_time (bvsub res3 #x01))))
         (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___301 #x32)
         temp___301)) s17)
  (bvule s17 current_time))
  (fp.lt (to_rep (select battery_level_at s17)) battery_threshold)))
  (and
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule #x00 s17) (bvule s17 current_time))
  (fp.lt (to_rep (select battery_level_at s17)) battery_threshold)))
  (forall ((s17 (_ BitVec 8)))
  (=>
  (and
  (bvule (let ((temp___302 (bvsub current_time (bvsub res3 #x01))))
         (ite (bvult current_time (bvsub res3 #x01)) (bvadd temp___302 #x32)
         temp___302)) s17)
  (bvule s17 #x31))
  (fp.lt (to_rep (select battery_level_at s17)) battery_threshold)))))
  (= res3 (bvadd s2 #x01)))
  ...
  (or (and (and (= s2 s4) (= s5 s2)) (= s2 #x31))
  (and (not (= s2 #x31))
  (and (and (= s3 s4) (= s5 s3))
  (and (and (= s2 result4) (= s3 (bvadd s2 #x01)))
  (and
  (and
  (and
  (and
  (ite (bvult current_time s3) (= o4 (bvadd (bvsub current_time s3) #x32))
  (= o4 (bvsub current_time s3))) (= o5 (select battery_level_at o4)))
  (= o6 (to_rep o5)))
  (= result5 (ite (fp.lt o6 battery_threshold) true false)))
  (not (= result5 true)))))))))))))))
...
;; H
  (assert
  (=> (and (bvule #x00 s1) (bvule s1 #x31)) (= res13 (mk_t__ref res4))))
...
;; H
  ...
  (= (t__content failsafe__model__time_below_threshold__result4) #x00)))

;; H
  (assert
  (=>
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule #x00 s17) (bvule s17 #x31))
  (fp.lt (to_rep (select battery_level_at s17)) battery_threshold)))
  (= (t__content failsafe__model__time_below_threshold__result4) #x32)))

;; H
  (assert
  (not
  (ite (= (fp.geq (to_rep (select battery_level_at current_time)) battery_threshold) false)
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule #x00 s17) (bvule s17 #x31))
  (fp.lt (to_rep (select battery_level_at s17)) battery_threshold))) false)))

;; H
  (assert
  (not
  (ite (= (fp.geq (to_rep (select battery_level_at current_time)) battery_threshold) false) false true)))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (and (= o8 (t__content failsafe__model__time_below_threshold__result4))
  (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= temp___303 (bvsub current_time o8))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (and (= o9 (t__content failsafe__model__time_below_threshold__result4))
  (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= result8 (ite (bvult current_time o9) true false))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (=> (= result8 true) (= o10 (bvadd temp___303 #x32)))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (=> (not (= result8 true)) (= o10 temp___303))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= o11 (select battery_level_at o10))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= result7 (ite (fp.leq battery_threshold o12) true false))))
...
;; H
  (assert
  (and
  (= o7 (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01))
  (in_range1
  (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01))))
