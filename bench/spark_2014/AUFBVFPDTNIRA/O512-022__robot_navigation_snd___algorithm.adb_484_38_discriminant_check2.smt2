...
;; H
  (assert (= o77 (us_split_fields5 o76)))

;; H
  (assert (= o78 (rec__gaps__gap__bearing o77)))

;; H
  (assert (= o80 (aldiff o78 o79)))
...
;; H
  (assert (fp.leq o80 (fp #b0 #b10000000 #b10010010000111111011011)))

;; H
  (assert (= o81 (fp.abs o80)))

;; H
  (assert (= o74 (bearing disttogoal)))
...
;; H
  (assert (= o72 (us_split_fields5 o71)))

;; H
  (assert (= o73 (rec__gaps__gap__bearing o72)))

;; H
  (assert (= o75 (aldiff o73 o74)))
...
;; H
  (assert (fp.leq o75 (fp #b0 #b10000000 #b10010010000111111011011)))

;; H
  (assert (= o82 (fp.abs o75)))

;; H
  (assert (= result13 (ite (fp.lt o82 o81) true false)))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 27, characters 0-0
  (not
  (= (rec__algorithm__findbestvalley__gap_id_pair__opt
     candidate_valley_ids__split_discrs2) (rec__algorithm__findbestvalley__gap_id_pair__opt
