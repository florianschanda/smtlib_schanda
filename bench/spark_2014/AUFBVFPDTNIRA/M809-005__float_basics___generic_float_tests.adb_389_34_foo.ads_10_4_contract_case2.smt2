...
;; H
  (assert (= o (to_int (fp.to_real (fp.roundToIntegral RNA x)))))

;; H
  (assert (= i1 o))

;; H
  (assert (in_range1 (to_int (fp.to_real (fp.roundToIntegral RNA x)))))
...
;; H
  (assert
  (=> (= (fp.eq x (fp #b0 #b01111111 #b10000000000000000000000)) true)
  (= i2 2)))
