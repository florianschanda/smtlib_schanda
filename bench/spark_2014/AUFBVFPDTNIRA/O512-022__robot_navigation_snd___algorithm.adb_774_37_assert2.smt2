...
;; H
  ...
  (=>
  (and
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (fp.max (to_rep5
                                                               (rec__robot_iface__proxy__robot_radius
                                                               (us_split_fields9
                                                               (rec__algorithm__controller__robot
                                                               (let ((subject
...
;; H
  (assert
  (= o10 (fp.mul RNE ((_ to_fp 8 24) RNE (to_real (to_rep9
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1))))))))
  (= result4 (mk___split_fields__ref midvalleyangle__split_fields1))))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1))))))))
  (= midvalleyangle__split_fields2 (us_split_fields1 temp___1036))))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1))))))))
  (= midvalleyangle__split_fields4 (mk___split_fields__ref
                                   midvalleyangle__split_fields2))))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1))))))))
  (= midvalleyangle__split_fields5 midvalleyangle__split_fields2)))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1)))))))))
  (= result5 (mk___split_fields__ref midvalleyangle__split_fields1))))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1)))))))))
  (= midvalleyangle__split_fields3 (us_split_fields1 temp___1035))))
...
;; H
  ...
  (< 0 (to_rep9
       ...
       (rec__algorithm__valley_option__value
       (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1)))))))))
  (= midvalleyangle__split_fields5 midvalleyangle__split_fields3)))
