...
(define-fun us_split_fields_W__2__projection ((a us_split_fields2)) integer
...
(define-fun us_split_fields_Z__3__projection ((a us_split_fields2)) Bool
  (rec__tagged_discr__t__z1 a))

(define-fun us_split_fields_X__3__projection ((a us_split_fields2)) integer
  (rec__tagged_discr__t__x1 a))

(define-fun us_split_fields_Y__3__projection ((a us_split_fields2)) float
...
;; tagged_discr__u2__compat_axiom
  (assert
  (forall ((v us_rep1))
  (! (= (ite (is_zero__3 v) 1 0) (ite (is_zero__31 us_tag1 v) 1 0)) :pattern (
...
;; is_zero__3__def_axiom
  ...
  (! (= (= (is_zero__3 v) true)
     ...
     (= (to_rep1 (rec__tagged_discr__u2__w (us_split_fields3 v))) 0))
     (= (to_rep1 (rec__tagged_discr__u2__xx (us_split_fields3 v))) 0))
     (fp.eq (to_rep (rec__tagged_discr__u2__yy (us_split_fields3 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern (
  (is_zero__3 v)) )))
...
(define-fun us_split_fields_Z__2__projection ((a us_split_fields4)) Bool
...
(define-fun us_split_fields_Y__2__projection ((a us_split_fields4)) float
...
(define-fun us_rep___4__projection ((a us_rep2)) us_split_discrs (us_split_discrs3
                                                                 a))
...
;; tagged_discr__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (ite (is_zero__2 (of_base1 v)) 1 0) (ite (is_zero1 us_tag4 v) 1 0)) :pattern (
  (is_zero1 us_tag4 v)) )))

;; tagged_discr__u2__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (ite (is_zero__3 (of_base v)) 1 0) (ite (is_zero1 us_tag1 v) 1 0)) :pattern (
  (is_zero1 us_tag1 v)) )))

;; tagged_discr__init__T3b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (ite (is_zero v) 1 0) (ite (is_zero1 us_tag5 v) 1 0)) :pattern (
  (is_zero1 us_tag5 v)) )))
...
;; tagged_discr__init__2__T8b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (ite (is_zero__2 (of_base1 v)) 1 0) (ite (is_zero1 us_tag7 v) 1 0)) :pattern (
  (is_zero1 us_tag7 v)) )))
...
;; is_zero__def_axiom
  ...
  (! (= (= (is_zero v) true)
     ...
     (= (to_rep1 (rec__tagged_discr__t__x (us_split_fields1 v))) 0)
     (fp.eq (to_rep (rec__tagged_discr__t__y (us_split_fields1 v))) (fp #b0 #b00000000 #b00000000000000000000000))))) :pattern (
  (is_zero v)) )))
...
;; tagged_discr__u1__compat_axiom
  (assert
  (forall ((v us_rep2))
  (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag4 v) 1 0)) :pattern (
  (is_zero__21 us_tag4 v)) )))

;; tagged_discr__init__2__T8b__compat_axiom
  (assert
  (forall ((v us_rep2))
  (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag7 v) 1 0)) :pattern (
...
;; is_zero__2__def_axiom
  ...
  (! (= (= (is_zero__2 v) true)
     ...
     (= (to_rep1 (rec__tagged_discr__t__x2 (us_split_fields5 v))) 0)
     (fp.eq (to_rep (rec__tagged_discr__t__y2 (us_split_fields5 v))) (fp #b0 #b00000000 #b00000000000000000000000))))
     (= (to_rep1 (rec__tagged_discr__u1__w (us_split_fields5 v))) 0))) :pattern (
  (is_zero__2 v)) )))
...
;; WP_parameter_def
 ;; File "tagged_discr.ads", line 52, characters 0-0
  (not (= temp___256 (rec__tagged_discr__t__discr v__split_discrs))))
(check-sat)
(exit)
