...
;; H
  ...
  acceleration speed1) (fp #b0 #b10000001 #b01000000000000000000000))))

;; H
  (assert (= o (fp.div RNE acceleration speed1)))

;; H
  (assert (fp.isFinite32 (fp.div RNE acceleration speed1)))
...
;; H
  (assert (fp.lt delta_speed2 (fp #b0 #b00000000 #b00000000000000000000000)))

;; H
  (assert (= o3 (fp.add RNE speed1 delta_speed2)))

;; H
  (assert (= speed2 o3))

;; H
  (assert (fp.isFinite32 (fp.add RNE speed1 delta_speed2)))

;; H
  (assert (in_range1 (+ distance1 5)))

;; H
  (assert (fp.lt final_speed speed2))

;; H
  (assert (fp.lt minimum_valid_speed speed2))
...
;; WP_parameter_def
 ;; File "units.ads", line 27, characters 0-0
  (not (fp.lt minimum_valid_speed speed2)))
(check-sat)
(exit)
