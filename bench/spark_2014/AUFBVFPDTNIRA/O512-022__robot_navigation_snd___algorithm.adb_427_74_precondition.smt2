...
;; H
  (assert (= result7 (isrisinggapsafe this o24)))
...
;; H
  (assert (= o27 (rec__gaps__gap__bearing o26)))

;; H
  (assert (= o29 (aldiff o27 o28)))

;; H
  (assert (fp.isFinite32 o29))
...
;; H
  (assert (fp.leq o29 (fp #b0 #b10000000 #b10010010000111111011011)))

(assert
;; WP_parameter_def
 ;; File "algorithm.ads", line 27, characters 0-0
  (not (not (= (oeq disttogoal zero_position) true))))
(check-sat)
(exit)
