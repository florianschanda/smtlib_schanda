...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep (rec__p__r__b (us_split_fields1 a)))
...
;; H
  (assert
  (= (mk___split_fields full_s__split_fields full_s__split_fields1) (us_split_fields1
                                                                    null_r)))

;; H
  (assert (= full_s__split_fields3 full_s__split_fields1))

;; H
  (assert (= full_s__split_fields2 full_s__split_fields))
