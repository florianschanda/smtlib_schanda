...
;; build_rec__post_axiom
  (assert
  (forall ((a Int))
  (! (=> (dynamic_invariant a true true true true) (dynamic_invariant1
...
(define-fun dynamic_invariant2 ((temp___expr_188 us_rep2)
...
;; build_rec_ok__post_axiom
  (assert
  (forall ((a Int))
  (! (=> (dynamic_invariant a true true true true) (dynamic_invariant2
...
(define-fun dynamic_invariant4 ((temp___expr_201 us_rep3)
...
;; build_arr__post_axiom
  ...
  (forall ((f Int) (l Int))
  (! (=>
     (and (dynamic_invariant3 f true true true true) (dynamic_invariant3 l
     true true true true)) (dynamic_invariant4 (build_arr f l) true false
