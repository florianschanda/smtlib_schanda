...
(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/proofinuse__floating_point/gnatprove/floating_point.mlw", line 10111, characters 5-8
  (not
  (fp.leq tmp1 (fp #b0 #b10001111110 #b1111111111111111111111100000000000000000000000000000))))
(check-sat)
(exit)
