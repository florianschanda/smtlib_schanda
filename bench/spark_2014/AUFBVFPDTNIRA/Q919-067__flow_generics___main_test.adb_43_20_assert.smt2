...
(declare-fun main_test__mat_in__aggregate_def (Float32 Float32 Float32
  Float32 Float32 Float32 Float32 Float32 Float32) map1)

(declare-fun main_test__mat_map__aggregate_def (Float32 Float32 Float32
  Float32 Float32 Float32) map1)

(declare-fun main_test__mat_out__aggregate_def (Float32) map1)

(declare-fun main_test__mat_in2__aggregate_def (Float32 Float32 Float32
  Float32 Float32 Float32 Float32 Float32 Float32) map1)

(declare-fun main_test__mat_map2__aggregate_def (Float32 Float32 Float32
  Float32 Float32 Float32) map1)
...
;; def_axiom
  (assert
  (forall ((temp___1939 Float32) (temp___1940 Float32) (temp___1941 Float32)
  (temp___1942 Float32) (temp___1943 Float32) (temp___1944 Float32)
  (temp___1945 Float32) (temp___1946 Float32) (temp___1947 Float32))
...
;; def_axiom
  (assert
  (forall ((temp___1951 Float32) (temp___1952 Float32) (temp___1953 Float32)
  (temp___1954 Float32) (temp___1955 Float32) (temp___1956 Float32))
...
;; def_axiom
  (assert
  (forall ((temp___1964 Float32) (temp___1965 Float32) (temp___1966 Float32)
  (temp___1967 Float32) (temp___1968 Float32) (temp___1969 Float32)
  (temp___1970 Float32) (temp___1971 Float32) (temp___1972 Float32))
...
;; def_axiom
  (assert
  (forall ((temp___1976 Float32) (temp___1977 Float32) (temp___1978 Float32)
  (temp___1979 Float32) (temp___1980 Float32) (temp___1981 Float32))
