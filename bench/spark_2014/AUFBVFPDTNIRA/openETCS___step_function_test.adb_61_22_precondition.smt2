...
;; H
  ...
  (fp.eq (to_rep
         ...
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
                 sfun_merge__split_fields) i3)))) (min
                                                  (get_value
                                                  (mk___rep1
                                                  sfun3__split_fields2)
                                                  (to_rep2
...
;; H
  (assert
  (and (= o82 (get_value (mk___rep1 sfun4__split_fields2) i2))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              sfun4__split_fields2) i3)))) i2)
  (< i2 (to_rep2
        (rec__step_function__delimiter_entry__delimiter
        (us_split_fields1
        (select (rec__step_function__step_function_t__step
                sfun4__split_fields2) (+ i3 1)))))))
  (fp.eq o82 (to_rep
             (rec__step_function__delimiter_entry__value
             (us_split_fields1
             (select (rec__step_function__step_function_t__step
...
;; H
  (assert
  (and (= o81 (get_value (mk___rep1 sfun3__split_fields2) i2))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              sfun3__split_fields2) i3)))) i2)
  (< i2 (to_rep2
        (rec__step_function__delimiter_entry__delimiter
        (us_split_fields1
        (select (rec__step_function__step_function_t__step
                sfun3__split_fields2) (+ i3 1)))))))
  (fp.eq o81 (to_rep
             (rec__step_function__delimiter_entry__value
             (us_split_fields1
             (select (rec__step_function__step_function_t__step
...
;; H
  ...
  (ite (fp.leq o81 o82) (fp.eq o83 o81) (fp.eq o83 o82)))))

(assert
;; WP_parameter_def
 ;; File "step_function_test.adb", line 37, characters 0-0
  (not (= (is_valid (mk___rep1 sfun_merge__split_fields)) true)))
(check-sat)
(exit)
