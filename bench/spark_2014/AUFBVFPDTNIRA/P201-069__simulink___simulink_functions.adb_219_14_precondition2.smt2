...
(declare-fun log__2__function_guard (Float64 Float64 Float64) Bool)
...
;; log__2__post_axiom
  ...
  (! (=>
     ...
     (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) base))
     (not (fp.eq base (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
...
(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/P201-069__simulink/gnatprove/simulink_functions.mlw", line 19869, characters 5-8
  (not
