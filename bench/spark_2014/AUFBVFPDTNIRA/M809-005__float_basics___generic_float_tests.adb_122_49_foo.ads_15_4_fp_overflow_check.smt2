...
(declare-const foo__double_tests__bad_optimisation_1__result1 Float64)

(declare-const foo__double_tests__bad_optimisation_1__result2 Float64)

(declare-const foo__double_tests__bad_optimisation_1__result3 Float64)

(declare-const foo__double_tests__bad_optimisation_1__result4 Float64)
...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (fp.isFinite64 (fp.div RNE a b))))
(check-sat)
(exit)
