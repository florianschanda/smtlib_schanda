...
(declare-const buf (Array Int float))
...
;; H
  (assert (= temp___1591 (f Tuple0)))

;; H
  (assert (in_range temp___1591))

;; H
  (assert (<= 0 temp___1591))

;; H
  (assert (<= temp___1591 3))

;; H
  (assert (= o3 temp___1591))
...
;; H
  (assert (= o6 ((_ to_fp 11 53) RNE o5)))
...
;; H
  (assert (= o7 ((_ to_fp 11 53) RNE o2)))
