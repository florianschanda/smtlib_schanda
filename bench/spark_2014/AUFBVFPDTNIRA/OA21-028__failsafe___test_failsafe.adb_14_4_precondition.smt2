...
;; H
  ...
  (and
  (= current_time9 (let ((temp___273 (bvadd current_time8 #x01)))
                   (ite (bvule (bvsub #x32 current_time8) #x01)
                   (bvsub temp___273 #x32) temp___273)))
...
;; WP_parameter_def
 ;; File "failsafe.ads", line 20, characters 0-0
  (not (= (is_valid failsafe_state8 battery_level_at8 current_time9) true)))
(check-sat)
(exit)
