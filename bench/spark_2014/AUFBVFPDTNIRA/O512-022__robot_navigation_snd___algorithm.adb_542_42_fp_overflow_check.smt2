...
(define-fun o11 () us_rep (mk___rep (mk___split_fields o9)))

(define-fun o12 () us_rep (mk___rep (mk___split_fields o8)))
...
;; H
  (assert (= o12 (create__2 (fp #b0 #b10000000 #b10010010000111111011011))))
