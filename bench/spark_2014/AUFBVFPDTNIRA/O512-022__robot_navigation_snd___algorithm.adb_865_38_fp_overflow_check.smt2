...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields1))))) (t__content
...
;; H
  (assert
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep5
                                                       (rec__robot_iface__proxy__obstacle_avoid_dist
                                                       (us_split_fields9
                                                       (rec__algorithm__controller__robot
...
;; H
  ...
  (t__content disttoclosestobstacle1) (to_rep5
                                      (rec__robot_iface__proxy__robot_radius
                                      (us_split_fields9
                                      (rec__algorithm__controller__robot
                                      (us_split_fields__content9
...
;; H
  (assert
  (and
  (= o13 (fp.sub RNE (t__content disttoclosestobstacle1) (to_rep5
                                                         (rec__robot_iface__proxy__robot_radius
                                                         (us_split_fields9
                                                         (rec__algorithm__controller__robot
                                                         (us_split_fields__content9
                                                         this__split_fields1)))))))
  (fp.isFinite32 (fp.sub RNE (t__content disttoclosestobstacle1) (to_rep5
                                                                 (rec__robot_iface__proxy__robot_radius
                                                                 (us_split_fields9
                                                                 (rec__algorithm__controller__robot
                                                                 (us_split_fields__content9
