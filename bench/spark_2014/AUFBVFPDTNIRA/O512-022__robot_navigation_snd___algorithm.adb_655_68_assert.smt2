...
;; H
  ...
  (not (= (oeq o5 zero_position) true)))))))

;; H
  (assert
  (and (= temp___1012 (create__4 o6 o10))
  (=> (not (fp.eq o6 (fp #b0 #b00000000 #b00000000000000000000000)))
  (not (= (oeq temp___1012 zero_position) true)))))
...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields3))))) (to_rep5
                                                             (rec__robot_iface__proxy__max_range
                                                             (us_split_fields9
                                                             (rec__algorithm__controller__robot
...
;; H
  (assert
  (=> (= (distinct 0 0) true)
  (and (= o11 (print1 (mk___rep1 disttogoal__split_fields2)))
  (dynamic_invariant2 o11 true false true true))))
