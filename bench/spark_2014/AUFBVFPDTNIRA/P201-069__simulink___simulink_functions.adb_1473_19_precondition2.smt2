...
;; oexpon__post_axiom
  ...
  (! (=>
     ...
     (and
     (=> (fp.eq right (fp #b0 #b00000000 #b00000000000000000000000))
     (fp.eq result (fp #b0 #b01111111 #b00000000000000000000000)))
     (and
     (=> (fp.eq right (fp #b0 #b01111111 #b00000000000000000000000))
     (fp.eq result left))
     (and
     (=> (fp.eq left (fp #b0 #b01111111 #b00000000000000000000000))
     (fp.eq result (fp #b0 #b01111111 #b00000000000000000000000)))
     (=> (fp.eq left (fp #b0 #b00000000 #b00000000000000000000000))
