...
;; H
  (assert (fp.leq (fp #b0 #b10000001 #b01000000000000000000000) x))

;; H
  (assert (fp.leq x (fp #b0 #b10000011 #b01000000000000000000000)))

;; H
  (assert (= o (fp.mul RNE x (fp #b0 #b10000000 #b00000000000000000000000))))
