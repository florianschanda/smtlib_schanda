...
;; H
  (assert
  (= o10 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))))
...
;; H
  (assert
  (= o13 (fp.add RNE o12 (fp #b0 #b10000000 #b10000000000000000000000))))
...
;; H
  (assert
  (= o15 (fp.add RNE o14 (fp #b0 #b10000001 #b00000000000000000000000))))
...
;; H
  (assert
  (= o19 (fp.add RNE o18 (fp #b0 #b10000001 #b01000000000000000000000))))
