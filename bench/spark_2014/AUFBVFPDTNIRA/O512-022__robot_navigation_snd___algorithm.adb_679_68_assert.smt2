...
;; H
  ...
  (= temp___1026 (mk___rep9 (us_split_fields__content9 this__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___1025 disttoclosestobstacle1)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___1024 (let ((subject i)) i1))))
...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields4))))) (to_rep6
                                                             (rec__algorithm__laser_scan_data__first
                                                             (us_split_fields15
                                                             (select
                                                             (rec__algorithm__controller__laserscan
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields8))))) (t__content
                                                             disttoclosestobstacle8))))
(check-sat)
(exit)
