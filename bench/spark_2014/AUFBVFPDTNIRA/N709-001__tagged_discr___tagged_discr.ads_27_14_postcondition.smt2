...
;; H
  ...
  (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0))
  (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))
  (= v__split_fields4 v__split_fields8)))
...
;; H
  ...
  (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0))
  (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))
  (= v__split_fields6 v__split_fields10)))
...
;; H
  (assert (= v__split_fields20 v__split_fields8))

;; H
  (assert (= v__split_fields21 v__split_fields9))

;; H
  (assert (= v__split_fields22 v__split_fields10))

;; H
  (assert (= v__split_fields23 v__split_fields11))
