...
;; pow3__post_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow3 x1) true false true true)) :pattern ((pow3 x1)) )))
...
;; pow5__post_axiom
  ...
  (forall ((x1 Float32))
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow5 x1) true false true true)) :pattern ((pow5 x1)) )))
...
;; pow7__post_axiom
  ...
  (forall ((x1 Float32))
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow7 x1) true false true true)) :pattern ((pow7 x1)) )))
...
(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/proofinuse__trigo/gnatprove/trigo.mlw", line 5296, characters 5-8
  (not
