...
;; H
  (assert
  (and
  (= o1 (fp.add RNE t_fp1 (fp.mul RNE ((_ to_fp 8 24) RNE (to_real nb_of_fp))
  delta_time)))
...
;; H
  (assert
  (and
  (= o2 (fp.add RNE t_pp1 (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) ((_ to_fp 8 24) RNE (to_real
  nb_of_fp))) delta_time)))
