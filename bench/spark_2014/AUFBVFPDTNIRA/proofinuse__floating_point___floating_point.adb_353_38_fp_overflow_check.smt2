...
;; H
  (assert
  (= o4 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))))
...
;; H
  (assert
  (= o7 (fp.add RNE o6 (fp #b0 #b10000000 #b10000000000000000000000))))
...
;; H
  (assert
  (= o9 (fp.add RNE o8 (fp #b0 #b10000001 #b00000000000000000000000))))
...
;; H
  (assert
  (= o13 (fp.add RNE o12 (fp #b0 #b10000001 #b01000000000000000000000))))
