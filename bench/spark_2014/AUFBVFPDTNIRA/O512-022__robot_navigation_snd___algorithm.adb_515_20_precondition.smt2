...
;; H
  ...
  (= o85 (element
         (rec__algorithm__controller__gapvec (us_split_fields19 this))
         (rec__algorithm__findbestvalley__gap_id_pair__rising
         (us_split_fields__content11 best_valley_ids__split_fields6))))
  (= (bool_eq4 o85
     (get
     (model__ (rec__algorithm__controller__gapvec (us_split_fields19 this)))
     (get1
     ...
     (rec__algorithm__controller__gapvec (us_split_fields19 this)))
     (rec__algorithm__findbestvalley__gap_id_pair__rising
     (us_split_fields__content11 best_valley_ids__split_fields6))))) true))))
...
;; H
  (assert
  (=> (= (distinct 0 0) true)
  (and (= o88 (print o87)) (dynamic_invariant1 o88 true false true true))))
