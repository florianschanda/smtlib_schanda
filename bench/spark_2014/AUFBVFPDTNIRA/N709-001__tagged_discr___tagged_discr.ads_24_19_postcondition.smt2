...
;; H
  (assert (= temp___2281 v__split_fields))

;; H
  (assert (= temp___2282 v__split_fields1))

;; H
  (assert (= temp___2283 v__split_fields2))

;; H
  (assert (= temp___2284 v__split_fields3))

;; H
  (assert (= v__split_fields4 v__split_fields))

;; H
  (assert (= v__split_fields5 v__split_fields1))

;; H
  (assert (= v__split_fields6 v__split_fields2))

;; H
  (assert (= v__split_fields7 v__split_fields3))
...
;; WP_parameter_def
 ;; File "tagged_discr.ads", line 16, characters 0-0
  ...
  (= (is_zero
     ...
     v__split_fields7) v__attr__tag)) true)))
(check-sat)
(exit)
