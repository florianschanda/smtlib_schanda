...
;; H
  (assert
  (= d (floats__test__d__aggregate_def
       (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
       (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
       (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
       (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
...
;; H
  (assert
  (= o27 (fp.add RNE (to_rep1 (select c4 2)) (to_rep1 (select b4 2)))))
...
;; H
  (assert
  (= o30 (fp.add RNE (to_rep1 (select c4 3)) (to_rep1 (select b4 3)))))
...
;; H
  (assert
  (= o33 (fp.add RNE (to_rep1 (select c4 4)) (to_rep1 (select b4 4)))))
...
;; H
  (assert
  (fp.isFinite64 (fp.add RNE (to_rep1 (select c4 4)) (to_rep1 (select b4 4)))))

;; H
  (assert (= o35 (store d3 4 o34)))
...
;; H
  (assert
  (fp.leq (to_rep1 (select d4 1)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))
...
;; H
  (assert
  (fp.leq (to_rep1 (select d4 2)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))
...
;; H
  (assert
  (fp.leq (to_rep1 (select d4 3)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))

(assert
;; WP_parameter_def
 ;; File "floats.adb", line 7, characters 0-0
  (not
  (fp.leq (to_rep1 (select d4 4)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
