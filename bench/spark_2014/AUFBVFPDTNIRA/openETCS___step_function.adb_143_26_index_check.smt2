...
;; H
  (assert
  (= o15 (select (rec__step_function__step_function_t__step
                 merge__split_fields3) o14)))
...
;; H
  ...
  (ite (fp.leq o13 o19) (fp.eq o20 o13) (fp.eq o20 o19)))))
