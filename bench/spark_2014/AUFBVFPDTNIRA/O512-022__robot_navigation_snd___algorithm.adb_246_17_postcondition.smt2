...
;; H
  (assert
  (=> (= result13 true)
  (= iterl__split_fields12 (us_split_fields5 temp___1102))))
...
;; H
  (assert
  (=> (= result13 true) (=> (= result17 true) (= o38 (to_rep5 o37)))))
...
;; H
  (assert
  (=> (= result13 true) (=> (= result16 true) (= o34 (to_rep5 o33)))))
...
;; H
  ...
  (= (bool_eq4 (mk___rep2 iterr__split_fields10) no_element) true))
  (= (range_equal
     (model__
     (mk___rep1
     (us_split_discrs1
     ...
     (- (get1
        ...
        (rec__algorithm__controller__gapvec
        (us_split_fields__content7 this__split_fields7)))))
        (mk___rep2 (us_split_fields__content2 iterr__split_fields8))) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep1
     (us_split_discrs1
...
;; H
  ...
  (=> (= result13 true)
  (=> (= result15 true)
  (= iterr__split_fields11 (mk___split_fields__ref2 iterr__split_fields10)))))
...
;; H
  (assert
  (=> (= result13 true)
  (= iterl__split_fields13 (mk___split_fields__ref2 iterl__split_fields12))))
...
;; WP_parameter_def
 ;; File "algorithm.adb", line 556, characters 0-0
  ...
  (fp.eq (to_rep6
         ...
         (us_split_fields11
         (rec__algorithm__controller__robot
         (us_split_fields__content7 this__split_fields14))))) (to_rep6
                                                              (rec__robot_iface__proxy__robot_radius
                                                              (us_split_fields11
                                                              (rec__algorithm__controller__robot
                                                              (us_split_fields__content7
