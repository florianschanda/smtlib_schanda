...
;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= (mk___split_fields4 temp___891
     (mk___rep (mk___split_fields temp___8911))) rayl__split_fields)))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= (mk___split_fields4 temp___890
     (mk___rep (mk___split_fields temp___8901))) rayr__split_fields)))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= temp___889 (mk___rep2 gapvec__split_discrs gapvec__split_fields))))
...
;; H
  ...
  (=> (and (<= 2 i1) (<= i1 999))
  (and
  (= algorithm__buildgapvector__B_9__dist__assume (fp.sub RNE (to_rep4
                                                              (rec__algorithm__laser_scan_data__first
                                                              rayl__split_fields2))
  (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))
  (fp.isFinite32 (fp.sub RNE (to_rep4
                             (rec__algorithm__laser_scan_data__first
...
;; H
  ...
  o5) (fp.leq o5 (fp #b0 #b01111111 #b00000000000000000000000)))
  (=> (fp.eq o4 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.eq o5 (fp #b0 #b01111111 #b00000000000000000000000)))))))

;; H
  (assert
  (and
  (= o2 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4
                                                                  (rec__algorithm__laser_scan_data__first
                                                                  rayr__split_fields7))))
  (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000)
  (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))

;; H
  (assert
  (= o3 (fp.mul RNE o2 (to_rep4
                       (rec__algorithm__laser_scan_data__first
                       rayl__split_fields7)))))

;; H
  (assert (and (= o6 o3) (fp.isFinite32 o3)))

;; H
  (assert (= o7 (fp.mul RNE o6 o5)))
