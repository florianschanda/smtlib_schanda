(set-info :source "Generated by Martin Brain on 2017-09-11 17:05:21+01:00 from revision 3122, file rewrite-rules.cpp (fdf03bf392b41a809f35d488ae2fd86b392eb758ad972ab139c17ad7613a9481bc2942baec2db40aedf37ca11151a5363c8a0bc29aa2e8ecd70d2a4c1592fbfd  rewrite-rules.cpp), benchmark divide_is_almost_multiply_by_reciprocal_sat using cbmc revision 6561 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function divide_is_almost_multiply_by_reciprocal_sat --round-to-minus-inf rewrite-rules.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
