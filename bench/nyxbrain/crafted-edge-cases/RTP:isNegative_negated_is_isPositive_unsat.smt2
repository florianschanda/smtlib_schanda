...
; set_to true (equal)
(define-fun |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; set_to true (equal)
(define-fun |smtlib_isNegative::smtlib_isNegative(float)::f@1#1| () (_ FloatingPoint 8 24) (fp.neg |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::f@1#1|))
...
(assert (= (select string.0(_ bv7 64)) (_ bv103 8)))
(assert (= (select string.0(_ bv8 64)) (_ bv97 8)))
...
; set_to true (equal)
(define-fun |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::1::neg@1#2| () Bool |smtlib_isNegative(float)#return_value!0#1|)

; set_to true (equal)
(define-fun |smtlib_isPositive::smtlib_isPositive(float)::f@1#1| () (_ FloatingPoint 8 24) |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::f@1#1|)
...
; set_to true (equal)
(define-fun |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::1::nor@1#2| () Bool |smtlib_isPositive(float)#return_value!0#1|)

; set_to false
(assert (not (= |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::1::neg@1#2| |isNegative_negated_is_isPositive_unsat::isNegative_negated_is_isPositive_unsat(float)::1::nor@1#2|)))
